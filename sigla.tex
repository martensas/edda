...
\begin{itemize}%
	...
	\item \textbf{\textlink{Alvissmal}} = \emph{Alvíssmǫ́l} (Speeches of Allwise)
	\item \textbf{\textlink{Atlakvida}} = \emph{Atlakviða} (Lay of Attle)
	\item \textbf{\textlink{Atlamal}} = \emph{Atlamǫ́l} (Speeches of Attle)
	\item \textbf{\textlink{Baldrsdraumar}} = \emph{Baldrs draumar} (Dreams of Balder)
	\item \Beowulf\ = \emph{Beowulf}
	\item \textbf{\textlink{Brot}} = \emph{Brot af Sig·urðarkviða} (Fragment of a Lay of Siward)
	\item \Deor\ = \emph{Déor} (Deer)
	\item \EyrbyggjaSaga\ = \emph{Eyrbyggja saga} (Saw of the Ere-dwellers)
	\item \textbf{\textlink{Fafnismal}} = \emph{Fáfnismǫ́l} (Speeches of Fathomer)
	...
	\item \textbf{\textlink{Gripisspa}} = \emph{Grípisspǫ́} (Spae of Griper)
	\item \Grottasongr\ = \emph{Grottasǫngr} (Song of Grotte)
	\item \Grougaldr\ = \emph{Gróugaldr} (Galder of Growe)
	\item \textbf{\textlink{Gudrunarhvot}} = \emph{Guð·ru̇narhvǫt} (Goading of Guthrun)
	\item \textbf{\textlink{GudrunOne}} = \emph{Guð·ru̇narkviða I} (First Lay of Guthrun)
	\item \textbf{\textlink{GudrunTwo}} = \emph{Guð·ru̇narkviða II} (Second Lay of Guthrun)
	\item \textbf{\textlink{GudrunThree}} = \emph{Guð·ru̇narkviða III} (Third Lay of Guthrun)
	...
	\item \textbf{\textlink{Hamdismal}} = \emph{Hamðismǫ́l} (Speeches of Hamthew)
	\item \textbf{\textlink{Harbardsljod}} = \emph{Hárbarðljóð} (Leeds of Hoarbeard)
	\item \Haustlong\ = \emph{Haustlǫng} (Harvest‑Long), Þjóð \emph{Haustl} in \Skp\ 3
	\item \textbf{\textlink{Havamal}} = \emph{Hávamǫ́l} (Speeches of the High One)
	\item \textbf{\textlink{HelgakvidaHjorvardssonar}} = \emph{Helgakviða Hjǫrvarðssonar} (Lay of Hallow Harwardson)
	\item \textbf{\textlink{HelgakvidaOne}} = \emph{Helgakviða Hundingsbana I} (First Lay of Hallow Hundingsbane)
	\item \textbf{\textlink{HelgakvidaTwo}} = \emph{Helgakviða Hundingsbana II} (Second Lay of Hallow Hundingsbane)
	\item \textbf{\textlink{Heliand}} = \emph{Heliand}
	\item \textbf{\textlink{Helreid}} = \emph{Helreið Bryn·hildar} (Hell‑ride of Byrnhild)
	\item \HervararSaga\ = \emph{Hervarar saga} (Saw of Harware and Heathric)
	\item \textbf{\textlink{Hildebrandslied}} = \emph{Hildebrandslied}
	\item \textbf{\textlink{Hymiskvida}} = \emph{Hymiskviða} (Lay of Hymer)
	\item \textbf{\textlink{Hyndluljod}} = \emph{Hyndluljóð} (Leeds of Hindle)
	\item \textbf{\textlink{Lokasenna}} = \emph{Lokasenna} (Flyting of Lock)
	...
	\item \textbf{\textlink{Oddrunargratr}} = \emph{Odd·rúnargrátr} (Weeping of Ordrun)
	\item \Ragnarsdrapa\ = \emph{Ragnarsdrápa} (Drape of Rainer), Bragi \emph{Rdr} in \Skp\ 3
	\item \textbf{\textlink{Reginsmal}} = \emph{Ręginsmǫ́l} (Speeches of Rein)
	\item \textbf{\textlink{Rigsthula}} = \emph{Rigsþula} (Thule of Righ)
	...
	\item \textbf{\textlink{Sigurdskamma}} = \emph{Sig·urðarkviða skamma} (Short Lay of Siward)
	\item \textbf{\textlink{Sigrdrifumal}} = \emph{Sigrdrífumǫ́l} (Speeches of Syedrive)
	\item \Skaldskaparmal\ = \emph{Skaldskaparmǫ́l} (Matter of Scoldship)
	\item \textbf{\textlink{Skirnismal}} = \emph{Skírnismǫ́l} (Speeches of Shirner)
	\item \Thorsdrapa\ = \emph{Þórsdrápa} (Drape of Thunder)
	\item \textbf{\textlink{Thrymskvida}} = \emph{Þrymskviða} (Lay of Thrim)
	\item \textbf{\textlink{Vafthrudnismal}} = \emph{Vafþrúðnismǫ́l} (Speeches of Webthrithner)
	\item \Volsathattr\ = \emph{Vǫlsaþáttr} (Strand of Walse)
	\item \VolsungaSaga\ = \emph{Vǫlsunga saga} (Saw of the Walsings)
	\item \textbf{\textlink{Volundarkvida}} = \emph{Vǫlundarkviða} (Lay of Wayland)
	\item \textbf{\textlink{Voluspa}} = \emph{Vǫluspǫ́} (Spae of the Wallow)
\end{itemize}%
