...
\begin{itemize}%
	...
	\item \Brot\ = \emph{Brot af Sig·urðarkviða} (Fragment of a Lay of Siward)
	...
	\item \Helreid\ = \emph{Helreið Bryn·hildar} (Hell‑ride of Byrnhild)
	...
	\item \Sigurdskamma\ = \emph{Sig·urðarkviða skamma} (Short Lay of Siward)
