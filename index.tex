...
\inxitem[P]{Homedall} (ON \emph{Hęim·dal(l)r}, OE \emph{*Hâm·deall})
  The Watchman of the Gods (\emph{vǫrðr goða} \textlink{Grimnismal} 13, \textlink{Lokasenna} 48), whose home is the \inx[P]{Heavenbarrows} (\textlink{Grimnismal} 13).  According to \textlink{Rigsthula} he fathered the three castes of men, which may also be referenced in \textlink{Voluspa} 1/2b.  He is the whitest of the \inx[P]{Eese} (\textlink{Thrymskvida} 15).  Homedall was the subject of the lost poem “Homedall’s galder” (\emph{Hęimdallargaldr}), of which only two lines survive; see \textlink{EddicFragments}[3].
...
\inxitem[P]{Wolder} (ON \emph{Ullr}, \emph{*Wuldor}, PNWGmc. \emph{*Wulþuz})
