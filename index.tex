...
\inxitem[P]{Homedal} (ON \emph{Hęimdal(l)r}, OE \emph{*Hâmdeall})
  The Watchman of the Gods (\emph{vǫrðr goða} \textlink{Grimnismal} 13, \textlink{Lokasenna} 48), whose home is the \inx[L]{Heavenbarrows} (\textlink{Grimnismal} 13).  According to \textlink{Rigsthula} he fathered the three castes of men, which may also be referenced in \textlink{Voluspa} 1/2b.  He is the whitest of the \inx[G]{Eese} (\textlink{Thrymskvida} 15).  Homedal was the subject of the lost poem “Homedal’s galder” (\emph{Hęimdallargaldr}), of which only two lines survive; see Eddic Fragment 3 under Mythic Poetry.
