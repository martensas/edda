...
\inxitem{thill}[C] (ON. \emph{þylja})
  To chant poetry or lists (so called \inx[C]{thules}[thule]) acquired by rote memorization. See also {thyle}[C].
...
\inxitem{Wonnel}[P] (ON. \emph{Váli}, PWgmc. \emph{Wanila} ‘the little \inx[P]{Wanes}[Wane] (uncertain)’)
...
\inxitem{Yivickings}[G] (ON. \emph{gjúkungar})
...
\inxitem{Ettinham}[L] (ON. \emph{Jǫtunhęimr}, \emph{Jǫtnahęimr})
...
\inxitem{Rakes of the Reins}[L] (ON. \emph{ragna rǫk})
  The ‘fates of the \inx[G]{Reins}’, euphemism for the destruction of the world.

\inxitem{Rakes of the Tues}[L] (ON. \emph{tíva rǫk})
  The \inx[L]{Rakes of the Reins}.

\inxitem{Up-heaven}[L] (ON. \emph{Upphiminn}, OE. \emph{Upheofon}, OS. \emph{Upphimil}, OHG. \emph{úfhimil})
