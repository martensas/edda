...
\inxitem[C]{Doom} (ON \emph{dómr}, OE \emph{dóm})
  ...
  Other illustrative examples in \Beowulf\ include 884b–887a: \emph{[...] Sige-munde ge·sprǫng / æfter déað-dæge \hld\ \textbf{dóm} un-lýtel / syþðan wíges heard \hld\ wyrm á·cwealde / hordes hyrde [...]} ‘For \inx[P]{Syemund} sprang up / after his death-day an unlittle \ken*{= great} \textbf{Doom}, / since hard in conflict he defeated the \inx[C]{Wyrm}, / the hoard’s herder.’
  and 953b–955a: \emph{[...] þú þé self hafast // dę́dum ge·fręmed \hld\ þæt þín \textbf{dóm} lyfað // áwa tó aldre [...]} ‘Thou hast for thyself by deeds accomplished that thy \textbf{Doom} lives for ever and ever.’

\inxitem[P]{feather-hame} (ON \emph{fjaðr-hamr}, OE \emph{feðer-hama}, OS \emph{feðar-}, \emph{feðer-hamo})
  A plumage which when donned by the wearer let him fly like, or become, a bird.  One is owned by Frow and used by Lock to fly between the homes.  In the \Heliand\ feather-hames are donned by angels who fly from heaven to earth. See also \inx[C]{hame}.
...
\inxitem[C]{nithe} (ON \emph{níð}, OE \emph{níþ}, OHG \emph{níd})
  Originally ‘hatred, emnity’.  In the Norse the sense is something like ‘shame’ which was not just a social abstraction, but almost a tangible thing.  So the curse ritual where the curser would “turn nithe” (\emph{snýja níð} against his enemy to cause him great misfortune.  A poet would “compose nithe” (\emph{yrkja níð}) through singing slanderous verses, which likewise had a adverse effect on their subject.  See also \inx[C]{nithing}.
...
\inxitem[C]{wale} (ON \emph{vǫlr})
  The staff or sceptre of a wallow.  TODO: archeological finds, mention Sutton Hoo.
...
\inxitem[P]{Fathomer} (ON \emph{Fáfnir})
  The \inx[C]{wyrm} slain by \inx[P]{Siward}, who was originally a man.  Son of \inx[P]{Rethmar}, brother of \inx[P]{Otter} and \inx[P]{Rein}.
...
\inxitem[P]{Syemund} (ON \emph{Sig-mundr}, OE \emph{Sige-mund}, MHG. \emph{Sieg-mund}, PNWGmc. \emph{*Sigi-munduʀ})
  In the Norse tradition the son of \inx[C]{Walsing} and father of \inx[P]{Siward}.  In \Beowulf\ it is instead Syemund himself who slays an unnamed wyrm.  Connected with his nephew \inx[P]{Sinfittle}.
...
\inxitem[P]{Webthrithner} (ON \emph{Vafþrúðnir})
  Ettin defeated by Weden in the wisdom contest in \Vafthrudnismal.
...
\inxitem[G]{All Gods} (ON \emph{ǫll goð})
  Occurs in ritual or ritual-adjacent use (see note to \Grimnismal\ 43, \Sigrdrifumal\ 2–3, \Lokasenna\ 11), strongly suggesting a conception of Godly Oneness (Divine Unity).  Compare the \inx[G]{Thing of the Gods}.
...
\inxitem[G]{Nears} (ON \emph{níarar} \char`~ \emph{njárar})
  A Swedish tribe, only mentioned in \Volundarkvida, where it is ruled by king \inx[P]{Nithad}.  The name and location may allow us to connect them with the Swedish province of Närke, cf. Old Swedish \emph{Nærikiar} ‘inhabitants of Närke’, \emph{Nærisker} ‘belonging to Närke; Nearish’.  The Old Swedish stem \emph{nær-} (with unclear vowel length, though it is probably long) would be a reduced form of \emph{níar-}, \emph{njár-}.
...
\inxitem[G]{Ossens} (ON \emph{ǫ́synjur})
  The wives of the \inx[G]{Eese}, see there.
...
\inxitem[L]{Thing of the Gods} (ON \emph{þing goða})
  The Divine Council or Assembly, where the Gods convene and make decisions; a conception well known from Near Eastern literature.  The Thing is only attended by the male Gods (\inx[G]{Eese}, \Baldrsdraumar\ 1, \Thrymskvida\ 14); it is held every day (\Grimnismal\ TODO).  According to Snorre twelve Gods apart from Weden were present at the Thing (viz. Thunder, Nearth, Free, Tew, Homedall, Bray, Wither, Wonnel, Woulder, Heener, Forset, Lock); this certainly corresponds to the Scandinavian and English jury of twelve men.
  Occurrences: \Voluspa\ 6, 9, etc, \Hymiskvida\ TODO.
...
\inxitem[F]{Earth and Up-heaven} (ON \emph{jǫrð \& upphiminn}, OE \emph{eorþe \& upheofon}, PGmc. \emph{*erþō \& uphiminaz})
  An ancient poetic merism meaning “the world”; used especially about the creation and destruction of the world, and in prayers.
  ON: Ribe Galder, \Voluspa\ 3, \Vafthrudnismal\ 20, \Thrymskvida\ 2, \Oddrunargratr\ 17; OE: \emph{Acreboot}; OHG: \emph{Wessobrunner Hymn}
