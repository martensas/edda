...
\inxitem[P]{Mundlefare} (ON \emph{Mundilfari})
  The father of \inx[P]{Sun} and \inx[P]{Moon} (\Vafthrudnismal\ 23).  Perhaps ‘Axle-goer’, if the first element = ON \emph{mǫndull} ‘handle of a mill’; in any case connected to the turning of the Heavens.
