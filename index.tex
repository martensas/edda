...
\inxitem[P]{Homedall} (ON \emph{Hęimdallr}, OE \emph{*Hámdall})
  Ward of the gods, whitest of the \inx[G]{Eese}.
...
\inxitem[P]{Shede} (ON \emph{Skaði}, OE \emph{Scede}(?), PGmc. \emph{Skadī})
  A female figure, possibly the namesake of \inx[L]{Shedeny} and the \inx[L]{Shedelands}, in which case she was in an early period closely associated with, and perhaps thought to guard, the Scandinavian (or properly \emph{Scadinavian}, see Shedeny) peninsula. In the Norse the daughter of \inx[P]{Thedse}, and later wife of \inx[P]{Nearth}.
...
\inxitem[P]{Sithguth} (OHG \emph{Sinthgunt}, PNWGmc. \emph{*Sinþa-gunþiz}(?))
...
\inxitem[P]{Wider} (ON \emph{Víðarr}, OE \emph{*Wídhere}, PNWGmc. \emph{*Wída-harjaʀ})
...
\inxitem[G]{All Gods} (ON \emph{ǫll goð})
  Occurs in ritual or ritual-adjacent use (see note to \Grimnismal\ 43, \Sigrdrifumal\ 2–3, \Lokasenna\ 11), which suggests a godly Oneness.  Related is the \inx[C]{Thing} of “all” Gods as found in the three lines shared between \Baldrsdraumar\ 1 and \Thrymskvida\ 14 and in the two lines repeated in \Voluspa\ 6, 9, &c.
...
\inxitem[L]{Geatland} (ON \emph{Gautland, Gautaland})
