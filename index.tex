...
\inxitem[C]{hold} (ON \emph{hollr}, OE \emph{hold}, OS \emph{hold}, OHG \emph{hold})
  ...
  So \textlink{Lokasenna} 4 (e.): \emph{holl ręgin} ‘\textbf{hold} \inx[G]{Reins}’, and \textlink{Oddrunargratr} 9/1: \emph{Svá hjalpi þér \hld\ hollar véttir} ‘So help thee \textbf{hold} \inx[C]{wights}’. %TODO: Numbering of Oddrunargratr is very uncertain.
...
\inxitem[C]{leek} (ON \emph{laukr}, OE \emph{léac}, PNWGmc \emph{laukaʀ})
  The leek was a plant of great cultural importance.  It was seen as the noblest plant, so \textlink{GudrunTwo} 2, where \inx[P]{Siward}’s superiority to the \inx[P]{Yivickings} is compared to a stag among wild beasts, gold among silver, and a green leek in grass; and \textlink{Voluspa} 4, where the earth of the \inx[L]{Golden Age} was grown with green leek.
...
\inxitem[C]{Tables} (ON \emph{tafl}, OE \emph{tæfl})
  Generic term for board games (e.g. chess).  In the \inx[C]{golden age} the \inx[G]{Eese} played such games (\textlink{Voluspa} 8).  Pre-Christian Germanic burials commonly feature boards and bricks (TODO: reference, maybe to the Salme ship burials).
...
\inxitem[P]{Hain}[Hain 1] (ON \emph{Hǫgni}, OE \emph{Haguna}, \emph{Hagena}, OHG \emph{Hagano}, Ger. \emph{Hagen}, PNWGmc. \emph{*Hagunó})
  A \inx[G]{Nivlings}[Nivling] and \inx[G]{Yivickings}[Yivicking], son of king \inx[P]{Yivick}, brother of \inx[P]{Guther} and \inx[P]{Guthrun}. In \textlink{Atlakvida} he defeats seven warriors before being captured by \inx[P]{Attle}, who has his heart cut out at the request of Guther.
...
\inxitem[P]{Homedal} (ON \emph{Hęim·dal(l)r}, OE \emph{*Hâm·deall})
  The Watchman of the Gods (\emph{vǫrðr goða} \textlink{Grimnismal} 13, \textlink{Lokasenna} 48), whose home is the \inx[L]{Heavenbarrows} (\textlink{Grimnismal} 13).  According to \textlink{Rigsthula} he fathered the three castes of men, which may also be referenced in \textlink{Voluspa} 1/2b.  He is the whitest of the \inx[G]{Eese} (\textlink{Thrymskvida} 15).  Homedal was the subject of the lost poem “Homedal’s galder” (\emph{Hęimdallargaldr}), of which only two lines survive; see \textlink{EddicFragments}[3].
...
\inxitem[P]{Mundlefarer} (ON \emph{Mundilfǿri} or \emph{Mundilfari})
  The father of \inx[P]{Sun} and \inx[P]{Moon} (\textlink{Vafthrudnismal} 23).  Perhaps ‘Millhandle-turner’, if the first element = ON \emph{mǫndull} ‘handle of a mill’.
...
\inxitem[P]{Wayland} (ON \emph{Vǫlundr}, OE \emph{Wéland, Wélund})
  A legendary smith captured by the tyrannical king \inx[P]{Nithad}.  In both the Norse \textlink{Volundarkvida} and English \Deor\ he takes his revenge by first killing Nithad’s unnamed sons and then raping his daughter \inx[P]{Beadhild}.  In the Norse version he is married to \inx[P]{Harware Elwight}.
...
\inxitem[P]{Wing-Thunder} (ON \emph{Ving-Þȯrr})
  ...
  \textlink{Thrymskvida}[1] (see there for etymology), \textlink{Alvissmal}[6].
...
\inxitem[P]{Yimer} (ON \emph{Ymir}, OE \emph{*Yime})
  The primeval ancestor of the \inx[G]{Ettins}, probably equivalent to \inx[P]{Earyelmer}.  The first Gods sacrificed Yimer and created the world from his corpse (\textlink{Vafthrudnismal} 21, \textlink{Grimnismal}[41]–42).
...
\inxitem[G]{Nears} (ON \emph{njárar} \char`~\ \emph{níarar})
  An old Swedish tribe mentioned in \textlink{Volundarkvida}, where it is ruled by king \inx[P]{Nithad}.  The location may allow us to connect them with the Swedish province of Närke, cf. Old Swedish \emph{Næríkjar} ‘inhabitants of Närke’, \emph{Nærisker} ‘belonging to Närke’.  The Old Swedish stem \emph{nær-} (with unclear vowel length, though it is probably long) would then be a reduced form of \emph{níar-}, \emph{njár-}.
...
\inxitem[G]{Reins} (ON \emph{rǫgn}, \emph{ręgin})
  The heavenly powers.  Judging from \textlink{Vafthrudnismal} TODO the term may be more closely associated with the \inx[G]{Wanes} than the \inx[G]{Eese}.
...
\inxitem[L]{Gap of Hawks} (ON \emph{Ginnunga-gap})
  \emph{ginnungr} ‘ginning’ being a poetic name for the hawk.  The air or lower atmospheric sky, which in the old Germanic cosmology is the midspace between \inx[L]{Earth} and \inx[L]{Upheaven}; not synonymous with the latter.  In the Eddic corpus only occurring once in \textlink{Voluspa} 3; see note there.  It is more prevalent in \Gylfaginning.
...
\inxitem[L]{Idewolds} (ON \emph{Iða-vęllir})
  The ‘Plains of Industry’, where the Gods settled and built Osyard.  Mentioned in \textlink{Voluspa}.
...
\inxitem[L]{Middenyard} (ON \emph{Mið-garðr}, OE \emph{Middan-geard}, OS \emph{Middil-gard}, OHG \emph{Mittil-gart}, Got. \emph{midjun-gards})
  The ‘Middle Enclosure’, which the Gods made as a home for men.  The enclosing poles were the hair-strands of \inx[P]{Yimer}’s eyebrows (\textlink{Grimnismal} 42); Middenyard is defended by \inx[P]{Thunder} (\textlink{Harbardsljod} TODO, \textlink{Voluspa} 53).  See also \inx[L]{Osyard}, \inx[L]{Outyards}.
  \textbf{Occurrences:} \textlink{Voluspa} 4, 53, \textlink{Grimnismal} 42, \textlink{Harbardsljod} TODO.
...
\inxitem[L]{Rakes of the Reins} (ON \emph{ragna rǫk})
  The ‘judgments, fated events of the \inx[G]{Reins}’, namely the destruction of the world as narrated most completely in \textlink{Voluspa}.

\inxitem[L]{Rakes of the Tews} (ON \emph{tíva rǫk})
  See \inx[L]{Rakes of the Reins}.

\inxitem[L]{Thing of the Gods} (ON \emph{þing goða})
  The Divine Council or Assembly, where the Gods convene and make decisions; a conception well known from Near Eastern literature.  Like the historical Germanic assemblies, the Thing is only attended by the male \inx[G]{Eese}, whereas the \inx[G]{Ossens} are \emph{á máli} ‘at speech’ (\textlink{Baldrsdraumar} 1, \textlink{Thrymskvida} 14).  The Thing is held every day at \inx[L]{Ugdrassle’s Ash}; Thunder wades to it, and the other Eese ride to it (\textlink{Grimnismal} 29–30).  Thirteen Gods were present at the Thing: \inx[P]{Weden}, \inx[P]{Thunder}, \inx[P]{Nearth}, \inx[P]{Free}, \inx[P]{Tew}, \inx[P]{Homedal}, \inx[P]{Bray}, \inx[P]{Wider}, \inx[P]{Wonnel}, \inx[P]{Woulder}, \inx[P]{Heener}, \inx[P]{Foresitter}, \inx[P]{Lock}) (\Gylfaginning\ TODO).  With Lock excluded this makes twelve, which corresponds to the Old Germanic jury of twelve men.
...
\inxitem[L]{Walhall} (ON \emph{Valhǫll}, OE \emph{*Wælheall})
  ...
  \textlink{Voluspa} 33/4a, \textlink{Grimnismal} 8/2, 24/2, \textlink{Hyndluljod} 1/4a, \textlink{HelgakvidaTwo} P2, \textlink{Atlakvida} 2/2a(?), Icelandic Rune Poem 4/2, Eddic Fragment 7/1.
\end{itemize}
