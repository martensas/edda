...
\inxitem[C]{guest} (ON \emph{gęstr}, OE \emph{giest}, OS \emph{gast}, OHG \emph{gast}, Got. \emph{gasts}, PGmc. \emph{gastiz})
  The Old Germanic peoples placed great value on hospitality. TODO.
...
\inxitem[C]{harrow} (ON \emph{hǫrgr}, OE \emph{hearg}, PNWGmc. \emph{*harugaʀ})
  A cairn built for ritual. \Hyndluljod\ 10 describes the construction of one. The Norwegian laws prescribe the “breaking of harrows and burning of hoves”.
...
\inxitem[G]{All Gods} (ON \emph{ǫll goð})
  Occurs in ritual or ritual-adjacent use (see note to \Grimnismal\ 43, \Sigrdrifumal\ 2–3, \Lokasenna\ 11), strongly suggesting a conception of Godly Oneness (Divine Unity).  Compare the \inx[L]{Thing of the Gods}.
...
\inxitem[L]{Thing of the Gods} (ON \emph{þing goða})
  The Divine Council or Assembly, where the Gods convene and make decisions; a conception well known from Near Eastern literature.  Like the historical Germanic assemblies, the Thing is only attended by the male \inx[G]{Eese}, whereas the \inx[G]{Ossens} are \emph{á máli} ‘at speech’ (\Baldrsdraumar\ 1, \Thrymskvida\ 14).  The Thing is held every day at \inx[L]{Ugdrassle’s Ash}; Thunder wades to it, and the other Eese ride to it (\Grimnismal\ 29–30).  Twelve Gods, apart from \inx[C]{Weden}, were present at the Thing (viz. \inx[P]{Thunder}, \inx[P]{Nearth}, \inx[P]{Free}, \inx[P]{Tew}, \inx[P]{Homedall}, \inx[P]{Bray}, \inx[P]{Wither}, \inx[P]{Wonnel}, \inx[P]{Woulder}, \inx[P]{Heener}, \inx[P]{Forset}, \inx[P]{Lock}) (\Gylfaginning\ TODO).  With Lock excluded this makes twelve, which certainly corresponds to the Scandinavian and English jury of twelve men.
