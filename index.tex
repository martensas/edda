...
\inxitem[P]{Homedal} (ON \emph{Hęimdal(l)r}, OE \emph{*Hâmdeall})
  The Watchman of the Gods (\emph{vǫrðr goða}, \Grimnismal\ 13, \Lokasenna\ 48), whose home is the \inx[L]{Heavenbarrows} (\Grimnismal\ 13).  He is the whitest of the \inx[G]{Eese} (\Thrymskvida\ 15).  Homedal was the subject of the lost poem “Homedal’s galder” (\emph{Hęimdallargaldr}), of which only two lines survive; see Eddic Fragments from Snorre’s Edda.
...
\inxitem[L]{Middenyard} (ON \emph{Mið-garðr}, OE \emph{Middan-geard}, OS \emph{Middil-gard}, OHG \emph{Mittil-gart}, Got. \emph{midjun-gards})
  The ‘Middle Enclosure’, which the Gods made as a home for men.  The enclosing poles were the hair-strands of \inx[P]{Yimer}’s eyebrows (\Grimnismal\ 42); Middenyard is defended by \inx[P]{Thunder} (\Harbardsljod\ TODO, \Voluspa\ 54).  See also \inx[L]{Osyard}, \inx[L]{Outyards}.
