...
\inxitem[P]{Wing-Thunder} (ON \emph{Ving-Þórr})
  ...
  Occurs in \Thrymskvida\ 1, \Alvissmal\ 6.
...
\inxitem[L]{Gap of Hawks} (ON \emph{Ginnunga-gap})
  \emph{ginnungr} ‘ginning’ being a poetic name for the hawk.  The air or lower atmospheric sky, which in the old Germanic cosmology is the midspace between \inx[L]{Earth} and \inx[L]{Upheaven}; not synonymous with the latter.  In the Eddic corpus only occurring once in \Voluspa\ 3; see note there.  It is more prevalent in \Gylfaginning.
