...
% Theology, mythology, independent order
	\include{books/01 Spae of the Wallow.tex}% — General introduction
%	\include{books/02 Speeches of Webthrithner.tex}% — Weeden
%	\include{books/03 Speeches of the High One.tex}% — Weeden
%	\include{books/04 From the Sons of king Reeding.tex}% — Weeden
%	\include{books/05 Speeches of Grimner.tex}% — Weeden
%	\include{books/Leed of Hoarbeard.tex}% — Weeden + Thunder
%	\include{books/Lay of Hymer.tex}% — Thunder
...
%	\include{books/The Thule of Righ.tex}% — Society
%
% Heroic poems, order of the Codex Regius
%	\include{books/First Lay of Hallow Hundingsbane.tex}
%	\include{books/Second lay of Hallow Hundingsbane.tex}f
