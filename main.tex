...
% Verse format commands
	...
	\NewDocumentCommand{\bva}{o}{% Begin verse a
		...
		\newdimen\width% Display verse number; offset it from the base line (is this too hacky?)
		\setbox0=\hbox{\textbf{\arabic{versea} }}%
		\width=\wd0 \advance\width by \dp0%
		\hspace{-\the\width}\textbf{\arabic{versea} }%
	}
