...
\newbibmacro*{textciteshorthand}{% Cite short hands. From Stack Exchange: https://tex.stackexchange.com/questions/489928/biblatex-apa-textcite-with-shorttitle
  \ifbool{cbx:parens}
...
\DeclareCiteCommand{\textciteshorthand}
  ...
  {\usebibmacro{citeindex}%
   \usebibmacro{textciteshorthand}}
  {}
  {\usebibmacro{textcite:postnote}%
   \usebibmacro{cite:post}%
}

\newbibmacro*{parenciteshorthand}{%
  \printfield[bibhyperref]{shorthand}%
}
...
\DeclareCiteCommand{\parenciteshorthand}[\mkbibparens]
  {\usebibmacro{cite:init}%
   \usebibmacro{prenote}}
  {\usebibmacro{citeindex}%
   \usebibmacro{parenciteshorthand}}
  {\multicitedelim}
