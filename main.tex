...
\usepackage[colorlinks=true]{hyperref}% For linking within the pdf
...
%		\setcounter{footnoteB}{0}% Not currently using these.
	...
	\NewDocumentCommand{\bva}{o o}{% Begin verse a
		...
		\IfValueTF{#1}{%
			\numberstanzafalse% If optional verse/stanza number exists or = 0 we disable the automatic numbering
		}{%
			\numberstanzatrue%
			\Xstanzaonlyfirst% For printing the stanza number in the apparatus
		}%
...
% Formatting of footnotes and critical apparatus
	...
	\NewDocumentCommand{\edtrans}{m m m}{%
		\edtext{#1}{\lemma{\textnormal{#1} ‘#2’}#3}%TODO: textnormal doesn't work
	}
...
% Encyclopedia commands
	\NewDocumentCommand{\inx}{o m O{#2}}{% Encyclopedia link (type, link, optional alt display)
		\IfNoValueTF{#1}{% TODO: phase this out
			...
			\hyperref[#1:#2]{#3}%\hyperref[#1:#2]{#3\textsuperscript{#1}
		}%
	}
