...
\renewbibmacro*{begentry}{%
  \iffieldundef{shorthand}
    {} % Do nothing if there is no shorthand
    {\printfield[plain]{shorthand}%
     \printunit*{\addspace=\space}}%
}

\DeclareSortingTemplate{includeshorthands}{
  \sort{
    \field{shorthand}
    \field{shorttitle}
    \name{author}
...
\ExecuteBibliographyOptions{sorting=includeshorthands}
