...
\Ballnote{The exact narrative referred to in the stanza is hard to pin down.  One possibility is that Weden swore an oath on a bigh (an armring) to marry Guthlathe; Sutting then hosted a banquet (simble) for the couple (cf. \emph{hins hindra dags} in st. 109), and Weden slept with her and then stole the mead.}%
