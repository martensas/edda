...
\ind í \alst{g}arði \alst{G}unnlaðar.}{\lemma{TODO}\Bfootnote{Weden stole the mead of poetry by seducing Guthlathe who was set to guard it, as told below in sts. 103–110.  Weden does indeed drink all of the mead, but he soon spits it out again and shows no adverse effects.  This suggests that the present stanza may be referring to a variant conception, where the mead has drawbacks of normal alcohol.  If this is the case it would lend support to the theory that the Guest-strand and the later parts of \Havamal\ were originally separate compositions.  See note to 14/1–2.}}\eva
...
\ind at hins \alst{f}róða \alst{F}jalars}{\lemma{TODO}\Bfootnote{Another reference to the Mead of Poetry, for Fealer was one of the two dwarfs who slew Quasher and made the mead.  Again the sense seems to be that Weden got drunk on it.}}; &
