...
\bvb Know, if thou have a friend, one which thou well trust, \\
...
\bvb If thou have another, one which thou badly trust, \\
...
and Guthlathe, made to weep.\evb\evg
...
\inx[C]{Thing}’s or ruler’s speech; \\
...
thou wilt have use if thou learn, \\
they will be good for thee if thou get: \\
Know, if thou have a friend, one which thou well trust: \\
...
out of that one which hangs with hides, \\
...
to open up for all.\footnoteB{i.e. the beam of the gate in front of the farm.} \\
...
\bvg\bva Við \edtext{\alst{h}lęifi mik sǿldu-t \hld\ né við \alst{h}orni-gi}{\lemma{hlęifi \dots\ horni-gi ‘loaf \dots\ horn’}\Bfootnote{i.e. “I had neither bread nor water”.}}; &
...
\ind \alst{B}ǫlþorns, \alst{B}ęstlu fǫður,}{\lemma{hinum frę́gja syni Bǫlþorns, Bęstlu fǫður ‘the famous son of Balethorn, Bestle’s father’}\Bfootnote{According to \Gylfaginning\ 6, Byre got for his wife Bestle, the daughter of the ettin Balethorn.  By her he fathered three sons: Weden, Will and Wigh.  The “famous son of Balethorn” mentioned here is then Weden’s maternal uncle, which reflects an old Germanic (and more broadly European) custom of sending sons away to be fostered by their mother’s brothers or father.  Cf. TODO: some reference.}} &
...
poured [from] \inx[P]{Woderearer}.\evb\evg


\bvg\bva Þȧ \edtrans{nam’k \alst{f}rę́vask}{I took to flourish}{\Bfootnote{A notorious mistranslation (TODO: source) has rendered these words as “I took semen”, seeing in them a reference to Weden “taking” the seed from hanged men in order to replenish his own powers (something not otherwise attested).  This absurd notion which is probably based on the word \emph{frę́} ‘seed’ makes no sense in the context of the text and has no philological grounding.  \emph{frę́vask} is without doubt a reflexive verb, and \emph{frę́} is used of plant seeds, not ejaculate.}} \hld\ ok \alst{f}róðr vesa &
...
\bvb Then I took to flourish, and be learned, \\
...
\emph{him} the harms eat, rather than me.\evb\evg
