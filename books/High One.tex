...
\edtrans{\alst{B}ú es \alst{b}ętra, \hld\ þótt lítit sé}{A dwelling is better though small it be}{\Bfootnote{The b-line is missing the necessary alliteration, but no good emendation suggests itself.}}, &
...
Ï \alst{v}indi skal \alst{v}ið hǫggva, \hld\ \edtrans{\alst{v}eðri}{weather}{\Bfootnote{i.e. ‘in good weather’; elsewhere the word \emph{veðr} typically means ‘storm’, but that can hardly be the sense here.}} ȧ sę́ róa, &
