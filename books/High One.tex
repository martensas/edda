...
The \textbf{Speeches of the High One} (\Havamal) is the second poem of \Regius, where it follows \textlink{Voluspa} and is followed by \Vafthrudnismal.  \Regius\ is the only mediæval manuscript witness for the whole poem, but several sts. (e.g. 1, 58, 84) are cited in other texts.
