...
\bvg
\bva Es-at maðr \alst{a}lls ve-sall, \hld\ þótt sé \alst{i}lla hęill, &
...
\bvg
\bva Bętra ’s \alst{l}ifðum, \hld\ \edtrans{an sé ó-\alst{l}ifðum}{than with the unliving}{\Bfootnote{emend; \emph{⁊ ſęl lıfðo}m \Regius. — The surface reading, \emph{ok sę́llifðum} ‘and with the joy-living’ is metrically defect; \emph{sę́l-} must be strongly stressed and thus carry alliteration. On the other hand an identical construction is found in \Fafnismal\ 30: \emph{Hvǫtum ’s bętra \hld\ an sé óhvǫtum} ‘With the brisk ’tis better than with the unbrisk’. The corruption is understandable; \emph{en}, younger form of \emph{an} ‘than’ was interpreted as \emph{en} ‘and’ and thus copied as ⁊ (the tironian \emph{et}), while \emph{*se ólıfðo}m (probably with the words cramped together) became \emph{sęl lıfðo}m.}}, &
...
\bvb ’Tis better with the living than with the unliving: ever gets the quick\footnoteB{i.e. the living.} a cow.\footnoteB{A reference to the cattle-based economy (see also st. 76), the cow being used as a metonym. The meaning is that new opportunities always present themselves.} A fire\footnoteB{His funeral-pyre.} I saw burning high for a wealthy man, but outside he was dead before the door.\evb
\evg
