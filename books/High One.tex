...
The \textbf{Speeches of the High One} (\textlink{Havamal}) is the second poem of \Regius, where it follows \textlink{Voluspa} and is followed by \textlink{Vafthrudnismal}.  \Regius\ is the only mediæval manuscript witness for the whole poem, but several sts. (e.g. 1, 58, 84) are cited in other texts.

\textlink{Havamal} is, as it comes down to us in \Regius, a varied collection.  It contains at least two poems of practical life advice, two mythological narratives, scattered gnomic poetry about runes, and a list of galders.  These materials are chiefly united by their attribution to the god Weden, or as he is called in 109, 111, and 166, the High One.
...
\ind svá \edtext{nýsisk \alst{f}róðra hvęrr \alst{f}yrir}{\lemma{nýsisk fyrir ‘looks ahead’}\Bfootnote{This verb underlies the noun \emph{for-njósn} as found in \textlink{Sigrdrifumal} 25.}}.\eva
...
\ind ok \edtrans{hęfr \alst{f}jǫlð of \alst{f}arit}{has journeyed much}{\Bfootnote{Cf. \textlink{Vafthrudnismal} 3, 44, et.c., where Weden repeats: \emph{Fjǫlð ek fór, \hld\ fjǫlð fręistaða’k, // fjǫlð ek ręynda ręgin} ‘Much I journeyed, much I tried, much I tested the \inx[G]{Reins}.’}}, &
...
\edtrans{\alst{Þ}vęginn ok męttr}{Washed and full}{\Bfootnote{A formulaic collocation.  Cf. \textlink{Reginsmal} 25 (\emph{kęmbðr} ‘combed’ — \emph{þvęginn} ‘washed’ — \emph{męttr} ‘full’) and \textlink{Voluspa} 33: (\emph{þó} ‘washed’ — \emph{kęmbði} ‘combed’).  These examples attest to the importance of personal hygiene in the culture, something further seen by the ubiquity of combs in pre-Christian graves (TODO: archeological reference).
...
\ind at \alst{ę}ngi es \alst{ęi}nna hvatastr.}{\lemma{þȧ \dots\ ęinna hvatastr ‘then \dots\ fiercest of all’}\Bfootnote{Almost identical to \textlink{Reginsmal} TODO/3–4, which however has \emph{flęirum} ‘more men’ instead of \emph{frǿknum} ‘the brave’.}}%
...
Sts. 103–110 contain Weden’s second “love adventure” in the \textlink{Havamal}, more specifically his theft of the Mead of Poetry from the ettin Sutting and his daughter, Guthlathe.
...
Having discussed external parallels to this myth we may now turn to the present stanzas.  The biggest difference between \Skaldskaparmal\ 5–6 and \textlink{Havamal} 103–110 is that \textlink{Havamal} is much more opaque.  Far from being a linear retelling of events, the narrative thread is actually quite difficult to follow, especially without the help of \Skaldskaparmal.  Indeed, one of the key details shared between \Skaldskaparmal\ and the Vedic hymns—the eagle—is not found in \textlink{Havamal}.  Other important \Skaldskaparmal\ elements not found in the \textlink{Havamal} are Quasher, the two dwarfs, and Baye.  It is thus clear that Snorre’s narrative cannot be exclusively based on \textlink{Havamal}, but must also rely on other, now-lost sources.  This hypothesis is supported by the large number of kennings for \textsc{poetry} found in the Scaldic corpus, which reference Quasher’s blood, the ransom of the two dwarfs, the eagle’s cargo and its “sending back” of a certain part of the mead \parencite[427--430]{Meissner1921}, the last element being found in kennings like Þstf Lv 3 (\Skp\ II) \emph{lęirr ara ins gamla} ‘dung of the ancient eagle \ken{bad poetry}’.

On the other hand there are elements found in \textlink{Havamal} 103–110 which do not appear in \Skaldskaparmal\ 5–6.  The focus of \textlink{Havamal} is squarely on Weden’s visit to and (particularly) betrayal of Sutting and his daughter Guthlathe.  The betrayal of Guthlathe as emphasized in \textlink{Havamal} contrasts sharply with the transactional and seemingly unemotional three-night affair in \Skaldskaparmal.  It is possible that the version of the myth underlying \textlink{Havamal} even saw Weden marry Guthlathe, thereby receiving the mead as a dowry.  This is supported by the archaic legal expression \emph{hins hindra dags} (st. 109), and would explain the mention of Weden’s oath (110).  The recipient of the oath may even have been Sutting, the father of the bride, as suggested by the description of him as \emph{svikvinn} ‘betrayed’ and by the fact that he perhaps hosted a banquet for Weden (110), although an internal problem with that view is that Weden is still said to have had to bore through the mountains (107), presumably to reach Guthlathe, in which case it comes off as unlikely that he would \emph{then} have asked Sutting for her hand, rather than simply seducing her then-and-there in her chamber.  See further notes to the relevant stanzas.

\textlink{Havamal} 103–110 begin with some social advice (103), after which the narrative is retold in the first person by Weden himself.  The sts. do not tell the myth in chronological order and leave much up to the listener; they are clearly composed for an audience that already knows the story.%  The following details are given:
%
%\begin{enumerate}
...
\ind við \edtrans{\alst{ȯ}-svinna \alst{a}pa}{unwise apes}{\Bfootnote{Formulaic; cf. \textlink{Grimnismal} 33, \textlink{Fafnismal} 11.}}}{\lemma{orðum \dots\ apa ‘Words \dots\ apes’}\Bfootnote{Cf. st. 125 which gives similar advice.}},\eva
...
Apart from these stanzas there are a few other manuscript attestations of similar Runic magic.  Closest at hand is st. 80 above, which would fit seamlessly into the present section.  Outside of \textlink{Havamal} there is \textlink{Sigrdrifumal} 5–17, also preserved in \Regius.
...
\Ballnote{Cf. \Grougaldr\ 10, which is very similar to the present stanza, and \textlink{MerseburgOne} (edited below under Galders), a galder that seems actually to have been used for loosening fetters.}\eva
