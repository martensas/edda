...
\bvb Hail the givers,\footnoteB{The hosts.} a guest is come in! \\
...
of speech, and of silence in return.\footnoteB{There is a well thought-out linear progression throughout this st: The guest must first wash himself, then dry himself with a towel, then be welcomed to sit and eat at the table and speak with the host. The host has done his part, and now it is the guest’s turn. This nicely leads the transition to the following sts., where the proper conduct of the guest (first in speech, and then in various other areas) is discussed.}\evb
\evg
...
\bvb A better burden bears man not on the road \\
than much manwit. \\
Worse way-provision he drags not along in the field\footnoteB{\emph{vǫllr} ‘plain, (uncultivated) field’ is repeated in sts. 38 and 49. It is easily understood that the heaths and plains of Iron Age Norway were particularly unsafe places, where a traveller needed to keep his wits with him, lest he fall victim to robbers or murderers.} \\
...
he robs men of their senses.\footnoteB{Here drunkenness is personified as a hovering bird, a “heron of forgetfulness”.} \\
...
\ind ok hęfr \edtrans{\alst{f}jǫlð of \alst{f}arit}{journeyed much}{\Bfootnote{Formulaic, also occuring in \Vafthrudnismal\ 3, 44, etc in the fixed lines (spoken by Weden): \emph{Fjǫlð ek fór, \hld\ fjǫlð fręistaða’k, // fjǫlð ek ręynda ręgin} ‘Much I journeyed, much I tried, much I tested the \inx[G]{Reins}.’.}}, &
...
of that\footnoteB{Rumours and gossip.} which goes about a man.\evb
\evg
...
A quick-spoken tongue—unless it be held in place\footnoteB{lit. ‘unless holders own it’ or ‘unless it own holders’. The ‘holders’ are perhaps the teeth which hold the tongue in place.}— \\
...
and manages to loiter about dry-skinned.\footnoteB{I.e. ‘untested’, equivalent to the English “get one’s feet wet”. This sense of \emph{fjall} is rare in Old Norse literature (but does occur elsewhere, e.g. in \Volundarkvida\ 11: \emph{ber-fjall} ‘bear-pelt’.), but compare Swedish \emph{fjäll} ‘scale (on fish and reptiles)’.}\evb
\evg
...
the guest, from a scoffing guest.\footnoteB{Here probably ‘stranger’; when a stranger is attacking one it is best not to engage. Cf. sts. 122–123 and 125.} \\
...
rewards shall be equal to gifts.\footnoteB{Equivalent to the last line of the previous st. (“reward duplicity against lie”).}\evb
\evg
...
nor of his horse instead. (although he has not a good one.)\evb
\evg
...
the eagle on the aged sea. \\
So is the man who among the many comes, \\
and has spokesmen few.\footnoteB{Cf. st. 25.}\evb
\evg
...
where I one had eaten.\footnoteB{Not everyone is hospitable, especially with regards to food, which was scarce and closely watched among subsistence farmers. The speaker notes that even a “trusty friend” (possibly sarcastic) would invite him more often if he could increase the amount of food rather than decrease it.}\evb
\evg
...
one’s good health—if thou canst keep it— \\
{[and]} not living by vice.\evb
\evg


\bvg
\bva \alst{E}s-at maðr \alst{a}lls \edtrans{ve-sall}{unblessed}{\Bfootnote{Or ‘woe-blessed’. The second element is etymologically identical to \emph{sę́ll} but lacks i-umlaut due to shortening of the root vowel in Proto-Norse. The ancestral forms would be \emph{*sāliʀ} and \emph{*wajē-sāliʀ}. Cf. here Proto-Norse ᚹᚨᛃᛖ-ᛗᚨᚱᛁᛉ \emph{wajē-māriʀ} ‘infamous’ on the Tjurkö bracteate, where the second element is the ancestor of ON \emph{mę́rr} ‘renowned, famous’, and would have the expected descendant \emph{*ve-marr}.}}, \hld\ þótt sé \alst{i}lla hęill, &
...
oneself dies likewise;\footnoteB{The power of this succinct merism may be less clear to the modern reader. In Germanic Iron Age society a man’s wealth was reckoned by how many heads of cattle (for which compare particularly English \emph{chattel} ‘tangible, movable property’ and the etymology of \emph{capital}) he owned, and his social power by the number of able male relatives ready to side with him in conflict. The meaning is thus: all your power will pass away, and so too must you. — For poetic analogues, see \textcite[99\psqq]{West2007}.} \\
...
\bvg
\bva Þat es þá \alst{r}ęynt, \hld\ es þú at \edtext{\alst{r}únum spyrr \hld\ hinum \alst{r}ęgin-kunnum}{\lemma{rúnum \dots\ hinum ręginkunnum ‘the runes, the ones born of the Reins’}\Bfootnote{This expression also appears on the C4th–6th Noleby stone (in the singular accusative \emph{rúnó raginakundó} ‘a rune born of the Reins’), which proves that some of the Runic magic vocabulary in Eddic poetry really is very old and of genuine Heathen origin. See also Encyclopedia \inx[C]{rune}.}}, &
...
\bvb Then that is proven of which thou inquirest the runes, the ones born of the Reins, \\
...
nor too early\footnoteB{i.e. in life.} in a son. \\
...
\bvb {[Billing’s maiden:]} \\
“And by evening shalt thou, Weden, come, \\
if thou wilt for thee have the maiden \ken*{= me}; \\
...
\bvb So I came next, as was the useful\footnoteB{Sarcastic.} \\
war-troop all awake; \\
with burning lights and carried wood;\footnoteB{They were presumably armed with sticks.} \\
so was for me a sad path\footnoteB{Ambiguous whether it refers to the beating he would have received at the hands of the men had he entered, or to his walk of shame away from the hall.} marked out.\evb
\evg
...
\bvb \inx[P]{Guthlathe} did give me, on the golden chair, \\
...
því’t \alst{Ó}ð-rerir \hld\ nú \alst{u}pp ’s kominn &
...
\bvb The well purchased thing \ken{mead of poetry} I have used well; \\
little is lacking for the learned— \\
for Woderearer is now come up \\
onto the rim of the \inx[C]{wigh} of men \ken*{= Middenyard}.\footnoteB{Weden has made good use of the mead of poetry, since it is now available to wise men on earth.}\evb
\evg
...
\bvg
\bva Baug-ęið \alst{Ó}ðinn \hld\ hygg at \alst{u}nnit hafi, &
...
\bvb ’Tis time to \inx[C]{thill}, upon the chair of the \inx[C]{thyle}. \\
...
or thou art forced out from within a place.\footnoteB{Very difficult phrase. Possibly a euphemism for needing to relieve oneself?}\evb
\evg
...
því’t af \alst{i}llum manni \hld\ fę́r \alst{a}ldri-gi &
...
anyone thy whole mind.\footnoteB{Cf. st. 124.}\evb
\evg
...
with unwise apes.\footnoteB{Cf. st. 125.}\evb
\evg
...
\ind \edtrans{\alst{l}íkn-fastan}{fast in liking}{\Bfootnote{The first element \emph{líkn} is somewhat difficult; see note to st. 8 and cf. st. 120. For this cpd itself \textcite{LaFargeGlossary} give a tentative ‘assured of favour’, while \CV\ gives ‘fast in goodwill, beloved’.}} at \alst{l}ofi.\eva
...
\ind es-a sá \alst{v}inr ǫðrum \hld\ es \alst{v}ilt ęitt sęgir.\eva

\bvb Kinship is then blended,\footnoteB{Cf. st. 44.} when any man decides \\
to tell one his whole mind.\footnoteB{Cf. st. 121.} \\
...
thou wilt have use if thou learnest; \\
they will be good for thee if thou gettest: \\
With three words\footnoteB{i.e. ‘not even with three words’.} shalt thou not flyte with a worse man; \\
...
\ind \alst{n}jóta munt ef \alst{n}emr, &
\ind þér munu \alst{g}óð ef \alst{g}etr: &
\alst{sk}ó-smiðr þú verir \hld\ né \alst{sk}ępti-smiðr, &
...
thou wilt have use if thou learnest; \\
they will be good for thee if thou gettest: \\
Rejoiceful of evil be thou never, \\
...
\ind \alst{n}jóta munt ef \alst{n}emr, &
\ind þér munu \alst{g}óð ef \alst{g}etr: &
Ef vilt þér góða \alst{k}onu \hld\ \alst{k}vęðja at \edtrans{gaman-rúnum}{pleasure-runes}{\Bfootnote{While easily interpreted as ‘sexual intercourse’, the word is used in st. 120 with a decidedly non-sexual meaning. Its base meaning is probably ‘good, light-hearted conversation’.}} &
...
\bvb Oft those who sit inside do hardly know, \\
...
heather against bite-sicknesses; but \inx[C]{rune}[runes] against \inx[C]{bale};\footnoteB{cf. sts. 124, 149.} \\
fold \ken{earth} shall take against flood.\evb
\evg
...
These scattered sts. are introduced by a larger initial in \Regius, showing the start of a new section. They have the header \emph{Rúna-tals þáttr} ‘Strand of the Rune-Tally’ in younger paper mss. They give an archaic, mystic impression; it is as if they were drawn from the lips of an Odinic priest.
...
\bvb Then I took to thrive, and be learned, \\
...
\bvb \inx[P]{Weden} among the \inx[G]{Ease}, but for the \inx[G]{Elves} \inx[P]{Dowen}; \\
...
Knowest thou one shall send? Knowest thou how one shall \inx[C]{soo}?\footnoteB{A symmetric structure would be attained if the first four verbs referred to \inx[C]{rune}[runes]: carving, interpreting, painting (with blood?), and divining—while the latter four referred to sacrifice: asking for boons, sacrificing, sending (the sacrifice or the prayer; making sure the gods receive it), and slaying the victim. Indeed this is suggest by the following stanza. See further relevant Encyclopedia entries. The meter of the st. is unusual, but bears some resemblance to Vg 216 (the Högstena galder). TODO: Elaborate.}\evb
\evg
...
long be lacking! \\
Although they would be good for thee if thou gettest, \\
...
\bvb Now are the High One’s speeches sung, in the High One’s hall; of great need for the sons of men, of harm for the sons of ettins! Hail he who sang [them]; hail he who knows [them]; may he use who learned [them]; hail those who heeded [them]!\evb
\evg
