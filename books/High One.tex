...
\bvg
\bva Þat ’s þá \alst{r}ęynt, \hld\ es þú at \edtext{\alst{r}únum spyrr \hld\ hinum \alst{r}ęgin-kunnum}{\lemma{rúnum \dots\ hinum ręginkunnum ‘the runes, the ones born of the Reins’}\Bfootnote{This expression also appears on the C4th–6th Noleby stone (in the acc. sg. \emph{rúnó ragina-kundó} ‘a rune born of the Reins’), which shows that at least some of the Eddic rune-magic indeed is of genuine Heathen origin. See also Encyclopedia \inx[C]{rune}.}}, &
