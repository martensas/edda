...
\bvg
\bva \edtext{\alst{V}ręiðr}{\lemma{Vręiðr}\Afootnote{TODO: Note about ambiguity of alliteration.}} vas þá \alst{V}ing-Þórr \hld\ es hann \alst{v}aknaði &
...
\bvg
\bva \edtext{\alst{O}k hann þat \alst{o}rða \hld\ \alst{a}llz fyrst of kvað:}{\lemma{Ok \dots\ of kvað ‘And ... did say’}\Bfootnote{The whole line is formulaic, occuring in five other places: sts. 3, 9 and 12 of the present poem; st 3 of \Oddrunargratr; st. 5 of \Brot.}} &
...
not on earth nor Up-heaven:\footnoteB{Formulaic, see Encyclopedia: \inx[F]{Earth and Up-heaven}.} \\
the \inx[G]{Ease}[os] \ken*{= Thunder = I} is robbed of his hammer!”\evb
\evg


\bvg
\bva Gingu þęir \alst{f}agra \hld\ \alst{F}ręyju túna &
\alst{o}k hann þat \alst{o}rða \hld\ \alst{a}llz fyrst of kvað: &
...
\bvg
\bva „Þó mynda’k \alst{g}efa þér \hld\ þótt ór \alst{g}ulli vę́ri &
ok þó \alst{s}ęlja \hld\ at vę́ri ór \alst{s}ilfri.“\eva

\bvb {[Frow quoth:]} “I would yet give it to thee, though it were golden; \\
and yet hand\footnoteB{\emph{sęlja}, cognate of English \emph{sell} here has its older sense of ‘hand over’, cf. Gotish \emph{saljan} \textcite[116]{Streitberg}: ‘\emph{opfern}; \textgreek{θύειν}’.} it to thee, as it were silvern.”\footnoteB{Regaining the hammer is of such importance to the gods (cf. st. 17; without it the Ease stand powerless against the \inx[G]{Ettins}), that Frow would lend the feather-hame to the greedy and untrusty Lock, even if it were made out of gold or silver.}\evb
\evg

\bvg
\bva \alst{F}ló þá Loki, \hld\ \alst{f}jaðr-hamr dunði, &
unz fyr \alst{ú}tan kom \hld\ \alst{á}sa garða &
...
until outside he came the \inx[L]{Osyard}[yards of the Ease], \\
and inside he came the \inx[L]{Ettinham}[homes of the Ettins].\evb
\evg


\bvg
\bva \alst{Þ}rymr sat á haugi, \hld\ \alst{þ}ursa dróttinn, &
...
\bvg
\bva „\edtrans{Hvat ’s með \alst{ǫ́}sum? \hld\ Hvat ’s með \alst{ǫ}lfum?}{What is with the Ease? What is with the elves?}{\Bfootnote{Formulaic, identical line occurs in \Voluspa\ .}} &
...
\bvb {[Thrim quoth:]} “What is with the Ease? What is with the elves? \\
...
\bvg
\bva „Ek \alst{h}ęfi \alst{H}lórriða \hld\ \alst{h}amar of folginn &
...
\bvg
\bva \alst{F}ló þá Loki, \hld\ \alst{f}jaðr-hamr dunði, &
unz fyr \alst{ú}tan kom \hld\ \alst{jǫ}tna hęima &
ok fyr \alst{i}nnan kom \hld\ \alst{á}sa garða; &
\alst{m}ǿtti hann Þór \hld\ \alst{m}iðra garða &
\alst{o}k \edtext{hann þat}{\Afootnote{emend.; \emph{þat hann} \Regius, with elsewhere unprecedented word order. Cf. note to st. 2.}} \alst{o}rða \hld\ \alst{a}llz fyrst of kvað:\eva
...
\bvg
\bva „Hęfir þú \alst{ø}rendi \hld\ sem \alst{ę}rfiði? &
...
\bvg
\bva „Hefi’k \alst{ø}rendi \hld\ \alst{ę}rfiði ok: &
...
\bvg
\bva Ganga þęir \alst{f}agra \hld\ \alst{F}ręyju at hitta &
\alst{o}k hann þat \alst{o}rða \hld\ \alst{a}llz fyrst of kvað: &
...
and he\footnoteB{Unclear. Possibly Lock, since he was the speaker of the last verse.} that word first of all did say: \\
...
\bvg
\bva Ręið varð þá \alst{F}ręyja \hld\ ok \alst{f}nasaði, &
\alst{a}llr \alst{á}sa salr \hld\ \alst{u}ndir bifðisk, &
stǫkk þat it \alst{m}ikla \hld\ \alst{m}ęn Brísinga: &
„Mik \alst{v}ęizt \alst{v}erða \hld\ \alst{v}er-gjarnasta &
...
\bvg
\bva \edtext{Sęnn vǫ́ru \alst{ę́}sir \hld\ \alst{a}llir á þingi &
ok \alst{ǫ́}synjur \hld\ \alst{a}llar á máli, &
ok of þat \alst{r}éðu \hld\ \alst{r}íkir tívar:}{\lemma{Sęnn \dots\ tívar ‘Soon \dots\ Tews’}\Bfootnote{Formulaic. Shared with \Baldrsdraumar\ 1. See also note to st. 29 below.}} &
\alst{h}vé þęir \alst{H}lórriða \hld\ \alst{h}amar of sǿtti.\eva

\bvb Soon were the \inx[G]{Ease} all at the \inx[C]{Thing}, \\
...
\bvg
\bva Þá kvað þat \alst{H}ęimdallr, \hld\ \alst{h}vítastr ása, &
...
\bvb Then quoth that \inx[P]{Homedall}, whitest of the Ease; \\
...
\bvg
\bva Lǫ́tum und \alst{h}ǫ́num \hld\ \alst{h}rynja lukla &
ok \alst{k}ven-váðir \hld\ umb \alst{k}né falla &
en á \alst{b}rjósti \hld\ \alst{b}ręiða stęina &
ok \alst{h}agliga \hld\ umb \alst{h}ǫfuð typpum!“\eva
...
\bvg
\bva Þá kvað þat \alst{Þ}órr, \hld\ \alst{þ}rúðugr áss: &
...
“Me will the Ease call \inx[C]{degenerate}, \\
if I let myself be bound with bride’s linen!”\evb
\evg


\bvg
\bva Þá kvað þat \alst{L}oki \hld\ \alst{L}aufęyjar sonr: &
...
\bvg
\bva \alst{B}undu þęir Þór þá \hld\ \alst{b}rúðar líni &
ok inu \alst{m}ikla \hld\ \alst{m}ęni Brísinga, &
létu und \alst{h}ǫ́num \hld\ \alst{h}rynja lukla &
ok \alst{k}ven-váðir \hld\ umb \alst{k}né falla &
en á \alst{b}rjósti \hld\ \alst{b}ręiða stęina &
ok \alst{h}agliga \hld\ of \alst{h}ǫfuð typpðu.\eva
...
\bvg
\bva Sęnn vǫ́ru \alst{h}afrar \hld\ \alst{h}ęim of vreknir, &
...
drove Weden’s son \ken*{= Thunder} into the Ettin-homes.\footnoteB{A very similar but more detailed description of Thunder driving is found in Thedwolf’s \Haustlong\ 14–16. In both poems his wagon is drawn by he-goats, causing great cosmic disturbance: crags (\emph{bjǫrg} in both) burst asunder and fires rage before him. See also \Baldrsdraumar\ 3 for a related description of Weden riding.}\evb
\evg


\bvg
\bva Þá kvað þat \alst{Þ}rymr, \hld\ \alst{þ}ursa dróttinn: &
...
\bvg
\bva \alst{G}anga hér at \alst{g}arði \hld\ \alst{g}ull-hyrnðar kýr, &
...
A great deal I own of treasures, a great deal I own of necklaces; \\
only Frow I think myself missing.”\evb
\evg


\bvg
\bva Vas þar at \alst{k}veldi \hld\ of \alst{k}omit snimma &
ok fyr \alst{jǫ}tna \hld\ \alst{ǫ}l framm borit. &
...
\bvg
\bva Sat in \alst{a}l-snotra \hld\ \alst{a}mbǫ́tt fyrir &
...
\bvg
\bva \alst{L}aut und \alst{l}ínu, \hld\ \alst{l}ysti at kyssa, &
...
\bvg
\bva Sat in \alst{a}l-snotra \hld\ \alst{a}mbǫ́tt \edtext{fyrir}{\Afootnote{add. \emph{†ſ.†} \Regius.}} &
es \alst{o}rð of fann \hld\ við \alst{jǫ}tuns máli: &
...
\bvg
\bva \alst{I}nn kom in \alst{a}rma \hld\ jǫtna systir, &
...
‘But when the gods came to their wits [after Balder’s death], then Frie spoke and asked which one among the Ease \textbf{would own “all my loves and holdness}, and will ride onto the Hellway and see if he can find Balder, and offer Hell a ransom if she will let Balder come home to Osyard.”’
\end{quote}
...
leggið \alst{M}jǫllni \hld\ í \alst{m}ęyjar kné, &
\alst{v}ígið okkr saman \hld\ \alst{V}árar hęndi!“\eva

\bvb Then quoth that Thrim, the lord of Thurses: \\
“Bear ye in the hammer, the bride for to bless; \\
lay Millner in the maiden’s knee, \\
bless together us two by the hand of \inx[P]{Ware}!\footnoteB{A minor goddess presumably presiding over marriages. See Encyclopedia.}”\evb
\evg


\bvg
\bva \alst{H}ló \alst{H}lórriða \hld\ \alst{h}ugr í brjósti &
...
\bvg
\bva Drap hann ina \alst{ǫ}ldnu \hld\ \alst{jǫ}tna systur, &
