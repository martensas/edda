...
\ind at \alst{l}ęið sé \alst{l}aun, ef þiggr.\eva
...
þvít \alst{a}llir męnn \hld \alst{u}rðu-t jafnspakir; &
\ind \alst{h}ǫlf es ǫld \alst{h}var.\eva

\bvb Of little sands, of little seas; little is the mind of man; for all have not become evenly wise; half is every man.\footnoteB{Where the shore is small, so is the sea. Men with hearts not much bigger than a fist, or heads the size of a stone, can only ever be half-wise.}\evb
...
\ind ok hafða'k þess \alst{v}æt-ki \alst{v}ífs.\eva
...
\ind \alst{v}egr, es \alst{v}æt-ki trøðr,\eva
