...
The two main mss. of the poem are M and C.  Fragments L and P are identical in terms of handwriting and page layout and appear to have originally belonged to the same codex.  Codex V is the same ms., as the Saxon Genesis, which clearly indicates a close relation between that text and \Heliand.
...
\flagstanza{\textbf{2}} Þȯ warð þiu \alst{t}íd kuman, \hld\ —þat þar gi·\alst{t}ald habdun &
\alst{w}ísa man mid \alst{w}ordun,— \hld\ þat skolda þana \alst{w}íh godes &
\alst{Z}akharias bi·\alst{s}ehan. \hld\ Þȯ warð þar gi·\alst{s}amnod filu &
...
\alst{Z}akharias þȯ gi·mahalda \hld\ ęndi wið \alst{s}elvan sprak &
...
\flagstanza{\textbf{3}} Þȯ warð þat \alst{h}even-kuninges bodon \hld\ \alst{h}arm an is móde, &
...
\alst{w}angun wárun im \alst{w}litige. \hld\ Þȯ fórun þar \alst{w}íse man, &
...
Þȯ sprak þar ên gi·\alst{f}ródot man, \hld\ þe só \alst{f}ilo konsta &
...
Þȯ sprak eft þe \alst{f}ródo man, \hld\ þe þar konsta \alst{f}ilo mahljan: &
...
\flagstanza{\textbf{4}} Þȯ ni was \alst{l}ang aftar þiu, \hld\ ne it al só gi·\alst{l}êstid warð, &
...
\flagstanza{\textbf{5}} Þȯ warð fon \alst{R}úmu-burg \hld\ \alst{r}íkes mannes &
...
\alst{d}ago ęndi nahto. \hld\ Þȯ skoldun sie þar êna \alst{d}ád frummjan, &
...
\alst{w}ísas mannas \alst{w}ord. \hld\ Þȯ kwam þar ôk ên \alst{w}íf gangan &
...
\alst{s}ivun wintạr \alst{s}aman. \hld\ Þȯ gi·fragn ik þat iru þar \alst{s}orga gi·stód &
...
Þȯ sie E\alst{r}ódesan þar \hld\ \alst{r}íkjan fundun &%TODO: Weird alliteration, also occurs in at least two other lines.
...
\flagstanza{\textbf{8}} Þȯ gi·fragn ik þat \alst{s}án aftar þiu \hld\ \alst{s}líð-mód kuning &
...
\alst{h}êlagna \alst{h}even-kuning. \hld\ Þȯ sie an þat \alst{h}ús innan &
...
\flagstanza{\textbf{9}} ak \alst{w}endun im eft an iro \alst{w}illjon. \hld\ Þȯ warð sán aftar þiu \alst{w}aldandes, &%NOTE: In cæsura
...
þes \alst{k}uninges gi·sïðos. \hld\ Þȯ skolda þar só manag \alst{k}indisk man &
...
\flagstanza{\textbf{10}} Gi·witun im þȯ eft an \alst{G}alilea-land \hld\ \alst{J}oseph ęndi Maria, &
...
\alst{w}irkjan is \alst{w}illjon. \hld\ Þȯ warð þar an þana \alst{w}íh innan &
...
\alst{J}ohannes þȯ gi·mahalde \hld\ ęndi te·\alst{g}ęgnes sprak &
...
\flagstanza{\textbf{12}} Só sprak þȯ \alst{j}ung \alst{g}umo \hld\ bi \alst{g}odes lêrun &
...
\flagstanza{\textbf{13}} Só ge·fragn ik þat \alst{J}ohannes þȯ \hld\ \alst{g}umono gi·hwi-likun, &
...
Ge·\alst{h}êli þínna \alst{h}ungar!“ \hld\ Þȯ sprak eft þe \alst{h}êlago Krist: &
...
géng im þȯ bi \alst{J}ordanes staðe: \hld\ þar ina \alst{J}ohannes ant·fand, &
...
\alst{f}urðor kwámun, \hld\ þȯ fundun sie þar ênna \alst{f}ródan man &
...
\flagstanza{\textbf{15}} tulgo \alst{l}ang-sam \alst{l}egar. \hld\ Þȯ fórun þar þie \alst{l}iudi tó &%NOTE: In cæsura.
...
Þȯ warð þar \alst{m}ęgin só \alst{m}ikil \hld\ umbi þana \alst{m}árjon Krist, &
...
\alst{g}óde \alst{g}adulingos. \hld\ Þȯ habda þero \alst{g}umono þar &
...
\flagstanza{\textbf{16}} Þȯ umbi þana \alst{n}ęrjandon Krist \hld\ \alst{n}áhor géngun &%NOTE ms. -- Þó] V 1 (27r)
...
gi·\alst{w}erkod an þesoro \alst{w}er-oldi, \hld\ al só it þar þȯ mid is \alst{w}ordun sagde &
...
\flagstanza{\textbf{17}} So \alst{sp}rak hé þȯ \alst{sp}áh-líko \hld\ ęndi sagda \alst{sp}el godes, &
...
\flagstanza{\textbf{22}} ge·\alst{b}ôd uppan þemu \alst{b}erge. \hld\ hé im þȯ \alst{b}êðju be·falh &
...
\flagstanza{\textbf{24}} Ge·wêt imu þȯ umbi \alst{þ}rea naht aftar þiu \hld\ þesoro \alst{þ}iodo drohtin &
...
\alst{f}agạr an \alst{f}lęttja, \hld\ þȯ þar \alst{f}olk undar im &
an þem \alst{b}ęnkjon só \alst{b}ętst \hld\ \alst{b}líðsja af·hóvun, &
\alst{w}árun þar an \alst{w}unnjun. \hld\ Þȯ im þes \alst{w}ínes brast, &
...
þiu \alst{f}atu \alst{f}ulljen, \hld\ ęndi hi þar mid is \alst{f}ingrun þȯ, &
...
ge·\alst{þ}igedi te \alst{þ}anke.“ \hld\ Þȯ warð þar \alst{þ}egạn manag &
...
\flagstanza{\textbf{25}} Ge·wêt imu þȯ mid is \alst{j}ungoron \hld\ fan þem \alst{g}ômun forð &%TODO: check gômun.
...
an þínumu \alst{h}ugi \alst{h}ardo.“ \hld\ Þȯ sagde \alst{h}even-kuninge, &
...
\flagstanza{\textbf{26}} \alst{h}imil ęndi erðe. \hld\ Þȯ ge·wêt imu þe \alst{h}êlogo Krist &%NOTE: In cæsura.
...
\alst{h}êljandero bętst: \hld\ þȯ sáhun sie þar ên \alst{h}rêo dragan, &
...
\alst{k}én imu þar ęndi \alst{k}livode. \hld\ Þȯ slógun þar eft \alst{k}rúd an gi·mang, &
...
\flagstanza{\textbf{30}} Þȯ im eft te·\alst{g}ęgnes \hld\ \alst{g}umono bętsta &
...
\flagstanza{\textbf{32}} Só gi·fragn ik þat þȯ \alst{s}elvo \hld\ \alst{s}unu drohtines, &
...
Só \alst{l}êrda hé þȯ mid \alst{l}istjun. \hld\ Þan fórun þar þea \alst{l}iudi tó &
...
þes \alst{f}íundo \alst{f}olkes, \hld\ \alst{f}ór imu þȯ, þar hé welde, &
...
\alst{J}udeono mid \alst{g}ômun. \hld\ Þȯ warð þar an þene \alst{g}ast-sęli &
...
\flagstanza{\textbf{34}} \alst{s}álig \alst{s}ókjan. \hld\ Þȯ ge·witun im þea ge·\alst{s}ïðos þanen, &%NOTE: In cæsura.
...
hét \alst{s}ie þȯ \alst{s}amnon, \hld\ þȯ þar \alst{s}ade wárun &
...
\alst{h}êrron \alst{h}abdun. \hld\ Þȯ sie \alst{h}even-kuning, &
...
ni af·hóf wið þat \alst{f}olk \alst{f}urður, \hld\ ak \alst{f}ór imu þȯ, þar hé welde, &
...
wið þes \alst{w}atares ge·\alst{w}in. \hld\ Þȯ gi·wêt imu \alst{w}aldand Krist &
...
\alst{h}êlag \alst{h}even-kuning. \hld\ Þȯ sie an \alst{h}ôhan wall &
...
\alst{b}erht-lík \alst{b}iliði. \hld\ Þȯ imu þar te \alst{b}edu gi·hnêg, &
þȯ warð imu þar \alst{u}ppe \hld\ \alst{ȯ}ðar-líkora &
...
só \alst{s}nêw te \alst{s}ehanne. \hld\ Þȯ warð þar \alst{s}eld-lík þing &
...
\alst{P}aradíse ge·lík. \hld\ \alst{P}etrus þȯ gi·mahalde, &
...
\alst{w}ído aftar þesaru \alst{w}er-oldi.“ \hld\ Þȯ gi·wêt imu \alst{w}aldand Krist &
...
\alst{w}ordun ge·\alst{w}ísde. \hld\ Þar was þȯ \alst{w}aldandes &
...
\alst{l}iudjun \alst{l}íði.“ \hld\ Þȯ þar te þemu \alst{l}êrjande kwam &
...
\alst{K}rist alo-waldo, \hld\ \alst{k}wað it þȯ, þar hé welde, &
...
\alst{h}rên sie þȯ mid is \alst{h}andun, \hld\ dede is \alst{h}elpe þar tó, &
...
\alst{s}êg mid þiu ge·\alst{s}ïðu, \hld\ þȯ warð þar allaro \alst{s}ango mêst, &
...
\alst{w}arode \alst{w}ís-líko. \hld\ Þȯ kwam þar ôk ên \alst{w}idowa tó, &
...
\alst{a}lles ovar \alst{e}rðu.“ \hld\ Þȯ weldun ina þe \alst{a}nd-sakon þar &
...
Þȯ ge·fragn ik þat þar þero \alst{i}disjo kwam \hld\ \alst{ȯ}ðar gangan &
...
hét ina þȯ \alst{l}êdjen, \hld\ þar \alst{L}azarus was &
...
Þȯ warð þar só \alst{m}anagumu \alst{m}anne \hld\ \alst{m}ód aftar Kriste, &
...
\alst{h}ęliðos u̇saro \alst{h}ôvdo.“ \hld\ Þȯ sprak þar ên gi·\alst{h}êrod man &
...
\alst{g}aru \alst{g}ódo mêst. \hld\ Þȯ warð þar \alst{g}umono só filu &
...
\alst{þ}olod \alst{þ}iad-kwála.“ \hld\ Þȯ warð þar \alst{þ}egạn manag &
...
Þȯ géng imu þar \alst{J}údas forð, \hld\ \alst{j}ungaro Kristes, &
...
\alst{g}ódaro mêðmo.“ \hld\ Þȯ gi·hét imu þat \alst{g}um-skępi þar &
...
an \alst{h}even-ríkja.“ \hld\ \alst{H}ugi warð þȯ gi·węndid &
...
\alst{m}êst an \alst{m}innjun \hld\ ęndi móste þar þȯ an þes \alst{m}ahtiges Kristes &
...
Gi·wêt imu þȯ \alst{g}angen, \hld\ þar hé êr is \alst{j}ungaron lét &
...
Sagde imu þȯ te \alst{t}êkne, \hld\ þȯ sie þar \alst{t}ó fórun &
...
gi·\alst{w}êt ina þȯ \alst{w}armjen. \hld\ Þar im ôk ên \alst{w}íf bi·gan &
...
\alst{l}ívu bi·\alst{l}ôsjen. \hld\ Þȯ kwámun þar at \alst{l}atstan forð &
...
\alst{w}ordun \alst{w}ráki. \hld\ Þȯ þar undar þemu \alst{w}erode a·rês &
...
ęndi ina þȯ \alst{l}êddun, \hld\ þar þero \alst{l}iudjo was, &
...
ni weldun it þȯ ant·\alst{f}áhan, \hld\ ak hétun ina \alst{f}orð aftar þiu &
...
Þȯ þar an þem \alst{b}ęnkjun a·rês \hld\ \alst{b}odo kêsures &
