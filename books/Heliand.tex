...
A Latin preface is preserved independently of the poem itself.  According to this short text, \Heliand\ was composed at the behest of emperor Ludwig (\emph{Ludowicus}, probably Ludwig “the Pious” 778–840, son of Charlemagne), who commanded a Saxon man, “who was regarded among his own as a not undistinguished poet” (\emph{qui apud suos non ignobilis vates habebatur}) to render the entirety of the Old and New Testaments into Saxon verse.  Thus, he, “beginning with the creation of the world, and summarizing according to the truth of history the most significant events, at times depicting certain events with a mystical sense where he saw fit, led the interpretation, according to poetic custom and with rather witty eloquence, through to the end of the entire Old and New Testaments.” (\emph{a mundi creatione initium capiens, iuxta historiae veritatem quaeque excellentiora summatim decerpens, interdum quaedam ubi commodum duxit, mystico sensu depingens, ad finem totius Veteris ac Novi Testamenti interpretando more poetico satis faceta eloquentia perduxit.})  According to native custom, the work was divided into fitts (\emph{vitteas}).

There is no reason to doubt the general truth of this account, although it is hard to believe that the poet should have rendered the entirety of the Old and New Testaments, even the prophets and epistles, into alliterative verse.  In any case the rendering of the Old Testament is probably to be identified with \SaxonGenesis, while the New Testament is what we have before us in \Heliand.

At the end of the preface we hear something less believable, for we are told that “they say that this same poet, while he was still entirely ignorant of this art, was warned in a dream to adapt the precepts of the Sacred Law into song, with a fitting melody in his own language.” (\emph{ferunt eundem Vatem dum adhuc artis huius penitus esset ignarus, in somnis esse admonitum, ut Sacrae Legis praecepta ad cantilenam propriae linguae congrua modulatione coaptaret.})  This narrative is clearly closely related to what Bede tells us about the illiterate Anglo-Saxon poet Cadman (see Cadman’s Hymn below), but whatever the truth of Cadman’s story, it can scarcely be the case that the poet behind \Heliand\ and \SaxonGenesis\ was ignorant of the poetic art.  Both poems are wrought in an intricate style, and their composer must doubtless have been trained in the traditional craft, having first mastered the art of secular (or pagan) heroic poetry before he was commissioned to versify the Biblical texts.  The preface itself tells us as much when it says that he “was regarded among his own as a not undistinguished poet”.

It was for good reason that the poet was esteemed among his own, for he displays considerable mastery in such “Beowulfian” type scenes as the great feast in the mead-hall (2005–12, 2736–42) or the stormy sea-voyage (2233–68, 2906–65).  It is precisely in these passages that his poetry is at its most fluid and expressive, for it is here he can make the most use of his inherited stock of oral-formulaic expressions, synonyms, and kennings.  When the poetry by contrast has to deal with exclusively Christian matters it is apparent that our poet is not as uncomfortable, and his work suffers as a result.  This is in part due to the lack of traditional formulae for the new religion, and although he invents some (e.g. \emph{allaro barno bętst} ‘best of all babes \ken*{= Christ}’) they quickly end up stale from overuse.  Another issue is, as will be discussed shortly, his priestly moralising approach, which is entirely foreign to the genuine Germanic poetry.

Another notable traditional element found throughout the poem is the relationship between Christ and his Disciples, which is consistently described using the vocabulary of the Germanic warband, the idiom of earlier heroic poetry like \Beowulf.  The Disciples are depicted as “thanes” loyal into death towards their lord (drighten, theeden) Jesus Christ; the Disciples even make speeches expressing their desire to win ever-lasting fame and glory by dying alongside their lord (e.g. Thomas at 3994–4002, Simon Peter at 4674–4689).  There is constant emphasis on their noble ancestry and high social status along with that of Jesus (e.g. 361b–367a) and his family, something which gives us an idea of the audience of the poem—these were members of the social elite, no mere commoners, and it was important for them that the heroes of the Gospel-story were of similarly high birth.

Still, we should not—as some authors have done—interpret such traditional elements as evidence for \Heliand\ reflecting a syncretist Germanic “warrior Christianity”.  It would not have been possible for the poet to excise the traditional heroic language—after all, he was hired to write an alliterative poem, and those elements were built into the very essence of the alliterative genre.  They were necessary for the poetry to function in the social setting of courtly performance, and for it to function as poetry at all, for the alliteration itself requires a large number of poetic synonyms and formulaic expressions.  It is within these confines that the poet relates the New Testament message, but that message is one of pacifism and humility.  The New Testament is not a warlike text, and neither is \Heliand; regardless of its aesthetics, its \emph{ethics} are thoroughly Christian.

We have seen how \Heliand\ adheress closely to Germanic poetic tradition in the language of sea-voyage, mead-hall, and relations between lord and servant, but in the idiom of war we find important divergences, and here the alliterative poetic tradition is turned against itself.  The Germanic warrior ideology comes under direct attack by means of its own specialised vocabulary, which is condemned not just in the speeches of the characters but in the poet’s own voice.  This is perhaps best seen in the episode of the Denial of Peter.  Peter first makes a solemn speech (4674–4689), declaring in formal heroic language that he will not betray Jesus Christ, his lord, but stay with him until the end and give his life in battle; he swears upon his courage and strength of hand (\emph{hand-kraft}).  Jesus first praises his admirable courage, but then predicts that he will betray him thrice before cockcrow, anyway.  Peter does just that, and after upon hearing the cock makes a lamenting speech (5012–5021).  The poet himself then reflects on the events (5022–50)—if not even Peter, “the best of men” and “most valiant of thanes” could keep his promise without God’s help, what is the point of it?  The solemn vow (\emph{bi-hêt}, = OE \emph{béot} which is used positively in \Beowulf), pride (\emph{hróm}; cf. \Hildebrandslied\ 60), bravery (\emph{mód}), and strength of hand (\emph{hand-kraft}, by which Peter vowed) are all to no avail if the help of God should fail one due to his sins.  Naturally, moral exegesis of this kind is totally foreign to the older pagan tradition.

Turning to the language of war itself, there is not that much warfare in the New Testament, but at the arrest of Jesus (4866–4885) the poet takes the opportunity to break out some traditional formulae.  Still, he is generally very restrained, and tries hard to avoid any celebration of war, perhaps because of its association with the warlike cult of Weden and his Walkirries and Oneharriers.  Where warlike sentiments do appear (e.g. at the arrest, or Peter’s vow at the Last Supper 4674–4689) they are swiftly reproached by Jesus and ultimately proven flawed and misguided.  Naturally the greedy beasts of battle are entirely expunged, and the traditional feminine poetic synonyms \emph{*gu̇ðja} and \emph{hildi}, found in \Hildebrandslied\ and commonplace in Norse and English poetry, have not fared much better.  \emph{*gu̇ðja}, found in early OS female names and the non-\Heliand\ compound \emph{gu̇þ-fano} ‘field standard’, is entirely absent, and \emph{hildi} is only used twice (ll. 68, 5044)—in both cases disparagingly.  In their stead we find neuter-gender synonyms like \emph{stríd, ur-lagi, wíg}, and \emph{gi·winn}.  It is probably not coincidental that \emph{Gunnr} and \emph{Hildr} are known as walkirries in the Norse tradition; those terms were far too closely asscoiated with frenzied war for our Chrisitian poet.

It was described above how the depiction of the Disciples in their relationship as servants of Christ makes use of the language of the Germanic war-band, but that was not entirely accurate.  Although the Disciples are described as loyal thanes (\emph{þegnos}), heroes (\emph{hęliðos}, cf. \Hildebrandslied\ 6), and earls (\emph{erlos})—words perfectly fit for a Germanic war-band in a poem like \Beowulf—they are not a \emph{war}-band.  They are never described by explicitly warlike terms like \emph{hildi-skalkos} ‘war-servants’, \emph{wépạn-berandos} ‘weapon-bearers’, or \emph{helm-berandos} ‘helmet-bearers’.  Those terms—which in \Beowulf\ or Norse poetry could describe any group of warriors, including the protagonists—are instead given a derogatory sense, and relegated to refer only to the wicked Jews under Herod, the killers of God (4811).

There are, of course, many other ways in which \Heliand\ departs from Germanic heroic tradition.  One that deserves mention is the treatment of hostile fate, which in the old pagan legends often plays a key role in driving the narrative (e.g. in \Hildebrandslied\ or the Walsing Cycle).  Although \Heliand\ refers to fated events by what are in all likelihood originally pagan expressions like \emph{regano gi·skapu} ‘Shapes of the Reins’ and \emph{wurdi-gi·skapu} ‘Weird-Shapes’, fated events can also be called \emph{godes gi·skapu} ‘God’s Shapes’—in the Christian worldview it is God that wields the destinies of Men—not the ambivalent Norns.
...
\alst{a}nd-ward for þem \alst{a}lo-waldon, \hld\ ne sí þat hé me an is \alst{â}rundi hwárod &
...
\alst{w}eros fon þesero \alst{w}er-oldi, \hld\ nu mí þe \alst{w}illjo gi·stód, &
...
Þó sie \edtext{E\alst{r}ódesan}{\Bfootnote{This alliteration also occurs in at least two other lines. TODO.}} þár \hld\ \alst{r}íkjan fundun &
...
\alst{ȯ}ðran gi·þęnkjen: \hld\ „nu ik is \alst{a}ldạr kan, &
\alst{w}êt is \alst{w}intẹr-gi·talu: \hld\ nu ik gi·\alst{w}innan mag, &
...
þat \alst{k}ind undar euwa \alst{k}unni, \hld\ nu þe \alst{k}uning ni livod, &
...
gi·náhid \alst{m}anno barnun. \hld\ Nu látad eu an euwan \alst{m}ód-sevon &
...
\alst{g}umon te \alst{g}arewja, \hld\ þan gí \alst{g}angan skulun &
...
\alst{m}ahtig fon iuwomu \alst{m}unde. \hld\ Be·þiu ne and-rádad gí iu þero \alst{m}anno níð &
...
„al hębbju ik só gi·\alst{l}êstid“, \hld\ kwað hé, „só þú mí \alst{l}êris nu, &
...
\alst{h}êto an þesaru \alst{h}ęllju: \hld\ nu is mí þínaro \alst{h}elpono þarf, &
...
\alst{l}êðaro spráka, \hld\ alles is mí nu þes \alst{l}ôn kumen.“ &
...
þat mí \alst{þ}ionodi þius \alst{þ}iod: \hld\ ni willju ik is sie \alst{þ}iggjen nu, &
...
þat gí \alst{d}reogerjas \hld\ \alst{d}arnungo nu &
...
\alst{w}ordo ęndi \alst{w}erko: \hld\ nu willjad gí mí \alst{w}ítnon hér &
...
\alst{m}íðan an mínumu \alst{m}óde, \hld\ nu ik mí su·lik \alst{m}ên ge·sprak.“ &
...
ge·\alst{f}rumid mid \alst{f}irihon: \hld\ íljat gí nu \alst{f}orð hinan, &
