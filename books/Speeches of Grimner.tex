...
BPB Frie sent her handmaid Full to Garfrith’s. She asked the king to be wary, that he might not be ended by that \inx[C]{feelcunning} man who was come in the land, and said that his mark was that no hound were so fierce that he would leap onto him.
...
\bvb \inx[P]{Thound} roars; dwells Thedwitner’s fish\footnoteB{A very difficult kenning to interpret, but see TODO.} in the flood; the river-stream seems far too great, for the noisy slain host \ken*{= Ownharriers} to wade through.\footnoteB{Presumably describing the river which surrounds Walhall, and which the dead have to pass on their way to it.}\evb
\evg
