...
\bvb — ’Tis time to tally the dwarfs in Dwollen’s host [back] to Loffer, for the kindreds of men;\footnoteB{A standard genealogical introduction (compare \Haleygjatal\ 1). The line of dwarfs is to be counted to their progenitor, Loffer. This possibly disagrees with the earlier introduction (“There was ...”), where Moodsown is said to be the foremost of the dwarfs, and Loffer is not mentioned.} they who sought, from the stone of the hall, the abode of \inx[L]{Earwongs}\footnoteB{\CV\ \emph{aurvangr} ‘a loamy field’, and indeed this fits etymologically.} to the \inx[L]{Erwolds}.\footnoteB{\Gylfaginning\ (TODO): “But these came from Swornshigh (\emph{Svarinshaugr}) to the Earwongs on the Erwolds, and thence Lofer is come; these are their names: Sherper (\emph{Skirpir}), Werper (\emph{Virpir}), Showfind, Great-grandfather, Elf and Ing (\emph{Ingi}), Oakenshield, Fale (\emph{Falr}), Frost, Finn, Ginner.”}\evb
\evg
...
\bvb Breath they owned not, \inx[C]{wode} they had not, not craft nor sound, nor good complexion. Breath gave Weden, wode gave Heener, craft gave Lother, and good complexion.\evb
\evg
...
\edtext{féspjǫll spaklig}{\lemma{“wise wealth-spells”}\Bfootnote{By some authors (see \parencite[51\psqq]{Haukur2020}) emended to \emph{fekk spjǫll spaklig} “he (= Weden) received wise tidings”}} \hld\ ok spáganda; &
...
\bvb A ship travels from the east—come will Muspell’s subjects by sea—but Locke steers it. Travel the warlocks all with Freck; with them comes the brother of Bylest \ken*{= Locke} along.\evb
\evg
