...
\bvg
\bva\mssnote{\Regius\ 1r/4, \Hauksbok\ 20r/2}Ek man jǫtna \hld\ ár of borna, &
þȧ es forðum \hld\ mik fǿdda hǫfðu; &
níu man’k hęima, \hld\ níu \edtext{íviðjur}{\Afootnote{thus \Regius\Hauksbok. \Regius\ was previously read \emph{íviði}, but this was disproved by an x-ray scan undertaken by \textcite{StefanKarlsson1979}.}}, &
...
\bvg
\bva\mssnote{\Regius\ 1r/6, \Hauksbok\ 20r/4, \GylfMS}Ár vas alda \hld\ \edtext{þar’s Ymir byggði}{\lemma{þar’s Ymir byggði ‘there where Yimer dwelled’}\Afootnote{\emph{þat’s ękki vas} ‘that when nothing was’ \GylfMS}}, &
...
\bvb Before the sons of \inx[P]{Byre} lifted up the flatlands, those who shaped the renowned \inx[L]{Middenyard}. Sun shone from the south on the stones of the hall; then was the ground grown with green leek.\footnoteB{The sons of Byre (according to \Gylfaginning\ 6: Weden, Will and Wigh) lift the lands out of the primordial chasm.}\evb
\evg
...
\bvg
\bva\mssnote{\Regius\ 1v/20, \Hauksbok\ 20r/36, \GylfMS}\edtext{Þȯrr ęinn \edtext{þar vá}{\lemma{þar vá ‘fought there’}\Afootnote{\emph{thus} \Hauksbok\Trajectinus\Upsaliensis; þar var ‘was there’ \Regius; þat vann ‘performed it’ \RegiusProse; þat vá ‘fought it’ \Wormianus}} \hld\ þrunginn móði, &
hann sjaldan sitr, \hld\ es slíkt of fregn; &
\edtext{ȧ gingusk ęiðar, \hld\ orð ok sǿri, &
mǫ́l ǫll męginlig, \hld\ es ȧ meðal \edtext{fóru}{\lemma{fóru ‘had gone’}\Afootnote{vǫ́ru ‘had been’ \Hauksbok\Trajectinus}}.}{\lemma{ȧ \dots\ fóru.}\Afootnote{\emph{om.} \Wormianus}}}{\lemma{Þȯrr \dots\ fóru.}\Bfootnote{The ordered followed is that of \Regius\Hauksbok; in \GylfMS\ the two helmings (\emph{Þȯrr \dots\ fregn;} \emph{ȧ \dots\ fóru}) come in reverse order.}}\eva
...
\bvb She saw \inx[G]{Walkirries}, widely come, ready to ride to \inx[L]{Godthede}. Shild held a shield and Shagle another; Guth, Hild, Gandle and Goreshagle; now are tallied the Nannies\footnoteB{\emph{Nanna} ‘\inx[P]{Nanny}’ is the wife of \inx[P]{Balder}.} \ken{women} of Harn \name{= Weden}; walkirries ready to ride the ground.\evb
\evg
...
\bvb I saw Balder’s—the bloody \inx[G]{Tues}[tue]’s, Weden’s child’s—\inx[C]{orlay} sealed\footnoteB{Notably, \emph{fela} ‘hide, conceal’ is used to describe burial in mounds, as in \Ynglingatal\ 24 or Öl 1 (900s): “hidden (\textbf{fulkin} \emph{folginn}) in this mound lies he whom the greatest deeds followed...”}; grown did stand—higher than the plains—a slender and very fair mistletoe.\footnoteB{Told allusively in 31–33 is the death of Balder at the hands of his blind brother Hath; it is found in much greater detail in \Gylfaginning\ 49.}\evb
\evg
...
\bvb Then comes \inx[P]{Line}’s \name{= Frie’s} second sorrow to pass,\footnoteB{The first sorrow was presumably the death of Balder, her son.} as Weden goes to strike against the wolf—but the bane of \inx[P]{Bellow} \ken*{= Free}, bright, [goes] against Surt—then will Frie’s beloved \ken*{= Weden} fall.\evb
\evg
...
vargs at \edtext{dauða}{\Afootnote{da... \Hauksbok}} \hld\ Víðars niðja.}{\lemma{Gínn \dots\ niðja.}\Bfootnote{The final part of this verse is almost impossible to read. I have based the edition on the reading of \textcite[13,44\psqq]{JonHelgason1971}.}}\eva
...
\bvb The Ease find each other on the Idewolds, and about the mighty earth-strip \ken*{the Middenyardsworm} converse, and there look back on mighty verdicts, and on Fimbletue’s \name{Weden’s} ancient runes.\evb
\evg
