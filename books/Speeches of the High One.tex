...
\ind \alst{f}eti ganga \alst{f}ramarr; &
því’t ó\alst{v}íst ’s at \alst{v}ita, \hld\ nę́r verðr á \alst{v}egum úti &
\ind \alst{g}ęirs of þǫrf \alst{g}uma.\eva

\bvb From his weapons shall man on the plain not take one step further;\footnoteB{The same phrase also appears in \Lokasenna\ 1.} for uncertain ’tis to know, when on the ways outside, man comes in need of a spear.\evb
\evg
...
\bvb My garments I gave on the plain, to two tree-men.\footnoteB{TODO: Note on their identity. Aniconic wooden statues? Scarecrows? What do previous authors write?} Champions they seemed when cloaks they had; shameful is the naked man.\evb
\evg
...
\ind \edtext{þótt hann \alst{h}afi’t góðan}{\lemma{þótt ... góðan “although ... good one”}\Bfootnote{As \textcite{FinnurEdda}\ points out, surely a late insertion. Whoever made it was not aware of the meter, interpreting the \Ljodahattr\ c-verse as an a-verse in \Fornyrdislag.}}.\eva

\bvb Washed and filled ought man to ride to the Thing, though he be not dressed too well; of his shoes and breeches ought no man to be ashamed, nor indeed of his horse, (although he might not have a good one.)\evb
\evg
...
\bvb Man is not all wretched, though he of poor health be: someone finds joy in sons, someone in friends, someone in ample \inx[C]{fee}, someone in works done well.\evb
\evg
...
\bvb Billing’s maiden I found on the beds, sun-white, sleeping. An earl’s pleasure seemed me nought to be, but to live by that body.\evb
\evg
...
\bvb Knowest thou how one shall carve? Knowest thou how one shall read? Knowest thou how one shall paint? Knowest thou how one shall tempt? Knowest thou how one shall bid? Knowest thou how one shall \inx[C]{bloot}? Knowest thou one shall send? Knowest thou how one shall \inx[C]{soo}?\footnoteB{A symmetric structure would be attained if the first four verbs refer to \inx[C]{runes}[runes]: carving, interpreting, painting (with blood?), and divining; while the latter four refer to sacrifice: making a request, sacrificing, sending the sacrifice(?) or making sure that the gods receive it, and slaying the victim. See further relevant Index entries. Over all the meter of the v. has a notable resemblance with Vg 216 (the Högstena galder). TODO: Elaborate.}\evb
\evg
...
\footnotetext[6]{A final line is likely missing here. — Identical word-pairing (\emph{biðja} ‘to bid’ – \emph{blóta} ‘to bloot’, \emph{senda} ‘to send’ – \emph{sóa} ‘to soo’) may reveal this v.’s relation with the previous one.}
...
\bvb Thus \inx[P]{Thound} <= Weden> catved for the rakes of nations, where up he rose as back he came.\footnoteB{A very cryptic v.}\evb
\evg
