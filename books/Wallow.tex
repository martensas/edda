...
—en \edtrans{\alst{b}ani \alst{B}ęlja}{the bane of Bellow \ken*{= Free}}{\Bfootnote{The being Bellow (ON \emph{Bęli}) was slain by Free in an obscure myth; see Index.}} \hld\ \alst{b}jartr at Surti— &
...
—but the bane of Bellow \ken*{= Free}, bright, [goes] against Surt— \\
...
\edtrans{munu \alst{h}alir allir \hld\ \alst{h}ęim-stǫð ryðja;}{all men will clear their homesteads}{\Bfootnote{After Thunder, the protector of men, is slain the earth is no longer inhabitable.  Cf. \Harbardsljod\ TODO, \Thrymskvida\ 18.}} &
