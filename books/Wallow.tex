...
\bvb “For hearing I ask all holy kindreds, greater and lesser, sons of Homedall\footnoteB{Cf. \Rigsthula, wherein Righ, identified by the prose as Homedall, sires three castes of men (namely earls, churls and thralls).} \ken{men}! Wilt thou, O Walfather \name{= Weden}, that I well count forth the ancient tidings of men, those which I foremost recall?\footnoteB{Cf. \Vafthrudnismal\ 34, 35 with very similar phrasing. The whole introductory formula is positively Indo-European, see \textcite{West2007}[63,92-93,312].}\evb\evg


\bvg\bva\mssnote{\Regius~1r/4, \Hauksbok~20r/2}\alst{E}k man \alst{jǫ}tna \hld\ \alst{á}r of borna, &
...
\bvb I recall \inx[G]{Ettins}, born of yore, they who formerly had nourished me. Nine \inx[C]{Home}[Homes] I recall; nine \inx[G]{Inwithies}; the renowned \inx[P]{Metwood} beneath the soil.\footnoteB{Certainly \inx[P]{Ugdrassle}, “beneath the soil” likely referring to it still being a seed.}\evb\evg


\bvg\bva\mssnote{\Regius~1r/6, \Hauksbok~20r/4, \GylfMS}\alst{Á}r vas \alst{a}lda \hld\ \edtrans{þar’s \alst{Y}mir byggði}{there as Yimer dwelled}{\Afootnote{\emph{þat’s ękki vas} ‘that when nothing was’ \GylfMS}}, &
...
\bvg\bva[5a]\mssnote{\Regius~1r/11, \Hauksbok~20r/7}\alst{S}ól varp \alst{s}unnan, \hld\ \edtrans{\alst{s}inni Mȧna}{the companion of Moon}{\Bfootnote{At times translated as ‘its moon’. This cannot be correct, as \emph{mȧni} ‘moon’ is masculine, while \emph{sinni}, dative singular of \emph{sïnn} ‘its (reflexive)’ is feminine.}}, &
...
\bvg\bva[5b][2]\mssnote{\Regius~1r/12, \Hauksbok~20r/7, \GylfMS}\alst{S}ól þat né vissi, \hld\ hvar hǫ̇n \alst{s}ali átti; &
...
\bvg\bva\mssnote{\Regius~1r/13, \Hauksbok~20r/9}\edtext{Þȧ gingu \alst{r}ęgin ǫll \hld\ ȧ \edtrans{\alst{r}ǫk-stóla}{rake-seats}{\Bfootnote{Their seats of judgment at the assembly.}}, &
\alst{g}inn-hęilǫg \alst{g}oð, \hld\ ok umb þat \alst{g}ę́ttusk}{\lemma{Þȧ \dots\ gę́ttusk ‘Then \dots\ of this.’}\Bfootnote{A formulaic expression for the convening of the \inx[C]{Thing} of the Gods (for which see Encyclopedia: \inx[G]{All Gods}), identically repeated below in sts. 9/1–2, 22/1–2, and 24/1–2.  Cf. also the three lines shared between \Baldrsdraumar\ 1/1–3 and \Thrymskvida\ 14/1–3, which follow the structure of the present stanza(s) very closely: \emph{Sęnn vǫ́ru ę́sir \hld\ allir á þingi // ok ǫ́synjur \hld\ allar á máli, // ok umb þat réðu \hld\ ríkir tívar:} ‘Soon were the \inx[G]{Eese} all at the \inx[C]{Thing}, // and the \inx[G]{Ossens} all at speech, // and of this counseled the mighty \inx[G]{Tews}:’.
In all five occurrences other than the present stanza (three from \Voluspa, the present poem, one from \Baldrsdraumar, one from \Thrymskvida), the demonstrative pronoun \emph{þat} ‘this’ clearly refers to the matter at hand, expressed with the verb in the subjunctive case (e.g. in \Thrymskvida\ 14/3–4: \emph{ok umb \emph{þat} réðu \hld\ ríkir tívar: //  hvé þęir Hlórriða \hld\ hamar of sǿtti?} ‘and of this counseled the mighty \inx[G]{Tews}: How they Loride’s \name{= Thunder’s} hammer would find?’).  Following this pattern we would surely expect to find two lines after \emph{umb þat gę́ttusk} ‘took counsel of this’ and before \emph{nǫ́tt} ‘night’ in the present stanza, and it seems most likely to presume that they have simply been lost in transmission.}}. &
...
\bvg\bva\mssnote{\Regius~1r/16, \Hauksbok~20r/10}Hittusk \alst{ę̇}sir \hld\ ȧ \alst{I}ða-vęlli, &
...
\bvg\bva\mssnote{\Regius~1r/18, \Hauksbok~20r/12}\alst{T}ęflðu ï \alst{t}u̇ni, \hld\ \alst{t}ęitir vǫ́ru, &
...
\bvg\bva\mssnote{\Regius~1r/20, \Hauksbok~20r/14, \GylfMS}Þȧ gingu \alst{r}ęgin ǫll \hld\ ȧ \alst{r}ǫk-stóla, &
...
\bvg\bva\mssnote{\Regius~1r/21, \Hauksbok~20r/15, \GylfMS}\edtext{\edtext{Þar vas \alst{M}óðsognir}{\Afootnote{so \Hauksbok; \emph{Þar †mótſognir vitnir†} ‘there Mootsowner wolf(?)’ \Regius. The prose of \Gylfaginning\ 14 agrees with \Hauksbok\ that the correct form of the name is \emph{Móðsognir}, not \emph{Mótsognir}.}} \hld\ \alst{m}ę́tstr of orðinn &
...
\bva\mssnote{\Regius~1r/23, \Hauksbok~20r/17, \GylfMS}\alst{N}ýi ok \alst{N}iði, \hld\ \alst{N}orðri, Suðri, &
...
\bvg\bva\mssnote{\Regius~1r/25, \Hauksbok~20r/18, \GylfMS}\alst{V}ęigr ok Gand-alfr, \hld\ \alst{V}ind-alfr, Þráinn, &
...
\bvg\bva\mssnote{\Regius~1r/28, \Hauksbok~20r/20, \GylfMS}\alst{F}íli, Kíli, \hld\ \alst{F}undinn, Náli, &
...
\bvg\bva\mssnote{\Regius~1r/30, \Hauksbok~20r/22, \GylfMS}Mál es \alst{d}verga \hld\ ï \alst{D}valins liði &
...
\bvg\bva\mssnote{\Regius~1r/32, \Hauksbok~20r/24, \GylfMS}Þar vas \alst{D}raupnir \hld\ ok \alst{D}olg-þrasir, &
...
\bvg\bva\mssnote{\Regius~1v/3, \Hauksbok~20r/27}\alst{Ǫ}nd þau né \alst{ǫ́}ttu, \hld\ \alst{ó}ð þau né hǫfðu, &
...
\bvg\bva\mssnote{\Regius~1v/5, \Hauksbok~20r/29, \GylfMS}\alst{A}sk vęit’k \edtext{standa}{\lemma{standa ‘standing’}\Afootnote{so \Regius\Hauksbok\Upsaliensis; \emph{ausinn} ‘poured, sprinkled’ \RegiusProse\Trajectinus\Wormianus}}, \hld\ hęitir \edtext{\alst{Y}gg-drasill}{\Afootnote{\emph{Ygg-drasils} \RegiusProse}}, &
...
\bvg\bva\mssnote{\Regius~1v/8, \Hauksbok~20r/31}Þaðan koma \alst{m}ęyjar \hld\ \alst{m}args vitandi &
...
\bvg\bva\mssnote{\Regius~1v/11, \Hauksbok~20v/5}Þat man hǫ̇n \alst{f}olk-víg \hld\ \alst{f}yrst ï hęimi, &
...
\bvg\bva\mssnote{\Regius~1v/13, \Hauksbok~20v/7}\alst{H}ęiði \alst{h}étu, \hld\ hvar’s til \alst{h}úsa kom, &
...
\bvg\bva\mssnote{\Regius~1v/16, \Hauksbok~20v/9}Þȧ gingu \alst{r}ęgin ǫll \hld\ ȧ \alst{r}ǫk-stóla, &
...
\bvg\bva\mssnote{\Regius~1v/17, \Hauksbok~20v/11}\alst{F}lęygði Óðinn \hld\ ok ï \alst{f}olk of skaut; &
...
\bvg\bva\mssnote{\Regius~1v/19, \Hauksbok~20r/34, \GylfMS}Þȧ gingu \alst{r}ęgin ǫll \hld\ ȧ \alst{r}ǫk-stóla, &
\alst{g}inn-hęilǫg \alst{g}oð, \hld\ ok umb þat \alst{g}ę́ttusk: &
...
\bvg\bva\mssnote{\Regius~1v/20, \Hauksbok~20r/36, \GylfMS}\edtext{\alst{Þ}ȯrr ęinn \edtrans{\alst{þ}ar vá}{fought there}{\Afootnote{so \Hauksbok\Trajectinus\Upsaliensis; \emph{þar var} ‘was there’ \Regius; \emph{þat vann} ‘did, accomplished it’ \RegiusProse; \emph{þat vá} ‘fought it’ \Wormianus}} \hld\ \alst{þ}runginn móði, &
...
\bvg\bva\mssnote{\Regius~1v/23, \Hauksbok~20v/1}Vęit hǫ̇n \alst{H}ęim-dallar \hld\ \alst{h}ljóð of folgit &
...
\bvg\bva\mssnote{\Regius~1v/25}\alst{Ęi}n sat hǫ̇n \alst{ú}ti, \hld\ þȧ’s hinn \alst{a}ldni kom &
...
\bvg\bva\mssnote{\Regius~1v/26, \GylfMS}\alst{A}lt vęit’k, \alst{Ó}ðinn, \hld\ hvar \alst{au}ga falt &
...
\bvg\bva\mssnote{\Regius~1v/29}Valði hęnni \alst{H}ęr-fǫðr \hld\ \alst{h}ringa ok męn, &
...
\bvg\bva\mssnote{\Regius~1v/30}Sá hǫ̇n \alst{v}al-kyrjur \hld\ \alst{v}ítt of komnar, &
...
\bvg\bva\mssnote{\Regius~2r/4}Varð af \alst{m}ęiði, \hld\ þęim’s \alst{m}ę́r sýndisk, &
...
\bvg\bva\mssnote{\Regius~2r/6}\edtext{Þó}{\lemma{Þó \dots\ kęmbði ‘washed \dots\ combed’}\Bfootnote{A collocation, see note to \Havamal\ 61 for discussion and other examples. Wonnel, being oathbound and on the mission to avenge his brother, could not engage in such acts of personal vanity.}} ę́va \alst{h}ęndr \hld\ né \alst{h}ǫfuð kęmbði, &
...
\bvg\bva[H1]\mssnote{\Hauksbok~20v/12}\edtext{Þȧ kná \edtrans{\alst{V}áli}{Wonnel}{\Afootnote{emend.; \emph{Vála} \Hauksbok}} \hld\ \alst{v}íg-bǫnd snúa &
...
\bvg\bva[34a]\mssnote{\Regius~2r/8}\alst{H}apt sá hǫ̇n liggja \hld\ und \alst{H}vera-lundi &
...
\bvg\bva[34b]\mssnote{\Regius~2r/9, \Hauksbok~20v/13}\alst{þ}ar sitr Sigyn \hld\ \alst{þ}ęygi of sínum &
...
\bvg\bva\mssnote{\Regius~2r/10}\alst{Ǫ́} fęllr \alst{au}stan \hld\ of \alst{ęi}tr-dala &
...
\bvg\bva\mssnote{\Regius~2r/11}Stóð fyr \alst{n}orðan \hld\ ȧ \edtrans{\alst{N}iða-vǫllum}{Nithwolds}{\Afootnote{\emph{Niða-fjǫllum} ‘Nithfells’ \Regius\Wormianus\ (paraphrase); \emph{fjǫllom nǫkkurum} ‘some certain fells’ \Trajectinus}} &
...
\bvg\bva\mssnote{\Regius~2r/13, \Hauksbok~20v/19, \GylfMS}\alst{S}al \edtrans{sá hǫ̇n}{she saw}{\Afootnote{\emph{vęit’k} ‘I know’ \GylfMS. The same relationship is found in st. 62.}} standa \hld\ \alst{s}ólu fjarri &
...
\bvg\bva\mssnote{\Regius~2r/15, \Hauksbok~20v/21, \GylfMS}\edtrans{Sá hǫ̇n}{she saw}{\Afootnote{so \Regius; \emph{ser hon} ‘she sees’ \Hauksbok; \emph{skulu} ‘shall [be]’ \GylfMS}} \alst{þ}ar vaða \hld\ \alst{þ}unga strauma &
...
\bvg\bva\mssnote{\Regius~2r/19, \Hauksbok~20v/4, \GylfMS}\alst{F}yllisk \alst{f}jǫrvi \hld\ \alst{f}ęigra manna, &
...
\bvg\bva\mssnote{\Regius~2r/21, \Hauksbok~20v/16}\alst{S}at þar ȧ haugi \hld\ ok \alst{s}ló hǫrpu &
...
\bvg\bva\mssnote{\Regius~2r/23, \Hauksbok~20v/18}\alst{G}ól of ǫ̇sum \hld\ \alst{G}ullin-kambi, &
...
\bvg\bva\mssnote{\Regius~2r/25}\alst{G}ęyr \alst{G}armr mjǫk \hld\ fyr \alst{G}nipa-hęlli, &
...
\bvg\bva\mssnote{\Regius~2r/28, \Hauksbok~20v/24, \GylfMS}\alst{B}rǿðr munu \alst{b}ęrjask \hld\ ok at \alst{b}ǫnum verðask, &
...
\bvg\bva\mssnote{\Regius~2r/32, \Hauksbok~20v/27, \GylfMS}\edtext{Lęika \alst{M}íms synir, \hld\ en \alst{m}jǫtuðr kyndisk &
...
\bvg\bva\mssnote{\Regius~2v/3, \Hauksbok~20v/28, \GylfMS}\edtext{Skęlfr \alst{Y}ggdrasils \hld\ \alst{a}skr standandi, &
...
\bvg\bva\mssnote{\Regius~2v/8, \Hauksbok~20v/30, \GylfMS}\alst{H}vat ’s með ǫ̇sum? \hld\ \alst{h}vat ’s með \edtrans{ǫlfum}{Elves}{\Afootnote{\emph{ǫ́synjum} ‘Ossens’ \Upsaliensis}}? &
...
\bvg\bva\mssnote{\Regius~2v/4, \Hauksbok~20v/32}\alst{G}ęyr nú \alst{G}armr mjǫk \hld\ fyr \alst{G}nipa-hęlli, &
\alst{f}ęstr mun slitna, \hld\ en \alst{f}reki rinna; &
\alst{f}jǫlð vęit hǫ̇n \alst{f}rǿða, \hld\ \alst{f}ramm sé’k lęngra &
of \alst{r}agna \alst{r}ǫk \hld\ \alst{r}ǫmm sig-tíva.\eva
...
\bvg\bva\mssnote{\Regius~2v/4, \Hauksbok~20v/32, \RegiusProse\Trajectinus\Wormianus}\alst{H}rymr ękr austan, \hld\ \alst{h}ęfsk lind fyrir, &
...
\bvg\bva\mssnote{\Regius~2v/6, \Hauksbok~20v/34, \RegiusProse\Trajectinus\Wormianus}\alst{K}jóll fęrr austan \hld\ \alst{k}oma munu Múspells &
...
\bvg\bva\mssnote{\Regius~2v/10, \Hauksbok~20v/36, \GylfMS}\edtext{\alst{S}urtr}{\Afootnote{\emph{Svartr} \Upsaliensis}} fęrr \alst{s}unnan \hld\ með \alst{s}viga lę́vi, &
...
\bvg\bva\mssnote{\Regius~2v/13, \Hauksbok~20v/37, \RegiusProse\Trajectinus\Wormianus}Þȧ kømr \alst{H}línar \hld\ \alst{h}armr annarr framm, &
...
\bvg\bva\mssnote{\Regius~2v/15, \RegiusProse\Trajectinus\Wormianus}\edtext{Þȧ kømr hinn \alst{m}ikli \hld\ \alst{m}ǫgr Sig-fǫður}{\lemma{Þȧ kømr \dots\ Sig-fǫður ‘Then comes \dots\ Syefather’}\Afootnote{\emph{Gęngr Óðins sonr \hld\ við ulf vega} ‘Goes Weden’s son against the wolf to fight’ \GylfMS}}, &
...
\bvg\bva[H2]\mssnote{\Hauksbok~20v/39}\edtext{Gïnn \alst{l}opt yfir \hld\ \alst{l}indi jarðar, &
...
\bvg\bva\mssnote{\Regius~2v/17, \Hauksbok~20v/41, \RegiusProse\Trajectinus\Wormianus}\edtrans{Þȧ kømr}{then comes}{\Afootnote{\emph{Gęngr} ‘goes’ \GylfMS}} hinn \alst{m}ę́ri \hld\ \alst{m}ǫgr Hlǫðynjar &
...
\bvg\bva\mssnote{\Regius~2v/22, \Hauksbok~21r/2}\alst{G}ęyr nú \alst{G}armr mjǫk \hld\ fyr \alst{G}nipa-hęlli, &
\alst{f}ęstr mun slitna, \hld\ en \alst{f}reki rinna; &
\alst{f}jǫlð vęit hǫ̇n \alst{f}rǿða, \hld\ \alst{f}ramm sé’k lęngra &
of \alst{r}agna \alst{r}ǫk, \hld\ \alst{r}ǫmm sig-tíva.\eva
...
\bvg\bva\mssnote{\Regius~2v/23, \Hauksbok~21r/4}Sér hǫ̇n \alst{u}pp koma \hld\ \alst{ǫ}ðru sinni &
...
\bvg\bva\mssnote{\Regius~2v/24, \Hauksbok~21r/5}\edtrans{Finnask}{find each other}{\Afootnote{\emph{hittask} \Hauksbok\ provides closer parallelism with st. 7, but for the same reason it may also have replaced earlier \emph{finnask}.}} \alst{ę̇}sir \hld\ ȧ \alst{I}ða-vęlli &
...
\bvg\bva\mssnote{\Regius~2v/26, \Hauksbok~21r/7}Þar munu \alst{ę}ptir \hld\ \alst{u}ndr-samligar &
...
\bvg\bva\mssnote{\Regius~2v/28, \Hauksbok~21r/9}Munu \alst{ȯ}-sánir \hld\ \alst{a}krar vaxa; &
...
\bvg\bva\mssnote{\Regius~2v/30, \Hauksbok~21r/11}Þȧ kná \alst{H}ø̇nir \hld\ \alst{h}laut-við kjósa &
...
\bvg\bva\mssnote{\Regius~2v/31, \Hauksbok~21r/12, \GylfMS}\alst{S}al \edtrans{sér hǫ̇n}{she sees}{\Afootnote{\emph{vęit’k} ‘I know’ \GylfMS}} standa \hld\ \alst{s}ólu fęgra, &
...
\bvg\bva[H3]\mssnote{\Hauksbok~21r/14}\edtext{Þȧ kømr hinn \alst{r}íki \hld\ at \alst{r}ęgin-dȯmi &
...
\bvg\bva\mssnote{\Regius~3r/2, \Hauksbok~21r/15}Þar kømr hinn \alst{d}immi \hld\ \alst{d}ręki fljúgandi, &
