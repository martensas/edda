...
the yin-holy Gods, and from each other took counsel of that.\footnoteB{10, 23, 25 (TODO) would suggest two lines be missing here.} \\
...
\edtrans{\alst{v}ǫ́ \alst{V}al-hallar}{the woe of Walhall}{\Bfootnote{i.e. Balder’s death.}}. \hld\ \alst{V}ituð ér ęnn eða hvat?\eva
...
\edtrans{\alst{l}ę́-gjarns}{a guiler-eager man’s}{\Bfootnote{A formulaic epithet applied to Lock. See note to TODO for other examples and discussion.}} líki \hld\ \alst{L}oka ȧ-þękkjan;\eva
