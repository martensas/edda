...
\alst{h}ęndi hinni \alst{h}ǿgri \hld\ \edtrans{of \alst{h}imin-jǫður}{over heaven’s rim}{\Afootnote{Composite reading; \emph{of himin †iodyr†} ‘over the heaven-horse-beast(?)’ \Regius\ is both nonsensical and unmetrical and must be rejected; \emph{of ioður} ‘over the rim’ \Hauksbok\ lacks alliteration.}};\eva
