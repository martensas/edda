...
\bvb The Ease found each other on \inx[L]{Idewolds}, \\
...
strong and lovely Ease along the settlement; \\
...
\bvb That troop-conflict\footnoteB{While reading \emph{folk-víg} as ‘ethnic conflict’ (between the Ease and Wanes) is appealing, I more cautiously read the first element \emph{folk} as carrying its earlier, more common sense of ‘troop, group of warriors’.} \ken{war} she recalls, the first in the \inx[C]{Home}, \\
...
\bvb Crowed over the Ease Goldencomb: \\
...
Fare the devil-lads all with Freck; \\
...
of the outlaw after the deaths of Wider’s kinsmen \ken*{= the Ease}.\evb
\evg
...
\bvb The Ease find each other on Idewolds, \\
