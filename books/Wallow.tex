...
that son of Weden took, one night old, to fight.\evb\evg
...
of \inx[P]{Whethring}’s \name{= Lock’s} lad \ken*{= the Wolf}; then is the Father \ken*{= Weden} avenged!\evb\evg
...
\edtext{gęngr \alst{Ó}ðins sonr \hld\ við \alst{o}rm vega.}{\lemma{gęngr \dots\ vega}\Afootnote{Only in \Regius.}} &
...
\alst{n}ęppr frȧ \alst{n}aðri, \hld\ \alst{n}íðs ȯ-kvíðnum.}{\lemma{Drepr \dots\ ȯ-kviðnum ‘Middenyard’s \dots\ adder’}\Afootnote{\emph{neppr af naðri \hld\ niðs ȯkvíðnum // munu halir allir \hld\ hęim-stǫð ryðja, // es af móði drepr \hld\ Mið-garðs véurr} ‘pained, away from the loathsome adder. All men will clear their homesteads when out of wrath Middenyard’s Wigh-ward strikes.’ \GylfMS}\Bfootnote{The order of lines found in \Gylfaginning\ may be the original.  After Thunder is slain, the Ettins take over the lands and make farming impossible.  Cf. \Thrymskvida\ 18: “Shortly the Ettins will settle Osyard, unless thou thy hammer for thyself dost fetch!”}}\eva

\bvb Then comes the renowned lad of Lathyn \name{= Earth} \ken*{= Thunder}: \\
Weden’s son goes the \inx[C]{worm} to meet. \\
...
\alst{S}ól tér \alst{s}ortna, \hld\ \edtext{\edtext{\alst{s}økkr}{\Afootnote{so \RegiusProse\Trajectinus\Wormianus; \emph{sígr} \Regius\Hauksbok\Upsaliensis}} fold í mar}{\lemma{søkkr \dots\ mar ‘sinks \dots\ the sea’}\Bfootnote{The reading \emph{søkkr} ‘sinks’ has been chosen over \emph{sígr} ‘descends’ based on Arn \emph{Þorfdr} 24 (\Skp\ II): \emph{søkkr fold í mar døkkvan} ‘the fold sinks into the dark sea’.}}, &
...
from heaven fade the clear stars. \\
...
\alst{g}ullnar tǫflur}{\lemma{undr-samligar gullnar tǫflur ‘wondersome golden game-bricks’}\Bfootnote{A rather fine literary device.  In st. 8 above the golden age of the Eese, spoiled by the three ettin-women, is signified by their playing board games.  The rediscovering of the golden board game then betokens a new golden age.}} \hld\ í \alst{g}rasi finnask, &
...
\bvb {[Then]} will unsown acres grow; \\
