...
\bvg
\bva\mssnote{\Regius~1v/1, \Hauksbok~20r/26}Unz \edtext{\alst{þ}rír}{\Afootnote{gramm. emend.; \emph{þrjár} \Regius\Hauksbok}} kvǫ̇mu \hld\ \edtext{ór \alst{þ}ví liði}{\Afootnote{\emph{þussa brúðir} ‘brides of thurses’ \Hauksbok\ is probably corrupt due to the influence of st. 8; the adjectives in l. 2 are in the masculine.}} &
\edtrans{\alst{ǫ}flgir ok \alst{ȧ}stkir}{strong and lovely}{\Afootnote{\emph{ȧstkir ok ǫflgir} (norm.) ‘lovely and strong’ \Hauksbok}} \hld\ \alst{ę̇}sir \edtrans{at húsi}{along the house}{\Bfootnote{An adverbial, ‘along the settlement’; the gods were not walking in the wilderness.}}; &
...
\alst{þ}ríar ór \alst{þ}ęim \edtrans{sal}{hall}{\Afootnote{so \Hauksbok, \GylfMS\ (paraphrase); \emph{sę́} ‘lake’ \Regius}}, \hld\ es \edtrans{und}{under}{\Afootnote{\emph{ȧ} ‘on’ \Hauksbok}} \alst{þ}olli stęndr; &
...
\alst{o}pt \alst{ȯ}-sjaldan, \hld\ þó \alst{ę}nn lifir.\eva
...
knǫ́ttu \alst{v}anir víg-spǫ́ \hld\ \alst{v}ǫllu sporna.\eva
...
\alst{g}ǫrvar at ríða \hld\ \alst{g}rund val-kyrjur.}{\lemma{Skuld \dots\ val-kyrjur}\Bfootnote{These four lines, especially from the out-of-place ending (\emph{nú eru talðar}), seem to be a latter insert from a \inx[C]{thule} counting the walkirries.}}\eva
...
\bvg
\bva\mssnote{\Regius~2r/6}Þó hann ę́va \alst{h}ęndr \hld\ né \alst{h}ǫfuð kęmbði, &
áðr ȧ \alst{b}ál of \alst{b}ar \hld\ \alst{B}aldrs and-skota. &
En \alst{F}rigg of grét \hld\ í \alst{F}ęn-sǫlum &
\alst{v}ǫ́ \alst{V}al-hallar. \hld\ \alst{V}ituð ér ęnn eða hvat?\eva
...
\bvg
\bva\mssnote{\Hauksbok~20v/12}\edtext{Þȧ kná \edtrans{\alst{V}áli}{Wonnel}{\Afootnote{emend.; \emph{Vála} \Hauksbok}} \hld\ \alst{v}íg-bǫnd snúa &
\alst{h}ęldr vǫ́ru \alst{h}arð-gǫr \hld\ \alst{h}ǫpt ór þǫrmum.}{\lemma{Þȧ \dots\ þǫrmum.}\Bfootnote{Only attested in \Hauksbok, where it is combined with 35b.}}\eva
...
\bvg
\bva[35a]\mssnote{\Regius~2r/8}\alst{H}apt sá hǫ̇n liggja \hld\ und \alst{H}vera-lundi &
\alst{l}ę́-gjarns líki \hld\ \alst{L}oka ȧ-þękkjan;\eva
...
\bvg
\bva[35b]\mssnote{\Regius~2r/9, \Hauksbok~20v/13}\alst{þ}ar sitr Sigyn \hld\ \alst{þ}ęygi of sínum &
...
\alst{s}ǫxum ok \alst{s}verðum, \hld\ \alst{S}líðr hęitir sú.\eva
...
\bvg
\bva\mssnote{\Regius~2r/11}Stóð fyr \alst{n}orðan \hld\ ȧ \alst{N}iða-vǫllum &
\alst{s}alr ór gulli \hld\ \alst{S}indra ę́ttar, &
en \alst{a}nnarr stóð \hld\ ȧ \alst{Ȯ}kólni, &
\alst{b}jór-salr jǫtuns, \hld\ en sá \alst{B}rimir hęitir.\eva
...
\bvg
\bva\mssnote{\Regius~2r/13, \Hauksbok~20v/19, \GylfMS}\alst{S}al sá hǫ̇n standa \hld\ \alst{s}ólu fjarri &
...
\bvg
\bva\mssnote{\Regius~2r/15, \Hauksbok~20v/21, \GylfMS}\edtrans{Sá hǫ̇n}{saw she}{\Afootnote{so \Regius; \emph{ser hon} ‘she sees’ \Hauksbok; \emph{skulu} ‘shall [be]’ \GylfMS}} þar vaða \hld\ þunga strauma &
...
\bvb There saw she wading through heavy streams: \\
...
\bvg
\bva\mssnote{\Regius~2r/23, \Hauksbok~20v/18}Gól of ǫ̇sum \hld\ Gullin-kambi, &
...
gullnar tǫflur \hld\ í grasi finnask, &
...
\edtrans{gulli þakðan}{thatched with gold}{\Afootnote{\emph{gulli bętra} ‘better than gold’ \RegiusProse\Trajectinus}}, \hld\ ȧ \edtext{Gimléi}{\Afootnote{metr. emend.; \emph{Gimlé} \Regius\Hauksbok\GylfMS}}; &
