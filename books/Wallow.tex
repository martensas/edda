...
\edtrans{\alst{l}ę́-gjarns}{guile-eager}{\Bfootnote{A formulaic epithet of Lock. See note to TODO for other examples and discussion.}} líki \hld\ \alst{L}oka ȧ-þękkjan;}{\lemma{Hapt \dots ȧ-þękkjan ‘A captive \dots\ to Lock,’}\Bfootnote{replaced with H1 \Hauksbok.}}
...
For him crowed, in Galewood\footnoteB{\emph{gagl} ‘wild goose’, maybe here referring to carrion-eating ravens? Galewood is probably the same location as Ironwood.}, \\
...
axe-eld, sword-eld—shields are split— \\
...
to [the sound of] the shrill Horn of Yell. \\
...
\bvb Surt comes from the south with the betrayer of the twig \ken{fire}; \\
from the sword shines the sun of the slain-Tews. \\
Boulders clash, but the fiends reel; \\
men march on the \inx[L]{Hell-ways}, but heaven is split.\evb\evg
...
when Weden fares to strike against the Wolf \\
...
Wider, to strike at that slaughter-beast. \\
He lets his hand drive the sword through the heart \\
...
mun \alst{Ó}ðins son \hld\ \edtrans{\alst{ęi}tri}{venom}{\Afootnote{emend.; \emph{ormi} ‘Wyrm’ \Hauksbok. It seems likely that the author of \Gylfaginning\ had access to this verse. Cf. \Gylfaginning\ 51: “Thunder bears the bane-word off the Middenyardswyrm and from thence strides nine paces away. Then he falls dead to the earth for the venom (\emph{ęitri}) which the Wyrm blows on him.”}} mǿta &
...
gape the jaws of the fierce Wyrm in the heights. \\
