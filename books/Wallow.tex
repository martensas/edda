...
The \textbf{Spae of the Wallow} (abbrev. \Voluspa) is probably the most important Norse mythological text surviving from Heathen times.  It is a \inx[C]{spae} (ON \emph{spǫ́} ‘prophecy’) foretold by a \inx[C]{wallow} (\emph{vǫlva} ‘seeress, sibyl, prophetess’) who has been summoned by Weden, the father of the Gods, in order to relate the mythic history of the World.

The wallow is a sign of the old Germanic belief that old women were invested with a certain psychic or prophetic power; when dead, they could apparently possess such knowledge as not even the chief god Weden himself knew.  It was for this reason that Weden undertook frequent journeys in order to question various beings about mythological lore, which should be seen in the light of his incessant lust for knowledge.  \Voluspa\ is not the only Eddic poem reflecting this motif; the most similar is \Baldrsdraumar, wherein Weden summons a wallow from her grave in order to find out why the god \inx[P]{Balder} is having ominous nightmares; there is also \Vafthrudnismal, wherein Weden challenges the wise ettin \inx[P]{Webthrithner} to a wisdom contest and defeats him, and Weden’s journeys are further alluded to in \Harbardsljod\ TODO.  In its role as a mythic catalogue \Voluspa\ also resembles \Grimnismal, \Sigrdrifumal, and \Alvissmal, but it differs from all aforementioned works in two key ways: \Voluspa\ is a prophecy rather than a motley collection of scattered mythological lore and a monologue rather than a dialogue or riddle contest.  Its unique importance lies in the fact that it offers a chronological overview of the Norse mythic timeline of the World from its creation to its coming destruction and rebirth.
...
\edtext{\alst{st}jǫrnur þat né vissu, \hld\ hvar þę́r \alst{st}aði ǫ́ttu}{\Afootnote{In \GylfMS\ this line comes last, so that the order is sun, moon, stars.}}; &
...
\alst{d}vergar \edtrans{ï}{in}{\Afootnote{so \GylfMS\Hauksbok; \emph{ór} ‘out of’ \Regius}} jǫrðu, \hld\ \edtrans{sęm \alst{D}urinn sagði}{as Dorn said}{\Afootnote{so \Regius\Hauksbok\RegiusProse\Wormianus; \emph{sem †dur menn† sagði} ‘as door-men(?) said’ \Trajectinus; \emph{sem †þeim dyrinn kendi†} ‘as the beasts(?) taught them’ \Upsaliensis}}.}{\lemma{þęir \dots\ sagði ‘They \dots\ said.’}\Bfootnote{The mss. readings offer two conflicting versions of the creation of the dwarfs.  Either they arose on their own; this is supported by the prose of \Gylfaginning\ 14 (see note to previous st.) and by the form of the stanza quoted there in the non-\Upsaliensis\ mss., but it may have been changed to correspond to the author’s vision.  On the other hand, \Regius, \Hauksbok\ and \Upsaliensis\ have the dwarfs Moodsowner and Dorn shaping “man-likenesses” out of soil.  The present ed. follows \Regius\Hauksbok\Upsaliensis.}}\eva
...
\edtext{\edtrans{\edtrans{Þȧ kømr}{Then comes}{\Afootnote{\emph{Gęngr} ‘Goes’ \GylfMS}} hinn \alst{m}ę́ri \hld\ \alst{m}ǫgr \edtrans{Hlǫðynjar}{Lathyn}{\Afootnote{add. \emph{gęngr Óðins sonr \hld\ við orm vega.} ‘Weden’s son goes the Wyrm to fight.’ \Regius.}},}{Then comes the famed lad of Lathyn}{\Afootnote{om. \Hauksbok.}} &
