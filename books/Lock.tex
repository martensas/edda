...
við \alst{s}ystur þinni \hld\ gazt \alst{s}líkan mǫg, &
...
\bvg {\small Týr:}
\bva „Fręyr ’s \alst{b}ęztr \hld\ allra \alst{b}all-riða &
\ind \alst{á}sa gǫrðum \alst{í}; &
\alst{m}ęy né grǿtir \hld\ né \alst{m}annz konu, &
...
\ind \alst{b}ǫl es \alst{b}ęggja þrá; &
...
\ind unz \alst{r}júfask \alst{r}ęgin; &
...
\bvg {\small Loki:}
\bva „\alst{G}ulli kęypta \hld\ lézt \alst{G}ymis dóttur &
\ind ok \alst{s}ęldir þitt \alst{s}vá \alst{s}verð, &
en es \alst{M}úspellz synir \hld\ ríða \alst{M}yrk-við yfir &
\ind \alst{v}eizt-a þá, \alst{v}ę-sall, hvé \alst{v}egr!“\eva
...
\bvg {\small Byggvir:}
\bva „Vęizt ef \alst{ø}ðli \alst{ę́}tta’k \hld\ sem \alst{I}ngunar-Fręyr, &
...
\bvb “Drunk art thou, Lock, so that thou art out of wits; \\
...
\ind it \alst{l}jóta \alst{l}íf of \alst{l}agit; &
\alst{ǫ}rgu baki \hld\ munt \alst{ę́} vesa &
\ind ok \alst{v}aka \alst{v}ǫrðr goða.“\eva
...
\bvb “’Tis light for the Lock—thou wilt not so for long \\
...
\bvg {\small [Loki kvað:]}
\bva „Vęizt ef mik á \alst{h}jǫrvi skulu \hld\ ins \alst{h}rím-kalda magar &
\ind \alst{g}ǫrnum binda \alst{g}oð, &
\alst{f}yrstr ok øfstr \hld\ vas’k at \alst{f}jǫr-lagi &
\ind \alst{þ}ar’s vér á \alst{Þ}jaza \alst{þ}rifum.“\eva

\bvb {[Lock quoth:]} \\
“Know that if on a sword shall, with the rime-cold lad’s \\
...
\bvg {\small [X kvað:]}
\bva „Veizt ef \alst{f}yrstr ok øfstr \hld\ vast at \alst{f}jǫr-lagi &
\ind \alst{þ}á’s ér á \alst{Þ}jaza \alst{þ}rifuð, &
frá mínum \alst{v}éum \hld\ ok \alst{v}ǫngum skulu &
þér ę́ \alst{k}ǫld \alst{r}ǫ́ð koma.“\eva
...
\bvb “Be thou now hale, O Lock, and receive the rime-chalice, \\
full of ancient mead, \\
that thou rather let me alone, among the sons of the Ease, \\
...
I know one—that I think myself to know— \\
adulterer with Loride’s wife, \\
and that was the guile-wise Lock!”\evb
\evg


\bvg {\small [Bęyla kvað:]}
\bva „\alst{F}jǫll ǫll skjalfa; \hld\ hygg á \alst{f}ǫr vesa &
\ind \alst{h}ęiman \alst{H}lórriða; &
hann \alst{r}ę́ðr ró \hld\ þeim’s \alst{r}ǿgir hér &
...
\bvg
\bva „\alst{Þ}ęgi þú, rǫg vę́ttr, \hld\ þér skal minn \alst{þ}rúð-hamar, &
...
The rock of shoulders \ken{head} I strike off thy neck, \\
...
\bvb {[Lock quoth:]} \\
“The son of Earth \ken*{= Thunder} is now here come inside, \\
...
\ind \alst{s}ęgja \alst{s}ęggjum frá &
síz í \alst{h}anska þumlungi \hld\ \alst{h}núkðir þú, ęin-hęri, &
\ind \edtrans{ok \alst{þ}óttisk-a \alst{þ}á \alst{Þ}órr vesa}{didst not seem to be Thunder then}{\Bfootnote{}}!“\eva
...
\bvg {\small [Þórr kvað:]}
\bva „\alst{Þ}ęgi þú, rǫg vę́ttr, \hld\ \alst{þ}ér skal minn \alst{þ}rúð-hamar, &
\ind \alst{M}jǫllnir, \alst{m}ál fyr-nema! &
...
\bpg\bpa En eptir þetta falz Loki í Fránangrs-forsi í lax líki. Þar tóku ę́sir hann. Hann var bundinn með þǫrmum sonar Nara; en Narfi, sonr hans, varð at vargi. Skaði tók eitr-orm ok festi upp yfir and-lit Loka; draup þar ór eitr. Sigyn, kona Loka, sat þar ok helt munn-laug undir eitrit. En er munn-laugin var full bar hon út eitrit, en meðan draup eitrit á Loka. Þá kipptiz hann svá hart við, at þaðan af skalf jǫrð ǫll; þat eru nú kallaðir land-skjálftar.\epa
