...
\bvg\bva\mssnote{\Regius~7v/17}\alst{F}ór þá Óðinn \hld\ at \alst{f}ręista orð-spęki &
...
\bvg\bva\speakernote{[Óðinn kvað:]}\mssnote{\Regius~7v/18}„\alst{H}ęill þú nú, Vaf-þrúðnir, \hld\ nú em’k í \alst{h}ǫll kominn &
...
\bvg\bva\speakernote{Vafþrúðnir}\mssnote{\Regius~7v/20}„Hvat ’s þat \alst{m}anna, \hld\ es í \alst{m}ínum sal &
...
\bvg\bva\speakernote{Óðinn kvað}\mssnote{\Regius~7v/22}„\edtext{\alst{G}agnráðr}{\Bfootnote{Gang-ráðr ‘Gangred; Journey-adviser’ \GylfMS. TODO: Is this st. actually quoted?}} hęiti’k, \hld\ nú em’k af \alst{g}ǫngu kominn, &
...
\bvg\bva\speakernote{Vafþrúðnir}\mssnote{\Regius~7v/24}„Hví þú þá, \alst{G}agnráðr, \hld\ mę́lisk af \alst{g}olfi fyrir? &
...
\bvg\bva\speakernote{[Óðinn kvað:]}\mssnote{\Regius~7v/26}„\alst{Ó}-auðigr maðr, \hld\ es til \alst{au}ðigs kømr, &
...
\bvg\bva\speakernote{Vafþrúðnir}\mssnote{\Regius~7v/28}„Sęg mér, \alst{G}agnráðr, \hld\ alls á \alst{g}olfi vill &
...
\bvg\bva\speakernote{[Óðinn kvað:]}\mssnote{\Regius~7v/30}„\alst{Sk}in-faxi hęitir, \hld\ es hinn \alst{sk}íra dręgr &
...
\bvg\bva\speakernote{Vafþrúðnir}\mssnote{\Regius~7v/32}„Sęg þat, \alst{G}agn-ráðr, \hld\ alls á \alst{g}olfi vill &
\ind þíns of \alst{f}ręista \alst{f}rama, &
...
the night over the useful \inx[G]{Reins}?”\evb
\evg
...
thence comes dew in the dales.\footnoteB{For another explanation of the origin of dew, see \Voluspa\ TODO.}”\evb
\evg
...
\ind verðr-at \alst{í}ss á \alst{ǫ́u}.“\eva
...
\bvg\bva\speakernote{Óðinn kvað}\mssnote{\Regius~8r/26, \AM~3r/16}„\alst{S}ęg þat \alst{s}jaunda, \hld\ alls þik \alst{s}vinnan kveða, &
\ind ok þú \alst{V}af-þrúðnir \alst{v}itir, &
...
\bvg\bva\speakernote{Vafþrúðnir kvað}\mssnote{\Regius~8r/27, \AM~3r/17}„\edtext{Und \alst{h}ęndi vaxa \hld\ kvǫ́ðu \alst{h}rím-þursi &
\ind \alst{m}ęy ok \alst{m}ǫg saman; &
\alst{f}ótr við \alst{f}ǿti}{\lemma{Und hęndi \dots\ fótr við fǿti ‘Within the hand \dots\ foot against foot’}\Bfootnote{The image is masturbatory. This myth is not attested in}} \hld\ gat hins \alst{f}róða jǫtuns &
\ind \alst{s}ex-hǫfðaðan \alst{s}on.“\eva

\bvb Webthrithner quoth: \\
“Withinn the hand of the \inx[G]{Rime-Thurses}[rime-thurse], they said, did grow \\
...
men always see his very self?”\evb
\evg
...
and he was not to the Eese begotten.”\evb
\evg
...
\bvg\bva\mssnote{\Regius~8v/30, \AM~3v/21}Nú við \alst{Ó}ðin \hld\ dęilda’k mína \edtrans{\alst{o}rð-spęki}{word-wisdom}{\Bfootnote{The same word-wisdom Weden in st. 5 set out to try.}}; &
