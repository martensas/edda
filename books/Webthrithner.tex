...
\bvb\speakernoteb{Webthrithner:}%
“\inx[P]{Mundlefarer} he is called—he is the father of Moon, \\
...
whence came Day who journeys over the folk, \\
...
\ind and thou, Webthrithner, oughtst to know, \\
whence came winter or warm summer, \\
...
\edtrans{\alst{h}ofum ok \alst{h}ǫrgum}{hoves and harrows}{\Bfootnote{A formulaic merism, see note to \textlink{Voluspa} 7 for other occurrences.

This stanza seems to be referring to the large count of cultic places named after Nearth—\textcite{Brink2007} counts 13 attestations in Norway, 17 in Sweden, 3 in Denmark; in addition there are a few on Iceland (TODO).  For Nearth’s harrow cf. \textlink{Grimnismal} 16, where it is said that Nearth \emph{rę́ðr hǫ́-timbruðum hǫrgi} ‘rules a high-timbered harrow’.  Also of interest is \textlink{Lokasenna} 51, where a goddess speaks of her \emph{vé ok vangar} ‘wighs and wongs’, two terms common in cultic place names.  The underlying theological understanding seems to be that the god is physically present as a ruler of his shrine.}} \hld\ rę́ðr \alst{h}und-mǫrgum &
...
\edtext{„İ \alst{V}ana-hęimi \hld\ skópu hann \alst{v}ís \edtrans{ręgin}{Reins}{\Bfootnote{\emph{ręgin} ‘the Reins, Powers’ is generally used simply to refer to the gods as a collective, but here seems to refer specifically to the \inx[G]{Wanes} in opposition to the \inx[G]{Eese}.}} &
...
\ind hęim með \alst{v}ísum \alst{v}ǫnum.“}{\lemma{ALL}\Bfootnote[nonum]{Cf. \Gylfaginning, \YnglingaSaga\ TODO.}}\eva
...
\ind \alst{h}ǫggvask \alst{h}vęrjan dag.}{\lemma{ALL}\Bfootnote[nonum]{This question-stanza is malformed in both \Regius\ and \AM\ and thus has to be partly reconstructed on the basis of st. 41.  The ms. preservation of 40–41 is as follows:
...
\edtext{„\alst{U}lfr glęypa \hld\ mun \alst{A}lda-fǫðr, &
\ind þęss mun \alst{V}íðarr \alst{v}reka; &
\alst{k}alda \alst{k}japta \hld\ hann \alst{k}lyfja mun &
\ind \alst{v}itnis \alst{v}ígi at.“}{\lemma{ALL}\Bfootnote[nonum]{For Weden’s fight with the Wolf and Wider’s revenge see \textlink{Voluspa} 51–52.}}\eva
...
„\alst{Ęy} \edtext{mann-gi}{\Afootnote{\emph{manni} dat. sg. \Regius\AM\ is impossible; a subject is needed.}} vęit, \hld\ hvat þú ï \alst{á}r-daga &
