...
\bvb Webthrithner: \\
“\inx[P]{Mundlefare} is [one] called; he is the father of Moon, \\
...
in days of yore might have become eldest?\footnoteB{i.e. ‘which being arose first of all?’ Cf. the question on the C9th Malt Stone (DR NOR1988;5): \textbf{huaʀisi : alistiąsa}, perhaps \emph{Hvaʀ es inn ęlisti ása?} ‘Who is the eldest of the Eese?’}”\evb
\evg
...
Whence \inx[P]{Nearth} did come [to dwell] among the sons of the \inx[G]{Eese}? \\
\inx[C]{hove}[Hoves] and \inx[C]{harrow}[harrows] he rules hound-many, \\
and he was not by the Eese begotten.”\evb
\evg
...
\bvb {[Webthrithner quoth:]} \\
“In \inx[L]{Waneham} the wise \inx[G]{Reins}\footnoteB{While \emph{ręgin} ‘Reins’ is usually just a synonym of \emph{goð} ‘gods’, it seems here to refer specifically to the Wanes, in contrast with the \inx[G]{Eese}.} shaped him, \\
