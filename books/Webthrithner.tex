...
í \edtrans{\alst{a}ldar rǫk}{the Rakes of the Age}{\Bfootnote{The \inx[L]{Rakes of the Reins}, the End Times.}} \hld\ hann mun \alst{a}ptr koma &
...
„\alst{Ęi}na dóttur \hld\ berr \edtext{\alst{a}lf-rǫðull}{\lemma{alf-rǫðull ‘Elf-wheel’}\Bfootnote{A rare poetic synonym (\emph{hęiti}) for the sun.  It occurs in two other places: \Skirnismal\ 4/3, and a Scaldic loose stanza by Iewind Spoiler-of-scalds (Eyv Lv 9 in \Skp\ 1).  It also appears in two lists of names for the sun: \Skaldskaparmal\ 69, Þul \emph{Sólar} 1/7 in \Skp\ 3, but these do not count as independent attestations since they may be drawing from any of the three earlier poems.)
...
\ind \edtrans{\alst{V}ingnis at \alst{v}íg-þroti}{after Wingner’s grown weary in war}{\Bfootnote{After Thunder dies.}}.“\eva
...
\ind after \inx[P]{Wingner}’s grown weary in war.”\evb\evg
