...
\bvb\ [\inx[P]{Weden} quoth:] “Counsel me now, \inx[P]{Frie}, as I desire to journey \\
to visit \inx[P]{Webthrithner}; \\
great curiosity I have of ancient staves \\
by that all-wise \inx[G]{Ettins}[ettin].\footnoteB{i.e. ‘I am greatly curious of the all-wise ettin’s ancient pieces of wisdom.’ Cf. v. 55.}”\evb
\evg


\bvg
\bva\mssnote{\Regius~7v/12}„\alst{H}ęima lętja \hld\ mynda’k \alst{H}ęrja-fǫðr &
...
\bvb {[Frie quoth:]} “At home I would wish to keep the Father of Hosts \ken*{= Weden}, \\
...
\bvb {[Weden quoth:]} “Much I journeyed, much I tried, \\
...
\bvb {[Frie quoth:]} “Whole journey thou, whole come thou back, \\
whole be thou on thy paths! \\
Thy wisdom avail thee, where thou shalt, O \inx[P]{Eldfather} \name{= Weden}, \\
...
\bvg
\bva\mssnote{\Regius~7v/18}„\alst{H}ęill þú nú, Vaf-þrúðnir, \hld\ nú em’k í \alst{h}ǫll kominn &
...
\bvb {[Weden quoth:]} “Hail thee now, O Webthrithner; now am I come into the hall, \\
to see thy self! \\
...
\bvb {[Webthrithner quoth:]} “What sort of man is that, who in \emph{my} hall \\
throws words at me? \\
...
\bvg
\bva\mssnote{\Regius~7v/22}„\edtext{\alst{G}agnráðr}{\Bfootnote{Gang-ráðr ‘Gangred; Journey-adviser’ \GylfMS. TODO: Is this st. actually quoted?}} hęiti’k, \hld\ nú em’k af \alst{g}ǫngu kominn, &
...
\bvb {[Weden quoth:]} “\inx[P]{Gainred} I am called, now am I come from walking, \\
...
\bvb {[Webthrithner quoth:]} “Why then, Gainred, speakest thou from the floor before me? \\
...
\ind \edtrans{mę́li \alst{þ}arft eða \alst{þ}ęgi}{ought to speak the needful or shut up}{\Bfootnote{Formulaic, line occurs identically in \Havamal\ 19.}}; &
\alst{o}fr-mę́lgi mikil \hld\ hygg’k at \alst{i}lla geti &
\ind hvęim’s við \alst{k}ald-rifjaðan \alst{k}ømr.“\eva

\bvb {[Weden quoth:]} “An unwealthy man, who to a wealthy one comes, \\
ought to speak the needful or shut up. \\
Great over-speaking, I judge, will bring evil \\
for whomever to a cold-ribbed\footnoteB{i.e. ‘cold-hearted, cunning’.} man comes.”\evb
\evg
...
\bvb {[Webthrithner quoth:]} “Say to me, Gainred, since on the floor thou wilt \\
try thy fame: \\
...
\bvg
\bva\mssnote{\Regius~7v/30}„\alst{Sk}in-faxi hęitir, \hld\ es hinn \alst{sk}íra dręgr &
...
\bvb {[Weden quoth:]} “\inx[P]{Shinefax} is called he who pulls the bright \\
...
\bvg
\bva\mssnote{\Regius~7v/32}„Sęg þat, \alst{G}agn-ráðr, \hld\ alls á \alst{g}olfi vill &
\ind þíns of \alst{f}ręista \alst{f}rama, &
hvé \alst{jó}r hęitir, \hld\ sá’s \alst{au}stan dręgr &
\ind \alst{n}ǫ́tt of \alst{n}ýt ręgin.“\eva

\bvb {[Webthrithner quoth:]} “Say this, Gainred, since on the floor thou wilt \\
try thy fame: \\
...
\bvg
\bva\mssnote{\Regius~7v/33}„\alst{H}rím-faxi \alst{h}ęitir, \hld\ es \alst{h}vęrja dręgr &
...
\bvb {[Weden quoth:]} “\inx[P]{Rimefax}\ he is called, who pulls every \\
...
\bvb {[Weden quoth:]} “\inx[L]{Iving} the river is called, which divides the ground \\
...
\bvb Weden [quoth]: “\inx[L]{Wighride} is the plain called, where Surt and the excellent gods \\
...
\bvb Webthrithner [quoth]: “Out of \inx[P]{Yimer}’s hull was the earth created, \\
but out of his bones the crags; \\
heaven out of the skull of the rime-cold ettin, \\
but out of his blood\footnoteB{\emph{svęiti} ‘sweat’ is often used to refer to blood.} the sea.\footnoteB{This st. very closely resembles \Grimnismal\ 40–41 TODO.}”\evb
\evg
...
\bvb Weden [quoth]: “Say the other, if thy wisdom suffices, \\
and thou, Webthrithner, knowest: \\
...
\bvg {\small Vafþrúðnir:}
\bva\mssnote{\Regius~8r/13, \AM~3r/4}„\alst{M}undil-fari hęitir, \hld\ hann’s \alst{M}ána faðir &
...
\bvb Webthrithner [quoth]: “\inx[P]{Mundelfare} is [one] called; he is the father of Moon, \\
and of Sun likewise. \\
...
\bvb Webthrithner [quoth]: “\inx[P]{Delling} is [one] called; he is the father of \inx[P]{Day}, \\
...
\bvb Weden quoth: “Say the fourth, as they call thee learned, \\
and thou, Webthrithner, knowest: \\
...
\bvg {\small Vafþrúðnir:}
\bva\mssnote{\Regius~8r/20, \AM~3r/10}\edtext{„\alst{V}ind-svalr hęitir, \hld\ hann’s \alst{V}etrar faðir, &
...
\bvb Webthrithner [quoth]: “\inx[P]{Windswoll}\ is [one] called, he is \inx[P]{Winter}’s father; \\
...
\bvg {\small Vafþrúðnir:}
\bva\mssnote{\Regius~8r/22, \AM~3r/12}„\alst{Ø}r-ófi vetra \hld\ áðr vę́ri \alst{jǫ}rð of skǫpuð, &
...
\bvb Weden quoth: “Say the sixth, as they call thee wise, \\
and thou, Webthrithner, knowest: \\
...
\bvg {\small Vafþrúðnir:}
\bva\mssnote{\Regius~8r/25, \AM~3r/15, \GylfMS}„\alst{Ó}r \alst{É}li-vǫ́gum \hld\ stukku \alst{ęi}tr-dropar, &
...
\bvb Webthrithner [quoth]: “Out of the \inx[L]{Ilewaves} splashed venom-drops; \\
...
\bva\mssnote{\Regius~8r/27, \AM~3r/17}„Und \alst{h}ęndi vaxa \hld\ kvǫ́ðu \alst{h}rím-þursi &
...
\bvb Webthrithner quoth: “Under the arm\footnoteB{lit. ‘hand’.} on the \inx[G]{Rime-Thurses}[rime-thurse], they said \\
...
\bvg {\small Vafþrúðnir kvað:}
\bva\mssnote{\Regius~8r/30, \AM~3r/19, \GylfMS}„\alst{Ø}r-ófi vetra \hld\ áðr vę́ri \alst{jǫ}rð of skǫpuð, &
\ind þá vas \alst{B}er-gęlmir \alst{b}orinn; &
...
\bvg {\small Vafþrúðnir:}
\bva\mssnote{\Regius~8r/34, \AM~3r/22}„\alst{H}rę́-svęlgr \alst{h}ęitir, \hld\ es sitr á \alst{h}imins ęnda, &
\ind \alst{jǫ}tunn í \alst{a}rnar ham; &
af hans \alst{v}ę́ngjum \hld\ kveða \alst{v}ind koma &
\ind \alst{a}lla męnn \alst{y}fir.“\eva

\bvb Webthrithner [quoth]: “\inx[P]{Rawswallower} is [one] called, who sits at the end of the heavens; \\
...
\bvb {[Weden quoth:]} “Say the tenth, since thou of the \inx[P]{Rakes of the Tews} \\
...
\bvg {\small [Vafþrúðnir kvað:]}
\bva\mssnote{\Regius~8v/3, \AM~3r/26}„Í \alst{V}ana-hęimi \hld\ skópu hann \alst{v}ís ręgin &
...
\bvb {[Webthrithner quoth:]} “In \inx[L]{Waneham} the wise \inx[G]{Reins}\footnoteB{While \emph{ręgin} ‘Reins’ is usually just a synonym of \emph{goð} ‘gods’, it seems here to refer specifically to the Wanes, in contrast with the \inx[G]{Ease}.} shaped him, \\
...
\bvg {\small [Vafþrúðnir kvað:]}
\bva\mssnote{\AM~3r/28}„\alst{A}llir \alst{ęi}n-hęrjar \hld\ \alst{Ó}ðins túnum í &
\ind \alst{h}ǫggvask \alst{h}vęrjan dag, &
\alst{v}al þęir kjósa \hld\ ok ríða \alst{v}ígi frá, &
\ind \alst{s}itja męir of \alst{s}áttir \alst{s}aman.“\eva

\bvb {[Webthrithner quoth:]} “All the \inx[G]{Ownharriers} in Weden’s yards \\
cut each other down every day. \\
The slain they choose and from the battle ride; \\
{[then]} they sit more at peace together.”\evb
\evg
...
\bvb {[Webthrithner quoth:]} “From the runes of the ettins and of all the gods \\
I can speak truly, \\
...
\bvb {[Webthrithner quoth:]} “\inx[P]{Life} and \inx[P]{Lifethrasher}, but they will hide themselves \\
...
\bvg {\small [Vafþrúðnir kvað:]}
\bva\mssnote{\Regius~8v/16, \AM~3v/9}„\alst{Ęi}na dóttur \hld\ berr \alst{a}lf-rǫðull, &
\ind áðr hana \alst{F}ęnrir \alst{f}ari; &
sú skal \alst{r}íða, \hld\ þá’s \alst{r}ęgin dęyja, &
\ind \alst{m}óður brautir \alst{m}ę́r.“\eva

\bvb {[Webthrithner quoth:]} “A lone daughter the elf-wheel \ken*{= Sun} bears \\
...
\bvg {\small [Vafþrúðnir kvað:]}
\bva\mssnote{\Regius~8v/19, \AM~3v/11}\alst{Þ}ríar \alst{þ}jóð-áar \hld\ falla \alst{þ}orp yfir &
...
\bvb {[Webthrithner quoth:]} “Three great rivers fall over the settlement \\
...
\bvb {[Webthrithner quoth:]} “\inx[P]{Wider} and \inx[P]{Wonnel} settle the \inx[C]{wigh}[wighs] of the gods \\
...
\bvg {\small [Vafþrúðnir kvað:]}
\bva\mssnote{\Regius~8v/25, \AM~3v/17}„\alst{U}lfr glęypa \hld\ mun \alst{A}lda-fǫðr, &
...
\bvg {\small [Vafþrúðnir kvað:]}
\bva\mssnote{\Regius~8v/28, \AM~3v/19}„\alst{Ęy} \edtext{mann-gi}{\Afootnote{\emph{manni} dat. sg. \Regius\AM\ is impossible; a subject is needed.}} vęit, \hld\ hvat þú í \alst{á}r-daga &
...
\bvb {[Webthrithner quoth:]} “Ever no man knows, what thou in days of yore \\
saidst into the son’s ear. \\
With \inx[C]{fey}\footnoteB{Webthrithner realizes that he was bound to die (\emph{fęigr} ‘fey’, a word with strong fatalistic connotations) from the moment he proposed the wager (v. 19), as no being can outwit Weden.} mouth I spoke my ancient \inx[C]{stave}[staves], \\
and of the Rakes of the Reins.\evb
\evg


\bvg
\bva\mssnote{\Regius~8v/30, \AM~3v/21}Nú við \alst{Ó}ðin \hld\ dęilda’k mína \alst{o}rð-spęki; &
\ind þú est ę́ \alst{v}ísastr \alst{v}era.“\eva

\bvb Now with Weden I [have] shared my word-wisdom;\footnoteB{The same word-wisdom Weden in st. 5 set out to try.} \\
