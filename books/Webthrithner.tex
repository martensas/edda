...
\edtext{\alst{f}or-vitni mikla \hld\ kveð’k mér á \alst{f}ornum stǫfum &
...
\ind en ór \edtrans{\alst{s}vęita}{blood}{\Bfootnote{Cf. \Sonatorrek\ 3/3 \emph{jǫtuns hals \hld\ undir þjóta} ‘the neck-wounds of the ettin \ken{seas} roar’.  In poetry \emph{svęiti} ‘sweat’ almost always means ‘blood’. This is shared with OE \emph{swât}, as seen e.g. in \Beowulf\ 1286a: \emph{sweord \emph{swâte} fâh} ‘sword stained with “sweat”’, 2689b–2690: \emph{hé ge-blódegod wearð // sâwul-dríore; \hld\ \emph{swât} ýðum wéoll.} ‘he was bloodied in soul-gore; the “sweat” gushed in waves’.}} \alst{s}ę́r.}{\lemma{Ór \dots\ sę́r. ‘From \dots\ the sea.’}\Bfootnote{The whole st. very closely resembles \Grimnismal\ 41; ll. 1 and 4 here are identical to ll. 1–2 there, and ll. 2 and 3a here are clearly related to ll. 3a and 4 there.

Still, the sts. are distinct enough that the one cannot be a direct scribal copy of the other.  The relationship is more likely to be oral, they have probably both been composed in the same West Norwegian milieu, deriving from an older common Germanic tradition (see the Hymn from Wessobrunn under Christian Poetry).}}“\eva
...
\ind and thou, Webthrithner, mightst know, \\
from whence Moon did come, who journeys over men, \\
...
\ind ok þú \alst{V}af-þrúðnir \alst{v}itir, &
\edtext{hvęrr \alst{á}sa \alst{ę}ldstr \hld\ eða \alst{Y}mis niðja &
\ind \alst{y}rði í \alst{á}r-daga.}{\lemma{hvęrr \dots\ ár-daga ‘who \dots\ days of yore.’}\Bfootnote{I.e. “which was the very first being?”  Cf. the question on the mystic C9th Malt Stone (DR NOR1988;5): \textbf{huaʀisi : alistiąsa}, perhaps \emph{Hvaʀ es inn ęlisti ȧsa?} ‘Who is the eldest of the Eese?’}}“\eva
...
„\edtrans{Sęg þat hit ǫ́ttunda, \hld\ alls þik fróðan kveða,}{Tell this eighth, since they call thee learned}{\Bfootnote{Alliteration is missing from this line but may easily be attained by supplying the b-verse from sts. 20 and 22: \emph{ef þitt ǿði dugir}.}} &
\ind ok þú \alst{V}af-þrúðnir \alst{v}itir, &
...
\ind á vas \alst{l}úðr of \alst{l}agiðr.}{\lemma{es hinn fróði jǫtunn á vas lúðr of lagiðr ‘when the learned ettin on the tree-trunk was laid’}\Bfootnote{An obscure mythological reference.
...
{\small The question and answer-pair 40–41 is malformed in \Regius\ and \AM, and thus has to be reconstructed.  \Regius\ has one complete stanza, but it is clearly a mix between the question and the answer.  \AM\ has only the very beginning of st. 40 (“Tell this eleventh”), followed by the full st. 41.  The full st. 41 is also found in all four mss. of \Gylfaginning\ with no textual variants.  In diplomatic transcription:

\Regius\ \emph{Segðv þat et .xi. hvar ytar tvnom i hǫggvaz hverian dag. Val þeir kíosa oc riþa vígi fra sitia meirr vm sáttir saman.}

\AM\ \emph{Sæg þat et .xi. allir eins hæriar oðins tvnvm i hǫgguaz hværian dag. Val þæir kiosa ok riða vigi fra sitja mæirr vm sattir saman.}

\RegiusProse\ \emph{Allir Einheriar Oþins tvnvm i havggvaz hverian dag; Val þeir kiosa ok riþa vigi fra, sitja meirr vm sattir saman.}

Although \Regius\ has a complete stanza, it stands out by lacking a refrain, something found in all other question-stanzas in the poem (see the Introduction).  For this reason the refrain has been inserted from sts. 20 and 22, which also have vowel-alliteration.  The word \emph{allir} ‘all’ has been inserted from the answer-stanza to get a proper line.  Needless to say, this solution is conjecture.}

\sectionline

\bvg\bva\speakernote{[Óðinn kvað:]}\mssnote{\Regius~8v/5, \AM~3r/28}%
„Sęg þat hit \alst{ę}llipta, \hld\ \emph{ef þitt \alst{ǿ}ði dugir} &
\ind \emph{ok þú \alst{V}af-þrúðnir \alst{v}itir,} &
hvar \emph{\alst{a}llir} \hld\ \alst{ý}tar túnum í &
...
\ind þá’s \alst{s}loknar \edtrans{\alst{S}urta-logi}{the flame of Surt}{\Bfootnote{The flame which reaches up to Heaven itself and burns the entire world; see \Voluspa\ 50, 54.}}?“\eva
