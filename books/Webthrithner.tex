...
\edtext{„Sęg þat hit \alst{ę}llipta, \hld\ \emph{ef þitt \alst{ǿ}ði dugir} &
\ind \emph{ok þú \alst{V}af-þrúðnir \alst{v}itir,} &
hvar \emph{\alst{a}llir} \hld\ \alst{ý}tar túnum í &
\ind \alst{h}ǫggvask \alst{h}vęrjan dag.}{\lemma{ALL}\Bfootnote{This question-stanza is malformed in \Regius\ and \AM\ and thus has to be partly reconstructed on the basis of st. 41, which is securely attested in all four mss. of \Gylfaginning\ with no textual variants.

As for the former two mss., \Regius\ has a complete stanza, which is clearly a mix between the question and the answer (normalised): \emph{Sęg-ðu þat hit ęllipta, hvar ýtar túnum í hǫggvask hvęrjan dag? Val þęir kjósa ok ríða vígi frá sitja męirr of sáttir saman.}, while \AM\ only has the very beginning of st. 40 (“Tell this eleventh”), followed by the full st. 41 (normalised): \emph{Sęg þat hit ęllipta allir ęins hęrjar Óðins túnum í hǫggvask hvęrjan dag. Val þęir kjósa ok ríða vígi frá sitja męirr of sáttir saman.}  Although \Regius\ has a complete question-stanza, it stands out by lacking a refrain in the first two lines, something found in all other questions in the poem (see Introduction); it also has no corresponding answer-stanza.

In order to restore a regular question-stanza the refrain \emph{ef þitt ǿði dugir ok þú Vaf-þrúðnir vitir} has been inserted from sts. 20 and 22, which also have an ordinal number alliterating with a vowel.  In line 3a the word \emph{allir} ‘all’ has been inserted from 41 to get vowel-alliteration with \emph{ýtar}.  Needless to say, this solution is conjectural.}}“\eva
...
„\alst{A}llir \edtext{\alst{ęi}n-hęrjar}{\Afootnote{so \GylfMS; \emph{ęins hęrjar} \AM}} \hld\ \alst{Ó}ðins túnum í &
