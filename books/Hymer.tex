...
The narrative of \Hymiskvida\ can be subdivided into the following episodes:
...
„þann’s ek \alst{ǫ}llum \edtrans{\alst{ǫ}l}{ale}{\Bfootnote{Often drunk by the gods at their feasts; see \Grimnismal\ 37/6 and note.}} \hld\ \alst{y}ðr of hęita.“\eva
...
\alst{H}vęrn létu þęir \hld\ \alst{h}ǫfði skęmra &
auk ȧ \alst{s}ęyði \hld\ \alst{s}íðan bǫ́ru, &
\edtext{át \alst{S}ifjar verr \hld\ áðr \alst{s}ofa gingi, &
\alst{ęi}nn með \alst{ǫ}llu \hld\ \alst{ø}xn tvȧ Hymis.}{\lemma{át \dots\ Hymis. ‘Sib’s \dots\ oxen.’}\Bfootnote{Cf. \Thrymskvida\ 24 for another instance of Thunder’s great eating, which curiously also uses the kenning \emph{Sifjar verr} ‘Sib’s husband \ken*{= Thunder}’.}}\eva

\bvb Each one they let shorten by a head, \\
and onto the cooking-pit then did carry: \\
Sib’s husband \ken*{= Thunder} ate before he went sleep \\
...
\bvb I think that the baits from the ox \\
...
(A new scene; the party is out at sea.  It is possible that a stanza has been lost here, or that the transition would have been indicated in some other way during oral performance.)
...
\alst{D}ró \alst{d}jarf-liga \hld\ \alst{d}áð-rakkr \edtrans{Þȯ\emph{a}rr}{Thunder}{\Bfootnote{Out of 8 three-syllable lines in \Hymiskvida, this is the only one which is deficient in both \Regius\ and \AM\ and cannot easily be emended by restoring an hiatus form.  In the quite strict meter (see Introduction above) observed by the \Hymiskvida\ poet we should expect a disyllabic form in this spot, and this may be had if we restore an archaic \emph{*Þȯarr} or \emph{*Þȯurr}.  Such a form is less secure than other hiatus forms, but is also required by the meter of \Hymiskvida\ 28/2b below, and further in the Scaldic \Thorsdrapa\ 2/2b.  This issue is treated in depth by \textcite{Haukur2023}, who argues for the form \emph{*Þóurr}.}} &
...
\alst{s}økkðisk \alst{s}íðan \hld\ \alst{s}á \edtrans{fiskr}{fish}{\Bfootnote{A good example showing that pre-modern speciation, especially in mythology, was not exact.  The appellation is not a mere fancy of the poet, for the Wyrm appears in the shape of a fish in various pre-Christian pictorial sources (e.g. GP 21).  It may also be called a fish in \Grimnismal\ 21 (see note there), and in Scaldic sources it is often called a saithe (\emph{sęiðr}).}} ï mar.\eva
...
\edtrans{svá’t \alst{á}r}{so that for a long time}{\Bfootnote{\textcite{FinnurEdda}\ suggests \emph{svá’t at ǫ́r} ‘so that by the oar’, but this burdens the strict meter.  For this sense of \emph{ár} cf. \Skirnismal\ 27.}} Hymir \hld\ \alst{ę}kki mę́lti, &
...
or our float-buck \ken{boat} do fasten.\footnoteB{Hymer tells Thunder who, having let go of the Wyrm, has nothing to show for the trip, that he can accomplish something half as great as the pulling of the whales if he carries them home and ties the boat by the shore.}”\evb\evg


\bvg\bva\mssnote{\Regius~14v/9, \AM~6v/6}%
\alst{G}ekk Hlórriði \hld\ \alst{g}ręip \edtext{ȧ}{\Afootnote{\emph{til ȧ} \Regius}} stafni &
...
En \alst{H}lórriði, \hld\ es at \alst{h}ǫndum kom, &
...
„drep við \edtrans{\alst{h}aus \alst{H}ymis, \hld\ hann ’s \alst{h}arðari}{Hymer’s skull! It is harder}{\Bfootnote{Ettins characteristically have hard skulls; see \Harbardsljod\ 15 and note for the significance of it.}}, &
\edtrans{\alst{k}ost-móðs}{choice-weary}{\Bfootnote{Hymer can justly be called “choice-weary”; at this point the gods have destroyed eight of his nine cauldrons and slain three of his bulls.}} jǫtuns, \hld\ \alst{k}alki hvęrjum!“\eva

\bvb until the handsome mistress \ken*{= Tew’s mother} gave \\
a great loving counsel, the only one she knew: \\
“Strike it against Hymer’s skull! It is harder— \\
...
\edtrans{fǿrðisk \alst{a}llra \hld\ ï \alst{ǫ̇}s-męgin}{brought himself to his highest Os-might}{\Bfootnote{The exact meaning of this is not clear, but a likely reading is that Thunder brings himself into his true form as the mighty, red-bearded man; recall that he was previously in the shape of a young boy (st. 18).  Cf. \Gylfaginning\ in its description of Thunder attempting to pull up the Wyrm: \emph{Þá varð Þórr reiðr ok fǿrðist í ás-megin} “Then Thunder turned wroth and drew himself into his Os-might” and the Eddic fragment about Thunder’s journey to Garfrith.}}; &
...
brought himself to his highest Os-might.— \\
...
ok ï \alst{g}ǫgnum \edtrans{stęig}{stepped}{\Afootnote{so \Regius; \emph{stóð} ‘stood’ \AM}} \hld\ \alst{g}olf niðr \edtext{ï}{\Afootnote{\emph{ȧ} (norm.) \AM}} sal; &
...
and stepped through the floor in the hall.\footnoteB{In the account of \Gylfaginning\ Thunder is said to have stepped through the boat when trying to pull up the Middenyardswyrm.  This detail is also seen on the carving of the Altuna stone from Uppland, Sweden; it may have been transposed to this place in the narrative. TODO.} \\
...
ok \alst{h}raun-\alst{h}vala \hld\ \alst{h}ann alla drap.}{\lemma{ALL}\Bfootnote[nonum]{This stanza is rather reminiscent of \Thrymskvida\ 31–32, where Thunder likewise smites a large group of ettins with his hammer.  The tone of both episodes is comedic.}}\eva
