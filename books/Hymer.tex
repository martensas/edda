...
lęit í \alst{au}gu \hld\ \alst{Y}ggs barn í þrá: &%NOTE: þrá is correct; it is not the same word as þrǫ́
...
\alst{s}jónum lęiddi \hld\ \alst{s}ínn and-skota.\eva
...
\edtrans{Sagði-t \alst{h}ǫ́num \hld\ \alst{h}ugr vęl}{His heart did not please him}{\Bfootnote{Lit. ‘his heart did not speak well to him’.}} þá’s sá &
...
\alst{V}éurr kvaðsk \alst{v}ilja \hld\ á \alst{v}ág róa, &
...
\alst{Þ}ess \edtext{vę́ntir mik}{\Afootnote{so \AM; \emph{vę́nti ek} \Regius}}, \hld\ at \alst{þ}ér \edtrans{myni-t}{will not}{\Afootnote{so \AM; \emph{myni} ‘will’ \Regius.  The \AM\ reading is preferable since it makes this the first of Hymer’s several challenges of strength to Thunder, which the god, to the ettin’s humiliation, easily accomplishes.}} &
...
\alst{ęi}nn á \alst{ǫ}ngli \hld\ \alst{u}pp sęnn tvȧ\emph{a}; &
...
\alst{Ę}gnði á \alst{ǫ}ngul \hld\ sá’s \alst{ǫ}ldum bergr, &
...
The poetic juxtaposition between the Storm-god and the Wyrm may be very old; cf. \Rigveda\ 1.32.13c: \emph{Índraş ca yád \hld\ yuyudʰā́tay Áhiş ca} ‘When Índra and the Wyrm (\emph{áhi}) fought each other.’}}\eva
...
\alst{D}ró \alst{d}jarf-liga \hld\ \alst{d}áð-rakkr \edtrans{Þȯ\emph{u}rr}{Thunder}{\Bfootnote{Out of 8 three-syllable lines in \Hymiskvida, this is the only one which is deficient in both \Regius\ and \AM\ and cannot easily be emended by restoring an hiatus form.  In the quite strict meter (see Introduction above) observed by the poet we should expect a disyllabic form in this spot, and this may be had if we restore an archaic \emph{*Þȯurr} or \emph{*Þȯarr}.  This form is less secure than other hiatus forms, but is also required by the meter of \Hymiskvida\ 28/2b below and further in the Scaldic \Thorsdrapa\ 2/2b.  The issue is treated in depth by \textcite{Haukur2023}.}} &
...
\alst{s}økkðisk \alst{s}íðan \hld\ \alst{s}á \edtrans{fiskr}{fish}{\Bfootnote{A good example showing that pre-modern speciation, especially in mythology, was not exact.  The appellation is not a mere fancy of the poet, for the Wyrm appears in the shape of a fish in various pre-Christian pictorial sources (e.g. GP 21).  It may also be called a fish in \Grimnismal\ 21 (see note there), and in Scaldic sources it is often called a saithe (\emph{sęiðr}).}} í mar.\eva
...
\alst{G}ekk Hlórriði \hld\ \alst{g}ręip \edtext{ȧ}{\Afootnote{\emph{til á} \Regius}} stafni &
...
\alst{ǫ́}st-ráð mikit, \hld\ \alst{ęi}tt es vissi,}{\lemma{unds \dots\ vissi, ‘until \dots\ knew:’}\Bfootnote{Harkening back to st. 4.}} &
...
\edtrans{fǿrðisk \alst{a}llra \hld\ í \alst{á}s-męgin}{brought himself to his highest Os-might}{\Bfootnote{The exact meaning of this is not clear, but a likely reading is that Thunder brings himself into his true form as the mighty, red-bearded man; recall that he was previously in the shape of a young boy (st. 18).  Cf. \Gylfaginning\ in its description of Thunder attempting to pull up the Wyrm: \emph{Þá varð Þórr reiðr ok fǿrðist í ás-megin} “Then Thunder turned wroth and drew himself into his Os-might” and the Eddic fragment about Thunder’s journey to Garfrith.}}; &
...
\alst{Þ}rótt-ǫflugr kom \hld\ á \alst{þ}ing goða &
