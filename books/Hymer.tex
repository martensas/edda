...
\bvg
\bva\mssnote{\Regius~14v/32, \AM~6v/22}En \edtrans{ér}{ye}{\Bfootnote{The audience. As pointed out in \textcite{FinnurEdda}, a verse containing such an address to the audience is otherwise unparalleled. (\Voluspa\ 1, for instance, is still ‘in character’ as the wallow.)}} \alst{h}ęyrt \alst{h}afið, \hld\ \alst{h}vęrr kann umb þat &
