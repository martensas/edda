...
\edtext{Þótti \alst{h}ǫ́rum \hld\ \alst{H}rungnis spjalla &
...
\alst{D}ró \alst{d}jarf-liga \hld\ \alst{d}áð-rakkr \edtrans{Þȯ\emph{u}rr}{Thunder}{\Bfootnote{Out of 8 three-syllable lines in \Hymiskvida, this is the only one which is present in both \Regius\ and \AM, and which cannot easily be emended by restoring an hiatus form.  In the quite strict meter (see Introduction above) observed by the poet we should expect a disyllabic form in this spot, and this may be had if we restore an archaic \emph{*Þȯurr} or \emph{*Þȯarr}.  This form is less secure than other hiatus forms, but is also required by the meter of \Hymiskvida\ 28/2b below and \Thorsdrapa\ 2/2b.  This issue is treated in depth by \textcite{Haukur2023}.}} &
