...
\footnotetext[1]{\emph{sęlja} ‘sell’ here has its earlier meaning, cf. Gothic \emph{saljan} ‘\emph{opfern}; θύειν’ (Streitberg 1910:116).}
...
\footnotetext[3]{Though Thunder is the one asking for the hame (“\emph{my} hammer”), Lock is the one that takes off flying.}
...
\footnotetext[1]{A linen band tied around the bride’s head.}
