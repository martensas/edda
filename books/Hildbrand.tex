...
\bvg
\bva[0][6]\alst{H}ilti-brant \edtext{gi·mahalta}{\Afootnote{\emph{heribrantes sunu} ‘Harbrand’s son’ add. \HildMS}} \hld\ her was \alst{h}êróro man &
...
\bvg
\bva[0][29]„wêt̨t̨u \alst{I}rmin-got {\small (kwad Hilti-brant)} \alst{o}bana ab \edtext{hewane}{\Afootnote{\emph{heuane} \HildMS}} &
...
„mit \alst{g}êru skal man \hld\ \alst{g}eba in·fȧhan &
...
\alst{w}estar ubar \alst{W}ęntil-sêo \hld\ dat̨ man \alst{w}ík fur·nam: &
...
\bvg
\bva[0][48]„\alst{w}elaga nú \alst{w}altant got {\small (kwad Hilti-brant)} \alst{w}ê-wurt skihit &
...
\bvg
\bva[0][57]„der sí doh nú \alst{a}rgósto {\small (kwad Hilti-brant)} \alst{ô}star-liuto &
