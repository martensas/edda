...
Where it appears in the cæsura, the extrametrical interjection \emph{kwad Hilti-brant} ‘quoth Hildbrand’ (found in ll. 30, 49, and 58) replaces the usual interpunct, to indicate that the pause of the cæsura has been filled with an indication of the speaker.  Outside of \Hildebrandslied, similar interjections are found throughout early Germanic poetry: in Old Norse (e.g. \Reginsmal\ 3/1, Anon \emph{Eirm} 1/1 in \Skp\ I), Old Saxon (e.g. \Heliand\ 226, \SaxonGenesis\ 1), and Old English (e.g. \Finnsburg\ 24).  The distribution of these interjections is such that they cannot be mere scribal additions (Old Norse poetry was first written down in the C12th, several centuries after the alliterative meter had gone extinct in Germany); instead, they appear to be genuine remnants of oral performance.
