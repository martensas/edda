...
Several galders or magical inscriptions are part of the cache of mediaeval rune-inscribed objects found at Bryggen in the city of Bergen, Norway.  For simplicity’s sake, they are here listed in ascending order of their runological numbers.
...
\begin{flushright}%
\textbf{Dating:} ca. 1335

\textbf{Meter:} \Galdralag
\end{flushright}%

A stick inscribed on four planed sides.  Part of the stick is broken off, which renders the text incomplete.  The inscription is clearly a “love-charm” (that is, a piece of sexually coercive magic), addressed---as is shown by the feminine dative \emph{sjalfri þér} ‘thy self’ on side D---to a woman.
The language closely resembles that of \textlink{Skirnismal}[36], in which Shirner, servant of the god Frea, threatens to carve a runic inscription which will curse the ettin-woman Gird with \emph{ęrgi} ‘queerness, sexual insatiability’, \emph{ǿði} ‘madness’, and \emph{ó·þoli} ‘restlessness, impatience’ unless she sleep with his master.  It seems that we are here dealing with just such a surviving runic curse, and that \textlink{Skirnismal}[36] is reflecting an  authentic form of Norse “love magic” (for it is unlikely that the present inscription should derive directly from that poem) by which a woman is cursed with sexual restlessness until she succumb to the will of the male curser.
...
\bvg\bva[A]Ríst ek \edtext{\alst{b}ót-rúnar \hld\ ríst ek \alst{b}jarg-rúnar}{\lemma{bót-rúnar \dots\ bjarg-rúnar ‘remedy-runes \dots\ rescue-runes’}\Bfootnote{Cf.~\textlink{Sigrdrifumal}[17]/1.}} &
\ind \alst{ei}n-falt við \alst{ǫ}lfum &
\ind \alst{t}ví-falt við \alst{t}rollum &
\ind \alst{þ}rí-falt við \alst{þ}u\emph{rsum}\eva

\bvb I carve remedy-runes, I carve rescue-runes: \\
...
so that she may not---though she for ever wants to, \\
...
\bvg\bva[]\edtrans{\alst{H}ęill sé þú \hld\ ok í \alst{h}ugum góðum}{Mayst thou be hale and in good spirits}{\Bfootnote{A formulaic greeting.  The very same line is found in \textlink{Hymiskvida}[41]; see note there for parallels.}}; &
\ind \alst{Þ}órr þik \alst{þ}iggi, &
\ind \edtrans{\alst{Ó}ðinn þik \alst{ęi}gi}{may Weden own thee}{\Bfootnote{See note to \textlink{Voluspa}[23].}}.\eva
