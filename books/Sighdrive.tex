...
A number of stanzas are quoted in \VolsungaMS, the main ms. of \VolsungaSaga.  \VolsungaSaga\ ch. 21 begins with the following passage, which is clearly based chiefly on \Sigrdrifumal\ P3, but in the mention of the gods perhaps also sts. 3–4:
...
\ind En \alst{a}nnarr hét \alst{A}gnarr, \hld\ \edtext{\alst{Au}ðu}{\Afootnote{corr.; \emph{Hauðu} \Regius}\Bfootnote{It is proven beyond a doubt by \Helreid\ 8 that the correct form of the name is in fact \emph{Auða} (as found in \VolsungaSaga\ 21; see introduction above).  The form with \emph{h-} is thus due to corruption.}} bróðir \\
