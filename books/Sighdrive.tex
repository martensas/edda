...
\bvg
\bva \edtrans{Hęilir \alst{ę́}sir, \hld\ hęilar \alst{ǫ́}synjur,}{Hail the Eese! Hail the Ossens!}{\Bfootnote{Probably formulaic, subverted by Lock in \Lokasenna\ 11 (see note there for possible ritual use).}} &
...
\bvb Hail the \inx[G]{Eese}! Hail the \inx[G]{Ossens}! Hail this bountiful fold \ken{earth}! Speech and \inx[C]{manwit} give ye us renowned two, and \inx[C]{healing-hands} while we live.”\evb
\evg
...
\bvg
\bva\mssnote{\Regius~32r/27–29, \VolsungaMS~24v/16–19}\alst{B}rim-rúnar skalt \edtrans{rísta}{carve}{\Afootnote{\emph{gjǫra} ‘make’ \VolsungaMS}} \hld\ ef vilt \alst{b}orgit hafa &
...
\bvb Surf-runes shalt thou carve, if thou wilt rescue sail-steeds \ken{ships} on the sound; on the stem shall [one] carve, and on the rudder’s blade, and lay fire into the oar. There is not so steep a breaker nor so blue-black waves, that thou not come whole off the sea.\evb
\evg
...
all the harms are measured\footnoteB{i.e. in advance.}!”\evb
\evg
