...
\ind \edtrans{hęil sjá in \alst{f}jǫl-nýta \alst{f}old!}{Hail this much-giving Fold!}{\Bfootnote{Cf. particularly \emph{Acreboot}: \emph{Hâl wes þú Folde \hld\ fira módor!} ‘Hail be thou, Fold, mother of men!’  Fold is a poetic name for \inx[P]{Earth} with cultic-poetic associations and is cognate with the Old Indian Earth-goddess \emph{Pr̥thivī}, whose name occurs frequently in \Rigveda.  For the epithet ‘much-giving’ cf. \emph{Iliad} 3.89: \textgreek{ἐπὶ χθονὶ πουλυ-βοτείρῃ} ‘upon the much-nourishing earth’.}} &
