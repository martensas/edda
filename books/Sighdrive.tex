...
\edtrans{En annarr hét Agnarr, \edtext{Auðu}{\Afootnote{corr. based on \VolsungaSaga\ 21 (see introduction); \emph{Hauðu} \Regius}} bróðir er vę́tr engi vildi þiggja.}{but the other was called Eyner, Ead’s brother, who in no way wished to sue for peace.}{\Bfootnote{This clause can be analyzed as two lines of \Fornyrdislag.  If this is indeed not just a coincidence, it perhaps derives from a now-lost narrative poem on which the prose is based:

En \alst{a}nnarr hét \alst{A}gnarr, \hld\ \alst{Au}ðu bróðir \\
es \alst{v}ę́tr ęngi \hld\  \alst{v}ildi þiggja.}}
...
\bpb She gave her name as Syedrive and was a walkirrie. She said that two kings fought; one was called Helm-Guther—he was old by then and the greatest warrior, and Weden had promised him victory, but the other was called Eyner, Ead’s brother, who in no way wished to sue for peace.
Syedrive made Helm-Guther fall in the battle, but Weden stung her with the sleeping-thorn as revenge for that and declared that she would never thenceforth win victory in battle and said that she must marry, “but I told him that I made a vow in response, to marry no such man as could be frightened.”  He \ken*{= Siward} speaks and asks her to teach him wisdom if she knew tidings out of all the \inx[C]{Home}[Homes]. Syedrive quoth:\epb\epg
...
\edtrans{\edtrans{á \alst{ęy}ra \alst{Á}rvakrs, \hld\ ok á}{on Yorewaker’s ear and on}{\Afootnote{om. \VolsungaMS}} \alst{A}lsvinns hófi}{on Yorewaker’s ear and on Allswith’s hoof}{\Bfootnote{The two horses that pull the Sun across the heavens; cf. \Grimnismal\ 38, \Sigrdrifumal\ 3/1 and note.}}, &
