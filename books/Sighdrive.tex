...
\allnote{This st. and the following represent the only surviving prayer to the collective Gods in the whole Norse literature (for prayers to individual gods, esp. Thunder and Weden, cf. \textcite{Lindow1988}, under “Galders” the Canterbury Galder and B 380). — Both sts. follow the same balanced format: the first helming (ll. 1–2) invokes the relevant gods, and the second (ll. 3–4) makes the request for their favour.}%
Hęill \alst{D}agr, \hld\ hęilir \edtrans{\alst{D}ags synir}{the sons of Day}{\Bfootnote{Their identity is uncertain, for Day does not have any known sons in the Norse mythology.  Based on comparative mythology the most likely candidates are the heavenly Horse Twins, who are securely attested in the Vedic, Greek, and Baltic traditions.  In the Vedic religion the two \emph{aşvínau} are the children of Father Heaven and follow the Dawn (\citeauthor{JamBrer2020}, \citeyear{JamBrer2020}, pp. 81–84), while in the Greek the two \textgreek{Δῐόσ·κουροι} (lit. ‘Sons of Zeús’) have a less apparent celestial role.  In the Latvian folksongs the \emph{Dieva dēli} ‘Sons of Dievs’ still retain their naturalistic significance, although they are not always twins \parencite[53--65]{Calin1996}.  Germanic evidence for the Twins is not secure, but they have often been associated with the Anglo-Saxon founding figures \emph{Hęngist} and \emph{Horsa}, which however have no solar associations other than coming from the east.  An archeological connection may be made with a pair of cultic figures from Grevensvænge, Denmark, dated to periods 4–5 (1100–700 BC) of the Nordic Bronze Age \parencite{Thrane2010}.  The two bronze figures, both wearing horned helmets, are depicted as sitting on their knees beside each other with their backs straight.  Both face forwards, their upper arms touching.  They mirror each other, so that the inner arm of each places his hand on his belly, while the outer raises a large axe.  These figures (one of which is now lost) were originally connected at their knees by a bronze support and belonged to a larger ensemble, which was probably originally placed upon a cultic boat \parencite{Glob1961}, in which case a solar association (like the other IE Twins) is certain.}}, &
...
En annarr hét Agnarr, Auðu bróðir er vę́tr engi vildi þiggja.
...
\bpb She gave her name as Syedrive and was a walkirrie. She said that two kings fought; one was called Helm-Guther—he was old by then and the greatest warrior, and Weden had promised him victory, but the other was called Eyner, Eade’s brother, who in no way wished to surrender.
