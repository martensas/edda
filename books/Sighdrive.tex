...
\ind hęil \edtrans{sjá in \alst{f}jǫl-nýta \alst{f}old}{this much-giving Fold}{\Bfootnote{Or, “the bountiful \inx[P]{Earth}”; an expression with Indo-European roots.  Throughout the rest of the Norse poetic corpus \emph{fold} refers exclusively to the unpersonified ‘land, earth’ without religious associations, and so the present instance seems to be a ritual archaism, for which cf. the Old English \emph{Æcerbót}: \emph{Hâl wes þú Folde \hld\ fira módor!} ‘Hale be thou, Fold, mother of men!’ and the Old Indian cognate \emph{Pr̥tʰivī́} (\cite[96]{JamBrer2020}, found frequently in \Rigveda, e.g. 1.89.4b: \emph{mātā́ Pr̥tʰivī́} ‘mother Earth’).  The common Indo-European root is \emph{*pl̥th₂-é(wi)h₂} ‘flat, broad one’, for the sense of which cf. Hfr \emph{Hákdr} 8 (in \Skp\ III), where Earth is the \emph{bręið-lęita brúðr Bál-ęygs} ‘broad-faced bride of Bale-eye \name{= Weden}’. —
