...
The \textbf{Speeches of Syedrive} (\Sigrdrifumal) are found in \Regius, where they directly continue the narrative told in \textlink{Reginsmal} and \Fafnismal.  In the manuscript there is no marker of any kind, not even an initial, separating the poem from \Fafnismal; the title is editorial.
