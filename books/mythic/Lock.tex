...
\speakernote{Ęldir:}%
\llap{„}Of \alst{v}ǫ́pn sïn dø̇ma \hld\ ok of \alst{v}íg-risni sïna &
...
\llap{„}\alst{I}nn skal ganga \hld\ \alst{Ę́}gis hallir ï &
...
\llap{„}Vęitst, ef \alst{i}nn gęngr \hld\ \alst{Ę́}gis hallir ï &
...
\speakernote{[Loki:]}%
\llap{„}Mant þat \alst{Ó}ðinn, \hld\ es vit ï \alst{á}r-daga &
...
\llap{„}\edtrans{\alst{M}ar ok \alst{m}ę́ki}{Steed and sword}{\Bfootnote{Formulaic pair; cf.~\textlink{Havamal}[83]/2.}} \hld\ gef’k þér \alst{m}ïns féar &
...
\llap{„}\alst{S}njallr est ï \alst{s}essi, \hld\ skal⸗at-tu \alst{s}vá gęra, &
...
\ind umb þïnn \alst{b}róður-\alst{b}ana.“\eva
...
\speakernote{[Loki] kvað:}%
\llap{„}Ęn þik \alst{s}íga kóðu \hld\ \edtrans{\alst{S}ȧms-ęyju}{Samsey}{\Bfootnote{\emph{Samsø} in Denmark, which features prominently in later legendary literature.  TODO: cite.}} ï &
...
\speakernote{[Frigg kvað:]}%
\llap{„}Vęitst ef \alst{i}nni \alst{ę́}tta’k \hld\ \alst{Ę́}gis hǫllum ï &
...
\alst{ȧ}sa ok \alst{a}lfa, \hld\ es hér \alst{i}nni eru, &
\ind \alst{h}vęrr hęfir þïnn \alst{h}ór vesit.“\eva
...
við \alst{s}ystur þïnni \hld\ gatst \alst{s}·líkan mǫg, &
...
\ind \edtrans{\alst{ȧ}sa gǫrðum}{the Yards of the Eese}{\Bfootnote{I.e., \inx[P]{Osyard}.}} \alst{ï}; &
...
\llap{„}\alst{Þ}ęgi þú, Týr, \hld\ \alst{þ}at varð þïnni konu &
...
\speakernote{[Loki kvað:]}%
\llap{„}\alst{Þ}ęgi þú, Hęim·dallr, \hld\ \alst{þ}ér vas ï ár-daga &
...
\speakernote{[Loki kvað:]}%
\llap{„}Vęitst ef mik ȧ \alst{h}jǫrvi skulu \hld\ ins \alst{h}rïm-kalda magar &
...
\speakernote{[Loki kvað:]}%
\llap{„}\alst{L}ėttari ï mǫ́lum \hld\ vast við \alst{L}auf·ęyjar son &
\ind þȧ’s lét⸗sk mér ȧ \alst{b}ęð þïnn \alst{b}oðit; &
...
\bvg\bva\mssnote{\Regius~16v/12}%
\llap{„}\edtext{\alst{H}ęill ves þú nú, Loki, \hld\ ok tak við \alst{h}rïm-kalki &
...
\llap{„}\alst{Þ}ęgi þú, rǫg vę́ttr, \hld\ þér skal mïnn \edtrans{\alst{þ}rúð-hamarr}{thrith-hammer}{\Bfootnote{“Strength-hammer”, \emph{þrúðr} ‘thrith’ being an obsolete word for strength generally used only in connection with Thunder or ettins.  \emph{Þrúðr} ‘\inx[P]{Thrith}’ is also the name of Thunder’s daughter.}}, &
...
\llap{„}\alst{Þ}ęgi þú, rǫg vę́ttr, \hld\ þér skal mïnn \alst{þ}rúð-hamarr, &
\ind \alst{M}jǫllnir, \alst{m}ál fyr·nema! &
...
\speakernote{[Loki kvað:]}%
\llap{„}\alst{Au}str-fǫrum þïnum \hld\ skalt \alst{a}ldri⸗gi &
