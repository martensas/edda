...
\ind \edtrans{bera \alst{t}ilt með \alst{t}vęim}{settle strife between two}{\Bfootnote{This statement appears to be what Snorre alludes to in \Gylfaginning~25:12: \emph{ok er hann ein-hendr ok ekki kallaðr sę́ttir manna} ‘and he is one-handed, and not called a reconciler of men’.  The sense seems to be that Tew’s one-handedness is also the reason why he, as a war god, cannot grant equal victory to both sides.}}; &
\edtext{\alst{h}andar ennar \alst{h}ǿgri \hld\ mun’k \alst{h}innar geta &
\ind es þér slęit \alst{F}ęnrir \alst{f}rȧ.}{\lemma{handar \dots\ frȧ. ‘the right \dots\ tore.’}\Bfootnote{As told in \Gylfaginning~25:9--12 and \Gylfaginning\ 34:TODO.}}“\eva
