...
Two unambiguous instances show that alliteration can fall between \emph{v} and a vowel: 2/4 (\emph{orði : vinr}) and 10/1 (\emph{Víð·arr : ulfs}), and 36/4 (n.) is ambiguous.  Still, the numerous other instances of normal \emph{v}- or vowel-alliteration show that this was not preferred, and it is notable that both \emph{orð} ‘word’ and \emph{ulfr} ‘wolf’ contained a \emph{v-} in an earlier stage of the language (see note to 2/4).

One line lacks suitable alliteration: 39/3.  14/2 is questionable.
...
Since all Scaldic attestations of \emph{vr-} alliterating with \emph{v-} rather than with \emph{r-} date to before 1000 \ce\ (cf.~\textlink{Havamal}[26]/2) this is a solid dating criterion for pre-Christian composition.

When it comes to another archaic trait, the occurrence of the preverbal particle \emph{of}, \Lokasenna\ shows a fairly high rate of 0.326 per 10 unique lines \parencite[70]{Sapp2022}, which is consistent with the use of \emph{vr-}.

The linguistic factors thus strongly suggest that \Lokasenna\ is a pre-Christian poem.
...
Lock greets the Gods sarcastically and asks for a drink (6).  When they ignore him he tells them to make a choice: either to invite him to sit or to drive him away (7).  Bray answers and tells him that they will never invite him (8), but Lock ignores him and turns to Weden, calling to mind a blood-oath between them (9).  Weden, acknowledging the oath, asks his son Wider to give Lock a drink and let him sit (10), and he does (P4).

Lock now begins his insults, first turning to Bray (11).  From Lock’s insult of Bray in st.~11 until Thunder’s arrival in st.~57 the poem has a very regular structure.  Lock and a god take turns insulting each other for one or two pairs of stanzas before another god comes to the defense of the previous one and becomes the new target for Lock’s insults.  There is no point in summarising the insults beyond the overview of speakers above, which the reader is encouraged to use.

After Thunder shows up Lock is at last forced to yield.  He curses the Eese and departs (64--65).  After this the prose tells us that Lock hid himself in the shape of a salmon, but was eventually caught and bound upon three sharp stones with a venomous serpent set above his face to torment him.  When he writhed from the pain the whole earth shook, in what is now called earth-quakes (P8).
...
\ind \edtrans{mann⸗gi ’s þér ï \alst{o}rði \alst{v}inr.}{none is thee a friend in words.}{\Bfootnote{I.e., ‘nobody says anything good about you’. --- Something may be said about the alliteration in this line and in 10/1 below (\emph{Víð·arr} : \emph{ulfs}).

The most likely understanding is that the semi-vowel \emph{v} (\textipa{/w/}) is participating in vowel-alliteration with \emph{o}, something occasionally allowed in Norse Eddic poems like \Lokasenna, but never in Scaldic poetry nor in the related West Germanic traditions.

An intriguing but very speculative explanation is if the alliteration originally fell exclusively on \emph{v}.  This finds support in the fact that in both the present st.~and 10/1 the vowel-words \emph{orð} ‘word’ and \emph{ulfr} ‘wolf’ originally began with \emph{v} (PN \emph{*worda, *wulfaʀ}); in the case of the word \emph{ulfr} this consonant is actually attested in archaic runic inscriptions.

For metrical reasons \Lokasenna\ must postdate the syncope of unstressed short vowels in some positions, but on the basis of the three closely related C7th runestones from Blekinge (DR 357--359, from Stentoften, Gummarp, and Istaby) that change is known to predate the loss of \emph{w} before rounded vowels (e.g. DR 359 \textbf{h\textsc{a}þuwulafʀ} \emph{Haþuwulᵃfʀ}).
If the alliteration indeed did originally fall on \emph{v} this would still not require dating \textlink{Lokasenna} to the late Proto-Norse period, something for which there is little support.  The fact that West Germanic does not allow alliteration between vowels and \emph{w} suggests that this license probably only arose in North Germanic following the loss of \emph{w} in certain positions, and the present alliteration could thus reflect archaic poetic formulae or perhaps a vague convention that only certain vowel-words should alliterate with \emph{v}.  In any case it seems to be an argument for an early date of \Lokasenna, for which cf.~also 15/3 n. below.
...
\speakernote{[Bragi] kvað:}%
\llap{„}\edtext{Vęit’k, ef \edtext{\emph{f}yr}{\Afootnote{\emph{‘þyr’} \Regius}} \alst{ú}tan vę́ra’k, \hld\ svá sem fyr \alst{i}nnan em’k, &
\ind \edtext{\alst{Ę́}gis hǫll \alst{o}f kominn}{\Bfootnote{The alliteration in this line is not highly questionable since the particle \emph{of} is unstressed.}}}{\lemma{Vęit’k, ef \emph{f}yr útan vę́ra’k, \hld\ svá sem fyr innan em’k, / Ę́gis hǫll of kominn ‘I know if I were outside, as I am inside come into Eagre’s hall’}\Bfootnote{As said in P1, the law of \inx[C]{grith} (a truce of non-violence, even between enemies) applies inside the hall, and Bray and the other gods are honour-bound not to injure Lock.}}, &
...
\ind \edtext{ok es⸗a þó \alst{ȯ}nu \alst{v}err}{\Bfootnote{An ambiguous case of alliteration between \emph{v} and a vowel.  \emph{ȯnu} is dat.~sg.~of \emph{vǫ̇n} ‘expectation’ with regular fronting of nasal \emph{ǫ̇} > \emph{ȯ} and loss of \emph{v} before \emph{o}.
In Scaldic poetry the earliest instance of the name \emph{Ǫ̇·lęifr} \char`~\ \emph{Ȯ·láfr} ‘Anlaf’ forming an ethelhending with \emph{ó} rather than an \emph{á} or \emph{ǫ́} is from c.~1070 \ce, Steinn \emph{Óldr} 5/4b: \emph{Ȯ·láfr borinn sólu} (\Skp\ 2).  Since \Lokasenna\ is almost certainly older than this (see introduction above) there is strong reason to restore to \emph{*vǫ̇nu}.}}.“\eva
...
\ind \edtrans{bera \alst{t}ilt með \alst{t}vęim}{settle strife between two}{\Bfootnote{Lit.~‘carry conciliation between two.’  This statement appears to be what Snorre alludes to in \Gylfaginning~25:12: \emph{ok er hann ein-hendr ok ekki kallaðr sę́ttir manna} ‘and he is one-handed, and not called a reconciler of men’.  The sense seems to be that Tew’s one-handedness is also the reason why he, as a war god, cannot grant equal victory to both sides.
--- \emph{tilt} ‘conciliation’ is a hapax, neutr.~acc.~sg.~of \emph{*tilr}, cognate with OE \emph{til} ‘good, upstanding’, Gothic \emph{ga·tils} ‘fitting, convenient’.  The use of this old and rare word in the poem is an archaism.}}; &
...
\llap{„}\alst{Þ}ęgi þú, rǫg vę́ttr, \hld\ þér skal mïnn \edtrans{\alst{þ}rúð-hamarr}{thrith-hammer}{\Bfootnote{“Strength-hammer”, \emph{þrúðr} ‘thrith’ being an obsolete word for strength used only in connection with Thunder or ettins.  \emph{Þrúðr} ‘\inx[P]{Thrith}’ is also the name of Thunder’s daughter.}}, &
