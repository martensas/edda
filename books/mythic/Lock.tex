...
Another trait in alliteration which may suggest an even earlier dating is the fact that alliteration between \emph{v-} and a vowel is isolated to two secure instances (2/4 and 10/1), both of which have vowel-words which in Proto-Norse began with \emph{w-}; see note to 2/4.

When it comes to the occurrence of the preverbal particle \emph{of}, a trait suggestive of an early dating and strongly correlated with \emph{vr-}, \Lokasenna\ shows a fairly high rate of 0.326 per 10 unique lines \parencite[70]{Sapp2022}.
...
\Ballnote{The myth of the binding of Lock is alluded to in \textlink{Voluspa}[34] and H1 and told at length in \Gylfaginning~50:3--25, which does not entirely agree with the present passage, although numerous details are shared between them (e.g.~the name of the force and the comment about earth-quakes at the end).

According to \Gylfaginning~50:20--22 (cited in \textlink{Voluspa}[H1] n.; cf.~there) the Eese captured two of Lock’s sons, Wonnel and “Nare or Narve”.  They turned Wonnel into a wolf (\emph{vargr}, which also means ‘outlaw’) and forced him to tear his brother Narve apart.  Then they took Narve’s intestines used them to bind Lock on top of three sharp stones.  The intestines hardened into iron and Lock was bound fast.

Since the author of \Gylfaginning\ knew \textlink{Voluspa} it is possible that he combined a prose text similar to the present \textlink{Lokasenna}[P8] with the stanza \textlink{Voluspa}[H1], interpreting the form \emph{Vȧla víg-bǫnd} as ‘Wonnel’s war-bonds’ (whereas the present ed.~adopts the emendation to nom.~sg.~\emph{Vȧl\emph{i}}).
