...
\speakernote{[Bragi] kvað:}%
\llap{„}\edtext{Vęit’k, ef fyr \alst{ú}tan vę́ra’k, \hld\ svá sem fyr \alst{i}nnan em’k, &
\ind \edtext{\alst{Ę́}gis hǫll \alst{o}f kominn}{\Bfootnote{The alliteration in this line is not highly questionable since the particle \emph{of} is unstressed.}}}{\lemma{Vęit’k, ef fyr útan vę́ra’k, \hld\ svá sem fyr innan em’k, / Ę́gis hǫll of kominn ‘I know if I were outside, as I am inside come into Eagre’s hall’}\Bfootnote{As said in P1, the law of \inx[C]{grith} (a truce of non-violence, even between enemies) applies inside the hall, and Bray and the other gods are honour-bound not to injure Lock.}}, &
...
\speakernote{[Fręyja kvað:]}%
\llap{„}\edtext{\alst{F}lǫ́ ’s þér tunga, \hld\ hygg at þér \alst{f}ręmr myni &
...
Þá gekk \edtext{\emph{Sif}}{\Afootnote{\emph{;} (prob. standing for a correction in the no longer extant margin) \Regius}\Bfootnote{That Sib is the speaker is supported by the mention of her in P1 and by the fact that st.~54 mentions Thunder, her husband.}} framm ok byrlaði Loka í hrím-kalki mjǫð ok mę́lti:\epa
...
\speakernote{[Loki kvað:]}%
\llap{„}\alst{Ja}rðar burr \hld\ es hér nú \alst{i}nn kominn; &
