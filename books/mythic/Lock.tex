...
ON \emph{fjarg} is never otherwise used as a simplex but does appear in the cpds.~\emph{fjarg-hús} ‘god-house(?)’ (\textlink{Atlakvida}[43]/4, 46/3) and \emph{fjarg-vęfr} ‘god-weave, silk’ (a poetic variant of \emph{goð-vęfr} ‘id.’; ÞKolb Lv 12 in \Skp\ 5) which confirm its sense of ‘Gods’.  It is found in a few additional cpds.~in modern Icelandic \parencite[s.v. \textit{fjarg-}]{OrdsifjaBok}.}}
