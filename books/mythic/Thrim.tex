...
This is further supported by the obscure myth wherein the two probable fire-figures Lock–identified in folklore with the Ash-Lad—and Homedal—whose fire-related epithets include \emph{Hęim·dallr} ‘World-Brilliant’, the Watchman of the Gods (\textlink{Grimnismal}[13]), the White Os, Goldentooth, and Haldenshid (\textlink{EddicFragments}[F3][3]:P1)—fight over it (\Skaldskaparmal\ 15, 23; ÚlfrU \emph{Húsdr} 2 (\Skp\ 3)).  Cf. \Haustlong\ 9 where Lock is called \emph{girði-þjófr brísings} ‘girdle-thief of the blaze’, i.e. ‘thief of the Blaze-girdle [= the Necklace of Blazes]’.
