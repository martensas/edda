...
\edtrans{Þykkj\emph{a} mér ór \alst{augum} \hld\ \edtrans{\emph{\alst{ę}ldar}}{fires}{\Afootnote{emend.; om. \Regius}} brinna!}{Methinks there are fires burning from her eyes!}{\Bfootnote{The line is clearly corrupt in \Regius\ (\emph{‘ þicci mer or avgom brenna’}); if we place the cæsura between \emph{ór} and \emph{augum} the a-verse is only three syllables long and alliteration must quite unnaturally fall on the weakly stressed preposition \emph{ór} ‘from’.
