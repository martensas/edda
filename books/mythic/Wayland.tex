...
Þat spyrr \alst{N}íð·uðr, \hld\ \edtrans{\alst{N}íara}{the Nears}{\Bfootnote{An obscure tribe.  The fact that they are located in Sweden in P1 above may allow us to connect them with the Swedish province of Närke.  In OSwe. they are known as \emph{Næríkjar} ‘inhabitants of Närke’, but this is derived from \emph{Næríki} ‘Närke’ which is in turn from \emph{nær-} ‘Near’ (tribal name) + \emph{ríki} ‘realm’; cf.~OSwe. \emph{nær-iskẹr} ‘belonging to Närke’.  The stem \emph{nær-} (with unclear vowel length) would then be a reduced form of \emph{níar-}, \emph{njár-}.}} dróttinn, &
