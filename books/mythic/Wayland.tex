...
\Volundarkvida\ only survives in full in \Regius\ (foll.~18r/4--19v/6), where it follows \textlink{Thrymskvida} and is followed by \textlink{Alvissmal}.  The beginning of the prose introduction is found on the very last foll.~of \AM\ (6v/26--28), where it follows \textlink{Hymiskvida}.

Although technically a heroic poem, \Volundarkvida\ is part of the mythological section of \Regius, to which it conforms orthographically \parencite[160--166]{Lindblad1980}, and it is found in the otherwise exclusively mythological \AM.  The poem also does not belong to the story of the Walsings, nor to the Hallow-poems, which are the main subjects of the heroic part of \Regius.  For these reasons, \Volundarkvida\ is placed under Norse Mythic Poetry in the pres.~ed.
