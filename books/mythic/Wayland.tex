...
The \textbf{Lay of Wayland} (abbrev.~\textlink{Volundarkvida}) is a psychologically complex narrative poem dealing with the capture and revenge of the famous smith Wayland.

\subsection{Textual preservation and transmission}

\Volundarkvida\ only survives in full in \Regius\ (foll.~18r/4--19v/6), where it follows \textlink{Thrymskvida} and is followed by \textlink{Alvissmal}.  The beginning of the prose introduction is also found on the very last foll.~of \AM\ (6v/26--28), where it follows \textlink{Hymiskvida}.

Although arguably more of a heroic poem, \Volundarkvida\ is part of the mythological section of \Regius, to which it conforms orthographically \parencite[160--166]{Lindblad1980}.  The poem is also found in the otherwise exclusively mythological \AM.  It does not belong to the cycle of the Walsings, nor to the Hallow-poems, which are the subjects of the heroic part of \Regius.  For these reasons, and following the choices of the mediaeval editors, \Volundarkvida\ is placed under Norse Mythic Poetry in the pres.~ed.

\subsection{Origin and motifs}

\Volundarkvida\ is a narrative poem telling the story of Wayland the Smith (ON \emph{Vǫlundr}, OE \emph{Wéland} or \emph{Wélund}, MHG \emph{*Welent}).  Wayland was one of the most popular figures in early mediaeval Germanic legend and independent versions of his tale are found in Germany, England, and Iceland.

In his archetypal form, Wayland is an uncannily talented smith who is taken captive and hamstrung by the greedy tyrant King Nithad (ON \emph{Níð·uðr}, OE \emph{Níþhad}, MHG \emph{*Nídung}).  Nithad forces Wayland to make jewels for him and his household but Wayland carries out a cruel revenge against the king: he murders his two sons and rapes his daughter, Beadhild (ON \emph{Bǫðv·ildr}, OE \emph{Beaduhild}, MHG \emph{*Botil}), making her pregnant.  At last, he makes a flight-suit out of feathers, typically (though not in \Volundarkvida) with the help of his brother Eyel (ON \emph{Ęgill}, OE \emph{Ægili}).  Having regained his mobility through ingenuity he makes his escape and leaves the ruined king’s household behind.

There is a strong parallelism throughout the narrative in that Wayland gets his revenge on the whole royal household by doing unto them what was done to him.  This theme is developed very effectively in the present poem (but cf.~the treatment in the OE \textlink{Deor}[1]--2).    Like Wayland was taken while waiting for his wife, so he murders Nithad’s two young sons and ends his family line.  Like he was made powerless, he defangs Nithad’s \emph{kunnig kvǫ̇n} ‘cunning wife’ by reducing her once powerful counsels to cold words.  Like he lost his wife’s golden ring, so he rapes Beadhild, depriving her of her maidenhood.

In this way the royal household is reduced to the very same state of abject powerlessness that Wayland himself experienced, something signalled by the repetition of the adjective \emph{vilja-lauss} ‘powerless’.  In st.~12 this word describes Wayland after he awakes in shackles, but in st.~31 it is King Nithad who uses it to refer to his own mental state after the deaths of his sons.  This sense of hopelessness also concludes the poem with Beadhild’s haunting words: “In no way did I know how to withstand him; in no way could I withstand him.”
...
\caption[The front panel of the Franks casket.  Anglo-Saxon, ca. 725 \ce.]{The front panel of the Franks casket.  Anglo-Saxon, ca. 725 \ce.  © John W. Schulze. \href{https://creativecommons.org/licenses/by/2.0/deed.en}{CC BY 2.0}.  \url{https://commons.wikimedia.org/wiki/File:Franks_Casket_front.jpg}}
\label{fig:franks}
\end{figure}
...
An Anglo-Saxon pictoral depiction of the story is found on the early C8th Franks casket, which shows Wayland drugging Beadhild, Nithad’s decapitated sons, and his brother Eyel collecting swan-feathers for the flight-suit (Fig.~\ref{fig:franks}).  The fact that the Wayland-Story is as prominent as the depiction of the Adoration of the Magi is a testament to the weight with which it was regarded in early mediaeval England.
...
\textlink{Volundarkvida} does indeed show signs of Old English influence in its vocabulary (1/2: \emph{al-vitr}, 11/2: \emph{ljóði}, 36/3: \emph{aukin}), nor do the proper names of its characters (particularly Beadhild and Thankred, the thrall) seem North Germanic.  Of course, the poem cannot be a direct translation from OE.  The impossibility of that is shown by the use of formulaic Norse lines (e.g.~16/1--2, 30/1--2) and by lines requiring North Germanic sound changes to alliterate (e.g.~14/3: \emph{ȯra aura~· i̇́ Ulf-dǫlum} ‘our ounces in the Wolfdales’ vs.~reconstructed OE: \emph{*u̇re éaras~· in Wulf-dalum}, and note that OE \emph{*éaras} ‘ounces’ is not even a real word).

Even older versions of the story must needs remain forever lost.  It is clear from their names that Wayland and Nithad are fairy-tale characters, not historical figures, for Wayland’s name means ‘Crafty Hand’ (< PGmc. \emph{*wéla-handuz}, \cite{Brate1908}) and Nithad’s ‘Shameful Fighter’ (< PGmc. \emph{*níþa-haduz}).

Comparatively there are striking similarities between Wayland and the Greek smith \textgreek{Δαίδαλος}.  Both are legendary inventors trapped on an island by an evil tyrant for whom they have been forced to work, and both make their escape alongside a near relation (Wayland’s brother Eyel, \textgreek{Δαίδαλος}’ son \textgreek{Ἴκαρος}) by means of a flight-suit.  The difficulty with these parallels is that the Wayland-story, anchored as it is in Germanic legend, is attested long before knowledge of Greek mythology can have existed in Northern Europe.  We may therefore be dealing with much older folklore, perhaps even going back to the Bronze Age (as the image of the Labyrinth definitely does) or the Neolithic European Farmers, although such connections cannot but remain speculation.

A unique narrative feature of the Norse \Volundarkvida\ is its incorporation of the motif of the swan-wife at the beginning of the poem.  This motif, widespread throughout world mythology (TODO: cite), is not otherwise found in connection with story of Wayland.  Whether this is the due to the incompleteness of our early parallel sources or a genuine innovation of the Norse Wayland-tradition remains unclear.

\clearpage

\section{Text}

\subsection{Frá Vǫlundi (‘From Wayland’)}
...
Brǿðr \edtrans{vǫ́ru}{were}{\Afootnote{om. \Regius}} þrír, synir Finna konungs. Hét einn Slag·fiðr, annarr Egill, þriði Vǫlundr.
...
Þar er vatn, er heitir Úlf-sjár.
...
\bpb Nithad was the name of a king in Sweden.  He had two sons and a daughter; she was called Beadhild.
There were three brothers, the sons of a king of the Finns.  The one was called Slayfinn, the other Eyel, the third Wayland.
...
Early in the morning they found by the lake-shore three women, and they were spinning linen. There beside them were their swan-\inx[C]{hame}[hames]; those were Walkirries.
There, there were the two daughters of King Ludwigh: Ladguth the Swanwhite and Harware the Elwight.  The third was Alerune, daughter of \inx[P]{Coser} of \inx[P]{Walland}.
The men took the women to their halls with them.  Eyel got Alerune, and Slayfinn the Swanwhite, and Wayland the Elwight.
The couples lived there for seven winters; then the women left to attend battles, and they did not come back.
...
\subsection{Frá Vǫlundi ok Níð·aði (‘From Wayland and Nithad’)}

\bvg\bva\mssnote{\Regius~18r/19}%
\alst{M}ęyjar flugu sunnan \hld\ \edtrans{\alst{M}yrk-við}{Mirkwood}{\Bfootnote{A great border forest, surely referenced for its association with the war-ravaged lands of the Gots and Huns; a natural environment for \inx[P]{Walkirries}.}} i̇́ gǫgnum &
\edtrans{\alst{a}l-vitr}{elwights}{\Bfootnote{“Strange beings, foreign wights”, from Proto-Norse \emph{*alja-wihtiz} or borrowed from OE \emph{æl-wihta} pl. ‘strange creatures, monsters’.}} \edtext{\alst{u}nga\emph{r}}{\Afootnote{gramm.~emend.; \emph{unga} \Regius}}, \hld\ \edtrans{\alst{ø}r·lǫg drýgja}{to fulfill orlay}{\Bfootnote{That is, to fulfill their preordained destinies, viz. to attend battles as Walkirries and choose which men to take away (cf.~P1 and st.~3).
...
\alst{d}rósir suð-rǿnar \hld\ \alst{d}ýrt li̇́n spunnu.\eva

\bvb Maidens flew from the south through \inx[P]{Mirkwood} \\
...
\Ballnote{The three swan-maidens meet the three brothers, and each one takes a husband.}%
\alst{Ęi}n nam þęira \hld\ \alst{Ę}gil at vęrja &
\alst{f}ǫgr mę́r \alst{f}ira \hld\ \alst{f}aðmi ljósum; &
ǫnnur vas \alst{S}van·hvít, \hld\ \alst{s}van-fjaðrar dró, &
\edtext{[...]}{\Bfootnote{A line mentioning Slayfinn has probably been lost here.}} &
ęn in \alst{þ}riðja \hld\ \alst{þ}ęira systir &
varði \edtrans{\alst{h}vítan}{white}{\Bfootnote{Pale skin being a sign of noble ancestry; cf.~17/3.}} \hld\ \alst{h}als \edtext{\emph{Vǫl}undar}{\Afootnote{sens.~emend.; \emph{Ǫnundar} \Regius}}.\eva
...
ęn hinn \alst{á}tta \hld\ \alst{a}llan þrǫ́ðu, &
ęn hinn \alst{n}íunda \hld\ \alst{n}auðr of skilði, &
\alst{m}ęyjar fẏstu⸗sk \hld\ ȧ \alst{m}yrkvan við, &
\alst{a}l-vitr \edtext{\alst{u}nga\emph{r}}{\Afootnote{gramm.~emend.; \emph{unga} \Regius}} \hld\ \alst{ø}r·lǫg drýgja.\eva
...
Kom þar af \alst{v}ęiði \hld\ \edtext{\alst{v}e\emph{ð}r-ęygr}{\Afootnote{emend., cf.~st.~9/3; \emph{†vegr†-ęygr} \Regius}} skyti &
...
\bvb There from the hunt came the stormy-eyed shooter, \\
...
if for him she might come.\evb\evg


\bvg\bva\mssnote{\Regius~18r/31}%
Þat spyrr \alst{N}íð·uðr, \hld\ \edtrans{\alst{N}íara}{the Nears}{\Bfootnote{An obscure tribe.  The fact that they are located in Sweden (P1 above) may allow us to connect them with the inhabitants of the Swedish province of Närke, who in OSwe.~are known as \emph{Næríkjar}, most likely from the tribal/geographical root \emph{nær-} + \emph{-íkjar} ‘inhabitants’.
The stem \emph{nær-} (with unclear vowel length) is also found in the adjective OSwe.~\emph{nær-iskẹr} ‘belonging to Närke, Närikian’ and could then be the equivalent of OWN \emph{níar-} \char`~\ \emph{njár-}.  For further discussion on the origin of OSwe.~\emph{nær-} see \textcite{Sahlgren1925}.}} dróttinn, &
at \alst{ęi}nn Vǫlundr \hld\ sat i̇́ \alst{U}lf-dǫlum; &
\alst{n}ǫ́ttum \edtext{\emph{f}óru}{\Afootnote{emend.; \emph{vóru} \Regius}} \edtext{sęg\emph{g}ir}{\Afootnote{emend.; \emph{segir} \Regius}}, \hld\ \edtrans{\alst{n}ęglðar vǫ́ru brynjur}{nailed were their byrnies}{\Bfootnote{The byrnies here are some kind of plate armour.}}, &
\alst{sk}ildir bliku þęira \hld\ við inn \alst{sk}arða mána.\eva

\bvb Nithad learns it, lord of the \inx[P]{Nears}, \\
...
\bvb He went the brown she-bear’s flesh to roast. \\
In early morn burned the twigs of all-dry pine, \\
the wind-dry wood, before Wayland.\evb\evg


\bvg\bva\mssnote{\Regius~18v/5}%
Sat ȧ \alst{b}er-fjalli, \hld\ \edtrans{\alst{b}auga talði}{bighs he counted}{\Bfootnote{Wayland’s grief and loneliness is skilfully illustrated by his counting all seven hundred rings, something which has apparently become habitual for him.}}, &
\edtrans{\alst{a}lfa ljóði}{prince of elves}{\Bfootnote{Probably referring to Wayland’s nature as a wild man; this is further seen by his bear-hunting, skiing, and fierce gaze, all associated with the Finns or Saami.  Cf.~14/2b and 32/1b, where Nithad calls him \emph{vísi alfa} ‘chief of elves’.}} \hld\ \alst{ęi}ns saknaði; &
\alst{h}ugði at \alst{h}ęfði \hld\ \alst{H}lǫð·vés dóttir, &
\alst{a}l-vitr \alst{u}nga \hld\ vę́ri \alst{a}ptr komin.\eva

\bvb He sat on the bear-pelt, the bighs he counted--- \\
the prince of elves was missing one! \\
He thought that Ludwigh’s daughter \ken*{= Harware} might have it, \\
that the young elwight might be come again!\evb\evg
...
ęn ȧ \alst{f}ótum \hld\ \alst{f}jǫtur of spęnntan.\eva

\bvb He sat so long that he fell asleep, \\
...
\llap{„}Hvęrir ’ro \alst{jǫ}frar \hld\ þęir’s \alst{ȧ} lǫgðu &
\edtext{\alst{b}ęsti*-si̇́ma}{\Afootnote{emend.; \emph{‘besti-byr-sima’} \Regius}} \hld\ ok \alst{b}undu mik?“\eva

\bvb\speakernoteb{[Quoth Wayland:]}%
...
\llap{„}Hvar gatst, \alst{V}ǫlundr, \hld\ \alst{v}ísi alfa, &
\alst{ȯ}ra \alst{au}ra, \hld\ i̇́ \alst{U}lf-dǫlum? &
\alst{G}oll vas þar ęigi \hld\ ȧ \alst{G}rana lęiðu, &
\alst{f}jarri hugða’k vȧrt land \hld\ \alst{f}jǫllum Rínar.“\eva

\bvb Now Nithad called, lord of the Nears: \\
...
\llap{„}\alst{M}an’k at \alst{m}ęiri \hld\ \alst{m}ę́ti ǫ́ttum, &
es vér \alst{h}ęil \edtrans{\alst{h}íu}{household}{\Bfootnote{The meter (a normal type C, x\#x\#P\#px) requires the restoration of the old hiatus form \emph{híu} for \emph{hjú}, a sign of composition before ca.~1150.  The alternative scansion would be catalectic.}} \hld\ \alst{h}ęima vǫ́rum: &
\alst{H}lað·guðr ok \alst{H}ęr·vǫr \hld\ borin vas \alst{H}lǫð·vé\emph{i}, &
\alst{k}unn vas Ǫl·ru̇n \hld\ \edtrans{\alst{K}íars}{Coser’s}{\Bfootnote{For the sense of this name see note to P1 above. ---
For the sake of meter the uncontracted hiatus form \emph{Kíarr} must be restored from \emph{Kjárr}; the verse is otherwise only three syllables long and catalectic.  The uncontracted form is also metrically necessary in \textlink{Atlakvida}[8]/1b and Edáð \emph{Banddr} 2 (\Skp\ 1). ---
...
\llap{„}es⸗a sá nú \alst{h}ýrr, \hld\ es ór \alst{h}olti fęrr.“\eva
...
\bpb King Nithad gave his daughter Beadhild the golden ring which he took from the bast rope in Wayland’s hall, but he himself carried the sword which Wayland had owned.  But the queen said:\epb\epg


\bvg\bva\mssnote{\Regius~18v/19}%
\llap{„}\alst{T}ęnn hǫ̇num \alst{t}ęygja⸗sk \hld\ es hǫ̇num ’s \alst{t}ét sverð, &
ok hann \alst{B}ǫðv·ildar \hld\ \alst{b}aug of þękkir, &
\alst{ǫ́}mun eru \alst{au}gu \hld\ \alst{o}rmi inum frȧna; &
\alst{s}níðið ér hann \hld\ \edtext{\alst{s}in\emph{v}a}{\Afootnote{metr.~emend.; \emph{sina} \Regius}\Bfootnote{The meter requires a heavy syllable for the lift, which may be obtained by restoring the archaic gen.~pl.~\emph{*sinva} of \emph{sin} ‘sinew’ (< PGmc.~\emph{*sin(a)wó}) \parencite[265]{Fulk2016}.  For the medial \emph{-v-} cf.~\emph{bǫl} ‘bale, curse’ (< PGmc.~\emph{*balwą}), gen.~pl.~\emph{bǫlva}.}} magni, &
ok \alst{s}ętið hann \alst{s}íðan \hld\ i̇́ \alst{S}ę́var-stǫð.“\eva
...
and set him thereafter on the Seastead!”\evb\evg
...
\bpb So it was done that the sinews in his houghs were cut and he was placed on the lonely islet which lay there before the land and which was called the Seastead.  There he forged for the king every kind of jewel.  No man dared go to him, save for the king alone.  Quoth Wayland:\epb\epg


\bvg\bva\mssnote{\Regius~18v/24}%
\llap{„}\edtrans{Ski̇́nn}{shines}{\Bfootnote{Metrically deficient, since \emph{sk-} and \emph{s-} cannot alliterate.  A possible emendation is \emph{se’k} ‘I see’.}} Níð·aði \hld\ sverð á linda, &
...
\bvb “The sword does shine on Nithad’s belt, \\
...
\alst{s}ynir Níð·aðar \hld\ i̇́ \alst{S}ę́var-stǫð.\eva
...
\speakernote{[Vǫlundr kvað:]}%
\llap{„}Komið \alst{ęi}nir tvęir, \hld\ komið \alst{a}nnars dags; &
...
\alst{S}nimma \edtext{kallað\emph{i}}{\Afootnote{emend.; \emph{kallað} \Regius}} \hld\ \alst{s}ęggr ȧ annan, &
\alst{b}róðir ȧ \alst{b}róður: \hld\ „gǫngum \alst{b}aug séa!“ &
\alst{K}vǫ́mu til \alst{k}istu, \hld\ \alst{k}rǫfðu lukla, &
\alst{o}pin vas \alst{i}ll-úð \hld\ es þęir \alst{i̇́} litu.\eva

\bvb Early one youth called out to another, \\
brother to brother: “Let us go see the bighs!” \\
They came to the chest, demanded the keys; \\
open was the evil when they gazed inside.\evb\evg


\bvg\bva\mssnote{\Regius~19r/3}%
Snęið af \alst{h}ǫfuð \hld\ \edtrans{\alst{h}u̇na}{bear-cubs}{\Bfootnote{This word is common in prose, but only in the sense ‘bear-cub’, never used as here about humans.  The affectionate sense for young boys perhaps relates to warrior-initiations done in bear-skins.  Its only occurrence in the sense ‘young boys’ outside of \Volundarkvida\ is in \textlink{Gudrunarhvot}[12]/1, but it is repeated by Nithad in st.~32 and mirrored by Wayland in st.~34 below.}} þęira &
ok und \edtrans{\alst{f}ęn \alst{f}jǫturs}{the fetter’s fen}{\Bfootnote{Unclear.  The smithy or islet may be Wayland’s “fetter”, in which case he buried them in a fen on the island.}} \hld\ \alst{f}ǿtr of \edtext{l\emph{a}gði}{\Afootnote{emend.; \emph{†logði†} \Regius}}, &
ęn \edtrans{þę́r \alst{sk}álar, \hld\ es und \alst{sk}ǫrum vǫ́ru}{the bowls which were under their curls}{\Bfootnote{Their skulls.}}, &
...
\alst{Ę}n ór \alst{au}gum \hld\ \edtrans{\alst{ja}rkna-stęina}{arkenstones}{\Bfootnote{Generally held to be a borrowing from OE.  Probably round crystals.}} &
sęndi \alst{k}unnigri \hld\ \edtext{\alst{k}\emph{vǫ̇n}}{\Afootnote{emend.; \emph{konu} \Regius}} Níð·aðar; &
ęn ór \alst{t}ǫnnum \hld\ \alst{t}vęggja þęira &
\alst{s}ló brjóst-kringlur, \hld\ \alst{s}ęndi Bǫðv·ildi.\eva

\bvb But out of their eyes arkenstones \\
...
\edtext{[...]}{\Bfootnote{The meter requires a half-line here, perhaps containing a repetition of 1a: \emph{baugi at hrósa} ‘to praise the bigh’.}}\ \hld\ es brotit hafði, &
\llap{„}\alst{þ}ori’g⸗a’k sęgja, \hld\ nema \alst{þ}ér ęinum.“\eva

\bvb Then Beadhild began to praise the bigh, \\
{[...]} which she had broken, \\
“I dare not tell it, save to thee alone!”\evb\evg


\bvg\bva\mssnote{\Regius~19r/8}%
\speakernote{Vǫlundr kvað:}%
\llap{„}Ek \alst{b}ǿti svá \hld\ \alst{b}rest ȧ golli, &
at \alst{f}ęðr þi̇́num \hld\ \alst{f}ęgri þykkir, &
ok \alst{m}ǿðr þi̇́nni \hld\ \alst{m}iklu bętri, &
...
and to thyself of the self-same rank.”\evb\evg


\bvg\bva\mssnote{\Regius~19r/10}%
\alst{B}ar hana \alst{b}jóri, \hld\ \edtrans{því’t \alst{b}ętr kunni}{for he knew better}{\Bfootnote{He was more cunning than she.}}, &
\alst{s}vá’t hǫ̇n i̇́ \alst{s}essi \hld\ of \alst{s}ofnaði. &
\speakernote{[Vǫlundr kvað:]}%
\llap{„}Nú \alst{h}ęfi’k \alst{h}ęfnt \hld\ \alst{h}arma mi̇́nna &
\alst{a}llra \edtrans{nema \alst{ęi}nna}{save one}{\Bfootnote{Presumably the deprivation of his mobility due to the hamstringing, which he resolves by crafting his flight suit.}} \hld\ \edtrans{\edtext{\alst{i̇́}·við-gjar\emph{n}a}{\Afootnote{emend.; \emph{i̇́·við-†giarira†} \Regius}}}{insidious ones}{\Bfootnote{King Nithad and his house.}}.“\eva
...
\llap{„}\alst{V}ęl ek,“ kvað \alst{V}ǫlundr, \hld\ „\alst{v}erða’k ȧ \edtrans{fitjum}{paddles}{\Bfootnote{\CV: \emph{fit} ‘the webbed foot of water-birds’, here a reference to the flight-suit which allows Wayland to regain his freedom.}}, &
...
\bvb “Well I”, quoth Wayland, “do fall on my paddles, \\
those of which Nithad’s men bereaved me!” \\
Laughing, Wayland threw himself in the air; \\
weeping, Beadhild went from the island, \\
grieved her lover’s flight and her father’s wrath.\evb\evg

\sectionline

\bvg\bva\mssnote{\Regius~19r/14}%
Úti \edtrans{st\emph{óð}}{stood}{\Afootnote{emend.; \emph{stęndr} ‘stands’ \Regius}} \alst{k}unnig \hld\ \alst{k}vǫ̇n Níð·aðar, &
ok hǫ̇n \alst{i}nn of gekk \hld\ \alst{ę}nd-langan sal, &
ęn hann ȧ \alst{s}al-garð \hld\ \alst{s}ętti⸗sk at hvíla⸗sk, &
\llap{„}Vakir þú \alst{N}íð·uðr, \hld\ \alst{N}íara dróttinn?“\eva
...
\llap{„}\edtrans{\alst{V}aki’k ȧ·valt \hld\ \alst{v}ilja-lauss}{I am always awake, powerless}{\Bfootnote{This line references sts.~12 and 20, but there Wayland was the powerless man who never slept.  By his revenge the suffering has been transferred onto Nithad.}}, &
\alst{s}ofna’k minst, \hld\ síðst \alst{s}onu dauða, &
\alst{k}ęll mik i̇́ hǫfuð, \hld\ \edtrans{\alst{k}ǫld eru⸗mk rǫ́ð þi̇́n}{cold seem thy counsels}{\Bfootnote{A severe insult to a woman of power, for such counsels to her husband was how she would influence worldly affairs.  In this way Wayland’s revenge reaches also Nithad’s wife.}}, &
\alst{v}ilnumk þęss nú, \hld\ at við \alst{V}ǫlund dø̇ma’k.“\eva

\bvb\speakernoteb{[Quoth Nithad:]}%
“I am always awake, powerless; \\
I sleep the least since my sons did die. \\
My head turns cold; cold seem thy counsels--- \\
would now but that I could speak with Wayland!”\evb\evg

\sectionline

\bvg\bva\mssnote{\Regius~19r/19}%
\Ballnote{The scene shifts again.  King Nithad, standing on the ground, sees Wayland hovering in the sky.  He calls out to him.}%
\speakernote{[Níð·uðr kvað:]}%
\llap{„}Sęg mér þat \alst{V}ǫlundr, \hld\ \alst{v}ísi alfa, &
af \alst{h}ęilum \alst{h}vat \hld\ varð \edtext{\emph{\alst{h}u̇}num}{\Afootnote{metr. emend.; \emph{sonum} \Regius}} mi̇́num?“\eva

\bvb\speakernoteb{[Quoth Nithad:]}%
“Tell me this, Wayland, O chief of elves: \\
what became of my healthy bear-cubs?”\evb\evg


\bvg\bva\mssnote{\Regius~19r/20}%
\speakernote{[Vǫlundr kvað:]}%
\llap{„}\alst{Ęi}ða skalt mér \alst{á}ðr \hld\ \alst{a}lla vinna, &
...
at þú \edtrans{\alst{k}vęlj⸗at}{shalt not torture}{\Bfootnote{A negative imperative.  The 2nd. sg. imper. of \emph{kvęlja} ‘torture’ is \emph{kvęl}, but the negative clitic \emph{⸗at} causes the \emph{-j-} of the stem to reappear in a rare \emph{liaison} effect.  This indicates that forms like \emph{kvęl} were still understood to contain \emph{-j}, just no longer pronounced, but which could reappear in the correct circumstance.}} \hld\ \edtext{\alst{k}vǫ̇n Vǫlundar, &
né \alst{b}rúði mi̇́nni}{\lemma{kvǫ̇n Vǫlundar ‘wife of Wayland’, brúði mi̇́nni ‘my bride’}\Bfootnote{Beadhild, who is now pregnant.}} \hld\ at \alst{b}ana verðir, &
þó’tt kvǫ̇n \edtext{\alst{ę\emph{i}}gim}{\Afootnote{emend.; \emph{†ę́gim†} \Regius}}, \hld\ þá’s \edtext{*\alst{é}r}{\Afootnote{metr. emend.; \emph{þér} \Regius}} kunnið, &
\edtext{eð\emph{a}}{\Afootnote{emend.; \emph{†eþ†} \Regius}} \alst{jó}ð \alst{ęi}gim \hld\ \alst{i}nnan hallar.\eva
...
did I send to the cunning wife of Nithad.\evb\evg


\bvg\bva\mssnote{\Regius~19r/28}%
Ęn ór \alst{t}ǫnnum \hld\ \alst{t}vęggja þęira &
\alst{s}ló’k brjóst-kringlur, \hld\ \alst{s}ęnda’k Bǫðv·ildi; &
nú gęngr \alst{B}ǫðv·ildr \hld\ \edtrans{\alst{b}arni aukin}{swollen with child}{\Bfootnote{A likely sign of OE influence, as this is the only ON occurrence of the past participle of \emph{auka} ‘to increase, augment’ in the sense ‘pregnant’, whereas this is otherwise attested in OE.  Indeed, in \textlink{Deor}[2][11], Beadhild is also described as \emph{éacen}, the direct cognate.}}, &
...
\llap{„}\alst{M}ę́ltir⸗a þat \alst{m}ál, \hld\ es mik \alst{m}ęirr tregi, &
...
there as thou jeerest by the clouds on high!”\evb\evg


\bvg\bva\mssnote{\Regius~19v/1}%
\alst{H}lę́jandi Vǫlundr \hld\ \alst{h}óf⸗sk at lopti, &
ęn \alst{ȯ}·kȧtr Níð·uðr \hld\ sat þȧ \alst{ę}ptir.\eva
...
\speakernote{[Níð·uðr kvað:]}%
\llap{„}Upp rís \edtrans{\alst{Þ}akk·ráðr}{Thankred}{\Bfootnote{A German name never found elsewhere in ON, but equivalent to MHG \emph{Dancrát}.}}, \hld\ \alst{þ}rę́ll minn batsti, &
...
\speakernote{[Níð·uðr kvað:]}%
\llap{„}Es þat \alst{s}att Bǫðv·ildr, \hld\ es \alst{s}ǫgðu mér, &
\alst{s}ǫ́tuð it Vǫlundr \hld\ \alst{s}aman i̇́ holmi?“\eva

\bvb\speakernoteb{[Quoth Nithad:]}%
“Is it true, Beadhild, as they told me--- \\
did thou and Wayland stay together on the islet?”\evb\evg


\bvg\bva\mssnote{\Regius~19v/4}\speakernote{[Bǫðv·ildr kvað:]}%
\llap{„}\alst{S}att ’s þat Níð·uðr \hld\ es \edtrans{\alst{s}agði}{\emph{he} told}{\Bfootnote{Beadhild knows that Wayland is the only one aware of the rape and thus deduces that \emph{he} told her father.  She makes a subtle change in the conjugation from her father’s general third person plural (“what they told”), to the specific singular form (“what \emph{he} told”).}} þér: &
\alst{s}ǫ́tum vit Vǫlundr \hld\ \alst{s}aman i̇́ holmi &
\alst{ęi}na \alst{ǫ}gur-stund, \hld\ \alst{ę́}va skyldi; &
ek \alst{v}ę́tr hǫ̇num \hld\ \edtext{\emph{\alst{v}inna}}{\Afootnote{metr. and sens. emend.; om. \Regius}} \edtext{kunna’k, &
ek \alst{v}ę́tr hǫ̇num \hld\ \alst{v}inna mátta’k}{\lemma{kunna’k ‘knew’, mátta’k ‘could’}\Bfootnote{Beadhild did not know (\emph{kunna} ‘to know, understand’) how to ward him off, yet even if she had been wise enough, she would still have been overpowered, for she had not the strength (\emph{mega} ‘to have strength to, avail’).  A touching final stanza.}}.“\eva

\bvb\speakernoteb{[Quoth Beadhild:]}%
“It is true, Nithad, which \emph{he} told thee. \\
