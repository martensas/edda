...
The \textbf{Lay of Wayland} (\textlink{Volundarkvida}) is a psychologically complex narrative poem dealing with the capture and revenge of the famous smith Wayland.

\subsection{Textual preservation and transmission}

\Volundarkvida\ only survives in full in \Regius, but the beginning of the prose introduction is found on the very last page of \AM\ which shows that the poem likewise was originally found there.  Although technically a heroic poem, \Volundarkvida\ is part of the mythological section in \Regius, for which reason it is placed under Norse Mythic Poetry in the pres.~ed.
...
but for all the eighth they yearned, \\
...
\bvb There came from the hunt the stormy-eyed shooter: \\
...
\bvb That learns Nithad, lord of the \inx[P]{Nears}, \\
...
sęndi \alst{k}unnigri \hld\ \edtext{\alst{k}\emph{vǫ̇n}}{\Afootnote{\emph{konu} \Regius}} Níð·aðar; &
...
þó’tt kvǫ̇n \alst{ęi}gim, \hld\ þá’s \edtext{*\alst{é}r}{\Afootnote{metr. emend.; \emph{þér} \Regius}} kunnið, &
