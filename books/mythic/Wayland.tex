...
Although arguably more of a heroic poem, \Volundarkvida\ is part of the mythological section of \Regius, to which it conforms orthographically \parencite[160--166]{Lindblad1980}.  The poem is also found in the otherwise exclusively mythological \AM.  It does not belong to the cycle of the Walsings, nor to the Hallow-poems, which are the subjects of the heroic part of \Regius.  For these reasons, and following the choices of the mediæval editors, \Volundarkvida\ is placed under Norse Mythic Poetry in the pres.~ed.

\subsection{Origin and motifs}

\Volundarkvida\ is a narrative poem telling the story of Wayland the Smith (ON \emph{Vǫlundr}, OE \emph{Wéland} or \emph{Wélund}, MHG \emph{*Welent}).  Wayland was one of the most popular figures in early mediæval Germanic legend and independent versions of his tale are found in Germany, England, and Iceland.
