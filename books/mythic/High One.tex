...
\ind \alst{h}verf es \edtrans{\alst{h}aust-gríma}{stormy fall night}{\Bfootnote{Lit. ‘fall-mask’, a cpd. \emph{haustr} ‘fall, autumn’ + \emph{gríma} ‘mask’.  It paints an image of the dark cloudy evening or night-sky, the thick dark clouds being the metaphorical ‘mask’.  Cf.~Weden’s names \emph{Grímr} ‘Grime; Mask’, \emph{Grímnir} ‘Grimner; the Masked One’ (\textlink{Grimnismal}[47], 50).}}; &
