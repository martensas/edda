...
Outside of \Havamal\ 138--146 (but cf.~st.~80 above which would fit seamlessly into the present section) there are a few other manuscript attestations of similar Runic magic, but nothing quite like the unabashed heathendom of the present stanzas.

Somewhat similar poetry preserved in \Regius\ is \textlink{Sigrdrifumal}[36] and \textlink{Sigrdrifumal}[5]--17, although there are signs that point towards the latter being a later antiquarian composition, something sts.~138--146 are quite likely not.
