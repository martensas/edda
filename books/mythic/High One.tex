...
\Ballnote{A problematic stanza in \Malahattr, unlike the surrounding \Ljodahattr\ sts.  The style is also unusual and the content fits poorly in context.  It is probably a later insertion.}%
...
\ind \edtrans{\alst{sk}ammar ’ro \alst{sk}ips ráar}{short are the ship’s sail-yards}{\Bfootnote{Also found in \Malshattakvadi\ 12/1a: \emph{skips láta menn skammar rár} ‘men say the ship’s sail-yards are short’ or ‘men make the ship’s sail-yards short.’  The sail-yards (ON \emph{ráar}) are the arms on the mast from which the sails are set, but the sense of the l. is unclear and interpretations vary (for an overview see \Malshattakvadi\ 12 in \Skp\ 3 and \textcite[110--111]{Evans1986}).  In any case it would appear by the sense of ll. 3–5 that this l. should also refer to something untrustworthy; one suggestion is that during a shipwrecksail-yards.}}, &
