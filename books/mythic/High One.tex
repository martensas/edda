...
\Ballnote{The \emph{riður} ‘rideresses’ were witches believed to leave their original human shapes or skins (\emph{hamir} ‘hames’) in order to fly (“ride”) around in the air tormenting and injuring the folk; the words \emph{tu̇n-riður} ‘town-rideresses’, \emph{kveld-riður} ‘evening-rideresses’ and \emph{myrk-riður} ‘darkness-rideresses’ all appear synonymous.  Note that \emph{riða} also means ‘fever’, which was thought to be caused by supernatural forces.
When the witches were out “riding” their human hames would be lying fast asleep, yet it was not the case that their whole mental faculties would disconnect from their bodies.  They would leave behind the part of their human soul and emotions which was thought to be inextricably linked to the body, the \emph{hugr} ‘mind, heart’.  (For the accuracy of this notion cf.~the famous passage in \VolsungaSaga\ 8.)
It was through his second sight that Weden could see these evil rideresses, and with his superior magical skill he would confuse them so that they would never be able to return to their original hames or minds, instead being doomed to stray as tormented ghosts.  Weden brags about doing this in \textlink{Harbardsljod}[20]; for Weden as troll- and witch-hunter cf.~further his role in the Wild Hunt of later folklore.

A vivid description of the witches’ ride with is found in the OSwe.~Elder Westgeatish Law (ca.~1250 \ce), RB 5:5 (my norm.): \emph{Þętta ęru ú·kvęðins-orð konu. ‚Iak sá, at þú rêt á kví-grindu lǿs-hárað ok í trolls ham, þá alt var iam-ript nátt ok dagr.‘ Kallar hana kunna firi·gęra konu ęllr kó, þęt ęr ú·kvęðins-orð. [\dots]} ‘These are words of insult to a woman: “I saw that thou rodest on the sheep-pen-fence loose-haired and in a troll’s hame when everything was equally divided between day and night.”  If he says that she knows how to destroy (with magic) a woman or a cow, that is a word of insult.’  It may be noted that the ms.~word \emph{quiggrindu} ‘sheep-pen-fence’ (dat.~sg.) has also been interpreted as \emph{kvíð-grindu} ‘womb-opening’, i.e.~the woman’s (bared) nether parts, the implication of which will be left to the reader; see \textcite[224--228]{Sjöros1919} for an overview.}
Þat kann’k \alst{t}íunda, \hld\ ef sé’k \alst{t}u̇n-riður &
\ind \alst{l}ęika \alst{l}opti ȧ, &
ek svá \alst{v}inn’k, \hld\ at \edtrans{þę́r \alst{v}illar fara}{they (\emph{f.}) go astray}{\Afootnote{emend.; \emph{þęir villir fara} ‘they (\emph{m.}) go astray’ \Regius}} &
