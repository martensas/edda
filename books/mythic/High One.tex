...
\edtext{\edtext{því’t}{\Afootnote{om. 1768}} ȧ \alst{h}verfanda \alst{h}véli \hld\ \edtrans{vǫ́ru þęim \alst{h}jǫrtu skǫpuð}{their hearts were shaped}{\Afootnote{\emph{er þeim hjarta skapat} ‘their heart is shaped’ 1768}}, &
\ind \edtext{\alst{b}rigð}{\Afootnote{\emph{ok brigð} 1768}} ï \alst{b}rjóst of \edtext{lagit}{\Afootnote{\emph{lagin} 1768}}.}{\lemma{því’t \dots\ lagið}\Bfootnote{Quoted in slightly divergent form in \FostrbroedhraSaga\ (ms. Thott 1768 4°, fol. 210r--v), where it is introduced with the words: \emph{Kom honum þá í hug kviðlingr sá, er kveðinn hafði verit um lausungar-konur:} ‘And then he remembered the ditty which had been composed about loose women:’}}\eva
...
\edtext{Mál}{\Afootnote{The \emph{M} takes up a single line in height but the right leg curves down to the line below in \Regius; it is noticably thicker than the capitals introducing individual sts.~but smaller than the initials introducing separate poems.}} ’s at \edtrans{\alst{þ}ylja}{thill}{\Bfootnote{To ‘recite, chant’, the verb corresponding to \emph{þulr} ‘thyle’.}} \hld\ \edtrans{\alst{þ}ular}{thyle}{\Bfootnote{The reciter, chanter of ancient lore.  See Index.}} stóli ȧ; &
