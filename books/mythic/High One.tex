...
I agree with \textcite{Males2024} on the interpretation of this stanza: since a gift always requires recompense, an excessive sacrifice creates an excessive obligation on the part of the god to whom it is addressed, which might upset the relationship with the god.  Males draws the analogy with an episode in \EgilsSaga, where a rival poet leaves an expensive shield for the protagonist Eyel and rides off; the latter understands this as a demand to compose a poem about the shield and is greatly insulted.

The gift cycle between Gods and Men, of which the present st. is a Germanic attestation, is a very important concept in Indo-European pagan religions.  The idea of sacrifices creating moral, if not legal, obligations for recompense is prevalent in the Roman religion and summarized by the ritual concept \textlatin{dō ut dēs} ‘I give that thou might give’ \parencite[102, 149]{Rupke2007}.  A similar expression is found in OI (\textoi{Taittirīya Saṃhitā} 1.8.4.1, during the \textoi{Rāja-sūya} or consecration of a king): \textoi{Dēhí mē, dádāmi tē; ní mē dʰēhi, ní tē dadʰē; ni·hā́ram ín ní mē harā, ni·hā́ram} ‘Give to me, I give to thee; bestow upon me, I bestow upon thee; bring gain indeed to me, [I bring] gain [to thee]’.}%
...
\ind \edtext{[...]}{\Bfootnote{For metrical reasons it is very likely that a line has been lost here.}}\eva
