...
\ind ok \edtrans{\alst{f}áði}{painted}{\Bfootnote{3rd sg.~past ind.~of \emph{fáa} ‘paint, decorate, adorn’, a semantic archaism.  The weak verb \emph{fáa} (< PGmc.~\emph{*faihijaną}) derives from the PGmc.~adjective \emph{*faihaz} ‘coloured, decorated’ and was associated with runic writing from the earliest period of the script’s existence.  It is found already in some of the very earliest Elder Futhark inscriptions, like the stones from Einang, Vetteland, Hole, and Rö (all ca.~100--400 \ce), all of which feature the formulaic phrase \emph{ek rúnó fa(i)hidó} ‘I painted the rune’.
In later inscriptions in the Younger Futhark, the 3rd sg.~past ind.~appears in the form \textbf{faþi}.  It is notable that the use of the verb in YF inscriptions is limited to archaic inscriptions, e.g., Ög 136, Sm 144, Vg 119, U Fv1912;8, Hs 7, DR 190, N 140 (all ca.~800--1000 \ce), many of which have explicitly pagan contents.  The verb does not appear in inscriptions belonging to the Christian runestone trend of the 11th and 12th centuries, and so the use of \emph{fáa} in reference to runic carving was likely formal or solemn.
Although the verb most likely originally referred to the colouring or painting of runes (perhaps with mineral paint, or even blood), as early as the bracteate period (ca.~450--550 \ce) it could be used for inscriptions in metal, including stamped ones (e.g., DR IK11, IK70, IK241,1--2).  This usage continues into the YF period (e.g., the metal inscriptions U Fv1912;8 and Hs 7).
In the rest of the ON manuscript corpus \emph{fáa} mostly appears in the past participle, carrying the sense ‘decorated, adorned’, and indeed it is only in \Havamal\ that we find the verb used in a runic context.  However, with the support of the above examples, we may safely say that this is an archaic formula, deriving from genuine pre-Christian runic tradition (cf.~1--2: \emph{ru̇num \dots\ hinum ręgin-kunnum} n. above).}}
