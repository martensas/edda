...
\Ballnote{This half-stanza is an orphan.  It may be connected to the previous st. to form a 6-line \Ljodahattr\ st., for which cf. sts. 6, 27, 102, 103, 138, 165.}%
...
\alst{b}lindr es \alst{b}ętri \hld\ an \edtrans{\alst{b}ręnndr}{burned}{\Bfootnote{On the funeral pyre; the word here means ‘dead’ in the same way as “six feet under” in English.  This synonymity is an important argument for dating \Havamal\ to the pre-Christian period, since cremation during the mediæval Catholic period was reserved for criminals and adulterers, whereas it here seems to be the commonly understood way of disposing the dead.  Cf. Introduction to the poem and the same use in st. 81 below.}} séi; &
...
\Ballnote{It is a boon and a blessing for a man to have a son, even if the father should die before his son is born.  The son will inherit and carry on his father’s name, lineage, and memory in a way no non-relative can, as exemplified by the raising of a stone memorial.  In a broader context we might consider how it is only a tiny few out of the great human masses who will leave behind any kind of lasting personal legacy beyond their direct familiar relations.  It is rare for non-family to tend a grave.  The current generation must soon die off, and even those who in their lifetimes see influence and success in their fields and careers are soon forgotten by posterity and relegated to the footnotes of the annals of history if they have no descendants to carry their names into future ages.}%
...
\Ballnote{This st. is most likely a later insert.  It is composed in \Malahattr\ unlike the surrounding \Ljodahattr\ sts., the style is unusual, and the content fits poorly in context.}%
