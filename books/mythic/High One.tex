...
\alst{F}ullar grindr \hld\ sá'k fyr \edtrans{\alst{F}itjungs sonum}{Fitting's sons}{\Bfootnote{Wholly unknown figures, perhaps a reference to a long-lost old folk-tale?}}, &
...
\bvb Full pens I saw before Fitting's sons; \\
...
\ind hinum \alst{r}ęgin-kunnum}{\lemma{ru̇num \dots\ hinum ręgin-kunnum `the runes born of the Reins'}\Bfootnote{`Runes of Godly origin', namely through Weden's Self-Hanging (sts.~138--139 below).  The expression is formulaic and very old, for it also appears on the ca. C5th Noleby stone (in the acc. sg. \emph{rúnó ragina-kundó} `a rune born of the Reins'); an undeniable proof of the antiquity of some of the runic lore preserved in Norse poetry.  See also Index: \inx[C]{rune}. --- \emph{hinum ręgin-kunnum} is unusual but need not be corrupt; cf.~the similar form of \textlink{Harbardsljod}[4]/2, 6/2, 13/3.  Related is possibly the form of following a c-verse by another line that joins it in alliteration, so st.~61/5 above, \textlink{Skirnismal}.}}, &
...
\edtext{Mál}{\Afootnote{The \emph{M} takes up a single line in height but the right leg curves down to the line below; is noticeably thicker than the capitals introducing individual sts.~but smaller than the initials introducing separate poems in \Regius.}} 's at \edtrans{\alst{þ}ylja}{chant}{\Bfootnote{The verb corresponding to \emph{þulr} `thyle'.}} \hld\ \edtrans{\alst{þ}ular}{thyle}{\Bfootnote{The reciter, chanter of ancient lore.  See Index.}} stóli ȧ; &
...
Against the interpretation of sacrifice, \textcite{Sundquist2010} argues convincingly that the present stanza is the etiology behind an initatory ritual likely used to initiate cultic leaders, thyles (\emph{þulir}) or gids (\emph{goðar}).  In this view, the nine nights are the liminal period during which Weden is being remade, halfway between the land of the living and the land of the dead, and his deprivation represents a passage ritual.  When Weden reemerges, he has become wise and learned in the arts of runic writing, Scaldic poetry, and the bloot.}%
...
Þȧ \edtrans{nam'k \alst{f}rę́va⸗sk}{I began to flourish}{\Bfootnote{A notorious mistranslation popularized by \textcite{Greenberg1988} has rendered these words as `I took semen'.  This would supposedly reference Weden ``stealing'' the ejaculate from hanged men in order to replenish his own powers---something not otherwise attested.  This preposterous notion makes little sense in the context of the text and has no philological grounding.  While Old Norse \emph{frę́} does mean `seed', it only refers to the seeds of plants, not to the ``seed'' of beasts or men.  Regardless, \emph{frę́va⸗sk} `to flourish' is a reflexive verb, and \emph{nam} before it means `began'.}} \hld\ ok \alst{f}róðr vesa &
...
With his unrivalled skill as a magician, Weden could see the rideresses and with his galder he would prevent them from returning to their original hames or minds, eventually annihilating them.  Weden brags elsewhere about doing this in \textlink{Harbardsljod}[20] and this also mirrors his role as troll- and witch-hunter in the Wild Hunt of later folklore.  Since the noun \emph{riða} on its own means `fever, chills' \parencite[s.v.~\textit{riða}]{FritznerDictionary}, we likely also here see Weden in his role as supernatural healer.}%
