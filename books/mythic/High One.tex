...
\ind \alst{n}jóta munt ef \alst{n}emr, &
\ind þér munu \alst{g}óð ef \alst{g}etr: &
\edtrans{\alst{f}jǫl-kunnigri}{many-cunning}{\Bfootnote{F.~dat.~sg.~of \emph{fjǫl-kunnigr} ‘sorcerous’, an adj.~used of both men and women.}} konu \hld\ skal⸗at-tu ï \alst{f}aðmi sofa, &
...
\ind thou wilt profit if thou learnest, \\
\ind they will be good for thee if thou gettest:} \\
In a \inx[C]{many-cunning} woman’s arms shalt thou never sleep, \\
...
\alst{ęi}k við \alst{a}b·bindi, \hld\ \alst{a}x við fjǫl-kyngi, &
\edtrans{\alst{h}ǫll við \alst{h}ý-rógi}{elder against married strife}{\Bfootnote{Both nouns are hapaxes.
