...
\Ballnote{It is likely that sts.~76--77 concluded the original Guests’ Strand.  This is supported internally by their tone of finality and their reflections on death, and externally by the fact that \Hakonarmal\ (composed ca. 961 \ce) borrows the first line of its final stanza 21 (\emph{dęyr fé \hld\ dęyja frę́ndr}) from their refrain.  The sense of both stanzas is that the whole of man’s earthly power will pass away with him, but a good reputation, fame and glory, can linger on.

The idea of “undying fame”, as stressed in these two sts., is an ancient Indo-European conception and features prominently in sources including Homer, the Greek lyric poets, the \Rigveda, and the Irish saga-cycles \parencite[396--98, 406--10]{West2007}.  Of particular relevance is the reconstructed PIE formula \emph{*ḱléwos ń̥·dʰgʷʰitom} ‘imperishable fame’, which has direct reflexes in both Vedic (OI \textoi{śrávaḥ \dots\ ákṣitam}, \Rigveda\ 1.9.7bc) and Greek (\textgreek{κλέος ἄφθιτον}) \parencites[406--10]{West2007}[173--178]{Watkins1995}.}%
\alst{D}ęyr \edtext{fé}{\lemma{fé, frę́ndr ‘Kine, kinsmen’}\Bfootnote{In the Germanic Iron Age farming society a man’s wealth was reckoned in heads of cattle (note that the Norman loan-word \emph{cattle} is itself the same word as \emph{capital}), his social power by the number of able male kinsmen and friends ready to side with him in conflict (cf.~sts.~62, 72 above).  For Indo-European poetic analogues, cf.~\textcite[99--100]{West2007}.}}, \hld\ \alst{d}ęyja frę́ndr, &
...
\ind \edtrans{\alst{d}ȯmr}{Doom}{\Bfootnote{In ON, this word otherwise means nothing other ‘judgment’, but here it carries the unique sense ‘fame’.  This latter sense should probably not be taken as a semantic development of the former, but rather as an independent reflex of the original sense ‘thing put’ of the PIE ancestor \emph{*dʰoh₁·mos}, from the verbal root \emph{*dʰeh₁-} ‘to put, place, lay’ (\cite[73]{Orel2003}, \cite[98]{Kroonen2013}; though neither note the sense ‘fame’).
In Greek and Indo-Iranian the root \emph{*dʰeh₁-} is in fact used formulaically with the object \emph{*ḱléwos} ‘fame’, which may be ‘laid’ on a man either by himself or the Gods \parencites[397--98]{West2007}[177--78]{Watkins1995}.  Thus, we may see in the semantic development from PIE \emph{*dʰoh₁·mos} ‘thing put’ > PGmc.~\emph{*dōmaz} > ON \emph{dȯmr} ‘fame’ a periphrastic expression, originally deriving from the lost Germanic usage of the same formula.

Within Germanic, the sense ‘fame’ is also found in the cognates OE \emph{dóm}, OS \emph{dóm}, which are most often used to refer specifically to fame after death.  In \textlink{Heliand} see particularly ll.~3996--4002.  In \Beowulf\ there are several examples; the best is 1384--1389, where Bewolf consoles King Rothgar after Grendle’s mother has slain his trusted advisor Asher (\emph{Æsc·hęri}):
\emph{Ne sorga, snotr gumá! \hld\ Sǿlre bið ǽg·hwǽm, /
þæt hé his fréond wrece, \hld\ þǫnne hé fela murne. /
U̇re ǽg·hwylc sceal \hld\ ęnde gi·bídan /
wor-ǫldǽ lífæs; \hld\ wyrce sé þe móte /
dómes ǽr déaðe; \hld\ þæt bið driht-guman /
un·lifgendum \hld\ æftær sǿlest.}
...
\emph{[...] Sige·munde gi·sprang /
æftær déað-dægǽ \hld\ dóm un·lýtel /
syþþan wígæs hard \hld\ wyrm á·cwaldǽ /
hordæs hyrdí [...]}
...
dǽdum gi·fręmid \hld\ þæt þín dóm lifað /
áwá tó aldrǽ [...]}
