...
\textbf{Meter:} (majority) \Ljodahattr, (minority) \Malahattr, \Fornyrdislag
\end{flushright}%
...
sjaldan \edtrans{\alst{b}autar-stęinar}{beat-stones}{\Bfootnote{Large standing stones raised in memory of the dead.  They appear frequently in Norse literature.  Cf.~\YnglingaSaga\ 8, which describes the laws instituted by the euhemerized Weden: \emph{en eptir alla þá menn, er nǫkkut manns-mót var at, skyldi reisa bauta-steina, ok held⸗sk sjá siðr lengi síðan.} ‘but in memory of all those men who had possessed masculine virtue beat-stones should be raised, and that custom was upheld for a long time since’.
Such stones are very common throughout Scandinavia and are not infrequently found near grave-mounds.  The raising of beat-stones is clearly related to the late Wiking Age trend of runestones, but unlike them were usually unadorned with any marks.  Beat-stones are also oftener found in direct funerary contexts, which is not as often the case with Wiking Age runestones.  In Norway of the Migration Period the line is somewhat blurred, and a large number of runestones survive from about the 2nd to 5th centuries often placed near grave fields.  Some hold only single personal names or genitive phrases, like KJ 90 from Sunde in Sunnfjord, western Norway: ᚹᛁᛞᚢᚷᚨᛊᛏᛁᛉ \textbf{widugastiʀ} ‘Woodguest’, or KJ 78 from Bø in Rogaland, southwestern Norway: ᚺᚾᚨᛒᛞᚨᛊ ᚺᛚᚨᛁᚹᚨ \textbf{hnabdas hlaiwa} ‘Naved’s grave’.  Others have longer inscriptions, like KJ 75 from Kjølevik, also in Rogaland: ᚺᚨᛞᚢᛚᚨᛁᚲᚨᛉ ᛖᚲᚺᚨᚷᚢᛊᛏᚨᛞᚨᛉ ᚺᛚᚨᚨᛁᚹᛁᛞᛟᛗᚨᚷᚢᛗᛁᚾᛁᚾᛟ \textbf{hadulaikaz ekhagustadaz hlaaiwidomaguminino} ‘Handlac [lies here].  I, Haystald, buried my lad.’}} \hld\ standa \alst{b}rautu nę́r, &
...
\ind \edtrans{\alst{d}ȯmr}{Doom}{\Bfootnote{Here meaning ‘judgment, glory’.  See Index.}} umb \alst{d}auðan hvęrn.\eva
