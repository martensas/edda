...
The normal change \emph{vr-} > \emph{r-} yields \emph{rǫ̇}, which is the only form this word ever takes outside of the present instance.  This includes \FGT\ where \emph{rǫ̇} is brought up as an example of a word with nasal \emph{ǫ̇} and contrasted with the oral \emph{ǫ́} in \emph{rǫ́} ‘sailyard’.
...
For another instance of alliterating \emph{vr-} and \emph{v-} cf.~\textlink{Havamal}[32]/2 below; for discussion of the validity this criterion see \textcite{Haukur2016}, \textcite[87--92]{Males2024Hav}.}} \alst{v}eru; &
