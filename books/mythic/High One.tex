...
Later Vedic texts clearly identify the Eagle with \textoi{Agní} (the god of fire), specifically in his form as the \textoi{gāyatrī́} meter \parencite{Bloomfield1896}.  One text in particular (\AitareyaBrahmana\ 3.25--27) is interesting in its etiological function: “What (the \textoi{gāyatrī}) seized with her right foot, that became the morning pressure (\textoi{prātaḥsavana}). \dots\ What she seized with her left foot became the noon pressure (\textoi{mādhyaṁdinaṁ savanam}). \dots\ What she seized became the third pressure (\textoi{tṛtīyam savanam}).” \parencite[6]{Bloomfield1896}.
