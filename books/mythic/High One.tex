...
For another instance of alliterating \emph{vr-} and \emph{v-} cf.~\textlink{Havamal}[32]/2 below; for a summary of discussion about this criterion, especially as it relates to the present poem see \textcite[87--92]{Males2024Hav}.}} \alst{v}eru; &
...
\alst{b}lindr es \alst{b}ętri \hld\ an \edtrans{\alst{b}ręnndr}{burned}{\Bfootnote{On the funeral pyre.  The word ‘burned’ here means ‘dead’ in the same way as “six feet under” in modern English; both refer to typical customs of dealing with human remains in their respective cultures.  This synonymity is an important argument for dating \Havamal\ to the pre-Christian period, since cremation was reserved for criminals and adulterers in the mediæval Catholic religion, whereas it in \Havamal\ seems to be the commonly accepted way of disposing the dead.  Cf.~Introduction to the poem above and the same semantics in st.~81 below.}} séi; &
