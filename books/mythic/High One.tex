...
The \textbf{Speeches of the High One} (abbrev. \textlink{Havamal}) is the second poem of \Regius, where it follows \textlink{Voluspa} and is followed by \textlink{Vafthrudnismal}.  \Regius\ is the only mediæval manuscript witness for the whole poem, but several sts.~(1, 58, 84, 76--77) are cited or alluded to in other texts.
...
The Guests’ Strand is down to earth and sceptical, gives its advice in the form of maxims and similes, frequently makes reference to the behaviour of the wise or unwise man, never makes use of the second imperative (only thrice of the verb \emph{skalt} ‘(thou) shalt’, 44--46), and has a perfectly fitting conclusion in sts.~76--77.
On the other hand the Speeches of Loddfathomer places great emphasis on magical or even superstitious ideas, gives its advice directly by means of the second imperative but not with a single mention of the behaviour of the wise man, and is much more varied, concluding with a long list of folk magical remedies in st.~137.  There is also direct repetition between them (most notably sts.~44, 119), which would seem redundant if both were originally a single work.

Since the full \textlink{Havamal}, then, appears to consist of at least a few originally separate compositions, two questions naturally arise: \emph{how} were these materials redacted into a single poem, and \emph{why}?  Any answers must needs be speculative, and so the following is only the translator’s own speculation.
...
The Strand is not clearly divided into thematic sections, but there is still a tendency towards groups of stanzas dealing with certain subjects and a progression from the more general theme of the guest to increasingly more abstract concerns like friendship, wisdom, and finally death and legacy; still, previous subjects often reappear after having been dropped for a few stanzas.  There are some also fine transitions employed in order to move from one theme to another (e.g. between sts.~4--5, or 10--11).

The spirit of the advice is very consistent throughout, and at all turns counsels caution and moderation.  Of particular importance is the idea of “manwit” (ON \emph{man-vit}), or knowledge about the proper conduct in various situations; this encompasses being silent rather than speaking nonsense, not indulging in food or drink, and so forth.

It seems very likely that the original Guests’ Strand ended with sts.~76--77.  This finds support internally in the thematic conclusion of death (whereas sts.~78 and 79 deal with wealth and love, and st.~80 is very divergent) and externally in \Hakonarmal\ 21, the final st.~of that poem, which most likely borrows its first two lines (\emph{dęyr fé \hld\ dęyja frę́ndr}) from \textlink{Havamal}[76]--77.

\bvg\bva\mssnote{\Regius~3r/4}%
\alst{G}ȧttir allar \hld\ áðr \alst{g}angi framm &
\ind \edtext{\edtext{of \alst{sk}oða⸗sk \alst{sk}yli,}{\Afootnote{om. \RegiusProse\Trajectinus\Upsaliensis\Wormianus}} &
\ind of \alst{sk}yggna⸗sk \alst{sk}yli;}{\lemma{of skoða⸗sk skyli / of skyggna⸗sk skyli ‘he should sry round / he should pry round’}\Bfootnote{I have borrowed the English translation of these two lines from \textcite{Bray1908}.}} &
...
\bvb Fire is of use for him who has come inside \\
\ind and is cold about his knees. \\
Food and of clothing are of use for the man \\
...
\bvb Water is of use for him comes for a meal, \\
\ind a towel and a hearty welcome, \\
...
at \edtrans{\alst{au}ga-bragði}{The subject of glances}{\Bfootnote{Idomatic.  \emph{auga-bragð} literally means ‘blink of an eye, moment’; the sense here is thus something like ‘a quick glance of derision’.}} \hld\ verðr sá’s \alst{ę}kki kann &
...
\ind \edtrans{mę́li \alst{þ}arft eða \alst{þ}ęgi}{ought to speak the needful or shut up}{\Bfootnote{This line occurs identically in \textlink{Vafthrudnismal}[10]/2.}}; &
...
The man who nothing knows knows not \\
...
\bvb He who never shuts up speaks quite enough \\
...
\bvb As the subject of glances shall man not treat another \\
...
\Ballnote{The situation hinted at in this and the following stanza is that two guests---unknown to eachother---have come to the same homestead.  The sense is that when mocked by a stranger it is best not to engage, since the dealing may quickly turn violent.  Cf.~sts.~122, 123, and 125.}%
...
\ind that he yet be flirting with fiends.\evb\evg


\bvg\bva\mssnote{\Regius~4r/1}%
\alst{G}umnar margir \hld\ eru⸗sk \alst{g}agn-hollir, &
\ind ęn \edtrans{at \alst{v}irði \emph{\alst{v}}reka⸗sk}{over food drive each other away}{\Bfootnote{The archaic initial \emph{vr-} in \emph{vreka⸗sk} must be restored for metrical reasons.  this really is quite an archaic feature since the pairing \emph{verðr} ‘food, a meal’, \emph{vreka} ‘drive away’ does not appear to be formulaic and \emph{reka} (< \emph{vreka}) alliterates exclusively with \emph{r-} in the extant Scaldic corpus.  Cf.~\textlink{Havamal}[26]/2 n. above.}}; &
...
\ind for his every meal of meat.\evb\evg
...
nor one with his money so not [...], \\
\ind that the repayments were loathed, if he could accept them.\evb\evg
...
\edtrans{\alst{V}ǫ́pnum ok \alst{v}ǫ́ðum}{With weapons and garments}{\Bfootnote{I.e.~weapons and armour (for the “garments” are probably no silks); friends are supposed to help each other and strengthen their capacity for violence so that they may come to each other’s aid in the future.  This alliterative word-pair is formulaic and in other occurences exclusively refers to implements of war; cf.~e.g. \Beowulf\ 39, where \inx[P]{Shield}’s pyre-ship is loaded with \emph{hilde-wǽpnum \alst\ ǫnd heaðo-wǽdum} ‘war-weapons and battle-garments’.}} \hld\ skulu \alst{v}inir glęðja⸗sk; &
...
\ind and from him thou wilt yet get good: \\
...
\Ballnote{For the stylistic device see st.~50 n. --- The sense of the advice not entirely clear; I take it to mean that a wise man uses careful speech to introduce himself and state his needs, whereas the fool speaks too much and thereby exposes his stupidity and parochial outlook.}%
...
\Ballnote{Man, regardless of his station, should never abuse his power.  No height of political power or physical strength will make him invincible, and such abuses will only earn him enemies.  Of course the historical examples of great men brought down for misuse of their power are endless.  In Germanic legend a notable example is Ermenric, who ruled the vast realm of the Gots with an iron fist (\textlink{Deor}[5]), but was maimed by two young boys after he had their sister trampled by horses (\textlink{Gudrunarhvot}, \textlink{Hamdismal}, Jordanes \emph{Getica} 129).  Consider the expression of \textcite{Hobbes1996}, ch. 13: “Nature hath made men so equall, in the faculties of body, and mind; as that though there bee found one man sometimes manifestly stronger in body, or of quicker mind then another; yet when all is reckoned together, the difference between man, and man, is not so considerable, as that one man can thereupon claim to himselfe any benefit, to which another may not pretend, as well as he. For as to the strength of body, the weakest has strength enough to kill the strongest, either by secret machination, or by confederacy with others, that are in the same danger with himselfe.”}%
...
\ind if at meal-time I needed no meat, \\
...
\Ballnote{The strain of thought continues from the previous st.: even the man whose health is failing can have something in which he can find joy, yet at the same time there is a difference in the nature of things.  In one’s youth good health is often given without working for it, whereas sons, kinsmen, kine, and good works are things one must work for to get and to keep.  The man who neglects his work cannot expect happiness or fortune in old age; indeed, in the end there is no happiness without work.}%
...
\alst{b}lindr es \alst{b}ętri \hld\ an \edtrans{\alst{b}ręnndr}{burned}{\Bfootnote{On the funeral pyre.  The word means ‘dead’ in Old Norse in the same way as “six feet under” in English; for both refer to typical customs of dealing with remains in their respective cultures.  This synonymity is an important argument for dating \Havamal\ to the pre-Christian period, since cremation was reserved for criminals and adulterers in the mediæval Catholic religion, whereas it in \Havamal\ seems to be a culturally neutra way of disposing of the dead.  Cf.~Introduction to the poem and the same use in st.~81 below.}} séi; &
...
\Ballnote{This st.~is most likely a later insert.  It is composed in \Malahattr\ (unlike the surrounding sts.~in \Ljodahattr), its style is unusual, and its content fits poorly in context.}%
...
\ind \edtrans{margr verðr \edtrans{af \alst{au}rum}{from wealth}{\Afootnote{emend. from meaningless \emph{†aflꜹðrom†} \Regius}} \alst{a}pi}{many a man becomes an ape due to wealth}{\Bfootnote{Cf.~\Solarljod\ 34/4: \emph{margan hefr auðr apat} ‘wealth has made an ape of many a man’, which also lends support to the emendation.}}; &
maðr es \alst{au}ðigr, \hld\ \alst{a}nnarr ȯ·auðigr, &
\ind skyli⸗t þann \alst{v}ítka \alst{v}áar.\eva

\bvb The one who nothing knows knows not: \\
\ind many a man becomes an \inx[C]{ape} due to wealth. \\
...
\Ballnote{Sts. 78--80 are poorly placed and seem like later inserts.  78--79 at least resemble the general content of the Guests’ Strand (although see 79/2 n.), but 80 is a true enigma.}%
...
\ind \alst{f}é eða \edtrans{\alst{f}ljóðs}{maid}{\Bfootnote{The poem’s first mention of the fair sex; this indicates that this st.~does not in fact belong to the original Guests’ Strand.}} mun-úð; &
...
\alst{m}ę́ki es ręyndr es, \hld\ \edtrans{\alst{m}ęy es gefin}{a maiden when she is given}{\Bfootnote{A young woman’s chastity should not be praised until she has been given in marriage and (it is implied) is proven a virgin.}} es, &
...
\alst{h}ęima \alst{h}ęst fęita, \hld\ ęn \alst{h}und ȧ búi.\eva
