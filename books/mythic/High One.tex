...
In this progression the poet often makes use of transitions in order to move from one theme to another (e.g. between sts.~4--5, or 10--11), but even still, previous subjects often reappear after having been dropped for a few stanzas.
...
at \edtrans{\alst{au}ga-bragði}{The subject of glances}{\Bfootnote{Idiomatic.  \emph{auga-bragð} literally means ‘blink of an eye, moment’; the sense here is thus something like ‘a quick glance of derision’.}} \hld\ verðr sá’s \alst{ę}kki kann &
...
\ind \edtrans{\alst{þ}unnu hljóði}{with sharp hearing}{\Bfootnote{Or ‘with thin silence’.}} \edtrans{\alst{þ}ęgir}{shuts up}{\Bfootnote{The importance of silence and not speaking frivolously is further brought up in sts.~17, 19, 22, 26--31, 45, 46, 63, 65, 73, 103, 117, 124, 125, 132--135.}}; &
...
\ind \alst{l}of ok \edtrans{\alst{l}íkn-stafi}{friendly words}{\Bfootnote{A cpd.~of \emph{líkn} + \emph{stafr}.  \emph{líkn} is defined by \ONP\ as: ‘mercy, compassion, relief, comfort, help’; cf.~its two other occurrences in the present poem: st.~120 and especially st.~123, where it is likewise paired with \emph{lof} ‘praise’.}}; &
\alst{ȯ}·dę́lla ’s við þat, \hld\ es \alst{ęi}ga skal &
\ind \alst{a}nnars brjóstum \alst{ï}.\eva

\bvb This one is blessed, who for himself does earn \\
\ind praise and friendly words. \\
...
\bvb It is not as good as they call it good, \\
...
\Ballnote{The coward may have been spared pain by the spears, but he cannot avoid the suffering of infirm old age (which in a world before modern medicine was even greater than today, consider only the loss of teeth); \emph{it} will never spare him.
The subtext is that since death is unavoidable it is better to live an honourable life and die young than a cowardly one and die of old age.  A related concept is the negative view of the \emph{strá-dauði} ‘straw-death’ (actually a hapax, only attested in \emph{Korm} 85, \Skp\ 5), i.e., a death in bed from old age or sickness.  Compare the speech attributed to the 10th century warrior Eyel Woolserk before a battle (\HakonarSaga\ 23): \emph{Þat óttuðumk ek um hríð, er friðr þessi inn mikli var, at ek mynda verða elli-dauðr inni á pall-strám mínum; en ek vilda heldr falla í orrostu ok fylgja hǫfðingja mínum; kann nú vera, at svá megi verða.} ‘I long feared while this great peace lasted that I would die of old age indoors upon my straw bed, but I would rather fall in battle and follow my chieftain; now it may be that it turns out so.’  A similar contempt for life is common in the older heroic literature (e.g. \textlink{Fafnismal}[10], \textlink{Atlakvida}[23]--27), written as it was to celebrate (the lives of) young kings and warriors.  Still, it must be said that \Havamal\ is uniquely nuanced in this regard (cf.~sts.~69--71 below), probably since its author was himself an old man and not a young warrior-poet.}%
...
\edtrans{\alst{H}aldi⸗t maðr ȧ kęri}{Man ought not to hold onto the cask}{\Bfootnote{This line has been variously interpreted but is generally understood (cf.~\cite[158--165]{Olsen1938}) as referring to a type of toast.  Finnur Jónsson suggests that we are dealing with a \emph{svęitar-drykkja} ‘company-toast’ where the drinking vessel would be passed around in a circle and each recipient would drink in turn \parencite[160--161]{Olsen1938}.  Such toasts were drunk for a long time in Northern Europe and indeed this is the origin of the Scandinavian toasting-word, \emph{skål} ‘prosit, cheers!’, lit.~‘bowl!’  “Holding onto” the vessel (and not letting the next person drink) would surely be seen as very rude, so the sense is that one should drink his share, but not too much; indeed, in 1519 a man in Jämtland was killed in an argument resulting from his refusal to pass on the bowl during a similar toast \parencite{Sjöberg1907}.

\textcite{Olsen1938}[161--165], who was not aware of the 1519 legal proceeding, doubts that such a delay could happen, and in any case thinks that it would not occur often enough to justify a warning against it.  He instead argues that the line refers to a type of drinking where each man is holding his own smaller legless horn which cannot be put down except emptied; “holding onto” the horn would thus be referring to holding a half-full horn in one’s hand rather than drinking up and getting refills.  The sense of the whole stanza would then be that when one is at a party it is best to keep with the festive spirit and keep drinking, rather than act “uncouthly” by sitting with a half-full horn and refusing to drink.  One should still not drink too much, but rather than “holding onto” a horn it is better simply to go to sleep when one feels he has drunk enough.}}, \hld\ drikki þó at \alst{h}ófi mjǫð, &
...
\edtrans{\alst{B}ú es \alst{b}ętra, \hld\ þó’tt lítit séi}{A dwelling is better though small it be}{\Bfootnote{The b-verse is missing the necessary alliteration, but no good emendation suggests itself. --- bętra ‘better’ | Better than the alternative.}}, &%NOTE: 2nd note is sort of a hack!
\ind \alst{h}alr es \alst{h}ęima \alst{h}vęrr; &
þó’tt \alst{t}vę́r gęitr ęigi \hld\ ok \edtrans{\alst{t}aug-ręptan sal}{a cord-roofed hall}{\Bfootnote{A hut with ropes instead of proper wooden rafters.}}, &
...
\Ballnote{The sense is that the poet has found no man so generous that he would refuse a gift formally presented to him or decline a small present as thanks for his generosity.}%
...
\edtrans{\alst{V}ǫ́pnum ok \alst{v}ǫ́ðum}{With weapons and garments}{\Bfootnote{I.e.~weapons and armour (for the “garments” are probably no silks); friends are supposed to help each other and strengthen their capacity for violence so that they may come to each other’s aid in the future.  This alliterative word-pair is formulaic and in other occurrences exclusively refers to implements of war; cf.~e.g. \Beowulf\ 39, where \inx[P]{Shield}’s pyre-ship is loaded with \emph{hilde-wǽpnum \hld\ ǫnd heaðo-wǽdum} ‘war-weapons and battle-garments’.}} \hld\ skulu \alst{v}inir glęðja⸗sk; &
...
\ind though thou wilt get good things from him: \\
...
ęn \edtext{\alst{ȯ}·snjallr}{\linenum{|3|||4}\lemma{ȯ·snjallr, gløggr ‘unvalorous, stingy’}\Bfootnote{Contrasting respectively with \emph{frǿkn, mildr} ‘brave, generous’ in the first half of the stanza; very fine parallelism.}} maðr \hld\ \alst{u}ggir hvat-vetna, &
...
\Ballnote{For the stylistic device see st.~50 n. --- The sense of the advice is not entirely clear; I take it to mean that a wise man uses careful speech to introduce himself and state his needs, whereas the fool speaks too much and thereby exposes his inexperienced and naive character.}%
...
\Ballnote{The sense is that man knows best those things on which he depends for his survival.}%
...
\Aallnote{Sts.~62--63 are reversed in \Regius, but a symbol at the start of each indicates that they should switch places.}%
...
\Ballnote{In reality there was nothing wrong with the ale, that was a mere pretext---the problem was with the people themselves.  There are no wrong times, only wrong people, and it is bad to waste one’s time where one is unwanted.}%
...
\Ballnote{Sts.~68--77 largely form a thematic unit, reflecting on life, legacy, and lastly death. --- The poet celebrates simplicity.  The best pleasures in life are not power and wealth, but a hot hearth, the bright rays of the sun in springtime, and living in good health.}%
...
\Ballnote{The strain of thought continues from the previous st.: even the man whose health is failing can have something in which he can find joy, yet at the same time there is a difference in the nature of things.  In one’s youth good health is taken for granted but the comforts of infirm old age---sons, kinsmen, kine, and good works---are things one must work for to get and to keep.  The man who neglects these things cannot expect happiness or fortune in old age; indeed, in the end there is no happiness without effort.}%
...
\alst{b}lindr es \alst{b}ętri \hld\ an \edtrans{\alst{b}ręnndr}{burned}{\Bfootnote{On the funeral pyre.  The word ‘burned’ here means ‘dead’ in the same way as “six feet under” in modern English; both refer to typical customs of dealing with human remains in their respective cultures.  This synonymity is an important argument for dating \Havamal\ to the pre-Christian period, since cremation was reserved for criminals and adulterers in the mediæval Catholic religion (cf.~\textlink{Atlamal}[84]/1), whereas it in \Havamal\ seems to be the commonly accepted way of disposing the dead \parencite[93--96]{Males2024Hav}.  Cf.~Introduction to the poem above and the same semantics in st.~81 below.}} séi; &
...
\Ballnote{It is a boon and a blessing for a man to have a son, even if the father should die before his son is born.  The son will inherit and carry on his father’s name, lineage, and memory in a way no non-relative can, as exemplified by the raising of a stone memorial.  In a broader context we might consider how it is only a tiny few out of the great human masses who will leave behind any kind of lasting personal legacy beyond their direct familiar relations.  The current generation must soon die off, and even those who in their lifetimes see influence and success in their fields and careers are soon forgotten by posterity and relegated to the footnotes of the annals of history if they have no descendants to carry their names into future ages.  It is rare for non-kin to tend a grave.}%
\alst{S}onr es bętri, \hld\ þó’tt séi \alst{s}íð of alinn &
\ind ęptir \alst{g}inginn \alst{g}uma; &
sjaldan \edtrans{\alst{b}autar-stęinar}{beat-stones}{\Bfootnote{Generally uninscribed standing stones raised in memory of the dead, which appear frequently in Norse literature.  Cf.~\YnglingaSaga\ 8, which describes the laws instituted by the euhemerized Weden: \emph{en eptir alla þá menn, er nǫkkut manns-mót var at, skyldi reisa bauta-steina, ok held⸗sk sjá siðr lengi síðan.} ‘but in memory of all those men who had possessed masculine virtue beat-stones should be raised, and that custom was upheld for a long time since’.  Standing stones are very common throughout Scandinavia and are not infrequently found near grave-mounds.

It must be noted that the raising of unmarked stones long precedes the runestone boom of the Wiking Age.  The older, unmarked stones are also more often found in direct funerary contexts, which is rarely the case with Wiking Age runestones, which on the other hand tend to be placed near important roads as memorials.  In Norway during the Migration Period this distinction between beat-stone and rune-stone was somewhat blurred, and a large number of runestones from about the 2nd to 5th centuries are placed near grave fields.  Unlike the later Wiking Age inscriptions these often hold only single personal names or genitive phrases, like KJ 90 from Sunde in Sunnfjord, western Norway: ᚹᛁᛞᚢᚷᚨᛊᛏᛁᛉ \textbf{widugastiʀ} ‘Woodguest’, or KJ 78 from Bø in Rogaland, southwestern Norway: ᚺᚾᚨᛒᛞᚨᛊ ᚺᛚᚨᛁᚹᚨ \textbf{hnabdas hlaiwa} ‘Naved’s grave’.  Others do have longer inscriptions, e.g.~KJ 75 from Kjølevik, also in Rogaland: ᚺᚨᛞᚢᛚᚨᛁᚲᚨᛉ ᛖᚲᚺᚨᚷᚢᛊᛏᚨᛞᚨᛉ ᚺᛚᚨᚨᛁᚹᛁᛞᛟᛗᚨᚷᚢᛗᛁᚾᛁᚾᛟ \textbf{hadulaikaz ekhagustadaz hlaaiwidomaguminino} ‘Handlac [lies here].  I, Haystald, buried my lad.’}} \hld\ standa \alst{b}rautu nę́r, &
...
\Ballnote{The tongue and head belong to the same body, but the former often leads to the demise of the latter and thereby itself; it is best to be cautious. --- This st.~is most likely a later insert.  It is composed in \Malahattr\ (unlike all surrounding sts., which are in \Ljodahattr), its style is unusual, and its content fits poorly in the context which at this point in the poem has moved away from the theme of cautious speech.}%
...
\Ballnote{It is best to rely on things in one’s control, here the provisions man carries with him when at sea (cf.~sts.~11, 116).  The man at the mercy of the forces of nature can never sleep safe and sound at night. --- In ll. 3--4 two names of Weden, a notably fickle god (cf.~st.~110), may be subtextually implied; the st.~may then also be taken as a warning against resigning one’s fate totally to the gods, who are perhaps not always trustworthy.}%
...
\ind \alst{h}verf es \edtrans{\alst{h}aust-grïma}{stormy fall night}{\Bfootnote{Lit. ‘fall-mask’, a cpd. \emph{haustr} ‘fall, autumn’ + \emph{grïma} ‘mask’.  It paints an image of the dark cloudy evening or night-sky, the thick dark clouds being the metaphorical ‘mask’.  Cf.~Weden’s names \emph{Grïmr} ‘Grime; Mask’, \emph{Grïmnir} ‘Grimner; the Masked One’ (\textlink{Grimnismal}[47], 50).}}; &
\edtrans{\alst{f}jǫlð of viðrir}{The winds blow far}{\Bfootnote{I.e., ‘the weather changes much’, ON \emph{(of) viðra} being a causative verb derived from \emph{veðr} ‘wind, storm’.  Cf.~Weden’s name \emph{Viðrir} ‘Withrer; Stormer, Man of the Storm’, which is most likely an agent noun formed to the same verb.}} \hld\ ȧ \edtrans{\alst{f}imm dǫgum}{five days}{\Bfootnote{I.e.~‘a week’ (which was originally five days long), paralleling ‘month’ in the next line.  See note to st.~51 above.}}, &
...
\Ballnote{It is likely that sts.~76--77 concluded the original Guests’ Strand.  This is supported internally by their tone of finality and their reflections on death, and externally by the fact that \Hakonarmal, composed ca. 961 \ce, borrows the first line of its final stanza 21 (\emph{dęyr fé \hld\ dęyja frę́ndr}) from these two sts.~ The sense of both stanzas is that all man’s earthly power will pass away as he does, but a good reputation, fame and glory can linger on.}%
...
\ind \edtrans{\alst{d}ȯmr}{Doom}{\Bfootnote{Here meaning ‘glory’.  See Index.}} umb \alst{d}auðan hvęrn.\eva
...
\ind now they carry the staff of want. \\
...
\bvb Come evening shall one praise a day, a woman when she is burned, \\
...
Mǫrg es \edtrans{\alst{g}óð mę́r}{good maiden}{\Bfootnote{The “goodness” here surely refers to faithfulness and chastity.  Cf.~\textlink{Skirnismal}[12].}}, \hld\ ef \alst{g}ǫrva kannar, &
...
Hǫ̇n svá \alst{g}ørir \hld\ at \edtrans{\alst{g}ȧir}{heed}{\Bfootnote{The nasal vowel in this verb is attested in Elfdalian \emph{gą̊}.}} ęigi &%TODO: ą̊ does not render properly
...
\ind firmly liked through his praise.\evb\evg
...
\Ballnote{If somebody reveals himself to be your enemy (e.g.~by putting a curse on you) then acknowledge it and act decisively; do not tolerate minor or underhanded insults because they may soon escalate if not dealt with early. --- This st.~has often been interpreted as a command to call out evil or injustice even when committed towards somebody else, and while there is nothing that speaks decisively against such a reading, it does not agree with the cautious and shrewd spirit of \textlink{Havamal}.}%
\alst{R}ǫ́ð⸗umk þér Lodd·fáfnir, \hld\ ęn \alst{r}ǫ́ð nemir, &
\ind \alst{n}jóta munt ef \alst{n}emr, &
\ind þér munu \alst{g}óð ef \alst{g}etr: &
...
\ind \edtrans{ęn lát þér at \alst{g}óðu \alst{g}etit}{but rather let thyself be pleased by good}{\Bfootnote{This construction is equivalent to \CV: \emph{geta}, A. IV. with acc.}}.\eva

\bvb \emph{I counsel thee, Loddfathomer---and thou oughtst to learn the counsels; \\
\ind thou wilt profit if thou learnest, \\
\ind they will be good for thee if thou gettest:} \\
In that which is bad do never rejoice, \\
...
Þat kann’k \alst{s}jaunda, \hld\ ef \alst{s}é’k hǫ́van \edtrans{loga}{blazing}{\Bfootnote{The word order makes this word look like the noun \emph{logi} ‘flame’ (“if I see a high flame”), but the noun modified by the adj. \emph{hǫ́van} ‘high’ is in fact \emph{sal} ‘hall’, and \emph{loga} is a verb ‘to blaze’.}} &
...
\alst{ȧ}sa ok \alst{a}lfa \hld\ ek kann \alst{a}llra \edtrans{skil}{distinctions}{\Bfootnote{Their unique attributes.  Cf.~\textlink{Hymiskvida}[38], where the corresponding verb \emph{skilja} ‘to discern, understand’ is used in the context of god-lore.}}, &
