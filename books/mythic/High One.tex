...
\subsection{Meter and formal characteristics}
...
Es⸗at maðr \alst{a}lls \edtrans{ve-sall}{unhappy}{\Bfootnote{I have elsewhere translated \emph{ve-sall} as ‘wretched’, but in the present stanza I render it literally in order to show the etymological relationship to \emph{sę́ll} ‘happy’ used elsewhere in the stanza.  The form \emph{-sall} lacks i-umlaut due to a shortening of the vowel before the umlaut became phonemic; the ancestral Proto-Norse form would be \emph{*wajē-sāliʀ}, for which cf.~ᚹᚨᛃᛖ-ᛗᚨᚱᛁᛉ \emph{wajē-mariʀ} ‘infamous’ on the Tjurkö bracteate where the second element is the ancestor of ON \emph{mę́rr} ‘renowned, famous’; the expected descendant of that word, ON \emph{**ve-marr}, is not attested.

I translate \emph{sę́ll} as ‘happy’, but it could also be rendered as ‘lucky’ or ‘blessed’ based on the fact that it carries a certain sense of innateness largely foreign to post-Enlightenment Western culture.  Compare here the idea of the king’s ‘luck’ (ON \emph{gipt}), which is thought to emanate from his person and shine over his land;
...
\bvb Man is not all unhappy though he be of poor health: \\
\ind someone becomes happy from sons, \\
...
\ind ęn úti vas \alst{d}auðr fyr \alst{d}urum.}{\lemma{ęld \dots\ durum. ‘A fire \dots\ the doors.’}\Bfootnote{The fire imay be taken to be the man’s funeral pyre burning on his farm, on which a considerable amount of his wealth has been spent---according to ibn Fadlan’s 10th c.~account of the Rus a third of a dead chieftain’s wealth was spent on his funeral clothes and another third on alcohol for the wake (\cite[49]{LundeStone2012})---yet in spite of the great fire he is just as dead.  The following stanza continues this thought.}}\eva
...
sjaldan \edtrans{\alst{b}autar-stęinar}{beat-stones}{\Bfootnote{Large standing stones raised in memory of the dead.  They appear frequently in Norse literature.  Cf.~\YnglingaSaga\ 8, which describes the laws instituted by the euhemerized Weden: \emph{en eptir alla þá menn, er nǫkkut manns-mót var at, skyldi reisa bauta-steina, ok held⸗sk sjá siðr lengi síðan.} ‘but in memory of all those men who had been like men should beat-stones should be raised, and that custom was upheld for a long time since’.
