...
\Ballnote{For the rhetorical trick see st. 50 n. — The sense of the advice not entirely clear; I take it to mean that a wise man uses careful speech to introduce himself and state his needs, whereas the fool speaks too much and thereby exposes his stupidity and parochial outlook.}%
...
\Ballnote{The strain of thought continues from the previous st.  Even the man whose health is failing has something in which he can find joy.}%
...
I translate \emph{sę́ll} as ‘blessed’, but it is not a past participle and could also be rendered as ‘lucky’ or ‘happy’; the translation ‘blessed’ is based on the fact that it carries a certain sense of innateness largely foreign to post-Enlightenment Western culture.  Compare here the idea of the king’s ‘luck’ (ON \emph{gipt}), which is thought to emanate from his person and shine over his land;
...
sumr af \alst{f}rę́ndum}{\lemma{sonum \dots\ frę́ndum ‘sons \dots\ kinsmen’}\Bfootnote{Cf.~st. 72 below, which stresses the importance of sons and kinsmen.  The gendered perspective may be noted.}}, \hld\ sumr af \alst{f}é ǿrnu, &
