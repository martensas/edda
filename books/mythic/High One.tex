...
The \textbf{Speeches of the High One} (abbrev. \textlink{Havamal}) is the second poem of \Regius, where it follows \textlink{Voluspa} and is followed by \textlink{Vafthrudnismal}.  \Regius\ is the only mediæval manuscript witness for the whole poem, but several sts.~(1, 58, 76--77, 84) are cited or alluded to in other texts.
