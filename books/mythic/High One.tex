...
\ind ï \alst{g}arði \alst{G}unn·laðar.}{\lemma{þęss fogls fjǫðrum \hld\ ek fjǫtraðr vas’k ï garði Gunn·laðar ‘By that bird’s feathers I was fettered in Guthlathe’s yard.’}\Bfootnote{The first use of the first-person pronoun in the poem. ---
...
\ind sïns of \edtext{\alst{m}ál*}{\Afootnote{gramm.~emend.; \emph{máls} \Regius}} \alst{m}aga.\eva
...
ęn \alst{ȯ}·vinar sïns \hld\ skyli \alst{ę}ngi maðr &
...
\ind opt kaupir sér ï \alst{l}ítlu \alst{l}of; &
...
\ind ęn til \alst{s}íð ï \alst{s}uma; &
...
es mér ï \alst{h}eðin \alst{h}vęrn \hld\ \edtrans{\alst{h}andar}{a hand}{\Bfootnote{Holding a dagger.}} vę̇ni.\eva
...
\ind \alst{h}verf es \edtrans{\alst{h}aust-grïma}{stormy fall night}{\Bfootnote{Lit. ‘fall-mask’, a cpd.~of \emph{haustr} ‘fall, autumn’ + \emph{grïma} ‘mask’.  The word paints an image of the dark cloudy evening or night-sky, the thick dusky clouds being the metaphorical ‘mask’.  Cf.~Weden’s names \emph{Grïmr} ‘Grime; Mask’, \emph{Grïmnir} ‘Grimner; the Masked One’ (\textlink{Grimnismal}[47], 50).}}; &
...
\ind \edtext{\alst{b}rigð}{\Afootnote{\emph{ok brigð} \textup{1768}}} ï \alst{b}rjóst of \edtext{lagit}{\Afootnote{\emph{lagin} \textup{1768}}}.}{\lemma{því’t \dots\ lagið}\Bfootnote{Quoted in slightly divergent form in \FostrbroedhraSaga\ (ms. Thott 1768 4°, fol. 210r--v), where it is introduced with the words: \emph{Kom honum þá í hug kviðlingr sá, er kveðinn hafði verit um lausungar-konur:} ‘And then he remembered the ditty which had been composed about loose women:’}}\eva
...
If ‘the day after the wedding night’ is in fact the sense of \emph{hindra dagr} in the present stanza, two interpretations are possible: (1) Weden refers sarcastically to the day after he slept with Guthlathe, as would be done during the wedding night.  (2) Weden actually married, or promised to marry, Guthlathe.  The latter interpretation may find further support in the “bigh-oath” of st.~110, but Guthlathe is never referred to in any surviving Norse sources as Weden’s wife, only his lover (Steinþ Frag 1 (\Skp\ 3)).}} \hld\ gingu \alst{h}rïm-þursar &
...
\ind \alst{n}jóta munt ef \alst{n}emr, &
\ind þér munu \alst{g}óð ef \alst{g}etr: &
\edtrans{\alst{f}jǫl-kunnigri}{manicunning}{\Bfootnote{F.~dat.~sg.~of \emph{fjǫl-kunnigr} ‘sorcerous’, an adj.~used of both men and women.}} konu \hld\ skal⸗at-tu ï \alst{f}aðmi sofa, &
