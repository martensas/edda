...
\ind ęn úti vas \alst{d}auðr fyr \alst{d}urum.}{\lemma{ęld \dots\ durum. ‘A fire \dots\ the doors.’}\Bfootnote{The fire is probably the man’s funeral pyre burning on his farm, on which a considerable amount of his wealth has been spent (according to ibn Fadlan’s account of the Rus (TODO) two thirds of a dead chieftain’s estate were spent on his lavish funeral), but in spite of which he is just as dead.  The next stanza continues this thought.}}\eva
...
\begin{small}
	...
	Having drunk the mead, he dons his eagle-hame and flies away from the mountain.  Sutting sees him, takes his own eagle-hame, and gives chase.  The Eese see the chase overhead and set out several large vats on the ground, into which Weden, still flying, spits out the mead. At this point Sutting has almost caught up with him, and so Weden “sends back” (\emph{senda aptr}, viz.~from behind) some of the mead, presumably into Sutting’s face.

	The mead caught in the vats is given to the Eese and to skilled poets (\emph{þeim mǫnnum, er yrkja kunnu} ‘those men who can compose verse’) but the portion which was “sent back” becomes the lot of bad poets (\emph{skald-fífla hlutr}).
	\end{quote}
\end{small}
...
Having discussed non-Norse parallels to the relevant myth we may now turn to its form in the present stanzas and how this differs from \Skaldskaparmal\ 5--6.  To begin with, the biggest difference between the treatment of the myth in \Skaldskaparmal\ and \Havamal\ is that the latter is very opaque; far from being a linear retelling of events, the narrative thread is actually quite difficult to follow, especially without the help of \Skaldskaparmal.
Notably, the Eagle, one of the key details shared between \Skaldskaparmal\ and the Vedic hymns, is not found in \Havamal.  Other important \Skaldskaparmal\ elements, like Quasher, the two dwarfs, and Baye, are also missing.  It is thus clear that Snorre’s narrative cannot be exclusively based on \textlink{Havamal}, but must either rely on other, now-lost sources or be invented by him.  That the former hypothesis is the correct one is proven by the large number of kennings for \textsc{poetry} found in the Scaldic corpus; these rely on the narrative as told in \Skaldskaparmal, but predate that text (ca. 1220) by up to four centuries.
...
The so-called \textbf{Speeches of Loddfathomer} (ON \emph{Loddfáfnismǫ́l}) is a series of advice stanzas addressed to \inx[P]{Loddfathomer}, an otherwise unknown figure who is clearly fictional.  His name is a compound of \emph{lodd-,} apparently related to ON \emph{loddari} ‘juggler, tramp’, OE \emph{loddere} ‘pauper, beggar’ + \emph{Fáfnir} ‘\inx[P]{Fathomer}’, literally ‘embracer’, the name of the famous \inx[C]{wyrm}.
The name thus paints the picture of an archetypal greedy fool in desperate need of the wisdom taught by Weden, his intellectual superior.  Loddfathomer reappears in st.~164, which reveals that the galders of 147--165 are also addressed to him, but he is not found outside of \textlink{Havamal}.  If he belongs to a lost mythological or legendary episode he most likely played a similar role to king Heathric in \HervararSaga\ 10.

The content of the advice in this section is generally similar and sometimes identical to that found in the Guests’ Strand (1--79) above, but some items are of a superstitious or religious nature (e.g. 113--114, 126, 129, 137), a topic the Guests’ Strand tends to avoid.

\sectionline

\bvg\bva\mssnote{\Regius~6r/14}%
\edtext{Mál}{\Afootnote{The \emph{M} takes up a single line in height but the right leg curves down to the line below; is noticably thicker than the capitals introducing individual sts.~but smaller than the initials introducing separate poems in \Regius.}} ’s at \edtrans{\alst{þ}ylja}{thill}{\Bfootnote{To ‘recite, chant’, the verb corresponding to \emph{þulr} ‘thyle’.}} \hld\ \edtrans{\alst{þ}ular}{thyle}{\Bfootnote{The reciter, chanter of ancient lore.  See Index.}} stóli ȧ; &
...
thou wilt not have meat nor any man’s pleasure; \\
...
\ind ok nem \edtrans{\alst{l}íknar-galdr}{galders of kindness}{\Bfootnote{Presumably metaphorical, i.e.~ways of speaking which will make one liked.}} meðan \alst{l}ifir.\eva
...
\Ballnote{If somebody reveals himself to be your enemy (e.g.~by putting a curse on you) then acknowledge it and act decisively; do not tolerate minor or underhanded insults because they may soon turn violent.  This st.~has often been interpreted as a command to call out evil or injustice even when committed towards somebody else, and while there is nothing that speaks decisively against such a reading, it probably does not agree with the cautious and shrewd spirit of \textlink{Havamal}.}%
\alst{R}ǫ́ð⸗umk þér Lodd·fáfnir, \hld\ ęn \alst{r}ǫ́ð nemir, &
\ind \alst{n}jóta munt ef \alst{n}emr, &
\ind þér munu \alst{g}óð ef \alst{g}etr: &
...
\Ballnote{The myth of Weden’s self-sacrifice (“the Hanging”) is told only here and nowhere else.  Still, the god has a strong association with hanging throughout the Norse corpus.  He is known as \emph{Hangi} ‘Hanged One’ (Tindr \emph{Hákdr} 1/5 in \Skp\ 1, cf.~note there), \emph{Hanga-týr} ‘Tew of Hanged Ones’ (\Skaldskaparmal\ 7), and \emph{Hanga-guð} ‘God of Hanged Ones’ (\Gylfaginning~20:10).  In st.~158 below he speaks of bringing a hanged man’s corpse back to life.
...
This passage makes Balethorn’s son Weden’s maternal uncle and the present st.~is thus an instance of the old Indo-European custom of sending sons away to be fostered by the mother’s male relations.  Cf.~TODO: some reference on this practice.}} &
...
\Ballnote{There is maybe something reminiscent of the Aristotelian \textgreek{εὐδαιμονῐ́ᾱ} in the whole stanza.  After Weden attained his wisdom he flourished; good speeches and deeds multiplied.}%
...
\edtrans{\alst{R}u̇nar munt finna \hld\ ok \alst{r}áðna stafi}{Runes wilt thou find and counselled staves’}{\Bfootnote{A close parallel is found in the long-line on the mediæval runestone N 13: \emph{ru̇nar ek ríst \hld\ ok ráðna stafi} ‘runes I carve and counselled staves.’}}, &
...
\Ballnote{The first four verbs refer to runes: carving, interpreting, colouring, and divining, the latter four to sacrifice: praying, worshipping, sending (the sacrifice or the prayer), and killing (the victim). --- The meter of this st.~is unusual, but bears some resemblance to Vg 216 (the Högstena galder). TODO: Elaborate.}%
...
I agree with \textcite{Males2024} on the interpretation of this stanza: since a gift always requires recompense, an excessive sacrifice imposes an excessive debt on the part of the god to whom it is addressed, which might upset the sacrificer’s relationship with the god.  Males draws the analogy with an episode in \EgilsSaga, where a rival poet leaves an expensive shield for the protagonist Eyel before riding off; the latter understands this as a demand to compose a poem about the shield and is greatly insulted.
...
\ind \edtext{[...]}{\Bfootnote{No gap is indicated in the ms., but the meter requires a c-verse in this position.  Its loss is most unfortunate since the pres.~st.~is an unusual look into pre-Christian religious attitudes.}}\eva
...
A vivid description of the witches’ ride with is found in the OSwe.~Elder Westgeatish Law (ca.~1250 \ce), RB 5:5 (my norm.): \emph{Þętta ęru ú·kvęðins-orð konu. ‚Iak sá, at þú rêt á kví-grindu lǿs-hárað ok í trolls ham, þá alt var iam-ript nátt ok dagr.‘ Kallar hana kunna firi·gęra konu ęllr kó, þęt ęr ú·kvęðins-orð. [...]} ‘These are words of insult to a woman: “I saw that thou rodest on the sheep-pen-fence loose-haired and in a troll’s hame when everything was equally divided between day and night.”  If he says that she knows how to destroy (with magic) a woman or a cow, that is a word of insult.’  It may be noted that the ms.~word \emph{quiggrindu} ‘sheep-pen-fence’ (dat.~sg.) has also been interpreted as \emph{kvíð-grindu} ‘womb-opening’, i.e.~the woman’s (bared) nether parts, the implication of which will be left to the reader; see \textcite[224--228]{Sjöros1919} for an overview.}
...
\Ballnote{This stanza is of great weight since it gives the whole poem a religious significance.  The memorisation and singing of the whole \Havamal\ will spiritually benefit mankind, but injure the Ettins, the enemies of Gods and men.  The dualistic worldview is thoroughly pre-Christian and the implied performance context is oral.  Cf.~further Introduction above.}%
