...
The idea of “undying fame” is an ancient Indo-European conception, and features prominently in Homer, the Greek lyric poets, the \Rigveda, and the Irish saga-cycles.  TODO: \emph{*ḱléwos ń̥·dʰgʷʰitom}.}%
\alst{D}ęyr \edtext{fé}{\lemma{fé, frę́ndr ‘Kine, kinsmen’}\Bfootnote{In the Germanic Iron Age farming society a man’s wealth was reckoned by how many heads of cattle (and the Norman loan-word \emph{cattle} is itself the same word as \emph{capital}) he owned, his social power by the number of able male kinsmen and friends ready to side with him in conflict (cf.~st.~72 above and TODO: reference?).  For Indo-European poetic analogues, cf.~\textcite[99--100]{West2007}.}}, \hld\ \alst{d}ęyja frę́ndr, &
...
\ind \edtrans{\alst{d}ȯmr}{Doom}{\Bfootnote{Here meaning ‘fame’.  See Index.}} umb \alst{d}auðan hvęrn.\eva
