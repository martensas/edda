...
\ind þann \edtrans{eta}{hurt}{\Bfootnote{Properly ‘eat’, but the verb here means ‘hurt, injure’.}} \alst{m}ęin hęldr an \alst{m}ik.\eva
...
Þat kann’k \alst{s}jaunda, \hld\ ef \alst{s}é’k hǫ́van \edtrans{loga}{blazing}{\Bfootnote{The word order makes this word look like the acc.~of the m.~noun \emph{logi} ‘flame’ (i.e., “if I see a high flame”), but the noun modified by the adj. \emph{hǫ́van} ‘high’ is in fact \emph{sal} ‘hall’, and \emph{loga} is the verb ‘blaze, burn’.}} &
