...
\begin{flushright}%
\textbf{Dating} \parencite{Sapp2022}: C13th (0.280)
...
The \textbf{Thule of Righ} (abbrev.~\Rigsthula) is an incomplete narrative poem describing the origin of the social classes and the monarchy.

\subsection{Textual preservation and transmission}

\Rigsthula\ is preserved only on a single folio (78rv) in the 14th century ms. \Wormianus, where it follows the Prose Edda and four grammatical treatises all written in the same hand as the poem.

Numerous leaves are unfortunately missing from the original \Wormianus, and among them the conclusion to \Rigsthula.  Still, part of what would have been found in the lost part of the poem can be gleaned from parallel sources, as will be dealt with below.
...
\Rigsthula\ is a powerful and, due to its incompleteness, enigmatic poem.  It has something of the folk-tale about it and serves as an etiology for the origin of the Wiking Age Norwegian class system and a celebration of the superiority of the warrior-nobility.

In the poem the mysterious Righ (ON \emph{Rígr}) fathers in succession three human sons with three women, \emph{Ędda} ‘Great-grandma’, \emph{Amma} ‘Grandma’, and \emph{Móðir} ‘Mother’.  Their respective sons become \emph{Þrę́ll} ‘Thrall’, \emph{Karl} ‘Churl’, and \emph{Jarl} ‘Earl’, each in turn serving as the ancestor for each of the three classes: the slaves, the freeholders or farmers, and the nobility.  In turn, the youngest of Earl’s twelve sons, Kin the young (\emph{Konr ungr}), becomes the first to hold the title of ‘king’ (\emph{konungr}).

\subsubsection{The identity of Righ}

The main mystery of the poem is the obscure figure Righ (\emph{Rígr}), identified in the prose introduction as Homedall.  His name has traditionally been seen as a sign of Irish influence on the basis of Old Irish \emph{rí} (oblique sg. stem \emph{ríg-}) ‘king’.

Righ does not appear in any other poetic source, but his name is found in two related genealogies: in \YnglingaSaga\ 17 and in the epitome of the lost \emph{Skjǫldunga saga}, both of which are included in the Appendix to the poem below.
...
In the parallel sources these two figures are ancestral to the later Danish and Norwegian monarchies through their relation to Righ, and this was almost certainly the case also in \Rigsthula, as shown by the pun on the name of Kin the young (ON \emph{Konr ungr}) and the title king (\emph{konungr}).  According to \YnglingaSaga\ 17, Righ was the first ruler to be called ‘king’ in the Scandinavian cultural sphere.
...
Although Righ is identified as Homedall in the prose introduction, his role in the poem is really more reminiscent of what we know about the god Weden.  Like Weden, Righ is an aristocrat, an inciter of war, and a teacher of runes; like Weden he bestows favour on his protegé, who tends to be the youngest son (cf.~\textlink{Grimnismal}[P1]--P2).

Since the introductory prose is likely the work of a learned writer, viz.~the compiler of the \Wormianus\ manuscript, it is not at all unlikely that it could be drawing on \textlink{Voluspa}[1]/2, where the unparallelled expression \emph{męgir Hęim·dalar} ‘sons of Homedall’ seems to be a kenning referring to men.  It is of course not impossible that Homedall also had the aforementioned Odinic traits, but we learn of no such thing from other sources where the runes are always the exclusive domain of Weden alone (so e.g.~\textlink{Havamal}[138]--139).  For these reasons, Righ is probably more likely to be identified with Weden than Homedall, the prose introduction notwithstanding.

\subsubsection{Class, race, and essentialism}

One of the most striking aspects of \Rigsthula\ is its long and detailed physical descriptions of the founders of the human social classes, which includes both dress and phenotype.  Thus Thrall is swarthy and crooked (sts.~7--8), Churl is red-haired, ruddy, and well-turned out, with wandering eyes (18--19), and Earl is blonde and pale, with a piercing gaze (33).  That piercing gaze is important as it symbolizes the acquisitive nature of earldom, unlike the wandering eyes of the freeholder.  The aristocratic earl, the type of man celebrated by \Rigsthula, is content with nothing but the best and will pursue it unrelentingly until victory or death.

It should not be controversial to say that \Rigsthula\ is by all accounts an essentialist poem which posits that distinctions in class are fundamentally racial.  According to this worldview one’s birth is not drawn by lot, nor are souls randomly assigned to their station; everything is due to blood, and the superior man breeds superior children who prove their natural superiority in warlike conquest.

If we are to search for a historical circumstance to explain the phenotypical differences described in the poem, the taking of “swarthy” (in comparison to the Nordic Scandinavians) slaves from the British Isles, especially Ireland, quite likely played a role.  As shown by \textcite{RodriguezVarela2023}, this slave traffic left a lasting and substantial effect on the genetics of all of Scandinavia, although Celtic ancestry gradually decreased after the Wiking Age.  A likely explanation for this is that the Celtic ancestry was negatively correlated with total fertility due to its concentration in the lower social strata.

It is common knowledge that to this day the Western Norwegians have both the highest rate of Celtic ancestry (e.g.~as measured by the haplogroup R1b-L21) and the greatest incidence of red and black hair amongst non-Uralic\-ised Norwegians \parencite{Bryn1929}, something also shared with the heavily Celtic-influenced Icelanders \parencite[326]{Coon1939}. %TODO: cite page of Bryn1929, cite Coon
As the Celtic slave populations were gradually assimilated (largely but not exclusively through concubinage) into the freeholding farmers the prevalence of red hair also in the mixed children would have been noticed and made them stand out against the blonde Nordic aristocracy among whom redness was likely nearly nonexistent, as still in our time amongst the Swedes.

Apart from the explanation of Celtic influence (which certainly was a reality), we should also remember that in a stratified society with an emphasis on breeding, attractive traits tend to accumulate in the upper strata.  Most Neolithic Eurasian societies have historically strongly favoured light skin, especially in women, as a sign of wealth and beauty, and Northern Europe, where the genes for light hair and blue eyes could also be selected for, was no exception to this rule, as shown by evidence both genetic \parencite{Wilde2014} and literary (most notably \Rigsthula\ itself).  As the Nordic upper classes were bred for beauty, strength, and intelligence these traits would co-mingle and gradually become strongly correlated, leading to a racialised in-group sense.%TODO: Davide Piffer writes about this


A curious anecdote known in somewhat varying form from two sagas, \Landnamabok\ 2.19 and \Halfssaga\ 17, reveals some complexities of the Norse essentialist worldview: A Norse king took to wife a daughter of a king of Barmland (\emph{Bjarma-land}, i.e., Permia) and she begot two sons with him, Garmund and Highmund, who came out swarthy and very ugly (\Halfssaga\ 17: \emph{svartir ok furðu ljótir}, implying Mongoloid features).  Upset, the queen switched out the two sons with a blonde and beautiful slave-boy, Loaf, of the same age.  One day when the boys were three years old all men had gone away save for the poet Bray the Old.  Loaf was sitting in the king’s high seat and playing with some gold, while Garmund and Highmund were down in the straw; jealous, the brothers pulled him down from the seat and took all the gold.  Loaf wept.  At that moment Bray knew that Loaf could not be the son of two noble parents, and announced it in a stanza, after which Garmund and Highmund regained their status as the king’s sons.

Even in this supposedly non-racialist anecdote the moral of the story is none other than biological essentialism.  The boy Loaf’s slavelike nature can instantly be ascertained by his behaviour, regardless of the way in which he is raised.  Like Churl, he does not have the eyes of acquisition which signify true nobility.  Being put on the king’s throne in no way entitles him to it, and when given the chance the king’s true sons quickly retake it.

TODO: Dumezil three-part society.

\subsection{Meter and stanza}

\Rigsthula\ consists of 183 total long-lines divided into 46 stanzas.  The length of the stanza is extremely irregular.  Stanzas of 3 (14/46: 1, 3, 5--6, 9--10, 15, 19, 24--25, 28, 32, 44--45) and 4 lines (15/46: 11, 14, 17, 20, 22--23, 26--27, 29, 33, 37--39, 43, 46) are most common, followed by 5 lines (10/46: 2, 8, 13, 16, 21, 30(?), 35, 40--42).  Other represented lengths are 2 (7, 18, 31), 6 (4, 34, 36), and 7 lines (12).

Metrically \Rigsthula\ is in an unusual form of \Fornyrdislag.  The meter is notable for its unusually high incidence of 3-syllable verses, which are not allowed in all types of \Fornyrdislag, and for the extremely high incidence of type A verses at 77.7 \%, higher than any other Eddic poem \parencite[152]{Sapp2022}.

\subsection{Language and style}

\Rigsthula\ has a very low occurrence of the particle \emph{of} at 0.082 per 10 unique lines \parencite[70]{Sapp2022}.

The language is exceptionally formulaic and repetitive, with many expressions, lines and even whole stanzas repeated identically throughout as Righ visits each of the three households.  This repetition gives the poem something of an incantatory feeling.

\subsection{Dating}

On the basis of the loose and unusual meter, the likely Celtic influence in the name \emph{Rígr}, its connection to later legendary material in the form of the textual parallels, and the extremely low prevalence of the particle \emph{of} \Rigsthula\ is most likely to be a late antiquarian poem composed after the conversion to Christianity, likely in the 12th or even 13th century.  To signs of a late composition may be added the poem’s central premise (but cf.~above for a comparative discussion), since it is questionable to what degree the social structure evinced in the poem actually existed in the Wiking Age, when even the wealthiest noble families were closely allied with freeholding farmers, compared to the more stratified High Middle Ages.
...
Another dimension for dating is the detailed descriptions of dress and lifestyle which may be considered archaeologically, particularly in sts.~15--16, 26--27, 29--30, 33.  On the basis of these \textcite{Nerman1969} estimates the composition of the poem to the Wiking Age, but this assumes that knowledge of earlier material culture cannot have survived after a certain period had passed, an assumption we know based on other sources (e.g.~\textlink{HelgakvidaHjorvardssonar}[9]/1, \textlink{Sigurdskamma}[68]/1) to be incorrect.
...
Svá segja menn í fornum sǫgum, at einn-hverr af ǫ́sum, sá er Heim·dallr hét, fór ferðar sinnar ok framm með sjóvar-strǫndu nǫkkurri, kom at einum húsa-bǿ ok nefndi⸗sk Rígr; eptir þeiri sǫgu er kvę́ði þetta.\epa

\bpb {\huge S}\textsc{o do men say} in the ancient \inx[C]{saw}[saws] that one of the \inx[P]{Eese}, he who was called \inx[P]{Homedall}, went upon his journey, and, going forth along a certain lake shore, he came upon a lone homestead and called himself Righ.  After that saw is this poem.\epb\epg


\bvg\bva\mssnote{\Wormianus~78r/4--5}%
\edtrans{Á\emph{r}}{Of yore}{\Afootnote{emend.; \emph{‘at’} \Wormianus}\Bfootnote{Formulaic; it is very common for poems to begin with \emph{ár} ‘of yore, in the beginning’.  Cf.~\textlink{Voluspa}[3]/1, \textlink{Hymiskvida}[1]/1, \textlink{HelgakvidaOne}[1]/1, \textlink{GudrunOne}[1]/1, \textlink{Sigurdskamma}[1]/1.}} kvǫ́ðu \alst{g}anga \hld\ \alst{g}rø̇nar brautir &
...
a mighty and ancient \inx[C][Os], cunning: \\
...
kom hann at \alst{h}úsi, \hld\ \alst{h}urð vas \edtrans{ȧ gę̇tti}{wide open}{\Bfootnote{Lit.~‘on the threshold’, in contrast to 14/2 and 24/3.}}; &
\alst{i}nn nam at ganga, \hld\ \alst{ę}ldr vas ȧ golfi, &
\alst{h}jȯn sǫ́tu þar \hld\ \alst{h}ǫ́r \edtext{a\emph{t}}{\Afootnote{sens. emend.; \emph{af} \Wormianus}} arni, &
\alst{Á}i ok \alst{Ę}dda \hld\ \alst{a}ldin-falda.\eva

\bvb He walked further thereafter on the middle of the road, \\
...
\alst{s}oð vas i̇́ bolla \hld\ \alst{s}ętti ȧ bjóð; &
...
ęn ȧ \alst{h}lið \alst{h}vára \hld\ \alst{h}jón sal-kynna.\eva
...
\bvb There he was thereafter for three nights in their midst; \\
he walked further thereafter in the middle of the road; \\
further thereafter passed nine months.\evb\evg
...
\edtrans{\alst{h}ǫr\emph{und}-svartan}{swarthy of skin}{\Afootnote{emend.; \emph{hǫrfi svartan} ‘swarthy with flax(?)’ \Wormianus}}, \hld\ \alst{h}étu Þrę́l.\eva
...
\alst{n}iðr-bjúgt es \alst{n}ęf, \hld\ \alst{n}ęfndi⸗sk \edtrans{Þír}{Thew}{\Bfootnote{A variant of \emph{þýr} ‘maid-servant, female slave’.
Unlike Thrall, this word is not attested in any prose texts, but it is found in poetry (chiefly in the plural) and in legal compounds like \emph{þý-borinn} ‘born of a female slave or concubine’.  It is related to OS \emph{thiwi} ‘maid(-servant)’, being the female form of the Proto-Norse \textbf{þewaʀ} ‘servant’, OE \emph{þéow} ‘slave, servant’, ultimately from the root of the verb \emph{þéa \char`~\ þjá} ‘to enthral’.}}.\eva
...
\alst{a}kra tǫddu, \hld\ \alst{u}nnu at svi̇́num, &
...
kom hann at \edtrans{\emph{\alst{h}ǫllu}}{hall}{\Afootnote{sens. and metr. emend. (cf.~st.~38); om. \Wormianus}}, \hld\ \alst{h}urð vas ȧ skíði, &
\alst{i}nn nam at ganga, \hld\ \alst{ę}ldr vas ȧ golfi, &
\alst{h}jón sǫ́tu þar \hld\ \alst{h}eldu ȧ syslu.\eva

\bvb Righ walked thereafter on straight roads, \\
came to a hall; the door was hinged. \\
He took to go inside; fire was on the floor; \\
a couple sat there, kept to their chores.\evb\evg
...
\bvb The man there carved a stick into a loom-beam. \\
...
\alst{d}úkr vas ȧ halsi, \hld\ \edtrans{\alst{d}vergar}{dwarfs}{\Bfootnote{\textcite{Nerman1969} explains this word as referring to an archaeological find.  TODO.}} ȧ ǫxlum; &
\alst{A}fi ok \alst{A}mma \hld\ \alst{ǫ́}ttu hús.\eva

\bvb There sat the woman, twirled a distaff, \\
...
\bvg\bva\mssnote{\Wormianus~78r/27}%
\alst{Þ}ar vas hann at þat \hld\ \alst{þ}rjár nę́tr saman; &
liðu \alst{m}ęirr at þat \hld\ \alst{m}ǫ̇nuðr níu.\eva
...
red-haired and ruddy; his eyes wandered.\evb\evg
...
vas \alst{h}urð \alst{h}nigin, \hld\ \alst{h}ringr vas i̇́ gę̇tti.\eva

\bvb Right walked thence on straight roads; \\
...
\alst{s}ǫ́tu hjȯn \hld\ \alst{s}ǫ́u⸗sk i̇́ augu &
...
\alst{v}i̇́n vas i̇́ kǫnnu, \hld\ \alst{v}arðir kálkar &
\alst{d}rukku ok \alst{d}ø̇mðu, \hld\ \alst{d}agr vas ȧ sinnum.\eva
...
\edtrans{\alst{ǫ}tul vǫ́ru \alst{au}gu \hld\ sem \alst{y}rmlingi}{fierce were his eyes like the young serpent’s}{\Bfootnote{Unlike those of Churl (st.~19/3), which wandered.  It is a common motif in Norse literature that those of noble stock distinguish themselves by their appearance and chiefly by a unique piercing gaze even at birth.  This is said of Hallow Syemund’s son in \textlink{HelgakvidaOne}[6]/3--4 and of the king’s son Wayland in \textlink{Volundarkvida}[17]/3 whose gaze is likewise compared to the serpent’s.  In \textlink{HelgakvidaTwo}[2]--4 the same Hallow is almost caught while in disguise as a bond-woman due to his unslavelike eyes, which, like in the present stanza, are said to be \emph{ǫtul} ‘fierce, terrible’.}}.\eva
...
\Ballnote{Righ approaches his son, Earl. He reveals himself as his father and initiates him into the warrior aristocracy by teaching him the runes and giving him the noble title Righ (cf.~st.~43/4 below); henceforth he will be known as Righ-Earl.  Finally Righ instructs him to set out and win lands for himself.}%
...
\edtext{\alst{m}ǿtt\emph{u}}{\Afootnote{\emph{mǿtti} \Wormianus}\lemma{mǿtt\emph{u} ‘they met’}\Bfootnote{Past singular \emph{mǿtti} is impossible, since the maiden is the one being met.  \emph{mǿta} ‘meet’ takes the dative.}} \edtext{\emph{\alst{m}ęyju}}{\Afootnote{om. \Wormianus}\lemma{\emph{męyju} ‘maiden’}\Bfootnote{A feminine dat.~sg.~noun meaning ‘maiden, virgin, girl’ is required here by the meter and the following adjectives;
\emph{męyju} dat.~sg.~of \emph{mę́r} fits perfectly with the alliteration and is to be considered fairly likely.}} \hld\ \edtext{\alst{m}jó-fingrað\emph{r}i}{\Afootnote{\emph{mjó-fingraði} \Wormianus}} &
...
white and wise; her name was Erne.\evb\evg


\bvg\bva\mssnote{\Wormianus~78v/22--24}%
Bǫ́ðu \alst{h}ęnnar \hld\ ok \alst{h}ęim óku, &
\alst{g}iptu Jarli, \hld\ \edtrans{\alst{g}ekk hón und li̇́ni}{she went ’neath the linen}{\Bfootnote{She donned the bridal veil; cf.~\textlink{Thrymskvida}[27].}}; &
...
\edtrans{\alst{ę́}vin-ru̇nar}{eternal runes}{\Bfootnote{A native, pre-Christian word; the first element is an otherwise lost adjective corresponding to Gothic \emph{aiweins} ‘eternal, everlasting’, OHG \emph{êwín} ‘id’.  This is one of two occurrences in the ON corpus, the other one being \textbf{aiuinrunąʀ} \emph{ęivin-ru̇naʀ} on the 9th c.~Malt stone (DR NOR1988;5/DK Sjy38), alongside \textbf{taitirunąʀ} \emph{tęiti-ru̇naʀ} ‘joy-runes’.}} \hld\ ok \alst{a}ldr-ru̇nar.\eva
...
eternal runes and life-runes.\evb\evg
...
\edtrans{\alst{R}ígr at hęita}{to be called Righ}{\Bfootnote{The title Righ passes through the generations, first in st.~35/3 from Righ (the grandfather) to Righ-Earl (the father), now from Righ-Earl to his son Kin the young.}}, \hld\ \alst{r}u̇nar kunna.\eva

\bvb With Righ-Earl he shared the runes, \\
...
\edtrans{\alst{k}olfi flęygði \hld\ \alst{k}yrði fugla}{hurled his bolts, stunned the birds}{\Bfootnote{Perhaps by means of a slingshot, an ancient and widespread birding practice.}}; &
...
\llap{„}Hvat skalt, \alst{K}onr ungr, \hld\ \alst{k}yrra fugla? &
...
In the epitome of the \emph{Skjǫldunga saga} we read \parencite[1--45]{Bjarni1982}:
