...
Notably, the two stanzas cited here are also found translated in \textcite{Saxo} 1.8.18--19, where they are said to have been spoken by Hadding and Rainhild, respectively.  For discussion see \textcite{Hopkins2021}.
...
\bvg\bva%
„\alst{L}ęið eru⸗mk fjǫll, \hld\ vas’k⸗a \alst{l}ęngi ȧ, &
...
\section{3. Homedall’s Galder (\emph{Hęim·dallar-galdr})}\chapterStart%
...
\bpg\bpa%
\edtrans{Heim·dallr}{Homedall}{\Bfootnote{“World-Brilliant”.  For the word \emph{dallr} ‘(possibly) brilliant, splendid’ see \textlink{Vafthrudnismal}[25] n.  Homedall appears to be an original fire-god, as seen by his epithets which resemble those of the Vedic \textoi{Agní}.}} heitir einn.  Hann er kallaðr \edtrans{hvíti ǫ́ss}{the White Os}{\Bfootnote{Cf. \textlink{Thrymskvida}[15]/1b: \emph{hvítastr ȧsa} ‘whitest of the Eese’.}}; hann er mikill ok heilagr.
Hann bǫ́ru at syni meyjar níu ok allar systr;
hann heitir ok \edtrans{Hallin·skíði}{Haldenshid}{\Bfootnote{“The one with slanting sticks;” seemingly a name for a kind of (ritual?) fire.  It appears alongside \emph{Hęim·dali} as a poetic synonym for the ram in Þul \emph{Hrúts} 1 (\Skp\ 3).}} ok \edtrans{Gullin·tanni; tennr hans vǫ́ru af gulli}{Goldentooth; his teeth were of gold.}{\Bfootnote{The name is self-explanatory.  A direct cognate occurs in \Rigveda\ 5.2.3 as an adjective describing \textoi{Agní}, the god of fire: \textoi{híraṇya-dantaṁ şúci-varṇam \dots\ a·paşyam} ‘I saw him with golden teeth and flaming color’, where OI \textoi{híraṇya-danta} < PIE \emph{*ǵʰl̥‌h₃·enyó-h₃dontos} \char`~
...
The following passage is from \Gylfaginning\ 35, which lists the \inx[P]{Ossens}.
