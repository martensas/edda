...
\RegiusProse, \Trajectinus \\
\Wormianus, \Upsaliensis~18v/19}%
...
\alst{m}ęnn \edtext{\edtrans{\edtext{\alst{m}ęin-svara}{\Afootnote{\emph{męins-vara} \Regius \emph{;} \emph{mein-svarar} \Upsaliensis}}}{false-swearing}{\Bfootnote{Acc.~pl.~of \emph{*męin-svari} or \emph{*męin-svarr}, an otherwise unattested adj.  Related words are \emph{męin-sǿri} ‘false oath, perjury’ and \emph{męin-svari} m. ‘perjurer’.
...
but specifically when done clandestinely and intentionally in ways deemed particularly reproachable.}}}{\Afootnote{corr.~from \emph{morð-varga męin-svara ok} by an inversion mark in same hand \Regius.}} &
...
\alst{S}ól \edtrans{tér}{doth}{\Afootnote{\emph{mun} ‘will’ \GylfMS}} \alst{s}ortna, \hld\ \edtrans{\edtext{\edtrans{\alst{s}ígr}{sinks}{\Afootnote{\emph{søkkr} \RegiusProse\Trajectinus\Wormianus}} fold ï mar}{\Afootnote{\emph{†sigrfolldinar†} \Upsaliensis,
