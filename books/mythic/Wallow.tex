...
\Ballnote{Ll. 3--4 are cited immediately following st.~9 in \Gylfaginning~14:15; see note to st.~9.}%
...
þęir \edtrans{\alst{m}an-líkun}{man-likenesses}{\Bfootnote{The Dwarfs were in the shape of Men, but not quite human.  In the creation of the Dwarfs before Men, we may find a reflex of a motif common throughout world mythology: the creation of several failed or incomplete generations of sentient beings by the God(s) prior to the current iteration of humans.  These failed or ancient generations are typically created out of other materials than those used for us, display non-human psychology and strange abilities, and are either destroyed or turned into sprites or animals.

The Dwarfs fit well into this description; they are created out of stone (whereas the first humans are made out of wood), are described in sources as unusually lustful and greedy but also as masterful craftsmen, and are a form of sprite.
Mythological parallels include the five ages in Hesiod’s \emph{Works and Days} 109--201, viz. the Golden Age, Silver Age, Bronze Age, Heroic Age, and Iron Age; the Jinn in Islam, created out of smokeless fire prior to the creation of Man out of clay (\emph{Quran} 15:26--27); and the failed attempts at creating humans in the pre-Columbian Mayan \emph{Popol Vuh}, where the first generation is made out of earth and mud but destroyed for its weakness (ll. 434--517), the second made out of effigies of carved wood, becoming spider monkeys (518--837), while the third and successful creation of humanity is out of maize (4822--4939) \parencite[64--75,178--181]{Christensen2007}.}} \edtext{\hld\ \edtext{\alst{m}ǫrg of gørðu}{\lemma{þęir man-líkun \hld\ mǫrg of gørðu}\Afootnote{so \Regius\Hauksbok\Upsaliensis \emph{;}
...
Of these two alternatives, the element \emph{goti} in the sense ‘man’ is preferable, since the walkirries are presumably thought to be gathered in Walhall, ready to fly out into the world of men in order to attend battles and claim the best warriors for Weden (cf.~\Hakonarmal\ 1).
The cpd.~is thus semantically identical to \emph{ver-þjóð}, \textlink{Lokasenna}[24]/3.  For \emph{Gót-þjóð} ‘folk, land of the Gots’ see \textlink{Helreid}[8]/1 n.}}: &
...
The following sts.~(11--15) contain two or three originally distinct lists of dwarf-names.  They interrupt the flow of the whole poem so much that they have been moved to the Appendix.  Their nature as a later insertion is in any case confirmed by their faulty meter \parencite[373]{Males2025}.
...
\alst{l}ang-niðja-tal \hld\ \edtext{\alst{L}ofars hafat}{\Bfootnote{This line would be unmetrical in the rest of the poem since the first lift is on a short syllable \parencite[373]{Males2025}.  This strongly suggests that the Dwarf-tally section is a later insert.}}.\eva
