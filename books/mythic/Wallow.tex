...
The civilising role of fire is found in Norse sources in \EyrbyggjaSaga\ 4 (\emph{fór Þór·ólfr eldi um land-nám sitt} ‘Thurolf journeyed with fire around his land-taking’) and \Gutasaga\ 1 (\emph{Þá var Gut·land so eliust, et þet dagum sank ok náttum var uppi.  En þann maðr kvam fyrsti eldi á land, ok síðan sank þet aldri.} ‘At that time Gotland was so uncanny(?) that it sank during the days and was up during the nights.  But that man [= Thelver, the mythical founder of Gotland] was the first who brought fire to the land, and thereafter it never sank.’)  It has Indian parallels \parencite[11]{EliadeReturn} and features in ritual; cf.~\textlink{Grimnismal}[43]/2.}} lǫgðu, \hld\ \alst{au}ð smíðuðu, &
