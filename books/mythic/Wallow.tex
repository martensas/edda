...
In Jordanes, \emph{Getica} 121 we find mention of the Gothic witches known as the \emph{haliurunnae}, believed to the ancestors of the Huns.  Their name is clearly cognate with OE \emph{hęlli-ru̇ne} ‘witch, sorceress’, formed from \emph{hęll} ‘hell, Underworld’ + \emph{ru̇ne} ‘whisperess, confidante’, thus signifying ‘those who convene with the dead’.
...
\subsubsection{Cyclical eschatology}

TODO: mention Indian yugas, Zoroastrian texts.
...
\alst{n}íu man’k hęima, \hld\ \alst{n}íu \edtext{ï·viðjur}{\Afootnote{so all; previously erroneously read \emph{‘iviði’} in \Regius.}\Bfootnote{Evil-working women or ogresses; their identity is by no means clear.  The f. \emph{jōn}-stem \emph{ï·viðja} also appears in a list of poetic synonyms for trollwomen (Þul \emph{Trollkvenna} 3 in \Skp\ 3).  A commonly suggested etymology is \emph{í} ‘in’ + \emph{viðr} ‘tree, forest’ (i.e. ‘tree, forest-dwellers’), but this would be an unusual formation and leaves the \emph{-j-} unexplained.  A more plausible etymology is a derivative of \emph{*ï·við} ‘malice’, attested in the cpd. \emph{ï·við-gjarn} ‘malicious’ (\textlink{Volundarkvida}[28]).
...
\alst{h}ęndi hinni \alst{h}ǿgri \hld\ of \edtrans{\alst{h}imin-jǫður}{heaven’s rim}{\Afootnote{composite; \emph{‘himin †iodyr†’} \Regius\emph{;} \emph{jǫður (‘ioður’)} \Hauksbok.}\Bfootnote{Some recent editors have taken it upon themselves to normalize the reading of \Regius\ as \emph{himin-jó-dýr} ‘heaven-horse-beast’, which is not just nonsensical but also unmetrical due the stress pattern.  On the other hand the reading of \Hauksbok\ (norm. \emph{jǫður} ‘rim, edge’) is clearly deficient since it lacks the necessary alliteration on \emph{h}.
...
\edtrans{Hvęrr skyldi \alst{d}verga}{Who would \dots\ of dwarfs’}{\Afootnote{so \Regius\Wormianus\Upsaliensis \emph{;} \emph{at skyldi dverga} ‘That they would \dots\ of dwarfs’ \RegiusProse\Trajectinus \emph{;} \emph{hverir skyldu dvergar} ‘Which dwarfs would [shape the troops out of \dots]’ \Hauksbok}} \hld\ \edtrans{\alst{d}rótt}{the troop}%
{\Afootnote{so \RegiusProse\Trajectinus\Upsaliensis\Wormianus \emph{;} \emph{drotin} ‘the lord’ \Regius \emph{;} \emph{dróttir} ‘the troops’ \Hauksbok}} \edtrans{\edtext{of}%
{\Afootnote{om. \Regius\Hauksbok}} skępja}{shape}{\Afootnote{\emph{of spękja} (norm.) ‘soothe’ \Upsaliensis}} &
\edtrans{ór \edtrans{\alst{b}rimi \alst{b}lóðgu}{bloody surf}{\Afootnote{so \Hauksbok\RegiusProse\Wormianus\Upsaliensis \emph{;} \emph{Brimis blóði} ‘the blood of Brimmer’ \Regius\Trajectinus}} %
\hld\ ok ór \edtrans{\alst{b}lǫ́um}{blue-black}{\Afootnote{so \emph{(‘blám’)} \Regius \emph{;} \emph{Bláins} ‘Blown’s’ \Hauksbok\Wormianus \emph{;} \emph{Bláms} (prob. a corrupt form of \emph{*Bláins}) \RegiusProse\Trajectinus\Upsaliensis}} lęggjum}{out of the bloody surf and the blue-black legs}{\Bfootnote{I find that the poem simply telling of ‘the bloody surf’ and the ‘blue-black legs’ fits better with its general allusive style, but this requires a composite reading.
...
\edtext{\edtext{Þar vas \alst{M}óð·sognir}{\Afootnote{so \Hauksbok \emph{;} \emph{Þar Mót·sognir †vitnir†} ‘there Mootsowner wolf(?)’ \Regius \emph{;} the paraphrase of \Gylfaginning~14:14 has \emph{Móð·sognir}}} \hld\ \alst{m}ę́tstr of orðinn &
...
\alst{A}sk vęit’k \edtext{standa}{\lemma{standa ‘standing’}\Afootnote{so \Regius\Hauksbok\Upsaliensis \emph{;} \emph{ausinn} ‘sprinkled’ \RegiusProse\Trajectinus\Wormianus}}, \hld\ hęitir \edtext{\alst{Y}gg·drasils}{\Afootnote{so \RegiusProse \emph{;} \emph{Ygg·drasill} all others}}, &
\alst{h}ǫ́r \edtrans{baðmr}{tree}{\Afootnote{\emph{borinn} ‘born’ (wo. doubt corrupt) \Upsaliensis.}}, \edtrans{\edtrans{ausinn}{sprinkled}{\Afootnote{\emph{hęilagr} ‘holy’ \RegiusProse\Trajectinus\Upsaliensis\Wormianus}} \hld\ \alst{h}víta auri}{sprinkled with white mud}{\Bfootnote{Cf.~st.~26/3--4 below.}}; &
...
\alst{s}ęið hǫ̇n \edtrans{hvar’s hǫ̇n kunni}{where she could}{\Afootnote{so \Hauksbok \emph{;} \emph{hǫ̇n kunni} ‘she knew’ \Regius}}, \hld\ \alst{s}ęið hǫ̇n \edtrans{hug lęikinn}{deluded minds}{\Afootnote{so \Hauksbok \emph{;} \emph{leikinn} \Regius}}; &
...
\edtrans{Sá hǫ̇n}{she saw}{\Afootnote{so \Regius \emph{;} \emph{sér hǫ̇n} ‘she sees’ \Hauksbok \emph{;} \emph{skulu} ‘shall [be]’ \RegiusProse\Trajectinus\Upsaliensis\Wormianus}} \alst{þ}ar vaða \hld\ \alst{þ}unga strauma &
...
Þar \edtrans{saug}{sucked on}{\Afootnote{so \Hauksbok \emph{;} \emph{†sv́g†} \Regius \emph{;} \emph{kvęlr} ‘torments’ \RegiusProse\Trajectinus\Upsaliensis\Wormianus}} \alst{N}íð·hǫggr \hld\ \alst{n}ái fram-gingna; &
...
\edtrans{\alst{s}vǫrt verða \alst{s}ól-skin}{Black turn the sun’s rays}{\Afootnote{so \Hauksbok\RegiusProse\Trajectinus\Upsaliensis\Wormianus \emph{;} \emph{svart var þá sól-skin} ‘Black was then the sun’s shine’ \Regius}\Bfootnote{As part of the Fimblewinter; see \textlink{Vafthrudnismal}[44]/3--4 n. ---
...
\Ballnote{St.~44 is cited in \Gylfaginning~51:7, where it is introduced by the words \emph{Svá segir í Vǫlu-spǫ́.} ‘So it says in the Spae of the Wallow.’
\Gylfaginning~51:5--6 puts the stanza in the context of three winters of war preceding the three winters that make up the Fimblewinter: \emph{En áðr ganga svá aðrir þrír vetr, at þá er um alla verǫld orrostur miklar.  Þá drepa⸗sk brǿðr fyrir á·girni sakar, ok engi þyrmir fǫður eða syni í mann-drǫ́pum eða sifja-sliti.} ‘But before them come three other winters when throughout all the world there are great battles.  Then do brothers slay each other for reasons of covetousness, and no man spares his father or son in murder of men or destruction of kinship.’

For the Fimblewinter described in \Gylfaginning~51:2--4 see \textlink{Vafthrudnismal}[44].}%
...
\edtrans{\alst{m}ę́lir}{speaks}{\Afootnote{\emph{†mey†} \RegiusProse \emph{;} \emph{†nie†} \Trajectinus}} Óðinn \hld\ við \alst{M}íms hǫfuð; &
\edtext{skelfr \alst{Y}gg·drasils \hld\ \alst{a}skr standandi, &
\alst{y}mr it \alst{a}ldna tré, \hld\ ęn \alst{jǫ}tunn \edtext{losnar}{\Afootnote{add. H2 \Hauksbok.}}}{\lemma{}\Afootnote{These lines are reversed in \Regius.}}.\eva
...
þȧ mun \alst{F}riggjar \hld\ \alst{f}alla \edtext{angan}{\Afootnote{so \Hauksbok\RegiusProse\Trajectinus\Upsaliensis\Wormianus \emph{;} \emph{angantyr} \Regius}}.\eva
...
\edtrans{\edtrans{Þȧ kømr}{Then comes}{\Afootnote{\emph{Gęngr} ‘Goes’ \RegiusProse\Trajectinus\Upsaliensis\Wormianus}} hinn \alst{m}ę́ri \hld\ \alst{m}ǫgr Hlǫðynjar,}{Then comes the famed lad of Lathyn}{\Afootnote{om. \Hauksbok \emph{;} add. \emph{gęngr Óðins sonr við ulf (\emph{pro} *orm) vega.} ‘Weden’s son goes the Wolf (error for ‘Wyrm’) to fight.’ \Regius.}} &
...
\alst{S}ól \edtrans{tér}{doth}{\Afootnote{\emph{mun} ‘will’ \RegiusProse\Trajectinus\Upsaliensis\Wormianus}} \alst{s}ortna, \hld\ \edtrans{\edtrans{\alst{s}ígr}{sinks}{\Afootnote{\emph{søkkr} \RegiusProse\Trajectinus\Wormianus}} fold ï mar}{the land sinks into the sea}%
...
\edtrans{Þat mun \edtext{\alst{ę́}}{\Afootnote{so \Hauksbok \emph{;} om. \Regius}} \alst{u}ppi, \hld\ meðan \alst{ǫ}ld lifir}{That will ever be remembered while the age lives}{\Bfootnote{Both verse-halves are formulaic, though their use in a list of dwarf-names is unparallelled.
