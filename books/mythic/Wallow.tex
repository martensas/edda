...
For the god’s general quest for knowledge there are numerous parallels.  There is \textlink{Vafthrudnismal}, wherein Weden defeats the wise ettin \inx[P]{Webthrithner} in a wisdom contest, Weden’s theft of the mead of poetry (\textlink{Havamal}[103]--110), his self-hanging and acquirement of the runes (\textlink{Havamal}[138], 139), and his giving up his eye to Mimer in exchange for wisdom (\textlink{Voluspa}[28]).
...
We find allusions to the Destruction in a large number of pre-Christian Norse works: most of the mythological poems (\Voluspa\ 43--55, \textlink{Vafthrudnismal}[17]--18, 44--53, \textlink{Grimnismal}[4]/4, 17, 24, 40, \textlink{Baldrsdraumar}[14], \textlink{Lokasenna}[10]/1, 39, 41--42, \textlink{Hyndluljod}[41], 43), several Scaldic eulogies (\Hakonarmal\ 20--21, \Eiriksmal\ 7), and poetic pre-Christian runestones (Sö 154 Skarpåker, perhaps also Vg 119 Sparlösa).
...
In the ubiquity of these allusions we see that the Rakes of the Reins was not  worries were felt acutely on a personal level by the practicioners of the pre-Christian religion, for the association is particularly strong in texts relating to death.  It is clear that the Heathens felt that the destruction was imminent and could come, as it were, “like a thief in the night” (cf.~\textlink{Heliand}[52][4358]--61).  Whether they found consolation in it is unclear, but it was clearly an important part of their attitudes towards death and one found not just in the funerary poems of kings (\Hakonarmal, \Eiriksmal) but also on runestones raised by more or less everyday people.
...
If we are to look for a historical explanation to the above-mentioned eschatological fixation the most likely candidate is undoubtedly the climate catastrophe of 536--537 \ce.  TODO.

Although ideas of the Destruction probably existed before 536, the massive social upheaval, likely along with Christian apocalypticism spreading from the converted Gots and Vandals, led to a new system of thought.
...
It seems that immediately prior to the poem’s commencing, Weden has awakened the wallow out of her grave.  He commands her to speak.

On the basis of its refrains the poem may be divided into the following sections: Introduction (1--2), Creation and the early age of the world (3--17), cosmological and mythological exposition and decline (18--42), Destruction (43--55), and Rebirth (56--62).
...
After st.~19 the order of stanzas in the two full recensions---\Regius\ and \Hauksbok---diverges significantly and they do not come to agree until st.~43.  With a single exception (st.~46) the order adopted for the present edition is that of \Regius, but since it is hard to decide which one is more original both are summarised here.
...
\edtrans{\alst{m}ęiri ok \alst{m}inni}{greater and lesser}{\Bfootnote{It is ambiguous to which noun phrase these adjectives belong.  It can either be (a) “all greater and lesser holy races”, which might be equivalent to the phrase \inx[F]{Eese and Elves} (earthly and heavenly supernatural beings; see Index for occurrences), or (b) “the greater and lesser sons of Homedall”.  (b) is to be preferred as the simpler reading since it avoids enjambment, in which case the sense of “greater or lesser” is more likely to be literal and physical (i.e., the younger and older members of the audience) rather than figurative (i.e., the varying social classes).}} \hld\ \edtrans{\alst{m}ǫgu Hęim·dalar}{sons of Homedall \ken{men}}{\Bfootnote{Usually interpreted as a kenning for \ken{men} on the basis of\textlink{Rigsthula}, according to which Homedall sired the social classes of men; this convention is followed here as it is felt to give the better sense.
Such a kenning is however unparallelled.  A more typologically likely interpretation (so \cite[23, 252]{Meissner1921}) would be to see \emph{męgir} in the sense ‘lads, comrades’, making the kenning equivalent to \emph{Hropts męgir} ‘Roft’s lads’ (\textlink{Lokasenna}[45]/3), \emph{allar áttir
Ingvi-Fręys} ‘all the kin of Ing-Free \ken{gods}’ (\Haustlong\ 10), \emph{Njarðar niðjar} ‘Nearth’s kinsmen’ (Hfr Lv 10 in \Skp\ 5).}}; &
...
\Ballnote{The Sun lifts herself up over the horizon and rises for the first time, but she does not know where to go after that.  The heavenly bodies are in a state of confusion and disorder.}%
...
(2) If we instead see \Regius’s \emph{‘iodyr’} as corrupted from an archetypal \emph{*iodur}, we can restore to \emph{of *himin-jǫður}, as done here (also e.g.~\cite{FinnurEdda}, \cite[292]{EddukvaediOne}).
...
Following this pattern we would expect to find such a question following \emph{umb þat gę̇ttu⸗sk} ‘took counsel of that’ in the present stanza and so it seems reasonably plausible (but not certain) that one has been lost in transmission.}}. &
...
\Ballnote{After the Golden Age is spoiled, the Gods must get their gold in some other way.  For this they need the Dwarfs who are associated with precious metals and ore-veins and make many great treasures for the Gods (e.g.~Glapner, \textlink{EddicFragments}[F8][VIII] and Shidebladner, \textlink{Grimnismal}[44]).  The ancient conception of spontaneous generation is clearly also at play; according to the prevalent view, maggots and worms were thought to spontaneously generate in rotting flesh and earth, and the dwarfs were apparently likewise thought to have spontaneously generated in stone.  As much is stated in \Gylfaginning~14:11--14, which continues with its paraphrase:
...
{\Afootnote{so \GylfMS \emph{;} \emph{drotin} ‘the lord’ \Regius \emph{;} \emph{dróttir} ‘the troops’ \Hauksbok}} \edtrans{\edtext{of}%
...
\alst{d}verga allra, \hld\ ęn \alst{D}urinn annarr;}{\lemma{Þar \dots\ annarr ‘There \dots\ second’}\Afootnote{om. \GylfMS}{\Bfootnote{These lines are not found in \Gylfaginning, but the author must have had the full stanza since he paraphrases them (see st.~9 n. above).}}} &
...
\Aallnote{The order of the lines follows \Regius\Hauksbok \emph{;} the order is 3, 4, 1, 2 in \GylfMS.}%
...
\edtrans{Sá hǫ̇n}{she saw}{\Afootnote{so \Regius \emph{;} \emph{sér hǫ̇n} ‘she sees’ \Hauksbok \emph{;} \emph{skulu} ‘shall be’ \GylfMS}} \alst{þ}ar vaða \hld\ \alst{þ}unga strauma &
...
This adjective is in the acc.~pl.~in all mss., including \GylfMS, but this is unexpected in the latter 4 since their version of line 1 has the verb \emph{skulu} ‘shall be’, which takes a nominative subject.
...
þȧ mun \alst{F}riggjar \hld\ \alst{f}alla \edtext{angan}{\Afootnote{so \Hauksbok\GylfMS \emph{;} \emph{angantyr} \Regius}}.\eva
...
\edtrans{Þȧ kømr hinn \alst{m}ikli \hld\ \alst{m}ǫgr Sig-fǫður}{Then comes the great son of Syefather}{\Afootnote{\emph{Gęngr Óðins sonr \hld\ við ulf vega} ‘Weden’s son goes the Wolf to fight’ \GylfMS.}}, &
\alst{V}íð·arr \edtext{\alst{v}ega}{\Afootnote{\emph{of veg} \GylfMS}} \hld\ at \alst{v}al-dýri; &
...
\Aallnote{The present form of the stanza is an amalgamation of all three ms.~traditions (\Regius, \Hauksbok, and \GylfMS) based most closely on \Hauksbok\ and \GylfMS, which have the last 3 lines in the same order.  \Regius\ has the lines in the order 1, 5, 4, 2, 3 and inserts an additional line between 1 and 5.}%
\edtrans{\edtrans{Þȧ kømr}{Then comes}{\Afootnote{\emph{Gęngr} ‘Goes’ \GylfMS}} hinn \alst{m}ę́ri \hld\ \alst{m}ǫgr Hlǫðynjar,}{Then comes the famed lad of Lathyn}{\Afootnote{om. \Hauksbok \emph{;} add. \emph{gęngr Óðins sonr við ulf (\emph{pro} *orm) vega.} ‘Weden’s son goes the Wolf (error for ‘Wyrm’) to fight.’ \Regius.}} &
\edtrans{gęngr \alst{f}et níu \hld\ \edtext{\alst{F}jǫrgynjar}{\linenum{|2|||3}\lemma{Hlǫðynjar, Fjǫrgynjar ‘Lathyn, Firgyn’}\Bfootnote{Both names for the \inx[P]{Earth}, who is Thunder’s mother.}} burr}{nine steps takes Firgyn’s son}{\Afootnote{om. \GylfMS.}} &
...
\alst{S}ól \edtrans{tér}{doth}{\Afootnote{\emph{mun} ‘will’ \GylfMS}} \alst{s}ortna, \hld\ \edtrans{\edtrans{\alst{s}ígr}{sinks}{\Afootnote{\emph{søkkr} \RegiusProse\Trajectinus\Wormianus}} fold ï mar}{the land sinks into the sea}%
...
\edtrans{\alst{g}olli þakðan}{thatched with gold}{\Afootnote{\emph{golli bętra} ‘better than gold’ \RegiusProse\Trajectinus}}, \hld\ ȧ \edtext{\alst{G}im·léi}{\Afootnote{metr. emend.; \emph{Gim·lé} \Regius\Hauksbok\GylfMS}}; &
...
\alst{R}ęginn ok \alst{R}áð·sviðr \hld\ ---\edtext{\alst{r}étt of talða}{\Afootnote{om. \GylfMS}}.}{\lemma{nú hęf’k dverga \dots\ rétt of talða ‘now have I the dwarfs rightly tallied’}\Bfootnote{An inset clause; since it does not list the names of any dwarfs it was omitted by Snorre in \Gylfaginning.}}\eva
