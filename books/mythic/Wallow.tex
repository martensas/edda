...
þat vas ęnn \alst{f}olk-víg \hld\ \edtrans{\alst{f}yrr}{earlier}{\Afootnote{so \Hauksbok \emph{;} \emph{fyrst} ‘first’ \Regius}\Bfootnote{The \Regius\ reading can hardly be correct, as this st.~is describing a different war than the first (that of st.~20); it has probably arisen due to the similarity with st.~20/1.}} ï hęimi; &
...
\edtrans{\alst{Y}ggjungr \alst{ȧ}sa}{the Frightener of the Eese \ken*{= Weden}}{\Bfootnote{To be understood as ‘the Frightener among the Eese’, i.e., ‘the Terrifying God’.  Cf.~the expression \emph{Ȧsa-Þȯrr} ‘Thunder of the Eese’, and Weden’s name \emph{Yggr} ‘Ug’, from the same root.}} \hld\ ok ï \alst{au}gu lęit: &
\speakernote{[Vǫlva:]}%
...
\edtrans{\alst{g}ól umb hǫ̇num}{For him crowed}{\Bfootnote{The crowing of three cocks---the first in Ettinham, the second in Walhall, the third in Hell---heralds the destruction of the world.}} \hld\ ï \edtrans{\alst{G}agl·viði}{Gagglewood}{\Bfootnote{An otherwise unknown location; the first element is \emph{gagl} ‘wild goose’.  Gagglewood is perhaps the same as Ironwood.}} &
