...
As a repository of mythic lore \textlink{Voluspa} resembles \textlink{Vafthrudnismal}, \textlink{Grimnismal}, \textlink{Sigrdrifumal}, and \textlink{Alvissmal}, but it differs from the aforementioned works in two key ways: \textlink{Voluspa} is a prophecy rather than a motley collection of scattered mythological lore and a monologue rather than a dialogue or riddle contest.  Its unique importance lies in the fact that it offers a chronological overview of the Norse mythic timeline of the World from its creation to its coming destruction and rebirth.

The understanding of this timeline is, unfortunately for the study of Norse mythology, troubled by the fact that the wallow continually speaks in the most obscure terms.  The myths are related in an allusive fashion which presupposes that the audience already familiar be with them, and while we can connect many of the allusions to more complete narratives in Snorre’s Edda (which, to complicate things further, often relies on \textlink{Voluspa}), others are entirely unknown to us.  Things are made even harder by the fact that the witness manuscripts disagree over the order and inclusion of numerous stanzas.

In order to properly elucidate the myths and their religious significance any investigation has to take into account all available materials: comparative mythology, historical sources, archeology, etymology, and folkloristics, and nowhere else is this more important than \Voluspa.  Although the body of Norse pre-Christian poetry is rather small, the available material for such a comparative study is truly vast, and since there is still a tremendous amount of work to be done there will undoubtedly creep in both omissions and errors.  Even so, it is hoped that the present commentary, along with that of the other poems included in this edition, will provide new and interesting perspectives to the reader, student, and scholar, not just of Germanic mythology, but of the history of religions in general.

\subsubsection{The wallow and wisdom}

As noted briefly above, \Voluspa\ is narrated by a wallow.  This figure represents the northern European belief that women, especially in elder age, were invested with a unique psychic or prophetic power, a power which became even greater when they died and might come into possession of truly hidden knowledge---knowledge perhaps unknown even to the chief god Weden Himself.
...
As has been impressively shown by \textcite{EliadeReturn}, pre-Abrahamic religions are centered around cycles and the power of \emph{being} inherent in their return.  The sun at dawn, the new moon, the daylight at the winter solstice, the warmth of spring---traditional man did not think the return of these things certain.  Rather, the sun, moon, daylight, indeed the world itself had to be strengthened and re-established through cyclical rituals harkening back to mythic time.  So it is that modern man thinks little of that which traditional man worried about with great fright and consequently heralded with great rejoicing.

In the traditional worldview the world consists of nested cycles, a series of ever-revolving concentric circles of rises and declines; the day, the month, the year, the human lifetime, and the world itself.  Each must rise and fall, decline and be regenerated.  In this way history is not linear, but cyclical; everything that is done has already been done before and in fact it is just this precedent which gives the present occurrence its realness.

\Voluspa\ focuses on the greatest cycle, that of the World itself, from its beginning as formless matter (3) through its creation by the Gods (4--6) and Golden Age (7--8) to its gradual decline (8--42) and prophecised destruction (43--55) and rebirth (56--62).  Although the poem is not explicit about it, it seems that the seed of evil is not entirely removed in the next world (cf.~62 n.), leaving the possibility open for yet another repetition of the cycle.

TODO: mention Indian yuga-s, Zoroastrian texts.

\subsubsection{The Wiking Age eschatological fixation}

One of the most important developments of the Germanic religion when compared with other Indo-European religions is its unique obsession with eschatology, the Rakes of the Reins.  Although the relevant myths are preserved only in the Norse literature, likely traces of the same are found on continental West Germanic territory in the form of the OHG \textlink{Muspilli} and the OS \textlink{Heliand} (both of which use the possibly pre-Christian inherited term \emph{Muspilli}, also found in ON as \emph{Muspell}; see st.~49/1 n.~below, \textlink{Muspilli} 56 n.)

What distinguishes the Germanic (and specifically Norse) religion from other Indo-European systems is not the presence itself of ideas of the destruction and rebirth of the World, which as discussed above are also found in Indo-Iranian sources, but specifically a fixation with the imminent Destruction of the World at the hands of the evil cosmic forces.  This worry was felt acutely on a personal level by the practicioners of the religion.

We find allusions to the Destruction in a large number of pre-Christian Norse works: most of the mythological poems (\Voluspa\ 43--55, \textlink{Vafthrudnismal}[17]--18, 44--53, \textlink{Grimnismal}[4]/4, 17, 24, 40, \textlink{Baldrsdraumar}[14], \textlink{Lokasenna}[10]/1, 39, 41--42, \textlink{Hyndluljod}[41], 43), several Scaldic eulogies (\Hakonarmal\ 20--21, \Eiriksmal\ 7), and poetic pre-Christian runestones (Sö 154 Skarpåker, perhaps also Vg 119 Sparlösa).  The connection is particularly strong in texts relating to death, and it is clear that the mourning Heathens felt that the destruction could begin at any time, coming, as it were, “like a thief in the night” (cf.~\textlink{Heliand}[52][4358]--61); whether they found consolation in it is unclear, but it was clearly an important part of their attitudes towards death.

The monsters of the Rakes of the Reins also figure iconographically, e.g.~on the 10th c.~Gosforth cross, showing Wider slaying the Middenyardswyrm.  Pre-Christian memorial runestones frequently depict a single ravenous wolf, e.g.~N 84 Vang and DR 285 and 286 Hunnestad, sometimes also accompanied by a ship (perhaps Nailfare, 48/4 n.), e.g.~DR 271 Tullstorp (Figure~\ref{fig:tullstorp}) and Ög 181 Ledsberg.  These pictoral motifs should probably be considered visual representations of the same attitude as found literarily in Sö 154 Skarpåker, \Hakonarmal\ 20--21, and \Eiriksmal\ 7.

\begin{figure}[b]
\centering
\includegraphics[width=\textwidth]{Tullstorp}
\caption{The Tullstorp stone (DR 271), showing a wolf above a ship, perhaps the Fenrerswolf and Nailfare.  Wiking Age, ca. 1000 \ce.  © Jorchr. \href{https://creativecommons.org/licenses/by-sa/4.0/deed.en}{CC BY-SA 4.0}.  \url{https://commons.wikimedia.org/wiki/File:Tullstorpstenen,_DR_271,Tullstorp_1-1,_Runristning.jpg}}
\label{fig:tullstorp}
\end{figure}
...
Many stanzas (3, 5, 9, 10--13, 15, 18, 24–25, 28, 37--40, 44--46, 48--54, 61) are also cited or paraphrased in \Gylfaginning, the first part of Snorre’s Edda, which in numerous passages closely follows the poem.  For the four mss. of \Gylfaginning: \RegiusProse, \Trajectinus, \Wormianus, and \Upsaliensis\ see the Introduction to Mythic Poetry above.

From the citations it is clear that Snorre had access to a third, now-lost, recension of \textlink{Voluspa}, and his citations are therefore of critical value as they represent the oldest form of the poem.
Although his paraphrases are harder to use, they too can provide important critical readings and serve as a tiebreaker for readings that differ between \Regius\ and \Hauksbok, e.g. in st.~19/2, where \emph{sal} ‘hall’ in the paraphrase agrees with \Hauksbok\ against \Regius\ \emph{sę́} ‘lake’.

\subsubsection{Table of stanzas}

The order of stanzas, which varies greatly across the mss., is illustrated by the following table.

Stanzas cited in \Gylfaginning\ have been handled in the following way: those cited independently are marked with a plus sign, while those belonging to a sequence of several sts.~are marked with an incrementing letter based on the sequence and a number for its position, so that \emph{A1} is the first stanza in the first sequence, \emph{B1} the first stanza in the second sequence, and so forth.
...
\llap{„}\edtrans{\edtext{\alst{H}ljóðs}{\Afootnote{The \emph{H} is an ornamented initial 5 lines in height, noticeably taller than any other initial save the one introducing \textlink{HelgakvidaOne} \Regius \emph{;} introduced by a small initial 2 lines in height \Hauksbok.}} bið’k}{For hearing I ask}{\Bfootnote{The same introductory expression is found in st.~2 of Eyel’s Head-ransom
(Egill \emph{Hfl} in \Skp\ 5): \emph{hljóðs biðjum hann} ‘for hearing we [I] ask him’.}} allar \hld\ \edtrans{\alst{h}ęlgar}{holy}{\Afootnote{so \Hauksbok \emph{;} om. \Regius}\Bfootnote{That the omission of this word in \Regius\ is nothing more than a scribal error is clearly shown by the meter;
...
\edtrans{\alst{Á}r vas \alst{a}lda}{It was early of ages}{\Bfootnote{By these words the wallow begins her narrative in mythic time, in the earliest age (\emph{ǫld}, cf.~st.~44/4--5 below), \emph{in illo tempore}.
...
áðr \edtrans{\alst{B}urs synir}{the Sons of Byre}{\Bfootnote{In \Gylfaginning~6:8--10 identified as the three brothers Weden (ON \emph{Óðinn}), Will (\emph{Vili}), and Wigh (\emph{Véi}), the first Gods.  For their identities cf.~st.~16/2: \emph{ę̇sir} n.~below.}} \hld\ \edtrans{\alst{b}jǫðum of ypðu}{revealed the flatlands}{\Bfootnote{The verb \emph{yppa} (here ‘reveal’) is a causative derived from ON \emph{upp} ‘up’, \emph{uppi} ‘above, up, on high, remembered’ (cf.~below st.~15/6a).  The translation as ‘reveal’ is based on its poetic sense ‘extol, divulge’ and its OE cognate \emph{yppan} ‘bring up, bring forth, reveal’.

There is an apparent contradiction here, since this verb, regardless of translation, implies the earth was covered, probably by the sea as is clearly implied by st.~56 below.  This problem can be explained in two ways.  (1) According to \Gylfaginning~7:3--5 the killing of Yimer flooded the world with so much blood that it drowned all the ettins except for Bearyelmer and his family, who survived by taking refuge on his canoe (\emph{lúðr}, see \textlink{Vafthrudnismal}[35] for discussion on this word and a citation of the relevant passage).  Thus, the present stanza would likewise allude to this primæval post-sacrificial flood.
(2) If the \Gylfaginning~(\RegiusProse\Trajectinus\Wormianus\Upsaliensis) version of l.~3/1b (\emph{þat’s ękki vas} ‘when nothing was’) is authentic, the wallow may not have intended to allude to the myth of Yimer at all but may instead have been thinking of something like Genesis 1:2, 9--10, where Elohim makes dry earth rise up from the deep waters.  The problem with explanation (2) is that st.~3/2 above states plainly that there was not yet any sea before the sons of Byre; as such (1) should be preferred.}}, &
...
\Ballnote{The Sun has lifted herself up over the horizon and risen for the first time, but she does not know where to go after that, nor do the Moon or the Stars.}%
...
If we instead see \emph{iodyr} \Regius\ as corrupted from an archetypal \emph{*iodur} shared by \Hauksbok, we can restore \emph{*himin-jǫður}, as done here.}}}{\lemma{Sól \dots\ himin-jǫður ‘Sun \dots\ heaven’s rim’}\Afootnote{om. \RegiusProse\Trajectinus\Wormianus\Upsaliensis.}}; &
...
\Ballnote{The Gods assemble at their Thing and solve the problem of the disorder of the heavenly bodies, implicitly by causing them to turn around in the Heavens (cf.~\textlink{Vafthrudnismal}[22]--25, \textlink{Grimnismal}[38]).  Thereafter they establish the reckoning of time by giving names to the natural cycles.  This name-giving, the establishment of norms, is seen as a part of the Godly ordering of the universe; in fact it is the very act of naming and thereby categorising these phenomena which sets them apart from the disordered Chaos.  Thus the categories and norms, rather than being arbitrarily invented by Man, are seen as stemming directly from the Gods \parencite[21--22]{EliadeReturn}.
This view should not be confused with the positive modern Christian scientific attitude towards Nature which is based on the idea of understanding the order in the perfect design of an intelligent Creator.  In the traditional worldview the raw matter already exists before the Gods in the disordered form of Yimer and other Ettins (cf.~\textlink{Vafthrudnismal}[31]).  The Creation consists in \emph{shaping} it according to the Godly Will, that is, the heroic masculine creative intellect.}%
\edtext{Þȧ gingu \edtrans{\alst{r}ęgin ǫll}{all the Reins}{\Bfootnote{All the Gods (\emph{ręgin} ‘Reins’, i.e. ‘Powers, Counsels’; a pantheistic word), here acting as one body.  According to \Skaldskaparmal\ 1 twelve Gods were present at the Thing apart from Weden; these were Thunder, Nearth, Free, Tew, Homedall, Bray, Wider, Wonnel, Wolder, Heener, Foresitter, and Lock.  However Wonnel and Lock can hardly have been seated at the Thing at the same time, since Wonnel was born to avenge Balder Lock was bound after Balder’s death (cf.~st.~34 below, \textlink{Lokasenna}[P8]), so that the Gods at the Thing later numbered twelve, including Weden.
The number twelve clearly belongs to historical Germanic Thing-proceedings; cf.~\textlink{Baldrsdraumar}[1]/1--3 n.}} \hld\ ȧ \edtrans{\alst{r}ǫk-stóla}{Rake-seats}{\Bfootnote{Their thrones of judgment.}}, &
\edtrans{\alst{g}inn-hęilǫg \alst{g}oð}{yin-holy Gods}{\Bfootnote{A reverent epithet, ‘the vast holy (i.e. inviolable) Gods’.  \emph{ginn-hęilagr} ‘yin-holy’ is composed of the augmentative prefix \emph{ginn-} ‘yin-’ (cf.~OE \emph{ġinn} ‘wide, vast, ample’) + \emph{hęilagr} ‘holy, inviolable’.
Outside of the present refrain this adjective only has one other occurrence in the Norse corpus, \textlink{Lokasenna}[11]/2: \emph{ǫll ginn-hęilǫg goð} ‘all yin-holy Gods’.}}, \hld\ ok umb þat \alst{g}ę̇ttu⸗sk}{\lemma{Þȧ \dots\ gę̇ttu⸗sk ‘Then \dots\ of that.’}\Bfootnote{A refrain (\emph{stęf}) describing the convening of the \inx[P]{Thing of the Gods} repeated below in sts.~9/1--2, 22/1--2, and 24/1--2.  The establishment of the Thing of the Gods is further described in \Gylfaginning~14:2--7 as cited in st.~7 below.  It is also mentioned in \textlink{Hymiskvida}[39]/1 and \textlink{Grimnismal}[29]--30.

We ought to cf.~the three lines shared between \textlink{Baldrsdraumar}[1]/1--3 and \textlink{Thrymskvida}[14]/1--3, which follow the same structure as the present refrain: \emph{Sęnn vǫ́ru ę̇sir \hld\ allir ȧ þingi // ok ǫ̇synjur \hld\ allar ȧ máli, // ok umb þat réðu \hld\ ríkir tívar.} ‘Soon were the \inx[P]{Eese} all at the \inx[C]{Thing}, // and the \inx[P]{Ossens} all at speech, // and of that counseled the mighty \inx[P]{Tews}.’
In every of either refrain for the formulaic convening of the Thing outside of the present stanza, the demonstrative pronoun \emph{þat} ‘this, that’ clearly refers to an immediately following question introduced by a \emph{hv}-word which describes a problem the Gods have to deal with (e.g. \textlink{Thrymskvida}[14]/4: \emph{hvé þęir Hlór·riða \hld\ hamar of sǿtti?} ‘how they Loride’s \name{= Thunder’s} hammer would find?’)
Following this pattern we would expect to find such a question following \emph{umb þat gę̇ttu⸗sk} ‘took counsel of that’ in the present stanza, and so it seems reasonably plausible (but not certain) that such has been lost in transmission.}}. &
...
The civilising role of fire is found in Norse sources in \EyrbyggjaSaga\ 4 (\emph{fór Þór·ólfr eldi um land-nám sitt} ‘Thurolf journeyed with fire around his land-taking’) and \Gutasaga\ 1 (\emph{Gut·land hitti fyrsti maðr þann, sum Þielvarr hít.  Þá var Gut·land so eliust, et þet dagum sank ok náttum var uppi.  En þann maðr kvam fyrsti eldi á land, ok síðan sank þet aldri.} ‘Gotland was first discovered by the man who was named Thelver.  At that time Gotland was so uncanny(?) that it sank during the days and was up during the nights.  But that man was the first who brought fire to the land, and thereafter it never sank.’).  This has close Indian parallels \parencite[11]{EliadeReturn}; fire features prominently in Norse ritual, cf.~\textlink{Grimnismal}[43]/2.}} lǫgðu, \hld\ \alst{au}ð smíðuðu, &
...
The IE root sense, clearly retained in Celtic and Germanic, thus appears to be a state of frenzied poetic inspiration, \emph{furor poeticus}, but the sense in the present stanza may also cleaves closer to ‘intelligent thought, mind’, or the power to express one’s thoughts with words which is unique to man.}} þau né hǫfðu, &
...
‘Further it is said that the Norns who dwell by the Well of Weird fetch water in the Well every day, and along with it the mud which lies around the well; and they pour it up over the Ash so that its branches should not harden or rot.  But that water is so holy that all things which come into the well turn as white as the membrane called the shell-membrane which lies inside the eggshell.’
...
\edtext{\alst{A}sk vęit’k \edtext{standa}{\lemma{standa ‘standing’}\Afootnote{so \Regius\Hauksbok\Upsaliensis \emph{;} \emph{ausinn} ‘sprinkled’ \RegiusProse\Trajectinus\Wormianus}}, \hld\ hęitir \edtext{\alst{Y}gg·drasils}{\Afootnote{so \RegiusProse \emph{;} \emph{Ygg·drasill} all others}}}{\lemma{Ask \dots\ Ygg·drasils ‘Ash \dots\ Ugdrassle’s’}\Bfootnote{The Ash of Ugdrassle, the World Tree.
That the Ash stands in the very center of the world is shown by \textlink{Grimnismal}[26]/4, where we learn that all waters run their course from it, and \textlink{Grimnismal}[31], which tells us that the roots from it reach and wrap around the world of Men, the Underworld, and the Ettinhomes.}}, &
...
\bvb An ash I know standing, ’tis called \inx[P]{Ugdrassle}’s: \\
...
\edtrans{\edtext{\alst{l}ę́-gjarn\emph{s}}{\Afootnote{gramm.~emend.; \emph{lę́-gjarn} (acc.~sg.) \Regius}}}{guile-eager}{\Bfootnote{An epithet of Lock, who is strongly associated with \emph{lę́} ‘guile, deceit’.  His name more often occurs paired with the adjective \emph{lę́-víss} ‘guile-wise’, so \textlink{Hymiskvida}[37]/4, \textlink{Lokasenna}[54]/5, and \Sorlathattr\ 2.}} \alst{l}íki \hld\ \alst{L}oka ȧ·þękkjan;}{\lemma{Hapt \dots\ ȧ·þękkjan ‘A captive \dots\ to Lock,’}\Afootnote{om.~and replaced by H1 \Hauksbok.}} &
...
\Ballnote{Ll.~1--2, 4 are cited in \Gylfaginning~52; see st.~36 above. --- This st.~takes a distinctly moralising tone otherwise rare in pre-Christian poetry; cf.~st.~44 below.  The crimes are what one might expect in a source from Germanic antiquity: perjury, murder and adultery.  In Scandinavian and Anglo-Saxon laws the committer of such crimes typically held the dishonourable title of \inx[C]{nithing}, that is, one afflicted with \inx[C]{nithe} (‘evil, shame’).  It is fitting, then, that such nithings should be tortured by a creature named Nithehewer (‘Nithe-striker’).
...
Watery punishment in the Heathen afterlife is also described in \textlink{Reginsmal}[3]--4 and possibly in \textlink{Grimnismal}[21]; a perjurious woman is drowned in a bog in \textlink{GudrunThree}[10].  This argument is pursued at at greater length in \textcite{RosenbergForthcoming}.}%
...
\alst{m}ęnn \edtext{\alst{m}ęin-svara \hld\ ok \edtrans{\alst{m}orð-varga}{murder-wargs}{\Afootnote{\emph{morð-vargar} (nom.~pl.) \Regius\RegiusProse\Trajectinus\Wormianus \emph{;} \emph{morðingjar} ‘murderers’ \Upsaliensis.}\Bfootnote{Men outlawed for murder, which is not merely the taking of human life, but specifically done clandestinely and intentionally in ways deemed particularly reproachable.}}}{\Afootnote{These two phrases (\emph{morð-varga} and \emph{męin-svara ok}) rev.~but the correct order indicated by a symbol \Regius.}} &
\edtext{ok þann’s \alst{a}nnars glępr \hld\ \edtrans{\edtext{\alst{ęy}ra-ru̇nu}{\Afootnote{\emph{†eyrna runa†} \Hauksbok}}}{ear-whisperess}{\Bfootnote{The second element nom. sg. \emph{ru̇na} ‘whisperess, confidante’ is derived from \emph{ru̇n} ‘whisper, secret’, and lit.~means ‘one with whom one shares whispers/secrets’; cf.~the masculine \emph{(of) ru̇ni} ‘friend, confidant’, OE \emph{ge·rúna} ‘counsellor’.  This word is also used in \textlink{Havamal}[115], which contains a warning not to seduce another man’s wife.}}.}{\Afootnote{om.~\RegiusProse\Trajectinus\Wormianus\Upsaliensis.}} &
...
In \emph{Kalevala} 47--49 she steals away the sun, moon, and fire, for which cf.~st.~24 n.~above.
...
This stanza takes a noticeably moral tone which may be compared with st.~38 above.  In the view of the wallow human moral failures accompany the decline and ultimate destruction of the World, and perhaps even speed it on.  This moralising may be seen as Christian influence (cf.~e.g.~\textlink{Muspilli} 59 for a similar condemnation), but the crimes listed both here and in st.~38 (perjury, murder, adultery, kinslaying, and incest) were all certainly forbidden also in pre-Christian Germanic legal systems and in the pre-Christian worldview a threat to the established social order was also a threat to the very existence of the World itself (see st.~38 n.~above).}%
...
ON \emph{ver-ǫld} is cognate with English \emph{world}, but in ON the sense “cosmos, universe” is usually expressed by \emph{hęimr} (e.g. l. 3 of the present stanza).}} \edtrans{stęypi⸗sk}{tumbles down}{\Bfootnote{\emph{grundir gjalla \hld\ gífr fljúgandi} (norm.) ‘foundations shrill, fiends flying’ add. after this l. \Hauksbok}} &
...
at \edtext{hinu}{\Afootnote{so \Hauksbok \emph{;} \emph{†en†} \Regius.}} \alst{g}alla \hld\ \edtrans{\alst{G}jallar-horni}{Yellhorn}{\Bfootnote{Or the ‘Horn of Yell’, viz. the river \emph{Gjǫll} ‘Yell’ as mentioned in \textlink{Grimnismal}[28]/6.  The root of the river’s name is the same as English “yell”.}};}{\lemma{Lęika \dots\ Gjallar-horni; ‘Mime’s \dots\ Yell.’}\Afootnote{om. \RegiusProse\Trajectinus\Wormianus\Upsaliensis}} &
...
\Ballnote{This st.~is paraphrased in \Gylfaginning~14:18 by the words: \emph{En þessir kómu frá Svarins-haugi til Aur-vanga á Jǫru-vǫllu, ok er kominn þaðan Lofarr.} ‘But these ones came from Swornshigh to the Earwongs on the Erwolds, and from them Loffer is come.’  After this \Gylfaginning\ cites st.~15/3--5.}%
...
\Ballnote{The dwarf-names in this st.~are split up in \Gylfaginning~14.
...
The names of ll.~3--5 are cited in \Gylfaginning~14:19 immediately following a paraphrase of st.~14, introduced by the words \emph{þessi eru nǫfn þeira} ‘these are their names’.}%
...
\alst{l}ang-niðja-tal \hld\ \edtext{\alst{L}ofars hafat}{\Bfootnote{This line would be unmetrical in the rest of the poem since the first lift is on a short syllable \parencite[373]{Males2025}.  This strongly suggests}}.\eva
