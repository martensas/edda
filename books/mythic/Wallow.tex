...
\bvg\bva\mssnote{\Regius~1r/6, \Hauksbok~20r/4, \\ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}%
...
\bvg\bva\mssnote{\Regius~1r/11, \Hauksbok~20r/7, \\ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}%
...
\bvg\bva\mssnote{\Regius~1r/20, \Hauksbok~20r/14, \\ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}%
...
{\Afootnote{so \RegiusProse\Trajectinus\Wormianus\Upsaliensis \emph{;} \emph{drotin} ‘the lord’ \Regius \emph{;} \emph{dróttir} ‘the troops’ \Hauksbok}} \edtrans{\edtext{of}%
...
\bvg\bva\mssnote{\Regius~1r/21, \Hauksbok~20r/15, \\ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}%
...
\alst{d}verga allra, \hld\ ęn \alst{D}urinn annarr;}{\lemma{Þar \dots\ annarr ‘There \dots\ second’}\Afootnote{om. \RegiusProse\Trajectinus\Wormianus\Upsaliensis}{\Bfootnote{These lines are not found in \Gylfaginning, but the author must have had the full stanza since he paraphrases them (see st.~9 n. above).}}} &
...
\alst{d}vergar \edtrans{ï}{in}{\Afootnote{so \Hauksbok\RegiusProse\Trajectinus\Wormianus\Upsaliensis \emph{;} \emph{ór} ‘out of’ \Regius}} jǫrðu, \hld\ \edtrans{sęm \alst{D}urinn sagði}{as Dorn said}%
...
\bvg\bva\mssnote{\Regius~1v/5, \Hauksbok~20r/29, \\ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}%
...
\alst{h}ǫ́r \edtrans{baðmr}{tree}{\Afootnote{\emph{borinn} ‘born’ (wo. doubt corrupt) \Upsaliensis.}}, \edtrans{\edtrans{ausinn}{sprinkled}{\Afootnote{\emph{hęilagr} ‘holy’ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}} \hld\ \alst{h}víta auri}{sprinkled with white mud}{\Bfootnote{Cf.~st.~26/3--4 below.}}; &
...
For the three Norns we may compare a strikingly similar description in the late ancient Gallo-Roman source \emph{De medicamentis} (TODO: cite), which relates a traditional Celtic myth of a tree standing in the middle of the sea, kept by three virgins; similar things are depicted on syncretic altars from western Germany, which depict the three \emph{Matronae Andrusteihae} ‘Tree-Standing Mothers’ next to a great tree (TODO: cite).
...
\alst{þ}ríar ór þęim \edtrans{sal}{hall}{\Afootnote{so \Hauksbok, \RegiusProse\Trajectinus\Wormianus\Upsaliensis\ (in the paraphrase); \emph{sę́} ‘lake’ \Regius}} \hld\ es \edtrans{und}{under}{\Afootnote{\emph{ȧ} ‘on’ \Hauksbok}} \edtrans{\alst{þ}olli}{tree}{\Bfootnote{Literally ‘fir’, but the word is only used for the alliteration and the species is generic.  The same may perhaps apply to \emph{askr} ‘ash’ above.}} stęndr; &
...
\bvg\bva\mssnote{\Regius~1v/19, \Hauksbok~20r/34, \\ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}%
...
\bvg\bva\mssnote{\Regius~1v/20, \Hauksbok~20r/36, \\ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}%
\Aallnote{The order of the lines follows \Regius\Hauksbok; they are 3, 4, 1, 2 in \RegiusProse\Trajectinus\Wormianus\Upsaliensis.}%
...
\bvg\bva\mssnote{\Regius~1v/26, \\ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}%
...
\bvg\bva\mssnote{\Regius~2r/13, \Hauksbok~20v/19, \\ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}%
\alst{S}al \edtrans{sá hǫ̇n}{she saw}{\Afootnote{\emph{vęit’k} ‘I know’ \RegiusProse\Trajectinus\Wormianus\Upsaliensis.}} standa \hld\ \alst{s}ólu fjarri &
...
\bvg\bva\mssnote{\Regius~2r/15, \Hauksbok~20v/21, \\ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}%
...
\edtrans{Sá hǫ̇n}{she saw}{\Afootnote{so \Regius \emph{;} \emph{sér hǫ̇n} ‘she sees’ \Hauksbok \emph{;} \emph{skulu} ‘shall [be]’ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}} \alst{þ}ar vaða \hld\ \alst{þ}unga strauma &
...
Þar \edtrans{saug}{sucked on}{\Afootnote{so \Hauksbok \emph{;} \emph{†sv́g†} \Regius \emph{;} \emph{kvęlr} ‘torments’ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}} \alst{N}íð·hǫggr \hld\ \alst{n}ái fram-gingna; &
...
\edtrans{\alst{Au}str}{In the east}{\Bfootnote{The cardinal direction associated with ettins and other fiendish creatures; cf.~\textlink{Hymiskvida}[5]/1 n.}} \edtrans{býr}{dwells}{\Afootnote{so \Hauksbok\RegiusProse\Trajectinus\Wormianus\Upsaliensis \emph{;} \emph{sat} ’sat/stayed’ \Regius}} \edtrans{hin \edtrans{\alst{a}ldna}{old}{\Afootnote{\emph{arma} ‘wretched’ \Upsaliensis}}%
...
ok \edtrans{\alst{f}ǿðir}{rears}{\Afootnote{so \Hauksbok\RegiusProse\Trajectinus\Wormianus\Upsaliensis \emph{;} \emph{fǿddi} ‘reared’ \Regius}} þar \hld\ \alst{F}ęnris kindir; &
...
\edtrans{\alst{s}vǫrt verða \alst{s}ól-skin}{Black turn the sun’s rays}{\Afootnote{so \Hauksbok\RegiusProse\Trajectinus\Wormianus\Upsaliensis \emph{;} \emph{svart var þá sól-skin} ‘Black was then the sun’s shine’ \Regius}\Bfootnote{As part of the Fimblewinter; see \textlink{Vafthrudnismal}[44]/3--4 n. ---
...
\bvg\bva\mssnote{\Regius~2r/28, \Hauksbok~20v/24, \\ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}%
...
\bvg\bva\mssnote{\Regius~2r/32, \Hauksbok~20v/27, \\ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}%
...
\bvg\bva\mssnote{\Regius~2v/8, \Hauksbok~20v/30, \\ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}%
...
\bvg\bva\mssnote{\Regius~2v/10, \Hauksbok~20v/36, \\ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}%
...
þȧ mun \alst{F}riggjar \hld\ \alst{f}alla \edtext{angan}{\Afootnote{so \Hauksbok\RegiusProse\Trajectinus\Wormianus\Upsaliensis \emph{;} \emph{angantyr} \Regius}}.\eva
...
\edtrans{Þȧ kømr hinn \alst{m}ikli \hld\ \alst{m}ǫgr Sig-fǫður}{Then comes the great son of Syefather}{\Afootnote{\emph{Gęngr Óðins sonr \hld\ við ulf vega} ‘Weden’s son goes the Wolf to fight’ \RegiusProse\Trajectinus\Wormianus\Upsaliensis.}}, &
\alst{V}íð·arr \edtext{\alst{v}ega}{\Afootnote{\emph{of veg} \RegiusProse\Trajectinus\Wormianus\Upsaliensis}} \hld\ at \alst{v}al-dýri; &
...
\Aallnote{The present form of the stanza is an amalgamation of all three ms.~traditions (\Regius, \Hauksbok, and \RegiusProse\Trajectinus\Wormianus\Upsaliensis) based most closely on \Hauksbok\ and \RegiusProse\Trajectinus\Wormianus\Upsaliensis, which have the last 3 lines in the same order.  \Regius\ has the lines in the order 1, 5, 4, 2, 3 and inserts an additional line between 1 and 5.}%
\edtrans{\edtrans{Þȧ kømr}{Then comes}{\Afootnote{\emph{Gęngr} ‘Goes’ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}} hinn \alst{m}ę́ri \hld\ \alst{m}ǫgr Hlǫðynjar,}{Then comes the famed lad of Lathyn}{\Afootnote{om. \Hauksbok \emph{;} add. \emph{gęngr Óðins sonr við ulf (\emph{pro} *orm) vega.} ‘Weden’s son goes the Wolf (error for ‘Wyrm’) to fight.’ \Regius.}} &
\edtrans{gęngr \alst{f}et níu \hld\ \edtext{\alst{F}jǫrgynjar}{\linenum{|2|||3}\lemma{Hlǫðynjar, Fjǫrgynjar ‘Lathyn, Firgyn’}\Bfootnote{Both names for the \inx[P]{Earth}, who is Thunder’s mother.}} burr}{nine steps takes Firgyn’s son}{\Afootnote{om. \RegiusProse\Trajectinus\Wormianus\Upsaliensis.}} &
...
\bvg\bva\mssnote{\Regius~2v/20, \Hauksbok~21r/1, \\ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}%
...
\alst{S}ól \edtrans{tér}{doth}{\Afootnote{\emph{mun} ‘will’ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}} \alst{s}ortna, \hld\ \edtrans{\edtrans{\alst{s}ígr}{sinks}{\Afootnote{\emph{søkkr} \RegiusProse\Trajectinus\Wormianus}} fold ï mar}{the land sinks into the sea}%
...
\bvg\bva\mssnote{\Regius~2v/31, \Hauksbok~21r/12, \\ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}%
...
\alst{S}al \edtrans{sér hǫ̇n}{she sees}{\Afootnote{\emph{vęit’k} ‘I know’ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}} standa \hld\ \alst{s}ólu fęgra, &
\edtrans{\alst{g}olli þakðan}{thatched with gold}{\Afootnote{\emph{golli bętra} ‘better than gold’ \RegiusProse\Trajectinus}}, \hld\ ȧ \edtext{\alst{G}im·léi}{\Afootnote{metr. emend.; \emph{Gim·lé} \Regius\Hauksbok\RegiusProse\Trajectinus\Wormianus\Upsaliensis}}; &
...
\bvg\bva[11]\mssnote{\Regius~1r/23, \Hauksbok~20r/17, \\ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}%
...
\bvg\bva[12]\mssnote{\Regius~1r/25, \Hauksbok~20r/18, \\ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}%
\alst{V}ęigr ok Gand·alfr, \hld\ \alst{V}ind·alfr, Þráinn, &
\alst{Þ}ękkr ok \alst{Þ}orinn, \hld\ \alst{Þ}rór, Vitr ok Litr, &
\alst{N}ár ok \alst{N}ý·ráðr, \hld\ ---\edtext{\edtext{\alst{n}ú hęf’k dverga}{\Afootnote{om. \RegiusProse\Trajectinus\Wormianus\Upsaliensis}}--- &
\alst{R}ęginn ok \alst{R}áð·sviðr \hld\ ---\edtext{\alst{r}étt of talða}{\Afootnote{om. \RegiusProse\Trajectinus\Wormianus\Upsaliensis}}.}{\lemma{nú hęf’k dverga \dots\ rétt of talða ‘now have I the dwarfs rightly tallied’}\Bfootnote{An inset clause; since it does not list the names of any dwarfs it was omitted by Snorre in \Gylfaginning.}}\eva
...
\bvg\bva[13]\mssnote{\Regius~1r/28, \Hauksbok~20r/20, \\ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}%
...
\bvg\bva[14]\mssnote{\Regius~1r/30, \Hauksbok~20r/22, \\ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}%
...
\bvg\bva[15]\mssnote{\Regius~1r/32, \Hauksbok~20r/24, \\ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}%
