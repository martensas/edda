...
The first is the motif of an enemy of the Gods wishing to steal away one of their women.  This is also attested in the myth of the ettin wall-builder (\textlink{Voluspa}[24] nn., \Gylfaginning~42) and in \textlink{Thrymskvida} (see Introduction to that poem), where the ettin Thrim demands the hand of the goddess Frow as a ransom for Thunder’s hammer Millner.

The second motif is that of a dwarf perishing (usually by turning to stone, although that is not stated explicitly in \Alvissmal) when exposed to sunlight, something famously used by J.R.R Tolkien in \emph{The Hobbit}, where three trolls turn to stone at daybreak.

\subsubsection{The language of the Gods}

The bulk of the poem (sts.~9--34) is however taken up by the listing of poetic synonyms for various things.  The poem contrasts the normal terms used by men with those used by the Elves, Dwarfs, Gods, and those in Hell or the Underworld.
...
The fascinating idea of a language of the Gods is not unique to the Norse but is also attested in other cultures.  Notably, Homer often mentions that things have different names among Gods and mortals.

So a certain hill at Troy “do men truly call ‘Thorny Hill’ (\textgreek{Βατίειαν}), but the Undying ‘the Barrow of much-springing Myrina’ (\textgreek{σῆμα πολυ·σκάρθμοιο Μυρίνης})” (\Iliad\ 2.813--814); a certain bird “do Gods called Bronzen (\textgreek{χαλκίδα}), but men \textgreek{κύμινδιν}” (\Iliad\ 14.291); and the river Scamander “do Gods call Xanthus (\textgreek{Ξάνθον}), but men Scamander (\textgreek{Σκάμανδρον})” (\Iliad\ 20.74).


Mortals call it Nighthawk but immortals Bronze Throat
...
\bvg\bva\speakernote{[All·víss kvað:]}%
...
\bvb\speakernoteb{[Allwise quoth:]}%
...
\bvg\bva\speakernote{[All·víss kvað:]}%
„\alst{Jǫ}rð hęitir með mǫnnum \hld\ ęn með \alst{ǫ}lfum fold, &
...
\bvg\bva\speakernote{[All·víss kvað:]}%
„\alst{H}iminn hęitir með mǫnnum \hld\ ęn \alst{H}lýrnir með goðum &
...
\bvg\bva\speakernote{[All·víss kvað:]}%
„\alst{M}ȧni hęitir með \alst{m}ǫnnum \hld\ ęn \alst{M}ylinn með goðum, &
...
\bvg\bva\speakernote{[All·víss kvað:]}%
„\edtext{\alst{S}ól hęitir með mǫnnum \hld\ ęn \alst{s}unna}{\lemma{Sól \dots\ sunna ‘Sun \dots\ Swail’}\Bfootnote{A problem arises for the translation since \emph{sól} is the normal word for ‘sun’ in ON, whereas the direct cognate to English “sun” \emph{sunna} is a poetic synonym.  To solve this \emph{sunna} has been translated as ‘swail’ (< OE \emph{sweġel}), a cognate of \emph{sól} that preserves the \emph{l} of the old IE heteroclitic noun (cf.~\cite{Kroonen2013}[463--464]).}} með goðum &
...
\bvg\bva\speakernote{[All·víss kvað:]}%
„\alst{Sk}ý hęita með mǫnnum, \hld\ ęn \alst{sk}úr-vǫ́n með goðum; &
...
\bvg\bva\speakernote{[All·víss kvað:]}%
„\alst{V}indr hęitir með mǫnnum, \hld\ ęn \alst{v}ǫ́fuðr með goðum; &
...
\bvg\bva\speakernote{[All·víss kvað:]}%
„\alst{L}ogn hęitir með mǫnnum, \hld\ ęn \alst{l}ę́gi með goðum, &
...
\bvg\bva\speakernote{[All·víss kvað:]}%
„\alst{S}ę́r hęitir með mǫnnum, \hld\ ęn \alst{s}ï-lę́gja með goðum, &
...
\bvg\bva\speakernote{[All·víss kvað:]}%
„\alst{Ę}ldr hęitir með mǫnnum \hld\ ęn með \alst{ǫ̇}sum funi &
...
\alst{f}rekan jǫtnar \hld\ ęn \alst{f}or-bręnni dvergar &
...
\bvg\bva\speakernote{[All·víss kvað:]}%
„\alst{V}iðr hęitir með mǫnnum. \hld\ ęn \edtext{\alst{v}allar fa\emph{x}}{\Afootnote{emend.; \emph{vallar far} \Regius.}} með goðum &
...
\bvg\bva\speakernote{[All·víss kvað:]}%
„\alst{N}ǫ́tt hęitir með mǫnnum \hld\ ęn \alst{n}jól með goðum, &
...
\bvg\bva\speakernote{[All·víss kvað:]}%
„\alst{B}ygg hęitir með mǫnnum \hld\ ęn \alst{b}arr með goðum &
...
\bvg\bva\speakernote{[All·víss kvað:]}%
„\alst{Ǫ}l hęitir með mǫnnum \hld\ ęn með \alst{ǫ̇}sum bjórr; &
