...
\speakernote{[Al·víss kvað:]}%
\llap{„}\alst{B}ękki \alst{b}ręiða \hld\ nú skal \alst{b}rúðr með mér &
\ind hęim i̇́ \alst{s}inni \alst{s}núask; &
...
\ind vast-u i̇́ \alst{n}ǫ́tt með \alst{n}á? &
...
\speakernote{[Al·víss kvað:]}%
\llap{„}Hvat ’s þat \alst{r}ekka \hld\ es i̇́ \alst{r}ǫ́ðum tęlsk &
...
at \alst{ȯ}·sátt mi̇́nni \hld\ skalt þat it \alst{u}nga man hafa &
...
\speakernote{[Al·víss kvað:]}%
\llap{„}\alst{S}áttir þi̇́nar \hld\ es ek vil \alst{s}nemma hafa &
...
\ind \alst{h}ęimi \alst{h}vęrjum i̇́.“\eva
...
\speakernote{[Al·víss kvað:]}%
\llap{„}\alst{Jǫ}rð hęitir með mǫnnum \hld\ ęn með \edtrans{\alst{ǫ̇}\emph{s}um}{Eese}{\Afootnote{\emph{ǫlfum} ‘Elves’ \Regius}\Bfootnote{The emendation from Elves to Eese is non-controversial.  The second verse in each answer-stanza otherwise always mentions the Gods, either with \emph{ǫ̇sum} ‘Eese’ and the same structure as the present verse (so sts.~26 and 34), or with \emph{goðum} ‘Gods’ (so 12, 14, 16, 18, 20, 22, 24, 28, 30, 32).  Aside from this argument, there is otherwise a repetition, as elves are mentioned in l.~3.  The error is in any case easily understandable, since the two words are written similarly and both refer to supernatural beings.}} fold, &
\ind kalla \alst{v}ega \alst{v}anir. &
\alst{i̇́}-grǿn \alst{jǫ}tnar \hld\ \alst{a}lfar gróandi &
\ind kalla \alst{au}r \alst{u}pp-ręgin.“\eva

\bvb\speakernoteb{[Quoth Allwise:]}%
“Earth it is called among men but among the Eese ‘fold’; \\
...
\ind kalla \alst{h}verfanda \alst{h}vél \alst{h}ęlju i̇́; &
...
\ind kalla i̇́ hęlju \alst{h}jalm \alst{h}uliðs.“\eva
...
\ind kalla i̇́ \alst{h}ęlju \alst{h}viðuð.“\eva
...
\speakernote{[Al·víss kvað:]}%
\llap{„}\alst{S}ę́r hęitir með mǫnnum, \hld\ ęn \alst{s}i̇́-lę́gja með goðum, &
...
\ind kalla i̇́ \alst{h}ęlju \alst{h}rǫðuð.“\eva
...
\ind kalla i̇́ \alst{h}ęlju \alst{h}nipinn.“\eva
...
\alst{h}ręina-lǫg jǫtnar \hld\ ęn i̇́ \alst{h}ęlju mjǫð; &
...
\ind nú ski̇́nn \alst{s}ól i̇́ \alst{s}ali.“\eva
