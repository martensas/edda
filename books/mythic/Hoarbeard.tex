...
The \textbf{Leeds of Hoarbeard} (\textlink{Harbardsljod}) is preserved in full (sts.~1--60) in \Regius\ on foll.~12r/30--13v/26.  Sts.~14/4b--60 are found in \AM\ on foll.~1r/1--1v/17.

\subsection{Contents}

\Harbardsljod\ is a dialogue between the two figures Thunder and Hoarbeard, who meet at a sound.  Thunder asks Hoarbeard, the ferryman, for passage; an argument ensues, and Thunder is forced to depart.  Thunder is the well-known god, but Hoarbeard merits discussion.  Considering his name, which appears in \textlink{Grimnismal}[51] as a name for Weden, and his generally Odinic character, he is near-universally considered to be the god Weden.

The difference in personality between the two gods is striking, so that \Harbardsljod\ is far from a flyting between, say, two warriors of equal stature.  Thunder is portrayed as moral and altruistic, but also rather naive and the foil for the insults of Hoarbeard.  Hoarbeard on the other hand is egoistic and sly.  He is the first to insult Thunder, and gets the last laugh by denying him passage.

The poem might be seen as an allegory on class relations, namely between the self-owning yeomen farmers and the warlike earls, represented by their patron gods.

\subsection{Meter}

Of all Eddic poems \textlink{Harbardsljod} is probably the strangest in terms of form.  It consists of 60 “stanzas”, if all of them can be called that.  No narrative prose is embedded apart from P1 at the very beginning, which merely sets the stage.

Stanza length varies greatly.  4 ll.~is by no means the standard (in fact only a single fully regular \Ljodahattr-stanza of type \emph{abcabc} occurs, viz.~st.~47), and many consist of single lines.

The meter is a mix of \Malahattr\ and \Ljodahattr.  Many ll.~are of an obscene length somewhat reminiscent of, but certainly not related to \textlink{Heliand} (e.g.~sts.~4/3b, 56/5a, 59/1--2); others have no metrical qualities at all (sts.~17, 31, 41, 44--46, 57, 60).

\subsection{Language}

The young clitic definite is employed with unique frequency throughout the poem.  On the other hand there is a presence of rare and prob.~old words (e.g. \emph{ǫgurr} in st. 13).

\subsubsection{Possibilities of performance}

The loose meter and non-formal language demand discussion.  To begin with, we should disregard the notion that \Harbardsljod\ is heavily corrupt and requires restoration and state clearly that no amount of emendation can “restore” \Harbardsljod\ to pure \Ljodahattr\ like we find in \textlink{Havamal} or \textlink{Lokasenna}.  Most lines, including those of unusual length or without metrical qualities, are readily understandable and fit well both within their immediate context and the poem as a whole.  If there is widespread corruption, it has produced a remarkably consistent, albeit unconventional, text.

Still, the poem is unconventional.  As all Norse poetry, at least of sufficient age (see below), was originally oral, \Harbardsljod\ must have been performed in some way.  Several problems are solved quite nicely if we assume that it was acted out in a sort of carnivalesque theatre with two actors standing on a stage, perhaps separated by a staged body of water, and shouting at each other; alternatively with one actor playing both roles by the use of props and acting.

The whole poem seems remarkably fit for such a performance, and with this assumption many pieces fall into place.  Take Thunder’s talk of his breakfast and the pack on his back (st.~3), which invites the actor to point to his back and then rub his belly; Hoarbeard’s insult of Thunder’s dress (st.~6), which would work much better if there was in fact an actor with his pants pulled up to his knees; or Hoarbeard’s declaration that he will not cross the water but instead remain \emph{hér} ‘here’ (st. 14), which invites stomping on the ground.  A theatric performance would also explain the metrical variations and the use of informal non-poetic features like the clitic definite as vulgar elements.  The prose lines may even have been shouted out, which would explain their lack of meter.

(TODO: mention the concept of the "double scene" by Lars Lönnroth?)

Further support is found in the structure of the dialogue, which has a remarkable affinity to a common fixture in comedic duos: the straight man (Thunder) and the funny man (Hoarbeard).  The (by Wiking Age standards) ever-moral Thunder serves as the perfect foil to the egoistic Hoarbeard and falls effortlessly for his opponent’s “trolling”.  It is hard not to imagine the audience laughing more and more as Thunder gets angrier and angrier, while at the same time harbouring respect for his boasting of his great feats, which in the pagan religion served not just as entertainment but also as ritual etiology \parencite{Lindow1988}.

\subsection{Dating}

Formal and linguistic criteria can be taken to point towards a later date for \Harbardsljod\ than for most other mythological poems, but as discussed above, the loose meter and use of the definite may be stylistic features as part of the relaxed and vulgar register of the poem, which is clearly meant to entertain its audience.

There are also features that speak against a late date.  Among content-based criteria, there is a thorough understanding of the personalities of the two gods, which would seem unlikely to have survived long after the conversion of Iceland and which does not come off as antiquarian.  The quotation of a variant ettin-name in st.~26 is notable since it points away from antiquarian composition, which would more likely have inserted the familiar name \emph{Skrymir} ‘Shrimer’.
...
The model devised by \textcite{Sapp2022} gives the poem a 57.8\% likelihood of being from the early 11th c., and a 37.7\% likelihood of being from the late 11th.  These scores are most similar to those obtained by \textlink{Gripisspa} (a poem recognized as very young---not from the 11th c.) but \Harbardsljod\ shares so little with it that the similarity is probably not reliable.
...
„Hvęrr ’s sá \edtrans{\alst{s}vęinn \alst{s}vęina}{swain of swains}{\Bfootnote{For the construction “X of Xs” cf.~}} \hld\ es stęndr fyr \alst{s}und’it handan?“\eva
...
\ind þȧ’s ek \alst{v}élta þę́r \edtrans{frȧ \alst{v}erum}{from mankind}{\Bfootnote{Alternatively ‘from their husbands’, but that makes less sense in the context.  For \emph{verar} ‘men, husbands’ in the general sense ‘mankind’ cf. st. 53/3 below, \textlink{Lokasenna}[24]/3.}}. &
...
\speakernote{Hár·barðr kvað:}%
„\edtrans{Þat hęfir \alst{ęi}k \hld\ es af \alst{a}nnarri skęfr}{An oak has that which it chafes from the other}{\Bfootnote{Proverbial, also appearing in \Malshattakvadi\ 26/3a.}}; &
\ind umb \alst{s}ik es hvęrr ï \alst{s}líku--- &
\ind hvat vannt-u \alst{þ}ȧ meðan, \alst{Þ}ȯrr?“\eva

\bvb%
“An oak has that which it chafes from the other; \\
\ind each man is for himself in such matters--- \\
\ind what didst thou accomplish in the meantime, Thunder?”\evb\evg


\bvg\bva\mssnote{\Regius~13r/9, \AM~1r/4}%
\Ballnote{Thunder here makes a moral statement against Hoarbeard’s egoism as expressed in the previous stanza.  In the religion, Thunder is the defender of the Gods and Middenyard (the home of Men) against the Ettins, for which cf. \textlink{Voluspa}[25], 53, \textlink{Thrymskvida}[18]; for Thunder’s killing of ettin-women in particular cf. sts. 37--39 below, \textlink{EddicFragments}[F6][6], and \textcite{Lindow1988}.}%
\speakernote{Þórr kvað:}%
...
\ind ęn \alst{Þ}ȯrr á \alst{þ}rę́la kyn.“\eva
...
Thou daredst not out of thy fear \\
...
\bvb%
“I learned them from the elderly who dwell in homely forests.”\evb\evg
...
\alst{þ}ar mun Fjǫrgyn \hld\ hitta \alst{Þ}ȯr, son sïnn, &
...
\speakernote{Hár·barðr kvað:}%
\Ballnote{The speaker is uncertain.  This line is separated with a speech marker from st. 59 in \AM; in \Regius\ it belongs to 59.}%
