...
Of all Eddic poems \textlink{Harbardsljod} is probably the strangest in terms of form.  Verse length varies greatly, and many lines (see especially the final stanza) are of an obscene length reminiscent of continental Germanic poems like \textlink{Heliand}; some have no metrical qualities at all.  The young clitic definite is employed with unique frequency throughout the poem.  These criteria would seem to point towards a later date for \Harbardsljod\ than most other mythological poems.

There are however features that speak against a late date.  These are the presence of rare words (e.g. \emph{ǫgurr} in st. 13), and a thorough understanding of the personalities of the two gods, which would seem unlikely to have survived long after the conversion of Iceland.  The model devised by \textcite{Sapp2022} gives the poem a 57.8\% likelihood of being from the early C11th, and a 37.7\% likelihood of being from the late 11th.  These scores are actually most similar to those obtained by \textlink{Gripisspa}, a poem recognized as very young.

What could we then be dealing with? It may of course be the case that \Harbardsljod\ is heavily corrupt, but there is no real evidence for this.  Most lines, including those of unusual length or without metrical qualities, are readily understandable and fit well both within their respective context and the poem as a whole.  If it is corruption, it has still produced a remarkably consistent, albeit unconventional, text.

An interesting solution to the problem is if we assume that the poem has been acted out as a sort of carnivalesque theatre with two actors standing on a stage and shouting at each other, or alternatively one actor playing both roles by the use of props and two voices.

The poem seems remarkably fit for such performance.  Take Thunder’s talk of his breakfast and the pack on his back (st. 3) which invite the actor to point to his back and then rub his belly; Hoarbeard’s insult of Thunder’s dress (st. 6), which would work much better if there was in fact an actor with his pants pulled up to his knees; or Hoarbeard’s declaration that he will not cross the water but instead remain \emph{hér} ‘here (st. 14), which invites stomping in the ground.  This context would also explain the metrical variations, the sporadic lack of alliteration, and the use of informal non-poetic features like the clitic definite as comedic, vulgar elements.

TODO: mention concept of "double scene" by Lars Lönnroth?
...
\bvb%
“Who is this swain of swains that stands here across the sound?”\evb\evg
...
\speakernote{[Þórr kvað:]}%
„\alst{St}ýr þú hingat ęikju’nni, \hld\ ek mun þér \alst{st}ǫðna kęnna &
...
þȧ mun’k \alst{f}orða \alst{f}jǫrvi mïnu \hld\ nema ek \alst{f}ęigr sé.“\eva
...
\speakernote{[Þórr kvað:]}%
„Harm ljótan \hld\ mér \alst{þ}ikkir ï \alst{þ}ví &
\ind at \alst{v}aða of \alst{v}áginn til þïn &
\ind ok \alst{v}ę́ta \edtrans{ǫgur}{burden}{\Bfootnote{The sense of this word is not clear, though it is probably the same as the first element of the compound \emph{ǫgur-stund} ‘burdensome hour’ found in \textlink{Volundarkvida}[42].  I find the most convincing interpretation to be that it refers to the food Thunder carries on his back, as previously mentioned in st. 3.  Thunder then uses his desire not to get his food wet as an excuse not to wade.  Some authors have read it as a euphemism for ‘bollocks’, but this is discordant with the angry, serious tone of the rest of the stanza and with Thunder’s general role in the poem as the “straight man” next to Hoarbeard.  It is also a very poor excuse for Thunder’s unwillingness to wade, since wading is a frequent attribute of this god (e.g. \textlink{Grimnismal}[29], \textlink{EddicFragments}[F6][6]), and at those occasions he shows no fear of “getting his bollocks wet”.}} mïnn; &
...
fannt⸗a-tu mann inn \alst{h}arðara \hld\ at \edtrans{\alst{H}rungni}{Rungner}{\Bfootnote{Rungner was a famous ettin slain by Thunder in a fierce battle (\Skaldskaparmal\ 24--25, \Haustlong\ 14--20).  Hoarbeard’s mention of him sets off a long argument over their respective accomplishments.}} dauðan.“\eva
...
\bvb%
“O Hoarbeard the \inx[C]{queer}! I would strike thee into \inx[P]{Hell}, \\
