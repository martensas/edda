...
The \textbf{Dreams of Balder} (\textlink{Baldrsdraumar}) is not preserved in \Regius, but rather in the early C14th ms. \AM.  A younger redaction, characterized by a number of post-mediæval additions, is transmitted in several copies in later paper mss.
...
ok hann ȧ \alst{S}lęipni \hld\ \alst{s}ǫðul of lagði, &
...
nam hann \alst{v}ittugri \hld\ \edtrans{\alst{v}al-galdr}{slain-galder}{\Bfootnote{i.e. a galder to quicken the dead, in this case the wallow.  Cf. \textlink{Havamal}[158] where Weden tells how He can bring hanged men back to life with runes.}} kveða, &
...
en \alst{ǫ̇}s-męgir \hld\ í \alst{o}f-vę̇ni; &
...
\speakernote{[Vǫlva kvað:]}%
„Rindr berr \edtext{\emph{\alst{V}ȧla}}{\Afootnote{required by alliteration; om. \AM}} \hld\ ï \alst{v}estr-sǫlum, &
...
áðr ȧ \alst{b}ál of \alst{b}err \hld\ \alst{B}aldrs and-skota;}{\lemma{sá \dots\ and-skota ‘he will \dots\ shooter’}\Bfootnote{These lines are, apart from the verb tense, identical to \textlink{Voluspa}[32]/4–33/2.  It is possible that both are building on a now-lost third poem; or that one has got these lines from the other.  (For discussion on the myth itself see \textlink{Voluspa}[31]–34.)}} &
\alst{n}auðug sagða’k, \hld\ \alst{n}ú mun’k þęgja.“\eva
