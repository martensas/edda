...
\alst{f}ramm ręið Óðinn, \hld\ \edtrans{\alst{f}old-vegr dunði}{the fold-way \ken{earth} resounded}{\Bfootnote{Cf. the description of \inx[P]{Thunder}’s riding in \Haustlong\ 14: \emph{dunði \dots\ mána vegr und hǫ́num} ‘the moon’s way \ken{sky/heaven} \dots\ resounded beneath him’); see further \textlink{Thrymskvida}[21].}}, &
...
\speakernote{[Óðinn kvað:]}%
„Ert-at \alst{v}ǫlva \hld\ né \alst{v}ís kona, &
