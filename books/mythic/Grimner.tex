...
\alst{B}ręiða-\alst{b}lik \edtrans{eru (hin sjaundu)}{are (the seventh)}{\Afootnote{\emph{hęita} ‘[they] are called’ \GylfMS.}}, \hld\ ęn þar \alst{B}aldr hęfir &
\ind \alst{s}ér of gǫrva \alst{s}ali, &
...
\alst{H}imin-bjǫrg \edtrans{eru (hin ǫ́ttu)}{are (the eighth)}{\Afootnote{\emph{hęita} ‘[they] are called’ \GylfMS.}}, \hld\ ęn þar \alst{H}ęim·dall &
...
\alst{G}litnir \edtrans{es (hinn tíundi)}{is (the tenth)}{\Afootnote{\emph{hęitir salr} ‘a hall is called’ \GylfMS}}, \hld\ hann ’s \alst{g}olli studdr &
