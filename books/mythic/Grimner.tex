...
Other instances of dative \emph{⸗umk} include \textlink{Lokasenna}[35]/1a: \emph{es⸗umk}, \textlink{Fafnismal}[1]/4: \emph{stǫnd⸗umk}, \textlink{EddicFragments}[F2][2]:1/1: \emph{eru⸗mk}, and \Ragnarsdrapa\ 7/2a: \emph{gǫf⸗umk}.}} \alst{f}uni! &
...
\Ballnote{This stanza is clearly closely related to \textlink{Vafthrudnismal}[21]; see there for discussion on Yimer.}%
