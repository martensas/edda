...
\alst{B}ręiða-\alst{b}lik \edtrans{eru (hin sjaundu)}{are (the seventh)}{\Afootnote{\emph{hęita} ‘[they] are called’ \RegiusProse\Trajectinus\Wormianus\Upsaliensis.}}, \hld\ ęn þar \alst{B}aldr hęfir &
\ind \alst{s}ér of gǫrva \alst{s}ali, &
...
\alst{H}imin-bjǫrg \edtrans{eru (hin ǫ́ttu)}{are (the eighth)}{\Afootnote{\emph{hęita} ‘[they] are called’ \RegiusProse\Trajectinus\Wormianus\Upsaliensis.}}, \hld\ ęn þar \alst{H}ęim·dall &
...
\alst{F}olk-vangr \edtrans{es (hinn níundi)}{is (the ninth)}{\Afootnote{\emph{hęitir} ‘[one] is called’ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}}, \hld\ ęn þar \alst{F}ręyja rę́ðr &
...
\alst{G}litnir \edtrans{es (hinn tíundi)}{is (the tenth)}{\Afootnote{\emph{hęitir salr} ‘a hall is called’ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}}, \hld\ hann ’s \alst{g}olli studdr &
