...
The \textbf{Speeches of Grimner} (\textlink{Grimnismal}) is preserved whole in both \Regius\ and \AM.  22 stanzas (11--15, 18--20, 23--24, 29, 34--37, 41--42, 45, 47--49, 51) are preserved in citation in \Gylfaginning, in the case of 23, 24, and 37 explicitly attributed to \emph{Grímnis mǫ́l}.
...
The text begins with the frame narrative, which tells the story of the two king’s sons Ayner and Garfrith.  The elder Ayner is fostered by Frie, while the younger Garfrith is fostered by her husband, Weden.  After their father’s death Garfrith upon the advice of Weden betrays his elder brother and becomes the king after his father (P1).
...
Here the gnomic section begins as Weden lists the individual abodes of the gods (4--17).  The locations are numbered, but a few facts speak to these numbers being later inserts:

\begin{enumerate}
  \item The alliteration is never reliant on the numbers; if one compares the numbered items in \textlink{Havamal}[147]--165 and \textlink{Vafthrudnismal}[20]--42 the difference is striking.
  ...
  \item In \Gylfaginning’s citations of sts.~11--15 the numbers are missing.
\end{enumerate}
...
Upon learning that the wizard is Weden himself Garfrith jumps up from his throne to take the god away from the fires, but trips and falls on his unsheathed sword.  After this his son Ayner becomes king and ruled the kingdom for a long time (P4).
...
Hann hljóp upp á land en hratt út skipinu, ok mę́lti: „\edtrans{Far þú þar er smyl hafi þik.}{Go thou whither the fiends may have thee!}{\Bfootnote{The same curse is attested with \emph{gramir} for \emph{smyl} in \textlink{Harbardsljod}[60] and in a related form in \textlink{Brot}[10].}}“
...
Frigg sendi eskis-mey sína, Fullu, til Geir·røðar. Hón bað konung varask at eigi fyr·gerði hǫ́num fjǫl-kunnigr maðr sá er þar var kominn í land, ok sagði þat mark á at engi hundr var svá ólmr at á hann myndi hlaupa.
...
\ind \edtrans{und’s of \alst{r}júfask \alst{r}ęgin}{until the Reins are ripped}{\Bfootnote{Until the \inx[P]{Rakes of the Reins}.  A formulaic expression; see note to \textlink{Baldrsdraumar}[14] for further occurrences.}}.\eva
...
\alst{G}laðs-hęimr hęitir (hinn fimti) \hld\ þar’s hin \alst{g}oll-bjarta &
...
\alst{B}ręiða-\alst{b}lik \edtrans{eru (hin sjaundu)}{are (the seventh)}{\Bfootnote{\emph{hęita} ‘[they] are called’ \RegiusProse\Trajectinus\Upsaliensis\Wormianus.}}, \hld\ ęn þar \alst{B}aldr hęfir &
\ind \alst{s}ér of gǫrva \alst{s}ali, &
ȧ því \alst{l}andi \hld\ es \alst{l}iggja vęit’k &
\ind \alst{f}ę́sta \edtrans{\alst{f}ęikn-stafi}{wicked deeds}{\Bfootnote{This sense of \emph{stafir} (lit.~‘staffs, staves’) is common in poetry.  Cf.~the direct cognate in \Beowulf\ 1018b: \emph{fâcen-stafas}, generally taken as referring to treacherous intrigues among the \inx[P]{Shieldings} \parencite[177]{KlaeberBeowulf}.}}.\eva
...
\alst{H}imin-bjǫrg \edtrans{eru (hin ǫ́ttu)}{are (the eighth)}{\Bfootnote{\emph{hęita} ‘[they] are called’ \RegiusProse\Trajectinus\Upsaliensis\Wormianus.}}, \hld\ ęn þar \alst{H}ęim·dall &
\ind kveða \alst{v}alda \alst{v}éum; &
þar \edtrans{\alst{v}ǫrðr goða}{Watchman of the Gods}{\Bfootnote{Formulaic epithet of Homedall, also occurring in \textlink{Lokasenna}[49] and possibly in \textlink{Skirnismal}[28]: \emph{vǫrðr með goðum} ‘the Watchman among the Gods’.  \Gylfaginning~27, where the present stanza is cited, gives some further details; see \textlink{EddicFragments}[F3][III].}} \hld\ drekkr ï \alst{v}ę́ru ranni &
...
\alst{F}olk-vangr \edtrans{es (hinn níundi)}{is (the ninth)}{\Bfootnote{\emph{hęitir} ‘[one] is called’ \RegiusProse\Trajectinus\Upsaliensis\Wormianus}}, \hld\ ęn þar \alst{F}ręyja rę́ðr &
\ind \alst{s}essa kostum ï \alst{s}al; &
\edtrans{\alst{h}alfan val \hld\ hǫ̇n kýss \alst{h}vęrjan dag}{half the slain she chooses each day}{\Bfootnote{Apart from the paraphrase in \Gylfaginning~this statement is unprecedented; in all other sources the battle-slain are devoted exclusively to Weden and chosen by his walkirries.
...
\bvb Folkwong is (the ninth), and there Frow rules \\
...
\alst{G}litnir \edtrans{es (hinn tíundi)}{is (the tenth)}{\Bfootnote{\emph{hęitir salr} ‘a hall is called’ \RegiusProse\Trajectinus\Upsaliensis\Wormianus}}, \hld\ hann ’s \alst{g}olli studdr &
\ind ok \alst{s}ilfri þakðr it \alst{s}ama; &
ęn þar \alst{F}or·seti \hld\ byggir \alst{f}lęstan dag &
...
\ind \alst{s}ér of gǫrva \alst{s}ali; &
\edtrans{\alst{m}anna þęngill \hld\ hinn \alst{m}ęins-vani}{The lord of men, the guiltless one}{\Bfootnote{Interesting epithets probably relating to Nearth’s roles in upholding the bounty of the land and the Law.  Cf.~my article on pre-Christian oaths (TODO).}} &
...
ęn þar \alst{m}ǫgr of lę́tsk \hld\ af \alst{m}ars baki &
...
Sts.~18--20 are cited in order in \Gylfaginning~38.  St.~18 is cited in \Gylfaginning~38:6, introduced by the words \emph{Svá er hér sagt} ‘So it is said here.’  \Gylfaginning~38:3, 5 provides context: \emph{En aldri er svá mikill mann-fjǫlði í Val-hǫll at eigi má þeim enda⸗sk flesk galtar þess er Sę́·hrímnir heitir.  Hann er soðinn hvern dag ok heill at aptni.  [...]  And·hrímnir heitir steikari’nn en Eld·hrímnir ketill’inn.} ‘But there is never such a great gathering of men in Walhall that they should not be satisfied with the flesh of the boar which is called Sowrimner.  He is cooked every day and is healthy and alive in the evening.  [...]  Andrimner is the name of the cook, but Eldrimner the kettle.’}%
\alst{A}nd·hrímnir \hld\ lę́tr ï \alst{Ę}ld·hrímni &
\ind \alst{S}ę́·hrímni \alst{s}oðinn, &
\alst{f}lęska bętst, \hld\ ęn þat \alst{f}áir vitu, &
...
\Ballnote{St.~19 is cited in \Gylfaginning~38:10, introduced by the words \emph{Svá segir hér.} ‘So it says here.’  \Gylfaginning~38:7--9 provides context: \emph{Þá mę́lti Gangleri: „Hvárt hefir Óðinn þat sama borð-hald sem Ein-herjar?“ Hárr segir: „Þá vist, er á hans borði stendr, gefr hann tveim úlfum, er hann á, er svá heita, Geri ok Freki.  En enga vist þarf hann: Vín er honum bę́ði drykkr ok matr.} ‘Then spoke Gangler: “Does Weden have the same table-customs as the Oneharriers?” High says: “The foodstuff which stands on his table he gives to the two wolves he owns, which are called so: Gar and Freak.  But he needs no foodstuffs: for him wine is both drink and food.’}%
\edtrans{\alst{G}era ok Freka}{Gare and Freak}{\Bfootnote{Weden’s two hounds.  It is not said with what food Weden feeds them, but if we consider Weden’s relation to the common ‘beasts of battle’ motif, it is most likely the corpses of dead warriors.}} \hld\ sęðr \alst{g}unn-tamiðr, &
\ind \alst{h}róðigr \alst{H}ęrja-fǫðr, &
ęn við \edtrans{\alst{v}ïn}{wine}{\Bfootnote{The wine on which he himself subsists may perhaps be identified with drink offerings.  For hallowing of alcohol to Weden cf.~the 7th c. \emph{Vita Columbani}, ch. 53, describing a heathen rite of the Swabians (\cite[1040D--1041A]{VitaColumbani}, my translation):
...
‘While he was staying there and going about the dwellers of that place, he found out that they were going to offer a profane sacrifice, and a large cask called a \emph{cupa}, which held about twenty-six measures, was filled with beer and set in their midst.  When the man of God asked what they wanted to do with it they answered that they wanted to offer it to their god \emph{Vodan}, whom others call Mercury.’}} ęitt \hld\ \alst{v}ápn-gǫfugr &
...
\Ballnote{St.~20 is cited in \Gylfaginning~38:13 and concludes the chapter, introduced by the words \emph{Svá sem sagt er} ‘Just as it is said’.  \Gylfaginning~38:11--12 provides context: \emph{Hrafnar tveir sitja á ǫxlum hónum ok segja í eyru honum ǫll tíðendi, þau er þeir sjá eða heyra.  Þeir heita svá, Huginn ok Muninn.  Þá sendir hann í dagan at fljúga um heim allan, ok koma þeir aptr at dǫgurðar-máli.  Þar af verðr hann margra tíðenda víss.  Því kalla menn hann Hrafna-guð.} ‘Two ravens sit upon his shoulders and speak into his ears all the tidings which they see or hear.  They are called thus: Highen and Minden.  He sends them out at dawn to fly about all the Home, and they come back at supper-time.  Thereof he becomes wise about many tidings.  Therefore men call him Raven-god.’}%
...
\ind þó sé⸗umk \alst{m}ęir of \alst{M}unin.\eva
...
\bvg\bva\mssnote{\Regius~9v/34, \AM~4v/22, \\ \RegiusProse\Trajectinus\Upsaliensis\Wormianus}%
\Aallnote{Sts.~23 and 24 come in reverse order in \AM.}%
\Ballnote{This st.~is cited in \Gylfaginning~21:6, the chapter describing Thunder, introduced by the words \emph{Svá segir í Grímnis-mǫ́lum} ‘So it says in the Speeches of Grimner’.  \Gylfaginning~21:4--5 provides the context: \emph{Hann á þar ríki er Þrúð-vangar heita, en hǫll hans heitir Bil-skirnir.  Í þeim sal eru fimm hundrað gólfa ok fjórir tigir.  Þat er hús mest svá at menn viti.} ‘He has his domain in the place called the Thrithwongs, but his hall is called Bilshirner.  In that hall there are five hundred and fourty floors.  That is the greatest house which men know of.’}%
...
\ind \edtrans{þȧ’s \edtext{fara}{\Afootnote{\emph{ganga} \Upsaliensis}} \edtext{við}{\Afootnote{so \AM\Wormianus\Upsaliensis; \emph{at} \Regius; \emph{með} \RegiusProse\Trajectinus}} \alst{v}itni at \alst{v}ega}{when to fight with the Wolf they fare}{\Bfootnote{At the Rakes of the Reins by Weden’s side.  Cf.~\textlink{Voluspa}[51]--52, \textlink{Vafthrudnismal}[53].}}.\eva
...
\ind ok bítr af \edtrans{\alst{L}ę́-raðs}{Leered}{\Bfootnote{Ugdrassle’s Ash, as is seen by the mention of the stag in st.~26 and again in st.~36.}} \alst{l}imum; &
\edtrans{\alst{sk}ap-kęr}{shape-vats}{\Bfootnote{According to \CV\ the central beer-vat, from which drinks were poured into smaller vessels.}} fylla \hld\ skal \edtrans{hins \alst{sk}íra mjaðar}{the pure mead}{\Bfootnote{The goat’s milk is sweet mead.}}, &
...
The shape-vat shall she fill with the pure mead; \\
...
ęn af hans \alst{h}ornum \hld\ drýpr ï \alst{H}ver-gęlmi &
...
\Gylfaginning~39:9--10 immediately continues with its paraphrase (cf.~sts.~25--26 above), clearly deriving from sts.~27--28: \emph{ok þaðan af falla þę́r ár, er svá heita: Síð, Víð, Sękin, Ekin, Svǫl, Gunn-þró, Fjǫrm, Fimbul-þul, Gípul, Gǫpul, Gǫmul, Geir-vimul. Þessar falla um ása byggðir.  Þessar eru enn nefndar: Þyn, Vín, Þǫll, Hǫll, Grǫ́ð, Gunn-þráin, Nyt, Nǫt, Nǫnn, Hrǫnn, Vína, Vegsvinn, Þjóð-numa.} ‘and thereof fall the rivers which are called so: Side, Wide, Shin, Ecken, Swale, Guththrew, Ferm, Fimblethule, Gipple, Gapple, Gamble, Garwimble.  These fall around the settlements of the Eese.  These are yet named: Tyne, Ween, Thuil, Huil, Gread, Guththrown, Nit, Nat, Nan, Ran, Wine, Wayswith, Thednumb.’}%
...
\alst{V}ïna hęitir ęnn, \hld\ ǫnnur \alst{V}eg-svinn, &
\ind \alst{þ}riðja \alst{Þ}jóð-numa; &
\alst{N}yt ok \alst{N}ǫt, \hld\ \alst{N}ǫnn ok Hrǫnn, &
\alst{S}lið ok Hrið, \hld\ \alst{S}ylgr ok Ylgr, &
...
því’t \alst{ǫ̇}s-brú \hld\ brinn \alst{ǫ}ll loga &
...
\Ballnote{This st.~is paraphrased in \Gylfaginning~16:6, immediately following the paraphrase of the last st.: \emph{En fjórir hirtir renna í limum asksins ok bíta barr; þeir heita svá: Dáinn, Dvalinn, Dún-eyrr, Dura-þrór.} ‘But four harts run in the limbs of the ash and bite its leaves; they are called thus: Dowen, Dwollen, Downeer, Doorthrew.’}%
\alst{H}irtir ’ro ok fjórir \hld\ þęir’s af \alst{h}ę́fingar ȧ &
\ind \edtrans{\edtext{\alst{g}ag-halsir}{\Afootnote{\emph{‘agaghalsir’} \Regius}} \alst{g}naga}{with turned necks gnaw}{\Bfootnote{An iconographic parallel to this line presents itself in the common Wiking Age depictions of great horned beasts turning their necks backwards, e.g. on the runestone E 2 or the round brooch from Espinge, Scania (HST 108124).}}: &
...
\Ballnote{\textlink{Grimnismal}[34]--36 are cited in \Gylfaginning~16:8 in the order 36, 34, 35.  They are introduced by \Gylfaginning~16:7--8: \emph{En svá margir ormar eru í Hvergelmi með Níð·hǫgg, at engi tunga má telja; svá segir hér:} ‘But so many wyrms are in Wharyelmer with Nithehewer that no tongue may count them.  So it says here:’}%
...
\alst{G}óinn ok Móinn, \hld\ þęir ’ro \alst{G}raf·vitnis synir, &
...
\alst{h}jǫrtr bítr ofan \hld\ ęn ȧ \alst{h}liðu fu̇nar, &
...
\bvg\bva\mssnote{\Regius~10r/30, \AM~5r/16, \\ \RegiusProse\Trajectinus\Upsaliensis\Wormianus}%
\Ballnote{St.~37 is cited in \Gylfaginning~36:2.  \Gylfaginning~36:1--2 introduces it: \emph{Enn eru þę́r aðrar er þjóna skulu í Val-hǫll, bera drykkju ok gę́ta borð-búnaðar ok ǫl-gagna.  Svá eru þę́r nefndar í Grímnis-mǫ́lum.} ‘Yet there are the other [heavenly] women who shall serve in Walhall, carry the drinks and prepare the table-cloth and ale-stuffs.  So are they named in the Speeches of Grimner.’}%
\alst{H}rist ok Mist \hld\ vil’k at mér \alst{h}orn beri, &
\ind \alst{Sk}eggj·ǫld ok \alst{Sk}ǫgul, &
\edtrans{\alst{H}ildr ok Þrúðr}{Hild and Thrith}{\Afootnote{\emph{Hildi ok Þrúði} \Regius\ stems from \emph{ꝺꝛ, ðꝛ} with r rotunda being interpreted and copied as \emph{ꝺı, ðı}; this becomes clear upon viewing the facsimile images.}}, \hld\ \alst{H}lǫkk ok \alst{H}ęr-fjǫtur, &
\ind \alst{G}ǫll ok \alst{G}ęir·ǫlul, &
\alst{R}and·gríð ok \alst{R}áð·gríð, \hld\ \alst{R}ęgin·lęif; &
\ind \edtrans{þę́r bera \alst{ęi}n-hęrjum \alst{ǫ}l}{they bring the Oneharriers ale}{\Bfootnote{As cupbearers in Walhall.  Pouring drinks was traditionally done by the ruler’s kinswomen during a feast; the most famous literary example would be Rothgar’s wife and daughter in \Beowulf.  The Walkirries may be daughters of Weden; see note to \textlink{Voluspa}[30]/5.  For the reception of dead warriors see also note to st.~53/3 below.}}.\eva
...
\Ballnote{According to \Gylfaginning~12:4--5 the wolf Sholl chases the sun while his brother Hater chases the moon (which is presumably why the latter is said to run ahead of the sun in the pres.~st.).  For discussion on these wolves see \textlink{Voluspa}[40] n.}%
...
ęn annarr \alst{H}ati, \hld\ hann ’s \alst{H}róð·vitnis sonr, &
...
but another one is \inx[P]{Hater}; he is \inx[P]{Rothwitner}’s son; \\
\ind he shall [run] in front of the clear bride of heaven \ken{sun}.\evb\evg


\bvg\bva\mssnote{\Regius~10v/6, \AM~5r/23, \\ \RegiusProse\Trajectinus\Upsaliensis\Wormianus \\ \AMb~9v/14, \EddaBms~3v/11}%TODO: Critical notes for these next two stanzas based on the mss. Sigla for ms. B = AM 757 a 4°.
\Ballnote{St.~41 is clearly closely related to \textlink{Vafthrudnismal}[21]; for Yimer see there. ---
Sts.~41--42 are cited in \Gylfaginning~8:25, introduced by the words \emph{Svá sem hér segir} ‘Just as it says here’.  The preceding \Gylfaginning~8:20--24 describes the Earth: \emph{[...] Hón er kring-lótt útan, ok þar útan um liggr inn djúpi sjár, ok með þeiri sjávar-strǫndu gǫ́fu þeir lǫnd til byggðar jǫtna ę́ttum.  En fyrir innan á jǫrðu’nni gerðu þeir borg um-hverfis heim fyrir ó·friði jǫtna.  En til þeirar borgar hǫfðu þeir brár Ymis jǫtuns ok kǫlluðu þá borg Mið·garð.  Þeir tóku ok heila hans ok kǫstuðu í lopt ok gerðu af ský’in.} ‘It is round without, and there on the outside around it lies the deep sea, and along that sea-shore they gave the land for the settling of the lineages of the Ettins.  But further within upon the Earth they made a stronghold around the Home against the enmity of the ettins.  But for that stronghold they used the eyebrows of the etting Yimer, and they called the stronghold Middenyard.  They also took his brains and threw them into the air and thereof made the clouds.’}%
Ór \alst{Y}mis holdi \hld\ vas \alst{jǫ}rð of skǫpuð, &
\ind ęn ór \edtrans{\alst{s}vęita}{blood}{\Afootnote{\emph{hans sára svęita ‘blood of his wounds’} \AMb\EddaBms}} \edtext{\alst{s}jór}{\Afootnote{so \AM\AMb\EddaBms; \emph{sę́r} \Regius}}, &
\alst{b}jǫrg ór \alst{b}ęinum, \hld\ \alst{b}aðmr ór hári, &
\ind ęn \edtrans{ór \alst{h}ausi \alst{h}iminn}{from his skull the heaven}{\Afootnote{\emph{himinn ór hausi hans ‘the heaven from his skull’} \AMb\EddaBms}}.\eva
...
\bvg\bva\mssnote{\Regius~10v/8, \AM~5r/25, \\ \RegiusProse\Trajectinus\Upsaliensis\Wormianus \\ \AMb~9v/16, \EddaBms~3v/12}%
...
ęn ór hans \alst{h}ęila \hld\ vǫ́ru þau hin \edtrans{\alst{h}arð-móðgu}{hard-minded}{\Afootnote{\emph{hríð-fęldu ‘stormy’} \AMb\EddaBms}} &
...
Nordberg’s interpretation becomes especially interesting when one considers the immediately preceding stanzas 41--42 which describe the ordering of the world by the Gods through the killing and dismembering of Yimer, the primordial victim.  That the killing of Yimer was in fact a sacrifice is supported by the manner in which it was done, viz.~beheading, which was the typical manner of slaying sacrificial bulls in the Wiking Age (cf.~\textlink{Vafthrudnismal}[21]/4 n.).

In other Indo-European religions the first sacrifice of a Great Being (most famously the Vedic \textoi{Púruṣa}, \Rigveda\ 10.90) serves as the model for all future sacrifice, the performance of which reenacts the creation and thereby enables the continued existence of the world and the social order (\cite[\emph{passim}]{Lincoln1986}; cf. \textlink{Voluspa}[7]/2 n.).
The sequence \textlink{Grimnismal}[41]--43 then appears to attest this also in the Germanic tradition.}%
\edtrans{\alst{U}llar}{Wolder’s}{\Bfootnote{It is uncertain why the rather obscure god Wolder is invoked here.  It cannot be simply for the sake of alliteration, since \emph{Óðins} ‘Weden’s’ would work just as well.  It is possible that Wolder had a particular role in the setting of the ritual fire, which would find support in the large number of firesteel-shaped amulets at the archeological site of \emph{Lilla Ullevi} (‘Wolder’s little \inx[C]{wigh}’) in Sweden; see Index: \inx[P]{Wolder} and \textcite{afEdholm2009}.}} \edtrans{hylli}{holdness}{\Bfootnote{‘Favour, loyalty, grace’.  This root (from which also the adjective \emph{hollr} ‘hold; favourable, loyal, gracious’ and verb \emph{hylla} ‘to make hold’) is used to refer to the grace of god(s) in both Heathen and Christian texts.  See Index: \inx[C]{hold} and \inx[C]{holdness}.}} \hld\ hęfr ok \edtrans{\alst{a}llra goða}{All Gods}{\Bfootnote{Cf.~\textlink{Sigrdrifumal}[3]--4, \textlink{Lokasenna}[11], which both hail the Gods as a collective (the former as part of a genuine prayer, the latter subversively).  For the oneness of the Gods see Index: \inx[C]{All Gods}.}} &
\ind hvęrr’s \edtext{tękr \alst{f}yrstr ȧ \alst{f}una}{\lemma{tękr \dots\ ȧ funa ‘touches the fire’}\Bfootnote{Viz.~the hallowed fire above which the holy cauldrons are hung; for the role of fire in Germanic and Vedic sacrifice see \textcite{Kaliff2005}. ---
An otherwise unattested phrase, but cf.~\emph{taka ęld} ‘light a fire’.  With \emph{ȧ} ‘on’ the verb \emph{taka} ‘take’ has a variety of idiomatic senses like ‘touch, react to, get involved in, get on’, etc.}}, &
...
\bvb \inx[P]{Wolder}’s \inx[C]{holdness} and that of \inx[C]{All Gods} \\
...
\bvg\bva\mssnote{\Regius~10v/13, \AM~5r/29, \\ \RegiusProse\Trajectinus\Upsaliensis\Wormianus}%
\Ballnote{St.~45 concludes Weden’s mythological wisdom. ---

The stanza is cited in \Gylfaginning~41:7, introduced by the words: \emph{Svá er hér sagt í orðum sjalfra ásanna:} ‘So it is said here in the words of the Eese themselves.’  \Gylfaginning~41:2--6 provides context: \emph{Þá mę́lti Gangleri: „All-mikill mann-fjǫlði er í Val-hǫll.  Svá njóta trú minnar, at all-mikill hǫfðingi er Óðinn, er hann stýrir svá miklum her. [...]“ Hárr segir: „[...]} 6 \emph{En satt er þat, er þú sagðir.  Mikill er Óðinn fyrir sér.  Mǫrg dǿmi finna⸗sk til þess.} ‘Then spoke Gangler: “A all-great gathering of men is there within Walhall.  So does my belief entertain that Weden is an all-great chieftain when he wields such a great host.” [...] 6 High says: “But true is that which thou saidst.  Weden is great in his own right.  Many examples attest to that.”’  For \Gylfaginning~41:3--5 see \textlink{Vafthrudnismal}[41] n.}%
...
\alst{B}il·rǫst \alst{b}rúa \hld\ ęn \alst{B}ragi skalda, &
\alst{H}ǫ́·brók \alst{h}auka \hld\ ęn \alst{h}unda Garmr.\eva
...
\Ballnote{Weden announces that he has revealed his true identity as a god and made the Gods aware of his situation; they will leave their feasting at Eagre’s hall (cf.~\textlink{Hymiskvida} and \textlink{Lokasenna}) and come to his rescue.  He then begins his list of names.}%
...
\Ballnote{Apart from the first line, which of course refers to the present situation, the underlying stories are not known.  They presumably refer to other now-lost myths involving Weden travelling in disguise.}%
\alst{G}rímni mik hétu \hld\ at \alst{G}ęir·raðar, &
\ind ęn \alst{Ja}lk at \alst{Ǫ̇}s·mundar; &
ęn þȧ \alst{K}jalar \hld\ es ek \alst{k}jalka dró, &
\ind \edtrans{\alst{Þ}rór \alst{þ}ingum at}{Throo at Things}{\Bfootnote{Perhaps a reference to a name under which Weden was invoked at the start of Things or legal assemblies.}}.\eva

\bvb Grimner they called me at Garfrith’s \\
\ind and Gelding at Osmund’s, \\
and Keller when I pulled the sled; \\
\ind Throo at \inx[C]{Thing}[Things].\evb\evg
...
\ind \alst{G}ǫndlir ok \edtrans{Hár·barðr}{Hoarbeard}{\Bfootnote{Viz.~in \textlink{Harbardsljod}.}} með \alst{g}oðum.\eva

\bvb Wisher and Omer, Evenhigh and Bivlend; \\
...
\alst{v}arar ’ro \edtrans{dísir}{Dises}{\Bfootnote{The Norns, fates, who have determined his hour of death.  Cf.~\textlink{Fafnismal}[11]--13, \textlink{Hamdismal}[30].}}, \hld\ nú knátt \alst{Ó}ðin séa; &
...
\edtrans{\alst{Ó}fnir ok Sváfnir}{Ovner and Swebner}{\Bfootnote{Both names are listed among poetic names of Weden in Þul \emph{Óðins} (in \Skp\ 3).  They are also the names of two serpents in 35/3a above.}} \hld\ hygg’k at \alst{o}rðnir sé &
