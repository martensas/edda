...
\Gylfaginning\ predates both \Regius\ and \AM, and \GylfMS\ must thus be distinct from both of them.  Common innovations shared between \Regius\ and \AM\ (e.g.~st.~18/4: om.~\emph{við}, 45/4: \emph{Bil·rǫst}) show that \Regius\AM\ share a common archetype distinct from that of \GylfMS.  Whether \GylfMS\ reflects a written or an oral version of the poem is unclear.
