...
The mythological lore found in \Grimnismal\ is very varied, and most of it will be discussed comparatively in the notes to the individual stanzas, but a few broader motifs ought to be discussed here.

\subsubsection{Weden as guardian of strangers}

TODO

\subsubsection{The lands of the Gods}

TODO: the God-world, Shamanism, Ugdrassle’s Ash as \emph{axis mundi}
...
þar \edtrans{\alst{v}ǫrðr goða}{Watchman of the Gods}{\Bfootnote{Formulaic epithet of Homedall, also occurring in \textlink{Lokasenna}[48]/4 and possibly in \textlink{Skirnismal}[28] (\emph{vǫrðr með goðum} ‘the Watchman among the Gods’).  A similar epithet is found in \Husdrapa\ 2, \emph{vári ragna} ‘Defender of the Reins’.  \Gylfaginning~27, where the present stanza is cited, gives some further details; see \textlink{EddicFragments}[F3][III].}} \hld\ drekkr ï \alst{v}ę́ru ranni &
...
\bvg\bva\mssnote{\Regius~10v/6, \AM~5r/23, \\ \RegiusProse\Trajectinus\Wormianus\Upsaliensis \\ \AMb~9v/14, \EddaBms~3v/11}%TODO: Critical notes for these next two stanzas based on the mss.
...
Sts.~41--42 are cited in \Gylfaginning~8:25, introduced by the words \emph{Svá sem hér segir} ‘Just as it says here’.  The preceding \Gylfaginning~8:20--24 describes the Earth: \emph{[...] Hón er kring-lótt útan, ok þar útan um liggr inn djúpi sjár, ok með þeiri sjávar-strǫndu gǫ́fu þeir lǫnd til byggðar jǫtna ę́ttum.  En fyrir innan á jǫrðu’nni gerðu þeir borg um-hverfis heim fyrir ó·friði jǫtna.  En til þeirar borgar hǫfðu þeir brár Ymis jǫtuns ok kǫlluðu þá borg Mið·garð.  Þeir tóku ok heila hans ok kǫstuðu í lopt ok gerðu af ský’in.} ‘It is round without, and surrounding it there lies the deep sea, and along that sea-shore they [= the Gods] gave the land for the settlement by the lineages of the Ettins.  But further within upon the Earth they made a stronghold around the Home against the enmity of the ettins.  But for that stronghold they used the eyebrows of the ettin Yimer, and they called the stronghold Middenyard.  They also took his brains and cast them into the air and thereof made the clouds.’}%
...
According to this view, the stanza is speaking of the Heavenly favour (\emph{hylli}) earned by the ritualist who sets the cooking fire, since that act enables the Gods to become guests at the ritual meal.
...
In other Indo-European religions the first sacrifice of a Great Being (most famously the Vedic \textoi{Púruṣa}, \Rigveda\ 10.90) serves as the model for all future sacrifice, the performance of which reenacts the Creation and thereby re-establishes the continued existence of the World and the social order (\cite[\emph{passim}]{Lincoln1986}; cf. \textlink{Voluspa}[7]/2 n.).  This re-establishment of Creation is made very explicit in the Vedic fire-sacrifice \parencite[11, 78--80]{EliadeReturn}.
With this in mind we may consider how the sequence \textlink{Grimnismal}[41]--43 likely forms a unit: sts.~41--42 describe the Creation of the World in the mythic past (\emph{illo tempore}) and the following st.~43 ties this into the present, bringing the Sacrifice out of profane time into mythic time.}%
