...
The \textbf{Speeches of Grimner} (\textlink{Grimnismal}) is preserved whole in both \Regius\ and \AM.  22 stanzas (11--15, 18--20, 23--24, 29, 34--37, 41--42, 45, 47--49) are preserved in citation in \Gylfaginning, in the case of 23, 24, and 37 explicitly attributed to \emph{Grímnis mǫ́l}.
...
\alst{Þ}rym-hęimr hęitir \edtrans{(hinn sétti)}{the sixth}{\Afootnote{om. \GylfMS}}, \hld\ \edtrans{es}{where}{\Afootnote{\emph{þar nú} ‘where now’ \Upsaliensis}} \alst{Þ}jatsi \edtrans{bjó}{dwelled}{\Afootnote{om. \Wormianus; \emph{býr} ‘dwells’ \Upsaliensis}}, &
...
\edtext{\alst{B}ręiða-\alst{b}lik}{\Afootnote{\emph{Bręiða} (with \emph{blik} added above the line in other hand) \Regius \emph{;} \emph{Bręiða-†blio†} \AM}} \edtrans{eru (hin sjaundu)}{are (the seventh)}{\Afootnote{\emph{hęita} ‘[they] are called’ \GylfMS.}}, \hld\ ęn þar \alst{B}aldr hęfir &
\ind \alst{s}ér of gǫrva \alst{s}ali, &
...
\alst{G}litnir \edtrans{es (hinn tíundi)}{is (the tenth)}{\Afootnote{\emph{‘h. e. x.’} (for \emph{*‘e. h. x.’}) \AM \emph{;} \emph{hęitir salr} ‘a hall is called’ \GylfMS}}, \hld\ hann ’s \alst{g}olli studdr &
\ind ok \alst{s}ilfri þakðr it \alst{s}ama; &
ęn þar \alst{F}or·seti \hld\ byggvir \alst{f}lęstan dag &
...
Sts.~18--20 are cited in order in \Gylfaginning~38 interspersed by short prose explanations.  St.~18 is cited in \Gylfaginning~38:6, introduced by the words \emph{Svá er hér sagt} ‘So it is said here.’  \Gylfaginning~38:3, 5 provides context: \emph{En aldri er svá mikill mann-fjǫlði í Val-hǫll at eigi má þeim enda⸗sk flesk galtar þess er Sę́·hrímnir heitir.  Hann er soðinn hvern dag ok heill at aptni.  [...]  And·hrímnir heitir steikari’nn en Eld·hrímnir ketill’inn.} ‘But there is never such a great gathering of men in Walhall that they should not be fully furnished with the flesh of that boar which is called Sowrimner.  He is cooked every day and is healthy and alive in the evening.  [...]  Andrimner is the name of the cook, but Eldrimner the kettle.’}%
\alst{A}nd·hrïmnir \hld\ lę́tr ï \alst{Ę}ld·hrïmni &
\ind \alst{S}ę́·hrïmni \alst{s}oðinn, &
...
\alst{ó}⸗umk of Hugin, \hld\ at \alst{a}ptr né \edtext{komi⸗t}{\Afootnote{\emph{komi} \AM}}; &
...
\bvg\bva\mssnote{\Regius~10r/15, \AM~5r/4, \\ \RegiusProse\Trajectinus\Wormianus\Upsaliensis}
...
því’t \alst{ǫ̇}s-brú \hld\ brinn \alst{ǫ}ll \edtext{loga}{\Afootnote{add.~\emph{ęn} \Upsaliensis}} &
\ind \alst{h}ęilǫg vǫtn \edtrans{\edtext{\alst{h}lóa}{\Afootnote{\emph{flóa} \Upsaliensis}}}{bellow}{\Bfootnote{A hapax. TODO.}}.\eva
...
\Ballnote{Sts.~34--36 are cited in \Gylfaginning~16 in the order 36, 34, 35; 34--35 are treated there as a single stanza.  St.~36 is introduced by \Gylfaginning~16:7--8: \emph{En svá margir ormar eru í Hvergelmi með Níð·hǫgg, at engi tunga má telja; svá segir hér:} ‘But there are so many wyrms in Wharyelmer with Nithehewer that no tongue may tally them.  So it says here:’  Between 36 and 34--35 \Gylfaginning~16:9 reads: \emph{Svá er enn sagt:} ‘Further it is said so:’.}%
...
\alst{G}óinn ok Móinn, \hld\ þęir ’ro \alst{G}raf·vitnis \edtrans{synir}{sons}{\Afootnote{\emph{liðar} ‘comrades’ \Upsaliensis}}, &
...
\bvg\bva\mssnote{\Regius~10v/6, \AM~5r/23, \\ \RegiusProse\Trajectinus\Wormianus\Upsaliensis \\ \AMb~9v/14, \EddaBms~3v/11}
...
\ind ęn ór \edtrans{\alst{s}vęita}{his blood}{\Afootnote{\emph{hans sára svęita} ‘the blood of his wounds’ \AMb\EddaBms}} \edtrans{\alst{s}jór}{sea}{\Afootnote{so \AM\Upsaliensis\AMb\EddaBms; \emph{sę́r} ‘id.’ \Regius \emph{sjár} ‘id.’ \RegiusProse\Trajectinus\Wormianus.}}, &
...
In other Indo-European religions the first sacrifice of a Great Being (most famously the Vedic \textoi{Púruṣa}, \Rigveda\ 10.90) serves as the model for all future sacrifice, the performance of which reenacts the Creation and thereby re-establishes the continued existence of the World and upholding the social order (\cite[\emph{passim}]{Lincoln1986}; cf. \textlink{Voluspa}[7]/2 n.).  The re-establishment of Creation is explicit in the ritual language of the Vedic fire-sacrifice \parencite[11, 78--80]{EliadeReturn}.
With this in mind we may consider how the sequence \textlink{Grimnismal}[41]--43 likely forms a unit: sts.~41--42 describe the Creation of the World in the mythic past (\emph{illo tempore}) and st.~43 connects it with the Bloot in the present.}%
...
\Ballnote{St.~45 concludes Weden’s mythological wisdom with a list of the greatest things in each category.  It is quite likely that this stanza concluded with \emph{Bil·rǫst brúa} ‘Bilrest of bridges’ as a \Ljodahattr\ c-verse and that the following verses are later interpolations in oral transmission.  Unlike the previous things listed they seem more trivial.  The interpolating tendency is visible in action in \AM\ which adds a final unmetrical verse at the end of the stanza. ---
...
\edtrans{\alst{B}if·rǫst}{Bivrest}{\Afootnote{so \GylfMS \emph{;} \emph{Bil·rǫst} ‘Bilrest’ \Regius\AM. --- om.~but corrected in line above by same hand \AM}} \alst{b}rúa \hld\ ęn \alst{B}ragi skalda, &
...
\Ballnote{Weden begins his list of names which takes up sts.~47--52; more names are given in the second list in 56--57.  Note that the name \emph{Óðinn} ‘Weden’ itself does not appear in the first list. --- The names from sts.~47--52 and 56 are also found in \Gylfaginning\ 20:11, introduced by the words: \emph{ok enn hefir hann nefnt⸗sk á fleiri vega, þá er hann var kominn til Geir·røðar konungs:} ‘and he has named himself in yet more ways when he was come to visit King Garfrith:’  The names are given in the order they appear in each stanza and the stanzas themselves come in the order: 47, 48, 49, 51, 52, 50, 56.  For the purpose of the present critical edition, variant names from \Gylfaginning~20:11 are noted for all relevant stanzas, but only sts.~47--49 are treated as being actually cited in \Gylfaginning.}%
...
%TODO: note variants from AM and GylfMS in all stanzas below.
...
\alst{A}l·fǫðr, \edtrans{\alst{V}al·fǫðr}{Walfather}{\Afootnote{om.~\AM}}, \hld\ \alst{A}t·ríðr ok Farma·týr; &
\edtext{\alst{ęi}nu nafni \hld\ hét⸗umk \edtrans{\alst{a}ldri⸗gi}{never}{\Afootnote{om.~\AM}} &
\ind síðst ek með \alst{f}olkum \alst{f}ór.}{\lemma{ęinu \dots\ fór. ‘by \dots\ fared.’}\Afootnote{om.~\GylfMS}}\eva
...
\Ballnote{Apart from the first line, which of course refers to the present situation, the underlying stories are not known.  They presumably refer to other now-lost myths involving Weden travelling in disguise. --- The names in this stanza are found in \Gylfaginning~20:11 where they appear in the order \emph{Jalkr, Kjalarr, Viðurr, Þrór} ‘Gelding, Keller, Wither, Throo’.}%
\alst{G}rïmni mik hétu \hld\ at \alst{G}ęir·raðar, &
\ind ęn \alst{Ja}lk at \alst{Ǫ̇}s·mundar; &
ęn þȧ \edtext{\alst{K}jalar}{\Afootnote{so \Regius \emph{;} \emph{Jalk} \AM.}} \hld\ es ek \alst{k}jalka dró, &
...
\bvb Wisher and Omer, Evenhigh and Bifling; \\
...
\alst{v}arar ’ro \edtrans{dísir}{Dises}{\Bfootnote{The Norns, fates, who have determined his hour of death.  Cf.~\textlink{Fafnismal}[11]--13, \textlink{Atlamal}[25]/4, \textlink{Hamdismal}[30].}}, \hld\ nú knátt \alst{Ó}ðin séa; &
...
\Ballnote{No trace of this stanza is found in the list of names in \Gylfaginning~20:11.  It is possible that it was not present in the version of the poem available to Snorre.}%
