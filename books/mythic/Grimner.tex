...
\alst{B}ǿr es sá (hinn þriði), \hld\ es \edtrans{\alst{b}líð ręgin}{the blithe Reins}{\Bfootnote{A reverent epithet for the Gods, also occurring in sts. 38/3, 42/1 below.  Parodied by Lock in \textlink{Lokasenna}[32]/3.  Cf. \emph{holl ręgin} ‘the hold Reins’ (\textlink{Lokasenna}[4]/3), \emph{nýt ręgin} ‘the bountiful Reins’ (\textlink{Vafthrudnismal}[13]/4, 14/2, 25/3).}} &
...
\ind \alst{M}ið-garð \alst{m}anna sonum,}{\lemma{Ęn ór hans brǫ́um \hld\ gørðu blíð ręgin / Mið-garð manna sonum ‘But from his brows the blithe Reins made Middenyard for the sons of men’}\Bfootnote{The Gods fenced in Middenyard (‘the middle enclosure’) by using the strands of Yimer’s eyebrows as poles.}} &
