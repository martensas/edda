...
\subsection{Cadman’s Hymn}

\bvg\bva[]%
Nú scylun \alst{h}ęrgan \hld\ \alst{h}eƀæn-rícæs ward, &
...
\alst{h}eƀæn til \alst{h}rófǽ, \hld\ \alst{h}âlig scęppend. &
Þá \alst{m}iddun-geard \hld\ \alst{m}ǫn-cynnæs ward, &
\alst{é}cí dryhtin \hld\ \alst{æ}fter tíadǽ, &
\alst{f}ir\emph{h}um \alst{f}oldú \hld\ \alst{f}réá al-mæhtig.\eva
