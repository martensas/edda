...
The use of end-rhymed Otfridian meter in ll.~60--61 suggests a relation between \Muspilli\ and Otfrid’s \emph{Evangelienbuch} (written 863--871 \ce), something which is strongly supported by the exact correspondence between l.~14 and \emph{Evangelienbuch} 1.18.9.  Since there appears to be a relation between these two texts, we ought to try to determine the direction of influence.  I believe that we may reasonably conclude on the basis of literary history that the direction of influence is more likely to be from \Muspilli\ to the \emph{Evangelienbuch} rather than the reverse.

With the exception of a very small number of irregular lines found exclusively in the first book (e.g. 1.4.9, 1.18.9), the \emph{Evangelienbuch} is completely end-rhymed and non-alliterative, suggesting that Otfrid was still finding his footing as it were, and occasionally borrowed older lines.  It would, however, be highly unusual for a poet working after the huge success of the \emph{Evangelienbuch} to employ alliteration, especially when he was clearly familiar with the end-rhymed form as proven by ll.~60--61; the natural choice for any writer would be to use end-rhyme throughout.  Indeed, the \emph{Evangelienbuch} seems to have definitively put an end to the alliterative tradition as a whole in Germany, since no alliterative poetry younger than the 9th century survives.

What is more, while \Muspilli\ 14 is a perfectly regular alliterative long-line, its direct equivalent \emph{Evangelienbuch} 1.18.9 is, from the perspective of Otfridian meter, utterly deficient.  It hardly makes sense for a later poet to borrow just that particular deficient line for his own alliterative work, whereas it is rather more likely that Otfrid’s was drawing on older alliterative poetry.

In other ways too, \Muspilli\ is more archaic than Otfrid; such archaisms are its use of originally pre-Christian expressions like \emph{poum, perga} (l.~50) and \emph{Mú·spell} (l.~56), but these may simply be due to its more rustic form and less theologically informed content and do not necessarily support an earlier relative dating.
