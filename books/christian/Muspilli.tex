...
The use of occasional end rhyme (see note to ll. 60--61) suggests a relation to Otfrid’s \emph{Evangelienbuch} (written 863--871 \ce), as does the exact correspondence between \Muspilli\ 14 and \emph{Evangelienbuch} 1.18.9.  For stylistic reasons the direction of influence is more likely to be in the direction of \Muspilli\ to the \emph{Evangelienbuch} than vice-versa.

With the exception of a very small number of irregular lines found exclusively in the first book, the \emph{Evangelienbuch} is completely end-rhymed and non-alliterative, suggesting that Otfrid was still finding his footing as it were, and occasionally borrowed older lines.  It would, however, be highly unusual for a poet working after the huge success of the \emph{Evangelienbuch} to employ alliteration, especially when he was clearly familiar with the end-rhymed form as proven by ll. 60--61; the natural choice for any writer would be to use end-rhyme throughout.  Indeed, the \emph{Evangelienbuch} seems to have definitively put an end to the alliterative tradition as a whole in Germany.

What is more, while \Muspilli\ 14 is a perfectly regular alliterative long-line, its direct equivalent \emph{Evangelienbuch} 1.18.9 is, from the perspective of Otfridian meter, utterly deficient.  It therefore hardly makes sense for a later poet to borrow just that particular deficient line for his own alliterative work, whereas it is considerably more likely that Otfrid’s was drawing on an older alliterative poem.

In other ways too, \Muspilli\ is more archaic, like in its use of originally pre-Christian expressions like \emph{poum, perga} (l. 50) and \emph{Mú·spell} (l. 56), but this may simply be due to its more rustic, alliterative form.
