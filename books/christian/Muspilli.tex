...
The sound change \emph{hl- > l-} is strongly suggested by the meter.  The verse is a hypermetrical type A1A1 scanning \textbf{P}x\#xxxx\#\textbf{P}x\#Px, and such verses, at least in \textlink{Heliand}, without exception require double alliteration \parencite[295--96]{Suzuki2004}.  Although the meter of \Muspilli\ and \textlink{Heliand} is not identical, the rule is so strong that it most likely applies in \Muspilli\ too.
