...
ant-tat \edtext{\alst{M}úd-spelles męgin}{\Bfootnote{Apparently an incorporation of an earlier Germanic expression, for which cf. OHG \emph{Múspilli} (\textlink{Muspilli} 56), ON \emph{Muspell}.  Reoccurs at line 4358 below.}} \hld\ oƀar \alst{m}an fęrid, &
