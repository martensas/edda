...
\alst{m}irki \alst{m}ên-skaðo}{\lemma{þe fíund náhor géng, / mirki mên-skaðo}\Bfootnote{The way Satan is described in this passage (continuing to 1115a) is extremely similar to the descriptions of the three monsters fought by Bewolf: Grendle (\Beowulf\ 99--836), Grendle’s mother (1251--1590), and the Dragon (2200--2711).
...
A particularly notable parallel is found between \Heliand\ 1095 and \Beowulf\ 2688, both of which pair \emph{*þeud-skaþō} with \emph{*þriddjō sinþa} ‘third time’ in reference to the third attack from the dragon/temptation from Satan.
Although the idea of three temptations is present in \Heliand’s Biblical source material (Matthew 4:1-11, Luke 4:1-13), the rule of threes is common throughout world mythology and as shown by \Beowulf\ also found in earlier Germanic monster-fights, so that this verbal parallel is likely also inherited.
