...
\alst{l}êrjan þesa \alst{l}iudi, \hld\ hwó sea skulin iro gi·\alst{l}ôƀon haldan &
...
\alst{d}iur-líkara \alst{d}úƀun--- \hld\ ęndi sat im uppan u̇ses \alst{d}rohtines ahslu, &
...
\alst{b}ętst allaro gi·\alst{b}oranaro manno, \hld\ kwað þat hé im wári allaro \alst{b}arno lioƀost. &
...
\alst{m}irki \alst{m}ên-skaðo}{\lemma{þe fíund náhor géng, / mirki mên-skaðo}\Bfootnote{The way Satan is described in this passage (continuing to 1115a) is noticably similar to the descriptions of Grendle and his mother in \Beowulf.  Agreements are found not just in descriptive nouns (\textlink{Heliand} 1062a: \emph{mên-skaðo} = \Beowulf\ 712a, 737b, 1339a: \emph{mân-scaða}, \textlink{Heliand} 1061b et c.: \emph{fíund} = \Beowulf\ 101b, 143b, 164b et c.: \emph{féond})
and adjectives (\textlink{Heliand} 1056a: \emph{níð-hugdig}, 1096a: \emph{balu-wís} \char`~\ \Beowulf\ 723a: \emph{bealo-hýdig}) but also in verbs that describe the antagonists as ‘visiting’ (\textlink{Heliand} 1075a: \emph{niuson} = \Beowulf\ 115a, 2074b: \emph{néosian}) and ‘drawing nearer’ (\textlink{Heliand} 1061b, 1075b: \emph{náhor géng} \char`~\ \Beowulf\ 745b: \emph{forð néar æt·stóp} ‘he stepped up nearer’) their intended victim.
It thus seems likely that the \textlink{Heliand}-poet is drawing on older traditional stories of night-stalking monsters in his description of Satan, in which case Christ in the present passage would have been understood by the contemporary Saxon audience as taking on the archetypal role of the Germanic heroic monster-slayer.}}: \hld\ wánda þat hé \alst{m}an ên-fald &
...
is \alst{g}eƀa \alst{g}erno drógun \hld\ \alst{g}umono gi·hwemu, &
