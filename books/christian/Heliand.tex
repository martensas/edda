...
hiet þat hie im ni \edtext{an·\alst{d}riede}{\Bfootnote{The original segmenting of \emph{an·drádan} is \emph{and-} + \emph{rádan}, but already by the time of \textlink{Heliand} it had clearly been reanalyzed as \emph{an(t)·drádan}, as seen by the alliteration in the present line and by the variant spelling \emph{antdrádan} seen throughout the poem.  Cf. English \emph{dread}, from OE \emph{drǽdan}, from earlier OE \emph{on·drǽdan}.}}: \hld\ „þína \alst{d}ádi sind“, kwaþ-hie*, &%
...
\edtrans{\alst{h}ôh-\alst{h}urnid skip}{high-horned ship}{\Bfootnote{A longship with a tall prow, as known from archæology.  The line, which reoccurs below at 2907a, is certainly a formulaic inheritance from earlier pagan Saxon poetry, for it belongs in the world of the North Sea, hardly the New Testament.
The segmenting of the words is ambiguous.  The pres.~ed.~reads the line as a type E, but it may also be read as a type D \emph{hôh hurnid-skip} ‘high horned-ship’.  To determine the correct reading we may cf.~the semantics of the name of the god Balder’s ship in Norse mythology, \emph{Hring-horni} ‘Ringhorn’, i.e.~‘one with a coiled prow’, which ought to be compared with OE \emph{hringid-stefná} ‘ringed-prowed’, a term for a ship (\Beowulf\ 32, 1131, 1897; see \textcite[116]{KlaeberBeowulf}).  It seems clear from this comparison that the term \emph{horn} is simply an archaic/poetic term for the stem-post of a ship, and therefore the pres.~l.~must be read as ‘high-horned ship’, not ‘high horned-ship’, since the important thing is that the prow is high, not that the ship has a prow (a tautology). ---
Cf.~also l. 1186a below: \emph{nęglid-skipu}.}}; \hld\ \alst{h}ęliðos kwámun, &
