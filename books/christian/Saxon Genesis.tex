...
\alst{a}fter te \alst{ê}wan-dage, \hld\ só lango só þius \alst{e}rða \edtext{lêƀot.}{\Afootnote{add. \emph{EXPL} \textbf{V}}\Bfootnote{The \emph{EXPL} in the ms. stands for ‘explicit’, customarily placed at the end of a text in mediæval mss.  This line also serves as a fitting conclusion to the poem.}}\eva
