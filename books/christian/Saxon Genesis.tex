...
The normalization follows that adapted for \textlink{Heliand}.  There is only one ms., Palatinus latinus 1447 (\textbf{V}, \url{https://digi.vatlib.it/view/MSS\_Pal.lat.1447/0005}), where the poem is found written on a few fragmentary pages between Latin theological texts.  In this ms. a small fragment of the \textlink{Heliand} is also found.
