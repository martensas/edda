...
\bvg\bva\mssnote{\Regius~11r/24, \AM~2r/24}\alst{M}ę́r ’s mér tíðari \hld\ an \alst{m}anna hvęim &
...
\bvg\bva\mssnote{\Regius~11r/29, \AM~2r/28}„\alst{M}yrkt es úti, \hld\ \alst{m}ál kveð’k okkr fara &
...
\bvg\bva\mssnote{\Regius~11v/2, \AM~2v/4}„Sęg þat \alst{h}irðir, \hld\ es á \alst{h}augi sitr &
...
\ind \edtrans{\alst{g}óðrar męyjar}{good maiden}{\Bfootnote{Formulaic, carrying with it a sense of chasttity. See note to \Havamal\ TODO for further occurrences.}} \alst{G}ymis.“\eva
...
\bvg\bva\mssnote{\Regius~11v/15, \AM~2v/14}\alst{Ę}pli \alst{ę}llifu \hld\ hér hef’k \alst{a}l-gullin, &
...
\bvb {[Shirner quoth:]} \\
“Seest thou, maiden, this sword—slender, pictured-painted\footnoteB{The sword is inlaid with metal forming a pattern. The expression is formulaic, cf. TODO.}, \\
...
\bvg\bva\mssnote{\Regius~11v/28, \AM~2v/24}\edtrans{\alst{T}ams-vęndi}{taming-wand}{\Bfootnote{Has been interpreted as a sword, TODO.}} þik drep’k, \hld\ ęn þik \alst{t}ęmja mun’k, &
...
\bvg\bva\mssnote{\Regius~11v/30, \AM~2v/26}\edtrans{\alst{A}ra þúfu \alst{á} \hld\ skalt \alst{á}r sitja}{On an eagle’s hill shalt thou sit in early morn}{\Afootnote{\emph{ár skalt sitja \hld\ ara þúfu á} ‘in early morn shalt thou sit on an eagle’s hill’ \AM}}, &
...
the gleaming serpent \ken*{= the Middenyardswyrm} among men.\footnoteB{Her food will be as disgusting as the Middenyardswyrm (for its disgusting nature see Note to \Hymiskvida\ 22).}\evb
\evg


\bvg\bva\mssnote{\Regius~11v/32}At \alst{u}ndr-sjónum verðir \hld\ es \alst{ú}t of kømr, &
...
More widely known mayst thou become than the Watchman among the Gods \ken*{= Homedall}; \\
mayst thou gape from the gates.\evb
\evg


\bvg\bva\mssnote{\Regius~12r/2}\edtrans{\alst{T}ópi ok ópi, \hld\ \alst{t}jǫsull ok ó·þoli}{Toop and oop, tessle and restlessness}{\Bfootnote{The first three of these four words are magic curse words; I have left them untranslated. TODO: Potential meanings.}}, &
...
\bvg\bva\mssnote{\Regius~12r/3}Tramar \alst{g}nęypa \hld\ þik skulu \alst{g}ęrstan dag &
...
\bvg\bva\mssnote{\Regius~12r/7}Með \alst{þ}ursi \alst{þ}rí-hǫfðuðum \hld\ \alst{þ}ú skalt ę́ nara &
...
\bvg\bva\mssnote{\Regius~12r/9}\edtext{Til \alst{h}olts ek gekk \hld\ ok til \alst{h}rás viðar &
...
\bvg\bva\mssnote{\Regius~12r/10}\alst{R}ęiðr ’s þér Óðinn, \hld\ \alst{r}ęiðr ’s þér Ása-bragr, &
...
\bvg\bva\mssnote{\Regius~12r/12}\alst{H}ęyri jǫtnar, \hld\ \alst{h}ęyri \alst{h}rím-þursar, &
...
sons of Sutting, the Os-retinues \ken*{= Eese} themselves: \\
...
\bvg\bva\mssnote{\Regius~12r/14}\alst{H}rím-grímnir hęitir þurs, \hld\ es þik \alst{h}afa skal &
...
\inx[C]{degeneracy} and madness and restlessness.— \\
So I carve it off as I carved it on, \\
if need arise for that.\footnoteB{Shirner has carved the curse (which will bring true all the threats from 26–35), but tells Gird that he will scrape it off if she will accept his demands. She then responds:}”\evb
\evg


\bvg {\small [Gęrðr kvað:]}
\bva\mssnote{\Regius~12r/19}„\edtext{\alst{H}ęill ves þú \alst{h}ęldr, svęinn, \hld\ ok tak við \alst{h}rím-kalki &
\ind \alst{f}ullum \alst{f}orns mjaðar,}{\lemma{Hęill \dots\ mjaðar ‘Hale \dots\ mead’}\Bfootnote{Occurs identically in \Lokasenna\ 53.}} &
...
\bvg\bva\mssnote{\Regius~12r/25}„\alst{S}ęg mér, Skírnir, \hld\ áðr verpir \alst{s}ǫðli af mar &
...
\bva\mssnote{\Regius~12r/28, \GylfMS}\alst{L}ǫng es nǫ́tt, \hld\ \edtrans{\alst{l}angar ’u tvę́r}{long are two}{\Afootnote{\emph{lǫng es ǫnnur} ‘long is another’ \GylfMS}}, &
