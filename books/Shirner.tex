...
því’t \alst{a}lf-rǫðull \hld\ lýsir of \alst{a}lla daga &
...
\ind sá hinn \edtrans{\alst{á}-mátki \alst{jǫ}tunn}{terrifying ettin}{\Bfootnote{Formulaic. \emph{á-máttigr} ‘terrifying’ (lit. perhaps ‘mighty in opposition’) has a supernatural connotation, and only occurs in four other places in \Regius: \Voluspa\ 8, \Grimnismal\ 11, \HelgakvidaHjorvardssonar\ 17 and \HelgakvidaHjorvardssonar\ 14. In the first three it is likewise paired with \emph{jǫtunn} ‘ettin’, while in the fourth it describes a man with clearly supernatural attributes.}}.“\eva

\bvb “’Tis dark outside; I declare it time for us to journey \\
over the drizzling mountains, \\
over the nation of the \inx[G]{Thurses}. \\
Both two we come, or us both does take \\
that terrifying ettin.\footnoteB{Shirner declares his intention not to abandon the horse given to him by his lord; they will either both make it, or both perish.}”\evb
\evg
