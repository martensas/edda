...
\subsection{Parallel in Gylfaginning}

The same narrative is found in \Gylfaginning\ 37, which also quotes stanza 42 of the present poem.  That account begins with a long introduction, corresponding to P1–2:
...
After which the author cites a variant of stanza 42, with some minor differences in wording that seem to stem from oral tradition (see Note to that st.)  He last explains that \emph{Þessi sǫk er til þess, er Freyr var svá vápn-lauss, er hann barðist við Belja ok drap hann með hjartar-horni.} ‘This event is the reason why Free was so weaponless when he fought against \inx[P]{Bellower} and slew him with a hart’s antler.’
