...
\ind sá hinn \edtrans{\alst{á}m-átki \alst{jǫ}tunn}{uncanny ettin}{\Bfootnote{Formulaic; the adjective \emph{ám-áttigr} ‘uncanny’ is used exclusively for evil supernatural beings.  See note to \Voluspa\ 8.}}.“\eva
...
\edtrans{\alst{Ę}pli \alst{ę}llifu}{Eleven apples}{\Bfootnote{Probably the apples of Idun, which grant perpetual youth to the gods.  It is not clear whether Shirner has the apples in his possession or whether he is merely promising big.}} \hld\ hér hef’k \alst{a}l-gullin, &
...
\ind \edtrans{ok stígir \alst{f}eti \alst{f}ramarr}{and take a step further}{\Bfootnote{Formulaic; a variant of \emph{feti ganga/gangir framarr} (\Havamal\ 38/2, \Lokasenna\ 1/2).}}, &
