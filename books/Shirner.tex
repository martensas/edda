...
\ind of-ręiði \edtext{afi}{\lemma{afi ‘man’}\Bfootnote{While this word usually means ‘father’ or ‘grandfather’, it must here certainly mean ‘man’ without a connotation of old age. See further \CV.}}.“\eva
...
\bvg {\small Skírnir:}
\bva\mssnote{\Regius~11r/17, \AM~2r/18}„Sęg þat Fręyr, \hld\ folk-valdi goða, &
\ind ok ek vilja vita, &
hví þú ęinn sitr \hld\ ęnd-langa sali, &
...
\ind mikinn móð-trega? &
því’t alf-rǫðull \hld\ lýsir of alla daga &
...
ungir saman \hld\ vǫ́rum í ár-daga, &
...
\ind sá hinn \edtrans{á-mátki jǫtunn}{terrifying ettin}{\Bfootnote{Formulaic. \emph{á-máttigr} ‘terrifying’ seems to have a supernatural connotation, and only occurs in four other places in the Poetic Edda: in three of them (\Voluspa\ 8, \Grimnismal\ 11 and \HelgakvidaHjorvardssonar\ 17) it is likewise paired with \emph{jǫtunn} ‘ettin’, while in \HelgakvidaHjorvardssonar\ 14 it describes a man with clearly supernatural attributes.}}.“\eva
...
hvé ek at and-spilli \hld\ komumk hins unga mans &
...
\bvg
\bva\mssnote{\Regius~11v/4, \AM~2v/5}„Hvárt est fęigr, \hld\ eða est fram ginginn &
\ind [...]; &
and-spillis vanr \hld\ þú skalt ę́ vesa &
...
\bvb {[The herdsman quoth:]} “Either art thou fey, or gone forth \ken{dead}; [...]. Lacking discourse shalt thou ever be, with Gymer’s good maiden \ken*{= Gird}.”\evb
\evg
...
\bvg
\bva\mssnote{\Regius~11v/15, \AM~2v/14}Ępli ęllifu \hld\ hér hef’k al-gollin, &
\ind þau mun’k þér Gęrðr gefa, &
frið at kaupa, \hld\ at þú þér Fręy kveðir &
\ind ó-lęiðastan at lifa.“\eva
...
\bvg {\small TODO}
\bva\mssnote{\Regius~11v/17, \AM~2v/15}„Ępli ęllifu \hld\ ek þigg aldri-gi &
...
\edtext{átta ’ru jafn-hǫfgir, \hld\ es af drjúpa &
...
\bvg {\small TODO}
\bva\mssnote{\Regius~11v/23, \AM~2v/19}„Sér þú mę́ki, mę́r, \hld\ mjóvan, mál-fáan, &
...
\bvg {\small TODO}
\bva\mssnote{\Regius~11v/25, \AM~2v/20}„Á-nauð þola \hld\ vil’k aldri-gi &
\ind at \edtrans{mans-kis}{‘any man’s (lit. ‘no man’s)’}{\Afootnote{\emph{mannz ænskis} \AM}} munum, &
þó hins get’k, \hld\ ef it Gymir finnizk &
vígs ó-trauðir \hld\ at ykkr vega tíði.“\eva
...
\bvg {\small TODO}
\bva\mssnote{\Regius~11v/27, \AM~2v/22}„Sér þú mę́ki, mę́r, \hld\ mjóvan, mál-fáan, &
\ind es hęf’k í hendi hér? &
...
\bvg
\bva\mssnote{\Regius~11v/28, \AM~2v/24}\edtrans{Tams-vęndi}{taming-wand}{\Bfootnote{Has been interpreted as a sword, TODO.}} þik drep’k, \hld\ ęn þik tęmja mun’k, &
...
\bvg
\bva\mssnote{\Regius~11v/30, \AM~2v/26}\edtrans{Ara þúfu á \hld\ skalt ár sitja}{On an eagle’s hill shalt thou sit in early morning}{\Afootnote{\emph{ár skalt sitja \hld\ ara þúfu á} ‘in early morning shalt thou sit on an eagle’s hill’ \AM}}, &
...
\bvg
\bva\mssnote{\Regius~11v/32}At undr-sjónum verðir \hld\ es út of kømr, &
\ind á þik Hrímnir hari &
\ind á þik hot-vetna stari, &
víð-kunnari verðir \hld\ an vǫrðr með goðum, &
...
\bvg
\bva\mssnote{\Regius~12r/7}Með þursi þrí-hǫfðuðum \hld\ þú skalt ę́ nara &
\ind eða ver-laus vesa, &
\ind þitt geð grípi; &
\ind þik morn morni &
ves þú sem þistill, \hld\ sá’s þrunginn vas &
\ind í ofan-verða ǫ́nn.\eva
...
\ind gamban-tęin at geta &
\ind gamban-tęin ek gat.\eva
...
hvé fyrir \alst{b}ýð’k, \hld\ hvé fyrir \alst{b}anna’k &
...
\ind ef gęrvask \alst{þ}arfar \alst{þ}ęss.“\eva
...
þó hafða’k \alst{ę́}tlat, \hld\ at mynda’k \alst{a}ldrigi &
\ind unna \edtrans{\alst{v}aningja}{the Waning \ken*{= Free}}{\Bfootnote{A rare word, lit. ‘descendant of the \inx[G]{Wanes}’, it only occurs at one other place in the corpus, namely in the \inx[C]{thule} of boar-names. Boars were sacred to Free, TODO.}} \alst{v}ęl.“\eva
