...
\bvg {\small [Shirner quoth:]}
\bva\mssnote{\Regius~11v/6, \AM~2v/7}„\edtext{Kostir}{\lemma{kostir ‘choices’}\Bfootnote{i.e. ‘alternative choices, other ways’.}} ’ru bętri \hld\ \edtext{an}{\Afootnote{so \AM; \emph{hęldr an at} ‘rather than to [be]’ \Regius}} kløkkva sé &
