...
It seems near-certain that the author of \Gylfaginning\ had access to \textlink{Skirnismal} directly rather than a mere retelling of the story.  There is no detail in his paraphrase that is not found in the present version of the poem, although the introductory prose differs a fair bit, and Shirner’s curse is entirely omitted.  This is easily explained if he his version of \textlink{Skirnismal} was written down from a slightly different oral tradition; the poetry, being in bound form, would be much more stable than the more fluid introductory prose.  To sum up a narrative mythic poem in prose form and then quote one or two stanzas is something probably done elsewhere in \Gylfaginning; see the Fragments from Snorre’s Edda below.
...
„Sér þú \alst{m}ę́ki, \alst{m}ę́r, \hld\ \alst{m}jóvan, \edtrans{\alst{m}ál-fáan}{picture-painted}{\Bfootnote{The sword is inlaid with metal (perhaps gold or silver) forming a pattern.  The expression \emph{mę́kir mál-fár} ‘picture-painted sword’ also occurs in \textlink{Brot} TODO.}}, &
