...
% Introduction.
\begin{flushright}%
\textbf{Dating} \parencite{Sapp2022}: 800s (0.110)–900s (0.890)
...
ok umb þat \alst{r}éðu \hld\ \alst{r}íkir tívar:}{\lemma{Sęnn \dots\ tívar ‘Soon \dots\ Tews’}\Bfootnote{Formulaic, identically shared with \Thrymskvida\ 14/1–3.  See also \inx[C]{Thing of the Gods}.}} &
