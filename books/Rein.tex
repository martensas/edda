...
The \textbf{Speeches of Rein} (\Reginsmal) is preserved in \Regius, where it follows \Gripisspa\ and is introduced with a large initial and an illegible title originally in red ink.  \Reginsmal\ clearly serves as the basis for \VolsungaSaga\ 14–15 and 17–18 (for ch. 16 see \Gripisspa), where sts. 1, 2, 6, and 18 are cited.

\subsection{The Siward sequence}

In \Regius, \Reginsmal\ is the first of a group of three very similar “poems” in an unbroken narrative sequence, for which reason the whole group will be discussed here.  The group also includes \Fafnismal\ and \Sigrdrifumal.

The existence of these three “poems”—indeed their very names—is really a product of later philology, and to paraphrase Bellows, it is doubtful whether it is logically sound.  Although \Fafnismal\ is introduced by a title and large initial and thus separated from \Reginsmal, the line between \Fafnismal\ and \Sigrdrifumal\ is entirely arbitrary since the two are continuous in the ms.  More importantly, none of the three “poems” is a unitary composition; but throughout them one finds the same amalgamation of narrative prose and stanzas in alternating \Fornyrdislag\ and \Ljodahattr.  It may be noted that the style of the \Ljodahattr\ stanzas is very similar throughout, and this may also be the case for the \Fornyrdislag-stanzas, so that we may be dealing with at least two long separate cycles treating the same overlapping story.  A particularly transparent example of overlap between sources is the speech of the tits in \Fafnismal\ (TODO: stanza numbers), where there is a good logical progression of thought if one only reads the stanzas in one meter, which is lost if one reads both.
...
\Ballnote{The wording of the first half of this stanza is very close to \Havamal\ 61 and \Voluspa\ 33; for discussion on personal hygiene and bathing see note to the former.}\eva
