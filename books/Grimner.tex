...
\edtrans{\alst{Á}r-vakr ok \alst{A}l-sviðr}{Yorewaker and Allswith}{\Bfootnote{The two horses which pull the sun-chariot also appear in \Sigrdrifumal\ 15/2; cf. note to the next st.}}, \hld\ þęir skulu \alst{u}pp heðan &
...
The conception of the sun pulled by a horse-driven chariot is attested going back to the Bronze Age.  A notable instance from the Germanic cultural area is the Trundholm sun chariot, a cultic object found on Zealand, Denmark belonging to the Nordic Bronze Age (\char`~\ 1400 BC), which may also depict horses pulling the Day and Night; see \hyperref[Vafthrudnismal:11]{\Vafthrudnismal\ 11–14} and Figures \ref{fig:trundholm-front}, \ref{fig:trundholm-back}.  Indo-European parallels include \Rigveda\ 1.50.8–9, 4.13.3, 5.45.9, and the Homeric Hymn to \emph{Hḗlios}.}\eva
