...
\bvb For eight nights I sat amid the fires here, \\
...
\ind \edtrans{bętri \alst{g}jǫld}{better recompense}{\Bfootnote{Namely the esoteric lore which makes up the rest of poem up to st. 53.}} \alst{g}eta:\eva

\bvb Hale shalt thou be, Ayner; as hale \\
Were-Tew \name{= Weden} bids thee be! \\
For a single drink shalt thou never get \\
better recompense:\evb\evg
...
\ind \edtrans{unds of \alst{r}júfask \alst{r}ęgin}{until the Reins are ripped}{\Bfootnote{i.e. until the \inx[C]{Rakes of the Reins}.  A formulaic expression; see note to \Baldrsdraumar\ 14 for further occurrences.}}.\eva

\bvb Holy is the land which I see lying \\
near the \inx[F]{Eese and Elves}; \\
...
\bva\mssnote{\Regius~9v/12, \AM~4v/2, \GylfMS}\alst{Þ}rym-hęimr hęitir \edtrans{(hinn sétti)}{the sixth}{\Afootnote{om. \GylfMS}}, \hld\ \edtrans{es}{where}{\Afootnote{\emph{þar nú} ‘where now’}} \alst{Þ}jatsi \edtrans{bjó}{dwelled}{\Afootnote{om. \Wormianus; \emph{býr} ‘dwells’ \Upsaliensis}}, &
...
the fewest wicked deeds.\evb\evg
...
and puts all disputes to sleep.\evb\evg
...
\ind \edtrans{\alst{h}ǫ́-timbruðum \alst{h}ǫrgi rę́ðr}{rules the harrow timbered on high}{\Bfootnote{The rare verb \emph{hǫ́-timbra} ‘timber on high’ otherwise only occurs in \Voluspa\ 7, likewise in connection with the \emph{hǫrgr} ‘harrow’.  The harrow is an outdoors holy place; see Encyclopedia.  Cf. also \Vafthrudnismal\ 38 where Nearth is said to rule a great many.}}.\eva

\bvb Nowetowns are (the eleventh), and there Nearth has \\
made for himself a hall. \\
The lord of men, the guileless one, \\
rules the \inx[C]{harrow} timbered on high.\evb\evg
...
and there the lad vows off the back of his steed, \\
...
in Eldrimner be boiled. \\
The best of meats, but few know this: \\
by what the \inx[G]{Oneharriers} are nourished.\footnoteB{The cook Andrimner ‘face-sooty’ cooks the boar Sowrimner ‘sow-sooty’ in the cauldron Eldrimner ‘fire-sooty’; by this meat are the Oneharriers nouished.}\evb\evg
...
for the noisy slain host to wade.\footnoteB{A difficult stanza.  Thound may be the river surrounding Walhall, which the dead have to pass over to reach it.  The stanza may also be referring to the punishment of criminals in waters; see note to \Voluspa\ 38 for discussion on that.}\evb\evg
...
\bvg\bva\mssnote{\Regius~10r/4, \AM~4v/24}\alst{H}ęið-rún hęitir gęit, \hld\ es stęndr \edtrans{\alst{h}ǫllu á Hęrja-fǫðrs}{on the hall of the Father of Hosts}{\Bfootnote{The hall of Weden, i.e. Walhall.  \emph{Hęrja-fǫðrs} looks like an unmetrical addition.}} &
...
they run around the hoard of the Gods \ken*{= Osyard}— \\
Thin and Win, Thall and Hall, \\
Gread and Guththorn.\evb\evg
...
{[by]} the third manly men.\evb\evg
...
they bear the Oneharriers ale.\footnoteB{The women listed in this st. are Walkirries. Their names are known from other lists of Walkirries, but differ somewhat in form. TODO: Note these differences}\evb\evg


\bvg\bva\mssnote{\Regius~10r/32, \AM~5r/18}%
\edtrans{\alst{Á}r-vakr ok \alst{A}l-sviðr}{Yorewaker and Allswith}{\Bfootnote{These horses also appear in \Sigrdrifumal\ 14a/2; see note to the next st.}}, \hld\ skulu \alst{u}pp heðan &
\ind \alst{s}vangir \alst{s}ól draga; &
en und þęira \alst{b}ógum \hld\ fǫ́lu \alst{b}líð ręgin, &
\ind \alst{ę́}sir, \alst{í}sarn-kol.\eva

\bvb Yorewaker and Allswith shall hence on high— \\
...
\bvb \inx[P]{Scoll} is the wolf called which follows the pure-faced \\
god \ken*{= Sun} to the shelter of the woods; \\
but second is \inx[P]{Hate}—he is \inx[P]{Rothwitner}’s son— \\
that one shall [run] in front of the bright bride of heaven \ken*{= Sun}.\footnoteB{According to \Gylfaginning\ 12 Scoll chases the Sun and Hate chases the Moon (which is why he runs in front of the sun).  See note to \Voluspa\ 40 for discussion on these wolves.}\evb\evg
...
and from his skull the heaven.\evb\evg
...
\bvb But from his eyebrows the blithe \inx[G]{Reins} made \\
\inx[L]{Middenyard} for the sons of men; \\
...
by that shall the willed relief awake. \\
All the Eese shall it bring inside, \\
upon Eagre’s bench, \\
at Eagre’s drinking!\footnoteB{Weden suddenly announces that he has made the other gods aware of his situation; they will leave their feasting at Eagre’s hall and come to his rescue.  He then begins to narrate his names.}\evb\evg
...
since among manfolk I fared.\evb\evg
...
\edtext{\alst{m}ę́ki liggja \hld\ sé’k \edtrans{\alst{m}íns vinar}{my friend}{\Bfootnote{The followers of a god were his \emph{friends}; cf. Eyel’s \Sonatorrek, where he speaks about his \emph{friendship} with Weden.  Already in \Beowulf\ we see that the Shieldings are called the \emph{Ing-wine} ‘friends of \inx[P]{Ing}’.}} &
...
Aware are the \inx[G]{Dises}, now dost thou see Weden— \\
