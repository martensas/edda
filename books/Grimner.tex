...
\ind \edtrans{gǫng·umk \alst{f}irr}{go far from me}{\Bfootnote{Equivalent to \emph{gakk mér firr}.  The word \emph{gǫng·umk} merits some linguistic discussion.  At some time in early PN, accusative personal pronouns were suffixed to certain verbs as object pronoun clitics; those which survive into ON are 3sg reflexive \emph{sik} (as \emph{-sk}) and 1sg \emph{mik} (as \emph{-umk}).  These clitics eventually became the passive endings found in later ON and modern North Germanic, but in early ON they could still serve as suffixed pronouns with a reflexive or even object-marking function, as is the case in this instance.  The normal 2sg imper. of ON \emph{ganga} ‘to go’ is \emph{gakk}, which goes back to a sound change in PN whereby word-final homorganic clusters were devoiced, and in the case of clusters of the form \textipa{/NC/} assimilated into \textipa{C̥\textlengthmark}, thus PN \emph{*gang} ‘go!’ (cf. Got. \emph{gagg} \textipa{/ɡaŋg/}, OHG \emph{gang}) > \emph{*gank} > \emph{gakk}, also \emph{*stand} ‘stand!’ > \emph{statt}, \emph{*bind} ‘bind!’ > \emph{bitt}.  This sound change was only active in early PN, and only affected those clusters which were word-final before any syncope of unstressed vowels; thus in the 1sg pres. ind. \emph{ek gęng, ek stęnd} (< \emph{*ek gangu, ek standu}) ‘I go, I stand’ et c. we find the original cluster.  The fact that the suffixion of the pronoun prevented assimilation establishes its \emph{terminus ante quem} as the early 7th century, and since such an irregular form as \emph{gǫng·umk} coexisting alongside \emph{gakk} cannot have survived very long, its presence here allows us to conclude that \Grimnismal\ is a rather old poem.  Cf. \emph{stǫnd·umk} in \Fafnismal\ TODO.}} \alst{f}uni! &
...
\bvg\bva\mssnote{\Regius~10r/28, \AM~5r/14, \GylfMS}%
