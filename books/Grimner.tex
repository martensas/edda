...
\ind for the noisy slain host to wade.\footnoteB{A difficult stanza.  Thound may be the river surrounding Walhall, which the dead have to pass over to reach it.  The stanza may also be referring to the punishment of criminals in waters; see note to \textlink{Voluspa} 38 for discussion.}\evb\evg
...
\ind the shield before the shining god \ken{sun}. \\
