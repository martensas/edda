...
\bvg
\bva\mssnote{\Regius~9v/2, \AM~4r/23}Ýdalir hęita, \hld\ þar’s Ullr hęfir &
...
\bvb Sinkbench is called the fourth, but there do waves \\
cool clash over [it]; \\
...
\bvg
\bva\mssnote{\Regius~9v/7, \AM~4r/28}Glaðshęimr hęitir hinn fimti \hld\ þar’s hin goll-bjarta &
...
weapon-dead men.\footnoteB{Cf. v. 14.}\evb
\evg
...
\bvg
\bva\mssnote{\Regius~9v/9, \AM~4r/31}Mjǫk ’s auð-kęnt \hld\ þęim’s til Óðins koma &
\ind \edtrans{sal-kynni at séa}{the hall to see}{\Afootnote{\emph{‘sia at sia’} \AM}}, &
...
\bvg
\bva\mssnote{\Regius~9v/10, \AM~4r/30}Mjǫk ’s auð-kęnt \hld\ þęim’s til Óðins koma &
...
made for himself a hall; \\
on that land, where I know lie the fewest staves of treachery.\footnoteB{Evil deeds.}\evb
\evg
...
\ind sér of gǫrva sali; &
manna þęngill \hld\ inn męins-vani &
...
\bvg
\bva\mssnote{\Regius~9v/26, \AM~4v/14}Gera ok Freka \hld\ sęðr gunn-tamiðr, &
\ind hróðigr Hęrjafǫðr, &
en við vín ęitt \hld\ vápn-gǫfugr &
\ind Óðinn ę́ lifir.\eva

\bvb Gerr and Freck does the battle-accustomed, \\
glorious Father of Hosts \name*{= Weden} feed; \\
but by wine alone does the weapon-worshipful \\
Weden ever live.\evb
\evg
...
\ind \edtrans{jǫrmun-grund}{ermin-ground}{\Bfootnote{‘the immense ground’ (for the rare prefix \inx[C]{ermin-} see Encyclopedia), denoting the earth as a vast flat expanse of land. This compound also occurs in a kenning in the st. on the late C10th Karlevi stone (Öl 1) referring to the unbounded sea as \emph{Ęndils jǫrmungrund} ‘Andle’s ermin-ground’ (Andle being a known “sea-king”), and in \Beowulf\ 859 as \emph{eormen-grund} carrying the same sense.}} yfir; &
...
for the noisy slain host to wade.\footnoteB{Thound is presumably the river surrounding Walhall, which the dead have to pass over to reach the hall. This stanza may also be referring to the punishment of men}\evb
\evg
...
\bvg
\bva\mssnote{\Regius~10r/4, \AM~4v/24}Hęiðrún hęitir gęit, \hld\ es stęndr \edtext{hǫllu á}{\lemma{hǫllu á ‘on the hall’}\Afootnote{\emph{hǫllu á Hęrja-fǫðrs} ‘on the Father of Host’s hall’ \Regius\AM\ is unmetrical, and likely added by a later redactor as clarification.}} &
\ind ok bítr af Lę́raðs limum; &
skap-kęr fylla \hld\ skal hins skíra mjaðar, &
\ind kná-at sú vęig vanask.\eva

\bvb Heathrune is called the goat, which stands on the hall \ken*{= Walhall}, \\
...
\bvg
\bva\mssnote{\Regius~10r/6, \AM~4v/26}Ęikþyrnir hęitir hjǫrtr \hld\ es stęndr \edtrans{hǫllu á}{on the hall}{\Afootnote{\emph{á hǫllu Hęrja-fǫðrs} ‘on the Father of Host’s hall’ \Regius\AM. See note to previous st.}}&
\ind ok bítr af Lę́raðs limum; &
en af hans hornum \hld\ drýpr í Hvergęlmi &
\ind þaðan ęiga vǫtn ǫll vega:\eva

\bvb Oakthirner is called the stag, which stands on the hall \ken*{= Walhall}, \\
and bites off Leered’s branches. \\
...
\bvg
\bva\mssnote{\Regius~10r/9, \AM~4v/28}Síð ok Víð, \hld\ Sę́kin ok Ęikin, \hld\ Svǫl ok Gunn-þró, &
...
\bvg
\bva\mssnote{\Regius~10r/12, \AM~5r/1}Vína hęitir enn, \hld\ ǫnnur Veg-svinn, &
...
\bvg
\bva\mssnote{\Regius~10r/17, \AM~5r/6}Glaðr ok Gyllir, \hld\ Glęr ok Skęið-brimir, &
...
than each unwise \inx[C]{ape} might think:\evb
\evg
...
\edtrans{Hildr ok Þrúðr}{Hild and Thrith}{\Afootnote{so \AM; \emph{Hildi ok Þrúði} \Regius\ stems from \emph{ꝺꝛ, ðꝛ} with r rotunda being interpreted and copied as \emph{ꝺı, ðr}, this becomes clear upon viewing the facsimile images.}}, \hld\ Hlǫkk ok Hęr-fjǫtur, &
...
a shield [before] the shining god \ken{sun}. \\
Crags and surf I know shall burn, \\
if he falls away.\footnoteB{The sun-disc was apparently thought to be a translucent shield, which protected the earth from the full power of the Sun behind it. Without it the whole world (“crags and surf”, \textsc{land} and \textsc{sea}; the totality of the earth) would burn up. In \Sigrdrifumal\ 14a/1 there is mentioned the “shield that stands before the shining god \ken{sun}”.}\evb
\evg


\bvg
\bva\mssnote{\Regius~10v/4, \AM~5r/21}Skoll hęitir ulfr, \hld\ es fylgir hinu skír-lęita &
...
but another one is \inx[P]{Hate}—he is \inx[P]{Rothwitner}’s son— \\
that one shall [run] in front of the bright bride of heaven \ken*{= Sun}.\footnoteB{According to \Gylfaginning\ 12, which is probably based on this st., Skoll chases the sun but Hate chases the moon. See note to \Voluspa\ 40 for discussion on these wolves.}\evb
\evg
...
\ind \alst{M}iðgarð \alst{m}anna sonum, &
...
því’t \alst{o}pnir hęimar \hld\ verða of \alst{á}sa sonum, &
\ind þá’s \alst{h}ęfja af \alst{h}vera.\eva

\bvb The \inx[C]{holdness} of \inx[P]{Woulder}—and of all the gods— \\
...
\bvg
\bva\mssnote{\Regius~10v/13, \AM~5r/29}Askr Ygg-drasils, \hld\ hann ’s ǿztr viða &
...
\bvg
\bva\mssnote{\Regius~10v/15, \AM~5v/2}Svipum hęf’k nú ypt \hld\ fyr sig-tíva sonum, &
...
on Eagre’s bench, \\
at Eagre’s drinking.\footnoteB{Weden suddenly announces that he has made the other gods aware of his identity, and thus they will leave their feasting at Eagre’s and instead come to help him.}\evb
\evg
...
\bvg
\bva\mssnote{\Regius~10v/19, \AM~5v/5}Saðr ok Svipall \hld\ ok Sann-getall, &
...
\bvg
\bva\mssnote{\Regius~10v/25, \AM~5v/11}Sviðurr ok Sviðrir \hld\ es ek hét at Søkk-mímis &
...
\bvg
\bva\mssnote{\Regius~10v/31, \AM~5v/16}Ęgg-móðan val \hld\ nú mun Yggr hafa, &
...
\bpg
\bpa\mssnote{\Regius~11r/5, \AM~5v/21}Geirrøðr konungr sat, ok hafði sverð um kné sér ok brugðit til miðs. En er hann heyrði, at Óðinn var þar kominn, stóð hann upp, ok vildi taka Óðin frá eldinum. Sverðit slapp ór hendi hánum; vissu hjǫltin niðr. Konungr drap fę́ti, ok steyptiz áfram, en sverðit stóð í gǫgnum hann, ok fekk \edtext{hann}{\Afootnote{þar af \AM}} bana. \edtext{Óðinn hvarf þá.}{\Afootnote{om. \AM}} En Agnarr \edtext{var þar}{\Afootnote{varð \AM}} konungr \edtext{lengi síðan.}{\Afootnote{om. \AM}}\epa
