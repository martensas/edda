...
\edtext{\edtrans{\alst{Á}r-vakr ok \alst{A}l-sviðr}{Yorewaker and Allswith}{\Bfootnote{The two horses which pull the sun-chariot also appear in \Sigrdrifumal\ 15/2; cf. note to the next st.}}, \hld\ þęir skulu \alst{u}pp heðan &
...
\ind ef hann \alst{f}ęllr ï \alst{f}rȧ.}{\lemma{ALL}\Bfootnote[nonum]{The sun-disc was apparently thought to be a translucent shield, which protected the earth from the full power of the sun behind it. Without it the world (“crags and surf”, \textsc{land} and \textsc{sea}; the totality of the earth) would burn up.  Cf. \Sigrdrifumal\ 15/1, which mentions the “shield that stands before the shining god \ken{sun}”.}}\eva
