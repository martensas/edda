...
Weden spoke: “Seest thou Ayner, thy foster son, as he begets children with a troll-woman in her cave?\footnoteB{This may relate to Frie’s role as love-goddess. Ayner is in any case a \inx[C]{degenerate} man, what one would call a ‘coomer’.}
...
\bvg\bva\mssnote{\Regius~10v/9, \AM~5r/26}\edtrans{\alst{U}llar}{Woulder}{\Bfootnote{The exact reason for why Woulder is invoked here is unclear, but it suggests that he has a role in the setting of the ritual fire, something possibly attested by the archeological finds at \emph{Lilla Ullevi}, Sweden. See Encyclopedia: \inx[C]{Woulder} and \textcite{afEdholm2009} for more.}} \edtrans{hylli}{holdness}{\Bfootnote{i.e. ‘favour, loyalty, grace’. This word and the corresponding adjective \emph{hollr} ‘hold; favourable, loyal, gracious’ and verb \emph{hylla} ‘to make hold’ are often used when speaking about divine grace, not just in Christian texts, but also (as here) w.r.t. to the Heathen gods. See Encyclopedia: \inx[C]{holdness} for other examples.}} \hld\ hęfr ok \edtrans{\alst{a}llra goða}{All Gods}{\Bfootnote{Cf. \Sigrdrifumal\ 2–3, \Lokasenna\ 11, which both hail the Gods as a collective (the former as part of a genuine prayer, the latter subversively). For the unity of the Gods, see Encyclopedia: \inx[C]{All Gods}.}} &
...
\bvb The \inx[C]{holdness} of \inx[P]{Woulder} and of \inx[C]{All Gods} \\
