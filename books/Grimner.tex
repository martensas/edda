...
There they stayed over the winter. The farmer’s wife fostered Ayner and the farmer Garfrith.\footnoteB{The husband and wife were Weden and Frie; this is clarified by the following prose. The motif of Weden favouring the youngest brother is also found in \textlink{Rigsthula}.}
...
\edtrans{\alst{H}rísi vęx \hld\ ok \alst{h}ǫ́u grasi}{with brushwood grows, and with tall grass,}{\Bfootnote{Identical to \textlink{Havamal} 119/6.}} &
...
\ind brave, to avenge his father.\footnoteB{At the Rakes of the Reins Wider avenges His father, Weden.  See \textlink{Voluspa} 51–52, \textlink{Vafthrudnismal} 53.}\evb\evg
...
\ind fiskr}{\lemma{Þjóð-vitnis fiskr ‘Thedwitner’s fish’}\Bfootnote{\emph{Þjóðvitnir} is easily analyzed as \emph{þjóð-} ‘great, main’ + \emph{vitnir} ‘wolf’.  The great wolf is naturally the \inx[P]{Fenrerswolf}, the brother of the Middenyardswyrm.  That the Wyrm can be called a fish is shown by \textlink{Hymiskvida} 24.}} flóði ï; &
...
\ind for the noisy slain host to wade.\footnoteB{A difficult stanza.  Thound may be the river surrounding Walhall, which the dead have to pass over to reach it.  The stanza may also be referring to the punishment of criminals in waters; see note to \textlink{Voluspa} 38 for discussion on that.}\evb\evg
...
\edtext{\alst{O}rmar flęiri \hld\ liggja und \alst{a}ski \alst{Y}gg-drasils &
\ind an þat of \alst{h}yggi \alst{h}vęrr &
\ind \alst{ȯ}-sviðra \alst{a}pa:}{\lemma{ALL}\Bfootnote[nonum]{This stanza is cited together with 35 and 36 in \Gylfaginning\ 16 in the order 36, 34, 35.  The three are introduced in the following way: \emph{En svá margir ormar eru í Hvergelmi með Níðhǫgg, at engi tunga má telja; svá segir hér:} ‘But so many worms are in Wharyelmer with Nithehewer that no tongue may count them. So it says here:’}}\eva
...
\edtext{\alst{S}valinn hęitir, \hld\ hann stęndr \alst{s}ólu fyrir, &
\ind \alst{sk}jǫldr \alst{sk}ïnanda goði; &
\alst{b}jǫrg ok \alst{b}rim \hld\ vęit’k at \alst{b}rinna skulu, &
\ind ef hann \alst{f}ęllr ï \alst{f}rȧ.}{\lemma{ALL}\Bfootnote[nonum]{The sun-disc was apparently thought to be a translucent shield, which protected the earth from the full power of the sun behind it. Without it the world (“crags and surf”, \textsc{land} and \textsc{sea}; the totality of the earth) would burn up.  Cf. \textlink{Sigrdrifumal} 15/1, which mentions the “shield that stands before the shining god \ken{sun}”.}}\eva
...
\ind sá skal fyr \alst{h}ęiða brúði \alst{h}imins.}{\lemma{ALL}\Bfootnote[nonum]{According to \Gylfaginning\ 12 Scoll chases the Sun and Hater the Moon; which is presumably why he runs in front of the sun)  See note to \textlink{Voluspa} 40 for discussion on these wolves.}}\eva

\bvb \inx[P]{Scoll} is the wolf called who follows the pure-faced \\
\ind god \ken{sun} to the shelter of the woods, \\
but second \inx[P]{Hater}; he is \inx[P]{Rothwitner}’s son— \\
...
\ind en \edtrans{ór \alst{h}ausi \alst{h}iminn}{from his skull the heaven}{\Afootnote{\emph{himinn ór hausi hans} ‘the heaven from his skull’ \AMb\EddaBms}}.}{\lemma{ALL}\Bfootnote[nonum]{This stanza is clearly closely related to \textlink{Vafthrudnismal} 21; see there for notes.}}\eva
...
\edtext{\alst{S}vipum hęf’k nú ypt \hld\ fyr \alst{s}ig-tíva sonum, &
...
\ind \alst{Ę́}gis drekku \alst{a}t.}{\lemma{ALL}\Bfootnote[nonum]{Weden announces that he has made the Gods aware of his situation; they will leave their feasting at Eagre’s hall (cf. \textlink{Hymiskvida} and \textlink{Lokasenna}) and come to his rescue.  He then begins the list of names.}}\eva
...
\edtext{\alst{Ǫ}lr est Gęir·røðr, \hld\ hęfr þú \alst{o}f-drukkit; &
\alst{m}iklu est hnugginn, \hld\ es þú est \alst{m}ïnu gęngi, &
\edtrans{\alst{ǫ}llum \alst{ęi}n-hęrjum}{of all the Oneharriers}{\Bfootnote{Linguistically, Garfrith is not bereft of the support of the Oneharriers but rather of the Oneharriers themselves, but the sense is the same: by breaking the Odinic code of conduct he has lost Weden’s favour, and thus been excluded from the community of oath-bound warriors, the Oneharriers.  A righteous king, however, could expect their truce, as was the case for Hathkin the Good according to the poem composed about him (Eyv \emph{Hák} in \Skp\ 1).  In that poem (st. 16/1–2) \inx[P]{Bray} greets him in the hall of the Gods, saying: \emph{Ęin-hęrja grið · skalt allra hafa; / þigg þú at ǫ̇sum ǫl.} ‘The truce of all the Oneharriers shalt thou have; accept ale from the \inx[G]{Eese}!’}} \hld\ ok \alst{Ó}ðins hylli.}{\lemma{ALL}\Bfootnote[nonum]{Weden now turns to address Garfrith directly.  He reproaches him and predicts his imminent death.}}\eva
...
\bvb Weden I am now called; Ug I was called earlier; \\
