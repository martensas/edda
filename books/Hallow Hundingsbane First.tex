...
\begin{flushright}%
\textbf{Dating} \parencite{Sapp2022}: late 1100s (0.805), early 1000s (0.103)
...
\bvg\bva\mssnote{\Regius~20r/21}\edtrans{\alst{Á}r vas \alst{a}lda}{It was the dawn of elds}{\Bfootnote{This formulaic introduction immediately situates the events of the poem in the distant mytho-heroic past, indeed, if one compares \Voluspa\ 3, at the beginning of history.}} \hld\ þat’s \alst{a}rar gullu &
...
\bvb It was the dawn of \inx[C]{eld}[elds], as eagles shrieked, \\
holy waters poured down from the Heavenfells; \\
then had Burhild in Browlund given birth \\
to Hallow the great of heart.\evb\evg


\bvg\bva\mssnote{\Regius~20r/23}\alst{N}ǫ́tt varð í bǿ, \hld\ \alst{n}ornir kvǫ́mu, &
...
those who shaped the age of the nobleman \ken*{= Hallow}. \\
They bade that battle-arrayer become the noblest, \\
and among princes seem the best.\evb\evg


\bvg\bva\mssnote{\Regius~20r/25}Sneru þę́r af \alst{a}fli \hld\ \alst{ø}r·lǫg-þǫ́ttu &
...
\bvg\bva\mssnote{\Regius~20r/27}Þę́r \alst{au}str ok vestr \hld\ \alst{ę}nda fǫ́lu, &
...
The kinswoman of Nare \name{unknown person} \ken{norn} tugged onto the northern ways \\
