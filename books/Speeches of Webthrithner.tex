...
\bva\mssnote{\Regius~REGTODO}Ráð mér nú \alst{F}rigg \hld\ alls mik \alst{f}ara tíðir &
...
\bvb “Counsel me now, \inx[P]{Frie}, as I desire to journey to visit \inx[P]{Webthrithner}; great curiosity I have of ancient staves by that all-wise \inx[G]{Ettins}[ettin].\footnoteB{i.e. ‘I am greatly curious of the all-wise ettin’s ancient pieces of wisdom.’ Cf. v. 55.}”\evb
\evg


\bvg {\small [Frie quoth:]}
\bva\mssnote{\Regius~REGTODO}\alst{H}ęima lętja \hld\ mynda’k \alst{H}ęrjafǫðr &
\ind í \alst{g}ǫrðum \alst{g}oða; &
\alst{ę}ngi \alst{jǫ}tun \hld\ hugða’k \alst{ja}fnramman &
\ind sęm \alst{V}afþrúðni \alst{v}esa.\eva

\bvb “I would hold the Father of Hosts \ken*{= Weden} at home\footnoteB{lit. perhaps ‘I would dissuade/hinder \dots\ at home’} in the yards of the gods, for no ettin [have] I thought to be even-strong with Webthrithner.”\evb
\evg


\bvg {\small [Weden quoth:]}
\bva\mssnote{\Regius~REGTODO}\alst{F}jǫlð ek \alst{f}ór, \hld\ \alst{f}jǫlð \alst{f}ręistaða’k, &
...
\bvb “Much I journeyed, much I tried, much I tested the \inx[G]{Reins}. This I wish to know: how the condition of the halls of Webthrithner might be.”\evb
\evg


\bvg {\small [Frie quoth:]}
\bva\mssnote{\Regius~REGTODO}\alst{H}ęill þú farir, \hld\ \alst{h}ęill þú aptr komir, &
...
\bvg
\bva\mssnote{\Regius~REGTODO}\alst{F}ór þá Óðinn \hld\ at \alst{f}ręista orðspęki &
...
\bvg {\small [Weden quoth:]}
\bva\mssnote{\Regius~REGTODO}\alst{H}ęill þú nú, Vafþrúðnir, \hld\ nú em’k í \alst{h}ǫll kominn &
...
\bva\mssnote{\Regius~REGTODO}Hvat’s þat \alst{m}anna, \hld\ es í \alst{m}ínum sal &
...
\bvg {\small [Weden quoth:]}
\bva\mssnote{\Regius~REGTODO}\edtext{\alst{G}agnráðr}{\Bfootnote{Gangráðr ‘Journey-adviser’ \GylfMS}} hęiti’k, \hld\ nú em’k af \alst{g}ǫngu kominn, &
...
\bvb “\inx[P]{Gainred} I am called, now am I come from walking, thirsty, to thy halls. In need of a welcoming have I journeyed for long; and [in need] of thy reception, ettin!”\evb
\evg


\bvg {\small [Webthrithner quoth:]}
\bva\mssnote{\Regius~REGTODO}Hví þú þá, \alst{G}agnráðr, \hld\ mę́lisk af \alst{g}olfi fyrir? &
...
\bva\mssnote{\Regius~REGTODO}\alst{Ó}auðigr maðr, \hld\ es til \alst{au}ðigs kømr, &
...
\bvg {\small [Webthrithner quoth:]}
\bva\mssnote{\Regius~REGTODO}Sęg mér, \alst{G}agnráðr, \hld\ alls á \alst{g}olfi vill &
...
\bvb “Say to me, Gainred, since on the floor thou wilt try thy fame: What is the horse called, which pulls each day above the lads of the retinue \ken{men}?”\evb
\evg


\bvg {\small [Gainred quoth:]}
\bva\mssnote{\Regius~REGTODO}\alst{Sk}infaxi hęitir, \hld\ es hinn \alst{sk}íra dręgr &
...
\bvb “\inx[P]{Shinefax} is called he who pulls the bright day above the lads of the retinue. The best of horses he seems among the \inx[G]{Reth-Gots}; the mane of that stallion ever shines.”\evb
\evg


\bvg {\small [Webthrithner quoth:]}
\bva\mssnote{\Regius~REGTODO}Sęg þat, \alst{G}agnráðr, \hld\ alls á \alst{g}olfi vill &
\ind þíns of \alst{f}ręista \alst{f}rama, &
hvé \alst{jó}r hęitir, \hld\ sá’s \alst{au}stan dręgr &
\ind \alst{n}ǫ́tt of \alst{n}ýt ręgin.\eva

\bvb “Say this, Gainred, since on the floor thou wilt try thy fame: What is the steed called, which from the east pulls night above the useful \inx[G]{Reins}?”\evb
\evg


\bvg {\small [Gainred quoth:]}
\bva\mssnote{\Regius~REGTODO}\alst{H}rímfaxi \alst{h}ęitir, \hld\ es \alst{h}vęrja dręgr &
...
\bvb “Say this, Gainred, since on the floor thou wilt try thy fame: How the river is called, which divides the ground between the sons of ettins and the gods?”\evb
\evg


\bvg {\small [Gainred quoth:]}
\bva\mssnote{\Regius~REGTODO}\alst{Í}fing hęitir \alst{ǫ́}, \hld\ es dęilir með \alst{jǫ}tna sonum &
...
\bvb “Say this, Gainred, since on the floor thou wilt try thy fame: How that plain is called, where \inx[P]{Surt} and the excellent gods find each other at war?”\evb
\evg


\bvg {\small [Gainred quoth:]}
\bva\mssnote{\Regius~REGTODO}\alst{V}ígríðr hęitir \alst{v}ǫllr, \hld\ es finnask \alst{v}ígi at &
...
\bvg {\small [Webthrithner quoth:]}
\bva\mssnote{\Regius~REGTODO}\alst{F}róðr ert nú gęstr, \hld\ \alst{f}ar á bękk jǫtuns, &
...
\bvg {\small [Gainred quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3r/1}Sęg þat hit \alst{ęi}na, \hld\ ef þitt \edtext{\alst{ǿ}ði}{\lemma{ǿði}\Bfootnote{The first word on fol. 3r. of \AM; from this point we have the poem in both manuscripts.}} dugir &
...
\bvg {\small [Webthrithner quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3r/2}Ór \alst{Y}mis holdi \hld\ vas \alst{jǫ}rð of skǫpuð, &
...
\bvg {\small [Gainred quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3r/3}Sęg þat \alst{a}nnat, \hld\ ef þitt \alst{ǿ}ði dugir &
\ind ok þú \alst{V}afþrúðnir \alst{v}itir, &
...
\bvg {\small [Webthrithner quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3r/4}\alst{M}undilfari hęitir, \hld\ hann’s \alst{M}ána faðir &
...
\bvg {\small [Gainred quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3r/6}\alst{S}ęg þat þriðja, \hld\ alls þik \alst{s}vinnan kveða &
\ind ok þú \alst{V}afþrúðnir \alst{v}itir, &
...
\bvg {\small [Webthrithner quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3r/8}\alst{D}ęllingr hęitir, \hld\ hann’s \alst{D}ags faðir, &
...
\bvg {\small [Gainred quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3r/9}Sęg þat \alst{f}jórða, \hld\ alls þik \alst{f}róðan kveða, &
\ind ok þú \alst{V}afþrúðnir \alst{v}itir, &
...
\bvg {\small [Webthrithner quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3r/10}\edtext{\alst{V}indsvalr hęitir, \hld\ hann’s \alst{V}etrar faðir, &
\ind ęn \alst{S}vǫ́suðr \alst{S}umars.}{\lemma{Vindsvalr \dots\ Sumars}\Bfootnote{Half of the v. seems to be missing.}}\eva
...
\bvg {\small [Gainred quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3r/11}Sęg þat \alst{f}imta, \hld\ alls þik \alst{f}róðan kveða, &
\ind ok þú \alst{V}afþrúðnir \alst{v}itir, &
...
\bvg {\small [Webthrithner quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3r/12}\alst{Ø}rófi vetra \hld\ áðr vę́ri \alst{jǫ}rð of skǫpuð, &
...
\bvg {\small [Gainred quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3r/14}\alst{S}ęg þat \alst{s}étta, \hld\ alls þik \alst{s}vinnan kveða, &
\ind ok þú \alst{V}afþrúðnir \alst{v}itir, &
...
\bvg {\small [Webthrithner quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3r/15}\edtext{\alst{Ó}r \alst{É}livǫ́gum \hld\ stukku \alst{ęi}trdropar, &
\ind svá \alst{ó}x unz ór varð \alst{jǫ}tunn; &
\edtext{órar ę́ttir \hld\ kómu þar allar saman; &
\ind því’s þat ę́ alt til atalt.}{\lemma{órar \dots\ atalt}\Bfootnote{\emph{om.} \Regius\AM}}}{\lemma{Ór \dots\ atalt}\Bfootnote{\emph{quoted in} \GylfMS}}\eva
...
\bvg {\small [Gainred quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3r/16}\alst{S}ęg þat \alst{s}jaunda, \hld\ alls þik \alst{s}vinnan kveða, &
\ind ok þú \alst{V}afþrúðnir \alst{v}itir, &
...
\bvg {\small [Webthrithner quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3r/17}Und \alst{h}ęndi vaxa \hld\ kvǫ́ðu \alst{h}rímþursi &
...
\bvg {\small [Gainred quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3r/18}Sęg þat ǫ́ttunda, \hld\ alls þik fróðan kveða, &
\ind ok þú \alst{V}afþrúðnir \alst{v}itir, &
hvat \alst{f}yrst of mant \hld\ eða \alst{f}ręmst of vęizt, &
\ind þú ert \alst{a}lsviðr \alst{jǫ}tunn.\eva
...
\bvg {\small [Webthrithner quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3r/19}\edtext{\alst{Ø}rófi vetra \hld\ áðr vę́ri \alst{jǫ}rð of skǫpuð, &
\ind þá vas \alst{B}ergęlmir \alst{b}orinn; &
...
\bvg {\small [Gainred quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3r/21}\alst{S}ęg þat níunda, \hld\ alls þik \alst{s}vinnan kveða, &
\ind ok þú \alst{V}afþrúðnir \alst{v}itir, &
...
\bvg {\small [Webthrithner quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3r/22}\alst{H}rę́svęlgr \alst{h}ęitir, \hld\ es sitr á \alst{h}imins ęnda, &
...
\bvg {\small [Gainred quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3r/24}Sęg þat \alst{t}íunda, \hld\ alls þú \alst{t}íva rǫk &
...
\bvg {\small [Webthrithner quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3r/28}\alst{A}llir \alst{ęi}nhęrjar \hld\ \alst{Ó}ðins túnum í &
\ind \alst{h}ǫggvask \alst{h}vęrjan dag, &
...
\bvg {\small [Gainred quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3v/1}Sęg þat \alst{t}olpta, \hld\ hví þú \alst{t}íva rǫk &
\ind ǫll \alst{V}afþrúðnir \alst{v}itir, &
...
\bvg {\small [Webthrithner quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3v/2}Frá \alst{jǫ}tna rúnum \hld\ ok \alst{a}llra goða &
...
\bvg {\small [Gainred quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3v/4}\alst{F}jǫlð ek \alst{f}ór, \hld\ \alst{f}jǫlð \alst{f}ręistaða’k, &
\ind fjǫlð ek \alst{r}ęynda \alst{r}ęgin; &
...
\bvg {\small [Webthrithner quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3v/6}\alst{L}íf ok \alst{L}ífþrasir, \hld\ ęn þau \alst{l}ęynask munu &
...
\bvg {\small [Gainred quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3v/8}\alst{F}jǫlð ek \alst{f}ór, \hld\ \alst{f}jǫlð \alst{f}ręistaða’k, &
\ind fjǫlð ek \alst{r}ęynda \alst{r}ęgin; &
...
\bvg {\small [Webthrithner quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3v/9}\alst{Ęi}na dóttur \hld\ berr \alst{a}lfrǫðull, &
\ind áðr hana \alst{F}ęnrir \alst{f}ari; &
sú skal \alst{r}íða, \hld\ þá’s ręgin \alst{d}ęyja, &
\ind \alst{m}óður brautir \alst{m}ę́r.\eva

\bvb “One daughter the elf-wheel \ken*{= Sun} bears before Fenrer might slay her. She shall ride—when the Reins die—the maiden, her mother’s paths.”\evb
\evg


\bvg {\small [Gainred quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3v/10}\alst{F}jǫlð ek \alst{f}ór, \hld\ \alst{f}jǫlð \alst{f}ręistaða’k, &
\ind fjǫlð ek \alst{r}ęynda \alst{r}ęgin; &
...
\bvg {\small [Webthrithner quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3v/11}\alst{Þ}ríar \alst{þ}jóðáar \hld\ falla \alst{þ}orp yfir &
...
\bvg {\small [Gainred quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3v/13}\alst{F}jǫlð ek \alst{f}ór, \hld\ \alst{f}jǫlð \alst{f}ręistaða’k, &
\ind fjǫlð ek \alst{r}ęynda \alst{r}ęgin; &
...
\bvg {\small [Webthrithner quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3v/14}\alst{V}íðarr ok \alst{V}áli \hld\ byggva \alst{v}é goða, &
...
\bvg {\small [Gainred quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3v/16}\alst{F}jǫlð ek \alst{f}ór, \hld\ \alst{f}jǫlð \alst{f}ręistaða’k, &
\ind fjǫlð ek \alst{r}ęynda \alst{r}ęgin; &
hvat verðr \alst{Ó}ðni \hld\ at \alst{a}ldrlagi, &
\ind þá’s \alst{r}júfask \alst{r}ęgin?\eva

\bvb “Much I journeyed, much I tried, much I tested the Reins. What brings Weden’s life to an end, when the Reins are rent?\footnoteB{Formulaic; see \Baldrsdraumar\ 14 and Note.}”\evb
\evg


\bvg {\small [Webthrithner quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3v/17}\alst{U}lfr glęypa \hld\ mun \alst{A}ldafǫðr, &
...
\bvg {\small [Gainred quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3v/19}\alst{F}jǫlð ek \alst{f}ór, \hld\ \alst{f}jǫlð \alst{f}ręistaða’k, &
\ind fjǫlð ek \alst{r}ęynda \alst{r}ęgin; &
...
\bvg {\small [Webthrithner quoth:]}
\bva\mssnote{\Regius~REGTODO, \AM~3v/19}\alst{Ęy} \edtext{manngi}{\Afootnote{\emph{manni} dat. sg. \Regius\AM\ is impossible; a subject is needed.}} vęit, \hld\ hvat þú í \alst{á}rdaga &
...
\bvg
\bva\mssnote{\Regius~REGTODO, \AM~3v/21}Nú við \alst{Ó}ðin \hld\ dęilda’k mína \alst{o}rðspęki; &
\ind þú ert ę́ \alst{v}ísastr \alst{v}era.\eva
