...
\bvg\bva\mssnote{\Wormianus~78rTODO}%
...
white of wheat—and covered the cloth.\footnoteB{Note the strong parallelism.  The rich household can afford an excess of expensive fabric and bread, to cover the platter with an embroidered (\emph{męrktr}) flaxen cloth, and then cover that cloth with loaves of wheat-bread.}\evb\evg
...
\edtrans{\alst{ǫ}tul vǫ́ro \alst{au}gu \hld\ sem \alst{y}rmlingi}{fierce were his eyes like the young serpent’s}{\Bfootnote{That noble stock distinguishes itself through physical appearance, especially a sharp and fierce gaze, is a common motif.  It appears e.g. in \Volundarkvida\ where Wayland’s gaze is like the serpnt’s, and the incident at the beginning of \HelgakvidaTwo, where Hallow, disguised as a thrall-woman, is almost caught due to his unslavelike eyes, which are, like in the present stanza, also said to be \emph{ǫtul} ‘fierce, terrible’.}}.\eva
...
\alst{S}onr ok \alst{S}vęinn, \hld\ (\alst{s}und ok tafl)}{\lemma{nǫ́mu lęika \dots\ sund ok tafl ‘they learned to play swimming and tables’}\Bfootnote{This sentence is embedded in the list of names.  Swimming and “tables” (\emph{tafl}, a generic word for board games—TODO) here serve as customary aristocratic activities.}} &
