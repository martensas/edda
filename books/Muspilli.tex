...
The \textbf{Muspell} (\textlink{Muspilli}) is an Old High German Christian poem dealing with the Day of Judgment.

\textlink{Muspilli} survives in a single copy, found scribbled in a Latin-language theological manuscript from the 820s CE with signum \emph{CLM 14098}; since the poem is marginalia, the dating of the manuscript can unfortunately only serve as a \emph{terminus post quem}.  The use of occasional end rhyme (see note to ll. 60–61) suggests a relation to Otfrid’s \emph{Evangelienbuch} (written 863–871 CE), as does the exact correspondence between \textlink{Muspilli} 14 and \emph{Evangelienbuch} 1.18.9.  Whatever the direction of influence, the author of \textlink{Muspilli} surely belonged to the same monastic C9th milieu as Otfrid.
...
Due to the low quality of the digitally available scans of the already very poorly preserved manuscript, the following edition has had to rely partly on the text found in the 17th edition of Braune’s \emph{Althochdeutsche Lesebuch} published in 1994.%TODO: add when true:  All critical choices have, however, been verified by me.
...
\edtext{dár ist \alst{l}íp áno tôd, \hld\ \edtext{\alst{l}i\emph{oh}t}{\Afootnote{\emph{lihot} ms.}} áno \edtext{finst\emph{r}í}{\Afootnote{\emph{finsti} ms.}}}{\Bfootnote{This line also appears in Otfrid’s \emph{Evangelienbuch} 1.18.9, in the form: \emph{Thár ist líb ána tôd, \hld\ lioht ána finstri.}  It is one of Otfrid’s rhymeless lines where alliteration compensates for the expected end-rhyme.  For the relevance of this shared line to the relation between \textlink{Muspilli} and \emph{Evangelienbuch} see Introduction above.}}, &
...
só in·\alst{p}rinnant die \edtext{\alst{p}erga, \hld\ \alst{p}oum}{\lemma{perga \dots\ poum ‘mountains \dots\ woods’}\Bfootnote{Formulaic word-pair; see note to \textlink{Wessobrunn} 3.}} ni ki·stęntit &
...
ni skolta síd \alst{m}anno nohhęin \hld\ \alst{m}iatun int·fáhan. &%NOTE: ni: 121v
