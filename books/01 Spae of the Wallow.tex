...
\footnotetext[1]{The ‘holy kins’, according to \Finnur referring to the gods, but it might "simply" be an allusion to the divine origin of men.}
...
\bvb About the \prop{Ease} crowed \prop{Goldencombe}, he who wakes men, at the \prop{Father of Hosts}’s [estate], but another one crows below the earth, a soot-red cock, at the halls of Hell.
...
\bvb Brothers will fight one another, and become [one another's] bane; sister's sons will waste their in-laws. 'Tis hard in the Home, great whoredom: halberd-\inx{eld}, short-sword-eld; shields are split. Wind-eld, outlaw-eld, before the world\footnotetext[1] is overthrown, no man will spare another.
\footnotetext[1]{\emph{ver-ǫld} ‘world’ might perhaps be better translated as ‘man-eld’, ‘the eld of man’ with the other elds preceding it.}
...
\bvb The sons of Mime play, but the Metted is kindled, to [the sound of] the shrill Horn of Yell. High blows Homedall; the horn is in the air; speaks Weden with the head of Mime.
...
\bvb Shakes the ash of Ugdrassle, standing; groans the old tree, and the ettin is loosened. All are frightened on the \textbf{Hell-ways}, before \textbf{Surt's kinsman} does devour it.
...
\footnotetext[2]{\Snorri \emph{guðar} 'gods'.}\\%E
...
\bvb Fields will grow unsown, all evil be bettered, Balder will come. The \inx{wal-tues}, Had and Balder, will well inhabit the building-plots of Roft. Know ye yet or what?
