...
\edtext{\alst{f}ir\emph{ih}o}{\Afootnote{\emph{fireo} \HildMS}\lemma{fir\emph{ih}o ‘men’}\Bfootnote{Gen.~of \emph{fir(a)ha}, a \emph{plurale tantum} poetic synonym for ‘men, people’ found throughout the Old Germanic languages.  In OHG it is only otherwise found in \textlink{Wessobrunn} 1 and \textlink{Muspilli} 55, never in prose \parenciteshorthand[s.v. \emph{fir(a)ha}]{EWA}, although it is also found in the cpd.~\emph{smala-firihi} m.~pl.~‘the common people’ \parenciteshorthand[s.v. \emph{ferah}]{EWA}.
...
\alst{b}retón mit sínu \edtrans{\alst{b}illju}{blade}{\Bfootnote{Instr.~sg.~of \emph{billi}, a hapax in OHG whose exact sense is unclear \parenciteshorthand[s.v. \emph{billi}]{EWA}.  It is cognate with OE \emph{bil} ‘a type of weapon’ which is exclusively used in poetry.  The rarity of this word in the old languages suggests that it is probably simply being used as a poetic synonym for ‘sword’ or ‘sharp weapon’, whence the present translation ‘blade’.}} \hld\ eddo ih imo t̨i \alst{b}anin werdan. &
