...
\textbf{Deer} (\Deor) is a short elegiac poem.  Across seven stanzas, the eponymous poet likens his own tragic fate to famous stories from Germanic heroic legend.

\subsection{Textual preservation and transmission}

\Deor\ is preserved only in \ExeterBook\ on fol.~100r/8--100v/13, where it follows the Christian poem “Soul and Body II” (\emph{Húru, þæs be·hófaþ} \dots) and is followed by the heroic \textlink{Wulf}.

\subsection{Contents}

The poem briefly summarizes the tragic lives of five figures from Germanic heroic legend, each ending with the refrain \emph{Þæs ofer·eode \hld\ þisses swá mæg} ‘That passed over; this may likewise.’  After this the poet reflects on fate, and finally tells his own story as an outcast.

\subsubsection{The legends}

The five legendary figures mentioned in the poem are:
...
The name of the poet, \emph{Déor}, first revealed in line 37, is the ancestor of modern English “deer”.  Although it can carry this sense in Old English, it can also betoken ‘beast, animal’ more generally.  The word is not otherwise known as a personal name and is therefore probably fictional; we may perhaps compare \textlink{Fafnismal}[2], where the young hero \inx[P]{Siward} calls himself \emph{gǫfugt dýr} ‘noble beast/deer’.
...
\bvg\bva[1]%
\alst{W}élund him \edtrans{be \alst{w}urman}{alongside worms}{\Bfootnote{I take this to be a description of Wayland’s desolate state after his hamstringing; he is forced to crawl on the ground in the company of worms (by which is also understood serpents). --- The possibility of this word being an English form of German \emph{Worms}, the capital of the Burgends, is unlikely since the OHG name for the city contemporary to the poem was \emph{Wormazia}.}} \hld\ \alst{w}ræces cunnade, &
...
boldly think out how she would manage that. \\
\emph{That} passed over; \emph{this} may likewise.\evb\evg


\bvg\bva[3][14]%
Wé þæt \alst{M}æð·hilde \hld\ \alst{m}ǫnge ge·frugnon &
wurdon \alst{g}rund-léase \hld\ \alst{G}eates frige, &
þæt hí seo \alst{s}org-lufu \hld\ \alst{s}lǽp ealle bi·nǫm. &
\alst{Þ}æs ofer·eode, \hld\ \alst{þ}isses swá mæg!\eva

\bvb We have learned that for Mathild many \\
...
\bvg\bva[4][18]%
\alst{Þ}eod·ríc âhte \hld\ \alst{þ}rítig wintra &
\alst{M}ǽringa burg; \hld\ þæt wæs \alst{m}ǫnegum cu̇þ. &
\alst{Þ}æs ofer·éode, \hld\ \alst{þ}isses swá mæg!\eva
...
\bvg\bva[5][21]%
Wé ge·\alst{a}scodan \hld\ \alst{Eo}rman·ríces &
\alst{w}ylfenne ge·þȯht; \hld\ âhte \alst{w}íde folc &
\alst{G}otena ríces. \hld\ \edtrans{Þæt wæs \alst{g}rim cyning!}{that was a grim king!}{\Bfootnote{Formulaic; cf.~\textlink{Widsith} TODO: \emph{Næs þæt sǽne cyning!} ‘That was not a bad king!’, \Beowulf\ 11b: \emph{Þæt wæs gód cyning!} ‘That was a good king!’}} &
...
wolven nature.  He wielded widely the host \\
...
\bvb One sits troubled by sorrow, of blessings bereft; \\
...
Âhte ic \alst{f}ela wintra \hld\ \alst{f}olgað tilne, &
\alst{h}oldne \alst{h}láford, \hld\ oþ þæt \alst{H}eorrenda nú, &
\alst{l}éoð-cræftig mǫnn \hld\ \alst{l}ǫnd-ryht ge·þâh, &
þæt mé \alst{eo}rla hléo \hld\ \alst{æ̂}r ge·sealde. &
\alst{Þ}æs ofer·eode, \hld\ \alst{þ}isses swá mæg!\eva
...
which the shelter of earls \ken{king} to \emph{me} once granted. \\
\emph{That} passed over; \emph{this} may likewise.\evb\evg
