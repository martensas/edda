...
The \textbf{Lay of Attle} (\textlink{Atlakvida}) is only preserved in \Regius, although it is closely paraphrased in \VolsungaMS.  It has long been held to be a particularly archaic poem, although that may have more to do with its style than its actual age, cleaving as it does to the old Germanic epic method of telling the whole story in poetry, rather an isolating the dialogue and otherwise relying on prose to progress the narrative.

In \Regius\ it has the title \emph{Atlakviða in grǿnlęndska} ‘the Greenlandish Lay of Attle’, but that descriptor has probably come from \textlink{Atlamal}.  The \textlink{Atlakvida} is clearly older than that poem, which does in fact show some signs of a Greenlandish origin.

\section{The Death of Attle (\emph{Dauði Atla})}

\bpg\bpa Guð·ru̇n Gjúka dóttir hefndi brǿðra sinna, svá sem frę́gt er orðit. Hon drap fyrst sonu Atla, en eptir drap hon Atla ok brendi hǫll’ina ok hirð’ina alla; um þetta er sjá kviða ort.\epa

\bpb {\huge G}uthrun Yivick’s daughter avenged her brothers, as has become famed. She first slew the sons of Attle, but after that she slew Attle and burned the hall and the whole hird. Regarding that this lay is wrought.\epb\epg
...
\bvb {\huge A}ttle sent a messenger to Guther \\
...
\alst{h}jalma gull-roðna \hld\ ok \alst{H}u̇na męngi, &
...
\alst{G}ull vissa’k ękki \hld\ ȧ \alst{G}nita-hęiði, &
...
\alst{H}ár fann’k \alst{h}ęiðingja \hld\ riðit ï \alst{h}ring rauðum; &
...
tied in a heath-dweller’s \ken{wolf’s} cloth? I think she offered a warning! \\
...
the golden bowls of craftsmen along the hands of men!\evb\evg
...
\alst{g}amna \alst{g}ręy-stóði, \hld\ ef \alst{G}unnarr \edtrans{né kømr-at}{comes not}{\Bfootnote{Note the archaic double negation \emph{né \dots\ -at}.}}.“\eva
...
\bvg\bva%
\alst{L}ęiddu land-rǫgni \hld\ \edtrans{\alst{l}ýðar ȯ·nęisir}{unshamed men}{\Bfootnote{Compare the long-line on the Thorsberg chape (\char`~\ 160–240 AD): \emph{wlþuþewaʀ \hld\ ni wajē-māriʀ} ‘Wolthew, the not ill-famed \ken{famous}’.}}, &
...
\bvb Unshamed \ken{famous} men led the lord of the land— \\
...
they drove the wand-shy horse across the all-green fields.\evb\evg
...
\bvb daves and spears.  But there Attle drank \\
wine in the wal-hall—watchmen stayed outside \\
to watch for Guther’s men, if they should come here to visit \\
...
the Hunnish harm-tricks? Go soon out of the hall!\footnoteB{Before anything evil might happen.}\evb\evg
...
\bvg\bva%
\alst{H}úna skjald-męyjar \hld\ \alst{h}ęrfi kanna, &
en \alst{A}tla sjalfan \hld\ létir ï \alst{o}rm-garð koma; &
nú ’s sá \alst{o}rm-garðr \hld\ \alst{y}kkr of folginn.“\eva

\bvb {[and]} the Hunnish shield-maidens know the harrow,\footnoteB{I.e. if he turned the Hunnish shield-maidens into enslaved farm-maids.} \\
but Attle himself oughtst thou to have put in the snake-pit— \\
now that snake-pit has enveloped you two!”\evb\evg


\bvg\bva%
„\alst{S}ęinað ’s nú, systir, \hld\ at \alst{s}amna niflungum, &
...
“It is late now, sister, to gather the Nivlings; \\
it is far to look for the support of men, \\
over the great fells of the Rhine, for unshamed \ken{famous} warriors.”\evb\evg
...
Hain smote seven men with his sharp sword, \\
but the eighth one he threw into hot fire.\evb\evg


\bvg\bva%
\edtext{Svá skal \alst{f}rǿkn \hld\ \alst{f}jǫ́ndum vęrjask;}{\lemma{Svá \dots\ vęrjask}\Bfootnote{Line moved from the last st. to this one since it seems to connect semantically with the immediately following line, and results in two typical four-line stanzas.}} &
...
\alst{h}ęldr an ȧ \alst{h}ǫndum gull \hld\ skïni \alst{H}úna bǫrnum.“\eva
...
\alst{ęi}ða opt of svarða \hld\ ok \alst{á}r of nefnda &
...
\bvg\bva%
\alst{Sk}ę́vaði þȧ hin \alst{sk}ír-lęita, \hld\ vęigar þęim at bera, &
...
\alst{sk}ǫp lét hȯn vaxa \hld\ en \alst{sk}íran malm vaða, &
...
She let the vats grow and the pure metal wade;
...
\alst{o}ptarr of faðmask \hld\ fyr \alst{ǫ}ðlingum.\eva
