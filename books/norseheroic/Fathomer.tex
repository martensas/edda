...
\llap{„}\edtrans{\alst{N}orna dóm}{The judgment of the Norns}{\Bfootnote{The time when the Norns decree that one should die, one’s predestined hour of death (cf.~\textlink{Skirnismal}[13]/3, \textlink{Gripisspa}[25]/4).  The expression is synonymous with \emph{kviðr norna} ‘verdict of the Norns’, \textlink{Hamdismal}[30]/4.}} \hld\ munt \edtrans{fyr \alst{n}ęsjum}{before the headlands}{\Bfootnote{I.e. ‘close at hand, imminent’.  An established metaphor for imminent death, cf.~\Sonatorrek\ 25, where Eyel concludes his poem by declaring that Hell (the goddess of Death) \emph{ȧ nęsjum stęndr} ‘stands upon the headlands’.}} hafa &
