...
The \textbf{Speeches of Fathomer} (abbrev. \textlink{Fafnismal}) is only preserved in \Regius, where it has the title \emph{Frá dauða Fáfnis} ‘From the death of Fathomer’.  It forms a continuous text with the preceding \textlink{Reginsmal} and the following \textlink{Sigrdrifumal} and should not be analyzed in isolation.
...
\bvg\bva%
\llap{„}\alst{H}ęipt-yrði ęin \hld\ tęlr þú þér í \alst{h}ví-vętna &
