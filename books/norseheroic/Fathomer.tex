...
The \textbf{Speeches of Fathomer} (abbrev. \textlink{Fafnismal}) is only preserved in \Regius, where it has the title \emph{Frá dauða Fáfnis} ‘From the death of Fathomer’.  It forms a continuous text with the preceding \textlink{Reginsmal} and the following \textlink{Sigrdrifumal} and should not be analysed in isolation.
...
\caption[The Ramsund carving.  Wiking Age, ca. 1030 \ce.]{The Ramsund carving.  Wiking Age, ca. 1030 \ce.  \emph{Details depicted: 1. Siward slays Fathomer.  2. Siward roasts Fathomer’s heart by a fire; he burns his finger and puts it in his mouth to cool it, inadvertently tasting the blood.  3. Two birds sit in the tree, presumably talking to Siward.  4. Rein lies decapitated surrounded by his bellows, tongs, and anvil.  5. Grane stands loaded with a chest on his back.  6. A wolf or dog; the only detail not found in \Reginsmal--\Fafnismal.}  © Bengt A. Lundgren/RAÄ. \href{https://creativecommons.org/licenses/by/4.0/deed.en}{CC BY 4.0}.  \url{https://pub.raa.se/visa/dokumentation/7dd6614e-950b-42bf-b31f-4f910c74e936}}
\label{fig:ramsund}
\end{sidewaysfigure}
...
\subsection{Frá dauða Fáfnis (‘From Fathomer’s death’)}

\bvg\bva%
\llap{„}\alst{S}vęinn ok \alst{s}vęinn! \hld\ Hvęrjum est \alst{s}vęini of borinn? &
\ind Hvęrra est \alst{m}anna \alst{m}ǫgr? &
es þú ȧ \alst{F}áfni rautt \hld\ þi̇́nn inn \alst{f}rȧna mę́ki; &
\ind stǫnd⸗umk til \alst{h}jarta \alst{h}jǫrr!“\eva

\bvb\speakernoteb{[Quoth Fathomer:]}%
...
\bpb Siward belied his name, for it was their belief in olden times that a \inx[C]{fey} man’s word could do much if he cursed his foe by name. Quoth he:\epb\epg


\bvg\bva%
\llap{„}\edtrans{\alst{G}ǫfugt dýr}{Noble Hart}{\Bfootnote{Or ‘Noble Stag’.  The hero Siward appears to have a particular association with the stag, something also found in \textlink{GudrunTwo}[2].  The association between hero, king, and stag in Germanic culture has old roots, as does the depiction of the stag locked in battle with the serpent, a motif found, e.g., on the Urnes stave church (figure~\ref{fig:urnes}, p.~\pageref{fig:urnes}).  See further \textcite{Krause2021}.
Into this complex of associations may be further pulled the god Frea; consider that Siward is called \emph{Fręys vinr} ‘Frea’s friend’ in \textlink{Sigurdskamma}[24]/4.  Frea fights against the ettin Bellower armed with an antler (\textlink{Voluspa}[51]/3 n.),
and the Danish kings, the \emph{Ing-winas} ‘Friends of Ing’ in \textlink{Beowulf} 1044, 1319 (note that Ing and Frea are synoymous), rule the hall \emph{Herut} ‘the Hart’.
An interesting archaeological parallel is the large stone sceptre found in the king’s mound at Sutton Hoo (for an archaeological description of this object see \textcite{Enright1983}).  The sceptre is relevant since it has attached at its top an iron ring, surmounted by a beautiful bronze hart.  With its great branching antlers, the hart comes off as a striking symbol of martial kingship, and the object as a whole most likely represents the same ideology as we find in the Norse and English heroic poetry.}} ek hęiti \hld\ ęn ek \alst{g}ęngit hef’k &%TODO: Figure?
\ind inn \alst{m}óður-lausi \alst{m}ǫgr, &
\alst{f}ǫður ek á’kk⸗a \hld\ sem \alst{f}ira synir, &
\ind \edtext{gęng \alst{e}k \alst{ęi}nn saman}{\Bfootnote{The present reading requires }}.“\eva

\bvb “Noble Hart am I called, but I have gone \\
\ind as the motherless lad. \\
A father I have not like the sons of men; \\
\ind \emph{I} go alone.”\evb\evg

\begin{figure}[p]
\centering
\includegraphics[width=\textwidth]{Urnes}
\caption[Detail of a struggling stag and serpent on the Urnes Stave Church, a common motif of the Urnes style.  Middle Ages, ca.~1140 \ce.]{Detail of a struggling stag and serpent on the Urnes Stave Church, a common motif of the Urnes style.  High Mediaeval, ca.~1140 \ce.  © Micha L. Rieser.  \url{https://commons.wikimedia.org/wiki/File:Stave_church_Urnes,_craving_detail_1.jpg}}
\label{fig:urnes}
\end{figure}

\bvg\bva%
\Ballnote{\VolsungaSaga\ 18 paraphrases: \emph{Ef þú átt engan fǫður né móður, af hverju undri ertu þá alinn? Ok þó’tt þú segir mér eigi þitt nafn á bana-dǿgri mínu, þá veiztu, at þú lýgr nú.} ‘If thou hast no father or mother, by which wonder art thou begotten? And although thou wilt not tell me thy name in my hour of death, thou knowest that thou art lying.’}%
\llap{„}Vęitst, ef \alst{f}ǫður né átt⸗at \hld\ sem \alst{f}ira synir, &
\ind af hvęrju vastu \alst{u}ndri \alst{a}linn?“ &
\edtext{[...]}{\Bfootnote{Two lines appear to be missing here, but they may have survived in the version of the poem underlying \VolsungaSaga, judging by its paraphrase as cited in its note to ALL.  It is apparently this now-missing appeal to Siward’s conscience---it would be dishonourable for him to lie to the dying Fathomer---that makes the young hero reveal his true name.}}\eva
...
\bvg\bva%
\llap{„}\alst{Ę́}tterni mitt \hld\ kveð’k þér \alst{ȯ}·kunnigt vesa &
\ind \edtrans{ok mik \alst{s}jalfan hit \alst{s}ama}{and my self the same}{\Bfootnote{Fathomer would not recognize Siward’s lineage (i.e., his father) or name, since he is an orphan who up until this point has not accomplished much.  Siward is not saying that his lineage is unknown even to himself, since \emph{sjalfan mik} ‘my self’ is in the accusative, not the dative.}}: &
\alst{S}ig·urðr ek hęiti \hld\ \alst{S}ig·mundr hét mi̇́nn faðir &
\ind es hęf’k þik \alst{v}ǫ́pnum \alst{v}egit.“\eva

\bvb\speakernoteb{[Quoth Siward:]}%
“My lineage, I say, is unknown to thee, \\
\ind and my self the same. \\
Siward I am called---Syemund was called my father--- \\
\ind who with weapons have smitten thee.”\evb\evg


\bvg\bva%
\llap{„}\alst{H}vęrr þik \alst{h}vatti, \hld\ hví \alst{h}vętja⸗sk lést, &
\ind mı̇́nu \alst{f}jǫrvi at \alst{f}ara? &
Inn \alst{f}rán-ęygi svęinn, \hld\ þú áttir \alst{f}ǫður bitran, &
\ind \edtrans{á-bornu \alst{sk}jór á \alst{sk}ęið.}{inborn traits show quickly}{\Bfootnote{The original is cryptic.  \emph{á skęið} means roughly ‘rapidly, quickly’, whence the expression \emph{ríða á skęið} ‘\CV: to ride at full speed’, but the other words are uncertain.  \textcite{LaFargeGlossary} read ‘your innate qualities show quickly’, suggesting two unattested words: an adjective \emph{*áborinn} ‘innate, inborn’ and a verb \emph{*skjóa} ‘to show’. Yet the lack of i-umlaut in the supposed 3rd sg. pres. ind. \emph{skjór} is difficult, since we would expect *\emph{*skýr}, as in \emph{skjóta} ‘to shoot,’ with 2nd/3rd sg. pres. ind \emph{skýtr}.
A solution would be emending to a 2nd sg. pres. subj. \emph{skjó\emph{i}r}, but this has not been undertaken.}}“\eva
...
\bvg\bva%
\llap{„}\alst{H}ugr mik \alst{h}vatti, \hld\ \alst{h}ęndr mér full-týðu &
\ind ok mi̇́nn inn \alst{h}vassi \alst{h}jǫrr; &
fár es \alst{h}vatr \hld\ es \alst{h}røða⸗sk tękr &
\ind ef i̇́ \alst{b}arn-ø̇sku es \alst{b}lauðr.“\eva

\bvb\speakernoteb{[Quoth Siward:]}%
“My heart goaded me; my hands availed me \\
\ind and this my sharp sword. \\
Few a man is bold when he takes to grow, \\
\ind if in childhood he be soft.”\evb\evg


\bvg\bva%
\llap{„}\alst{V}ęit’k, ef þú \alst{v}axa nę́ðir \hld\ fyr þinna \alst{v}ina brjósti, &
\ind séi maðr þik \edtrans{\emph{\alst{v}}ręiðan \alst{v}ega}{wrathfully fight}{\Bfootnote{Formulaic word-pair.}}; &
...
\bvg\bva%
\llap{„}Því bregðr þú nú mér, \alst{F}áfnir, \hld\ at til \alst{f}jarri sjá’k &
\ind \alst{m}i̇́num fęðr-\alst{m}unum, &
...
\bvg\bva%
\llap{„}\alst{H}ęipt-yrði ęin \hld\ tęlr þú þér ı̇́ \alst{h}ví-vętna &
\ind ęn ek þér \alst{s}att ęitt \alst{s}ęgi’k: &
It \alst{g}jalla \alst{g}oll \hld\ ok it \alst{g}lóð-rauða fé, &
\ind þér verða þęir \alst{b}augar at \alst{b}ana!“\eva

\bvb\speakernoteb{[Quoth Fathomer:]}%
“With hateful words alone dost thou answer everything, \\
...
\bvg\bva%
\Ballnote{Siward dismisses the curse.  He is a man, and therefore mortal; he must die regardless of whether he takes the gold or not, and it is better to die wealthy and renowned than wretched and unknown.}%
\llap{„}\alst{F}éi ráða \hld\ skal \alst{f}yrða hvęrr &
\ind \alst{ę́} til \edtrans{ins \alst{ęi}na dags}{the one day}{\Bfootnote{His predetermined day of death.}} &
...
\bvg\bva%
\Ballnote{Fathomer points out the danger of the curse: insidious death will find Siward in an unforeseen circumstance, and his fated death will be imminent.
--- \VolsungaSaga\ 18 paraphrases: \emph{Fátt vill þú at mínum dǿmum gera, en drukkna muntu, ef þú ferr um sjá ó·varliga, ok bíð heldr á landi, und’s logn er.} ‘Thou hast little wish to act according to my examples, but thou wilt drown if thou goest to journey carelessly at sea, so do rather abide on land until it is calm.’  It is notable that the redactor of \VolsungaSaga\ misunderstood the import of the stanza when he took it to be a warning specifically against sailing on the windy sea, which, of course, is only one example of the many potential ways in which Siward might die.}%
\llap{„}\edtrans{\alst{N}orna dóm}{The judgment of the Norns}{\Bfootnote{The time when the Norns decree that one should die, one’s predestined hour of death (cf.~\textlink{Skirnismal}[13]/3, \textlink{Gripisspa}[25]/4).  The expression is synonymous with \emph{kviðr norna} ‘verdict of the Norns’, \textlink{Hamdismal}[30]/4; cf.~also \textlink{Voluspa}[19]/5--6.}} \hld\ munt \edtrans{fyr \alst{n}ęsjum}{before the headlands}{\Bfootnote{I.e. ‘close at hand, imminent’.  An established metaphor for imminent death, cf.~\Sonatorrek\ 25, where Eyel concludes his poem by declaring that Hell (the goddess of Death) \emph{ȧ nęsjum stęndr} ‘stands upon the headlands’.}} hafa &
\ind ok \alst{ȯ}·svinns \alst{a}pa; &
i̇́ \alst{v}atni þú drukknar \hld\ ef i̇́ \alst{v}indi rę́r; &
\ind allt es \alst{f}ęigs \alst{f}orað.“\eva

\bvb\speakernoteb{[Quoth Fathomer:]}%
“The judgment of the Norns shalt thou have before the headlands, \\
...
\bvg\bva%
\Ballnote{Sts.~12--15 consist of two general mythological questions in a style most closely resembling \textlink{Vafthrudnismal}.  These questions do not at all contribute to the narrative and it is not impossible that yet more of them have been removed for that reason; cf.~note to st.~16.}%
\llap{„}Sęg mér, \alst{F}áfnir, \hld\ alls þik \alst{f}róðan kveða &
...
\bvg\bva\mssnote{\RegiusProse~5r/11, \Trajectinus~TODO, \\
\Wormianus~TODO, \Upsaliensis~TODO}%
\Ballnote{This stanza is cited in \Gylfaginning~15:32.  TODO.}%
\llap{„}\alst{S}undr-bornar mjǫk \hld\ hygg at nornir \alst{s}é, &
\ind \alst{ęi}gu-t þę́r \alst{ę́}tt saman; &
sumar ’ro \alst{ǫ̇}s-kunngar, \hld\ sumar \alst{a}lf-kunngar, &
\ind sumar \alst{d}ǿtr \alst{D}valins.“\eva

\bvb\speakernoteb{[Quoth Fathomer:]}%
“Of most sundry birth I judge the norns to be; \\
\ind they have not a lineage in common. \\
Some are Os-born, some Elf-born, \\
\ind some the daughters of Dwollen \ken{dwarfesses}.”\evb\evg


\bvg\bva%
\llap{„}Sęg mér þat, \alst{F}áfnir, \hld\ alls þik \alst{f}róðan kveða &
\ind ok \alst{v}ęl margt \alst{v}ita, &
\edtext{hvé sá \alst{h}olmr hęitir \hld\ es blanda \alst{h}jǫr-lęgi &
\ind \alst{S}urtr ok ėsir \alst{s}aman.}{\lemma{hvé \dots\ saman. ‘What \dots\ together?’}\Bfootnote{Namely at the Rakes of the Reins.  For the fight between Surt and the Gods see \textlink{Voluspa}[48]--53, \textlink{Vafthrudnismal}[17]--18.}}“\eva
...
\bvg\bva%
\llap{„}\edtrans{\alst{Ȯ}·skópnir}{Unshopner}{\Bfootnote{An otherwise unattested name.}} hęitir \hld\ ęn þar \alst{ǫ}ll skulu &
\ind \alst{g}ęirum lęika \alst{g}oð; &
\edtext{\alst{B}il-rǫst \alst{b}rotnar \hld\ es ȧ \alst{b}rott fara &
\ind ok svima i̇́ \alst{m}óðu \alst{m}arir.}{\lemma{Bil-rǫst \dots\ marir. ‘Bilrest \dots\ the sea.’}\Bfootnote{Bilrest is an alternative name for Bivrest, the Rainbow Bridge. --- These lines are explained by a passage of Snorre, \Gylfaginning~13:6: \emph{Ok svá sem hón er sterk, þá mun hón brotna þá er Mu·spells megir fara ok ríða hana, ok svima hestar þeira yfir stórar ár.  Svá koma þeir fram.} ‘And strong as it [Bivrest] is, yet it will shatter when the lads of Muspell fare and ride over it, and then their horses swim through great rivers.  So they make it forwards.’}}\eva
...
\llap{„}\alst{Ǿ}gis hjalmr \hld\ bergr \alst{ęi}nu⸗gi &
...
\bvg\bva%
\llap{„}\alst{Ęi}tri ek fnǿsta \hld\ es á \alst{a}rfi lá’k &
\ind \alst{m}iklum \alst{m}ı̇́ns fǫður.“\eva
...
\bvg\bva%
\llap{„}Inn rammi ormr, \hld\ þú gørðir frę́s mikla &
...
\bvg\bva%
\llap{„}\alst{R}ę́ð’k þér nú, Sig·urðr, \hld\ en þú \alst{r}áð nemir &
...
\bvg\bva%
\llap{„}\alst{R}áð ’s þér \alst{r}áðit \hld\ en ek \alst{r}íða mun &
\ind til þęss golls es i̇́ \alst{l}yngvi \alst{l}iggr, &
en þú, \alst{F}áfnir, \hld\ ligg i̇́ \alst{f}jǫr-brotum &
...
\bvg\bva% NOTE: Pun.
\llap{„}\alst{R}ęginn mik \alst{r}éð, \hld\ hann þik \alst{r}áða mun, &
...
\bpb Rein had disappeared while Siward fought Fathomer, and then came back as Siward wiped the blood off the sword. Quoth Rein:\epb\epg


\bvg\bva%
\llap{„}Hęill þú nú, \alst{S}ig·urðr, \hld\ nú hęfir \alst{s}igr vegit &
...
\bvg\bva%
\llap{„}Þat ’s \alst{ȯ}·víst at vita \hld\ þá’s komum \alst{a}llir saman, &
...
\bvg\bva%
\llap{„}\alst{G}laðr est nú, Sig·urðr, \hld\ ok \alst{g}agni fęginn &
\ind es þú þęrrir \alst{G}ram á \alst{g}rasi; &
\alst{b}róður mi̇́nn \hld\ hęfir þú \alst{b}ęnjaðan &
\ind ok vęld ek þó \alst{s}jalfr \alst{s}umu.“\eva

\bvb\speakernoteb{[Quoth Rein:]}%
“Glad art thou now, Siward, and rejoicing in gain \\
...
\bvg\bva%
\llap{„}Þú því \alst{r}étt \hld\ es ek \alst{r}íða skyldak &
...
\ind if thou hadst not braved my bold heart.”\evb\evg
...
\bvg\bva%
\llap{„}\alst{S}it-tu nú, \alst{S}ig·urðr, \hld\ en ek mun \alst{s}ofa ganga &
...
\bvg\bva%
\llap{„}\alst{F}jarri þú gekkt \hld\ meðan ek ȧ \alst{F}áfni rauð’k &
\ind mi̇́nn inn \alst{h}vassa \alst{h}jǫr; &
\alst{a}fli mi̇́nu \hld\ átta’k við \alst{o}rms męgin &
\ind meðan þú i̇́ \alst{l}yngvi \alst{l}átt.“\eva
...
\bvg\bva%
\llap{„}\alst{L}ęngi \alst{l}iggja \hld\ létir þú þann \alst{l}yngvi i̇́, &
\ind inn \alst{a}ldna \alst{jǫ}tun, &
ef þú \alst{s}verðs né nytir, \hld\ þęss es ek \alst{s}jalfr gørða, &
\ind ok þi̇́ns ins \alst{h}vassa \alst{h}jǫrs.“\eva
...
\bvg\bva%
\llap{„}\alst{H}ugr es bętri \hld\ en sé \alst{h}jǫrs męgin &
\ind hvar’s \emph{\alst{v}}ręiðir skulu \alst{v}ega, &
...
\ind i̇́ \alst{h}ildi-lęik \alst{h}afask &
...
\bpb {\huge S}\textsc{iward took} Fathomer’s heart and roasted it on a stick. When he thought that it was fully roasted and the blood frothed out of the heart then he touched it with his finger to see whether it was fully roasted. He burned himself and jerked his finger in his mouth. But when the heart’s blood of Fathomer came upon his tongue and he understood the speech of birds---he heard that tits were chirping in the brushes. Quoth the tit:\epb\epg


\bvg\bva%
\Ballnote{Sts.~32--33 are cited in \Skaldskaparmal\ 47.}%
\llap{„}Þar \alst{s}itr \edtext{\alst{S}ig·\emph{vǫ}rðr}{\Afootnote{metr.~emend.~\parencite[135--141]{Sievers1889}; \emph{Sig·urðr} \Regius}} \hld\ \alst{s}vęita stokkinn, &
...
\llap{„}Þar liggr \alst{R}ęginn, \edtext{\hld}{\Afootnote{add. \emph{kvað ǫnnur} ‘quoth the other one’ \Skaldskaparmal}} \alst{r}ę́ðr umb við sik, &
...
\llap{„}\alst{H}ǫfði skęmmra \hld\ láti hann inn \alst{h}ára þul &
...
\llap{„}\alst{H}orskr þø̇tti mér \hld\ ef \alst{h}afa kynni &
\alst{ǫ̇}st-ráð mikit \hld\ \alst{y}ðvar systra; &
...
\bvg\bva%
\llap{„}Es⸗at svá \alst{h}orskr \hld\ \alst{h}ildi-meiðr &
...
\bvg\bva%
\llap{„}Mjǫk es \alst{ȯ}·sviðr \hld\ ef hann \alst{ę}nn sparir &
...
\bvg\bva%
\llap{„}\alst{H}ǫfði skęmmra \hld\ láti hann þann inn \alst{h}ri̇́m-kalda jǫtun &
...
\llap{„}Verða\emph{-t} svá \alst{r}ík skǫp \hld\ at \alst{R}ęginn skyli &
...
\bvg\bva%
\llap{„}\alst{B}itt þú, \edtext{\alst{S}ig·\emph{vǫ}rðr}{\Afootnote{metr.~emend.~\parencite[135--141]{Sievers1889}; \emph{Sig·urðr} \Regius}}, \hld\ \alst{b}auga rauða; &
...
endowed with gold---if thou mightst get her!”\evb\evg


\bvg\bva%
\llap{„}Liggja til \alst{G}júka \hld\ \alst{g}rø̇nar brautir, &
\alst{f}ramm vísa skǫp \hld\ \alst{f}olk-líðǫndum; &
þar hęfir \alst{d}ýrr konungr \hld\ \alst{d}óttur alna, &
þá \alst{m}unt, \edtext{\alst{S}ig·\emph{vǫ}rðr}{\Afootnote{metr.~emend.~\parencite[135--141]{Sievers1889}; \emph{Sig·urðr} \Regius}}, \hld\ \alst{m}undi kaupa.“\eva
...
\bvg\bva%
\llap{„}Salr ’s ȧ \alst{h}ǫ́u \hld\ \alst{H}indar-fjalli, &
...
\bvb “A hall stands on the high Hindfell; \\
without it is all enwrapped in fire. \\
That one learned men have made \\
from an un-dark radiance of terror.”\evb\evg


\bvg\bva%
\llap{„}Vęit’k ȧ \alst{f}jalli \hld\ \alst{f}olk-vitr sofa &
...
\bvg\bva%
\llap{„}Knátt, \alst{m}ǫgr, séa \hld\ \alst{m}ęy und hjalmi &
...
Þar tók hann ǿgis-hjálm ok \edtrans{gull-brynju}{golden byrnie}{\Bfootnote{An obviously fictional object, the weight of which would be far too great to be practical.  Golden byrnies do not otherwise commonly feature in the Norse heroic material; the only other attestation of the present compound in the Norse corpus is in \textlink{Sigurdskamma}[47]/3.}} ok sverð’it Hrotta ok marga dýr-gripi ok klyfjaði þar með Grana.
