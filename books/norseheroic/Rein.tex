...
The \textbf{Speeches of Rein} (\textlink{Reginsmal}) is preserved in \Regius, where it follows \textlink{Gripisspa} and precedes \textlink{Fafnismal}.  It is introduced with a large initial and an illegible title originally in red ink.  \textlink{Reginsmal} clearly serves as the basis for \VolsungaSaga\ 14–15 and 17–18 (for ch. 16 see \textlink{Gripisspa}), where sts. 1, 2, 6, and 18 are cited.  Together with \textlink{Fafnismal} and \textlink{Sigrdrifumal} it also serves as a source for \Skaldskaparmal\ 46–48.
...
\bvb “Beget, still, a daughter”—quoth Rethmar—“a wolf-minded lady, \\
