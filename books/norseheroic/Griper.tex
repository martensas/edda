...
The first element is most likely to be equated with Gothic \emph{þiuþi-} ‘good’ (in \emph{þiuþi-qiss} ‘blessing’, calquing Greek \textgreek{εὐλογῐ́ᾱ}, \cite[s.v. \emph{þiuþiqiss}]{Streitberg}) rather than Gothic \emph{þiuda} ‘people, tribe’, ON \emph{þjóð} ‘id.’, OE \emph{þéod} ‘id.’
