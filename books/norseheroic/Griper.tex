...
\Gripisspa\ is unusually regular and well preserved.  Indeed, every single one of its 53 \Fornyrdislag\ stanzas is exactly four lines long, something otherwise attained only by the much shorter \textlink{GudrunThree}.  There is however a convincing explanation for this: our poem has not been transmitted for very long before ending up in the archetype of the heroic part of \Regius.

Although \textcite{Sapp2022}’s model arrives at a most probable early C11th date for the poem, its results cannot take precedence over reliable linguistic diagnostic criteria in the discussion of dating.  For \Gripisspa\ the relevant criteria are (1) the consistent contraction of older hiatus forms and (2) the exclusive occurrence of the short form of the name \emph{Sig·urðr} ‘Siward’.  Hiatus contraction is not found in Scaldic poetry older than ca. 1150, and the form \emph{Sig·urðr} is not consistently found in any other Eddic poem; in the Scaldic corpus the last use of the long \emph{Sig·vǫrðr} occurs in ca. 1148 (ESk \emph{Sigdr II} 1, \Skp\ 2).  Together these two traits point convincingly towards a late C12th dating, which would make the time between the poem’s composition to its inclusion in the \Regius\ archetype (ca. 1220) not more than 70 years, probably less.
...
lát-tu, inn \alst{í}tri, \hld\ þat, \alst{ǫ}ðlingr, nemas’k, &
