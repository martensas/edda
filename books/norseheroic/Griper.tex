...
The \textbf{Spae of Griper} (abbrev. \Gripisspa) is a fairly long poem dealing with the life of Siward.  It essentially serves as a summary of the entire Walsing-cycle from Siward’s life onwards.

\subsection{Preservation}

\Gripisspa\ is only preserved in \Regius, where it is found on foll.~26v/19--28v/29.

\subsection{Meter}

The meter is strict \Fornyrdislag\ with an almost syllable-counting tendency.  Anacrusis is occasionally allowed (3/2b, 45/3a).  No half-lines of type A3 appear in the b-verse.

The length of the stanza is unusually regular; indeed, every single one of the 53 \Fornyrdislag\ stanzas is exactly four lines long, something otherwise attained only by the much shorter \textlink{GudrunThree}.

\subsection{Style}

If \Gripisspa\ were to be described in a single word, it would be “bland”.  The poem is exceptionally formal and comes off as a product of late learning.

\subsection{Dating}

Although \textcite{Sapp2022}’s model arrives at a most probable early C11th date for the poem, its results cannot take precedence over reliable linguistic diagnostic criteria in the discussion of dating.

A convincing explanation for the metrical regularity of \Gripisspa\ is that the poem has just not been transmitted for very long before ending up in the archetype of the heroic part of \Regius.

For \Gripisspa\ the relevant criteria are (1) the consistent contraction of older hiatus forms and (2) the exclusive occurrence of the short form of the name \emph{Sig·urðr} ‘Siward’.  Hiatus contraction is not found in Scaldic poetry older than ca. 1150, and the form \emph{Sig·urðr} is not consistently found in any other Eddic poem; in the Scaldic corpus the last use of the long \emph{Sig·vǫrðr} occurs in ca. 1148 (ESk \emph{Sigdr II} 1, \Skp\ 2).  Together these two traits point convincingly towards a late C12th dating, which would make the time between the poem’s composition to its inclusion in the \Regius\ archetype (ca. 1220) not more than 70 years, probably less.
...
The first element is most likely to be equated with Gothic \emph{þiuþi-} ‘good’ (in \emph{þiuþi-qiss} ‘blessing’, calquing Greek \textgreek{εὐλογῐ́ᾱ}, \cite[s.v. \textit{þiuþiqiss}]{Streitberg}) rather than Gothic \emph{þiuda} ‘people, tribe’, ON \emph{þjóð} ‘id.’, OE \emph{þéod} ‘id.’
...
\bvg\bva%
„Þęss mun \alst{g}laðr konungr \hld\ \alst{G}ęiti spyrja &
...
Rein and Fathomer---rightly speaks Griper.”\evb\evg


\bvg\bva%
„\alst{Au}ðr mun \alst{ǿ}rinn \hld\ ef \alst{ę}fli’k svá &
...
a triumph amongst men as thou sayest for certain. \\
TODO. \\
TODO”\evb\evg
...
thou wilt ride to Yivick a triumph-sure man.”\evb\evg
...
\bvg\bva%
„\edtext{Þȧ’s því lokit \hld\ numin eru frǿði}{\Bfootnote{Alliteration is missing from this line and no obvious emendation can be found.}} &
...
\bvg\bva%
„Mun’k við þȧ \alst{G}unn·ar \hld\ \alst{g}ǫrva hlęyti &
...
\alst{G}unn·arr ok Hǫgni \hld\ en þú \alst{g}ramr þriði, &
...
\bvg\bva%
„\alst{L}it hęfir þú Gunn·ars \hld\ ok \alst{l}ę́ti hans. &
...
\bvb “Thou wilt lie, O point-knower of the host \ken{warrior}, \\
famous, beside the maiden like she were thy mother. \\
...
\bvg\bva%
„Mun \alst{g}óða kvǫ́n \hld\ \alst{G}unn·arr ęiga &
...
\bvg\bva%
„Mun hǫ̇n \alst{G}unn·ari \hld\ \alst{g}ǫrva sęgja &
...
\bvg\bva%
„Mun \alst{h}orskr Gunn·arr \hld\ at \alst{h}vǫtun hęnnar &
...
\bvg\bva%
„Þȧ ’s \alst{G}uð·ru̇nu \hld\ \alst{g}rimmt umb hjarta &
...
\bvb “Let us part in health; one will not withstand the \inx[C]{shape}[shapes]! \\
Now hast thou, Griper, done well as I asked. \\
Fast wouldst thou have told finer things \\
about my age, if thou couldst do so!”\evb\evg
