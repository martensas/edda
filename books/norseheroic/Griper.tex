...
The poem is very formal and comes off as a product of late learning.

\subsection{Dating}

Although \textcite{Sapp2022}’s model arrives at a most probable early C11th date for the poem, its results cannot take precedence over reliable linguistic diagnostic criteria.

A convincing explanation for the metrical regularity of \Gripisspa\ is that the poem has not been transmitted for very long before ending up in the archetype to the heroic half of \Regius.

Numerous traits speak to a late date for \Gripisspa.  The poem displays hiatus contraction, which is not found in Scaldic poetry older than ca. 1150.  It also has four metrically required occurrences of the short form \emph{Sig·urðr} (16/3, 24/2, 40/2, 53/4), a form which is not found in any other Eddic poem apart from \textlink{Hyndluljod}, another likely late composition \parencite[138--139]{Sievers1889}.

Together these two traits point convincingly towards composition in the late 12th c.
