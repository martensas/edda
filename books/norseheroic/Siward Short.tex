...
The most notable archaic feature is its use of the particle \emph{of} before nominals.  This particle originally corresponds to an older Germanic \emph{*ga-} (thus Anon \emph{Bjark} 1/4b (\Skp\ 3): \emph{of sinnar} ‘companions’ < PGmc \emph{*ga·sinþaniz} > OE \emph{ge·si̇́þas} ‘id.’) but becomes obsolete early in ON poetry except for when preceding verbs; in the Scaldic corpus attestations of \emph{of} before nominals occur almost exclusively(?---TODO) before ca. 1000 \ce\ (\Skp\ 5, p. xcic).
...
\alst{d}rukku ok \alst{d}ø̇mðu \hld\ \alst{d}ǿgr mart saman &
...
\alst{s}vá’t þęim \alst{S}ig·\emph{vǫ}rðr \hld\ ręið i̇́ \alst{s}inni &
...
ok hana \alst{S}ig·\emph{vǫ}rðr \hld\ \alst{s}vęipr i̇́ ripti, &
\alst{k}onungr inn hu̇nski, \hld\ \alst{k}vǫ̇n frjá si̇́na.\eva

\bvb She often goes outside, filled with hatred, \\
with ice-sheets and icicles, every evening \\
when he and Guthrun go to their bed \\
and Siward wraps her in a blanket, \\
the Hunnish king, to make love to his wife.\evb\evg
...
\bvb\speakernoteb{[Quoth Byrnhild:]}%
“I go without strength of will, husband, or children; \\
...
\alst{m}i̇́nu landi \hld\ ok \alst{m}ér sjalfri; &
mun’k \alst{u}na \alst{a}ldri \hld\ með \alst{ǫ}ðlingi.\eva

\bvb Due to that hatred she took to incite [men] to killing: \\
...
með \alst{n}á-bornum \hld\ \alst{n}iðjum mi̇́num, &
...
\bvg\bva%
Lǫtum son \alst{f}ara \hld\ \alst{f}ęðr i̇́ sinni; &
...
\bvb We shall let his son follow in his father’s tracks; \\
...
\bvg\bva%
\edtext{Ręiðr varð Gunn·arr \hld\ ok hnipnaði}{\Bfootnote{This line is missing alliteration and no obvious emendation can be found.  The most likely explanation is that the adjective \emph{ręiðr} ‘wroth’ was originally something else, since Guther does not appear to be actively angry, but rather confounded.}}, &
\alst{s}vęip \alst{s}i̇́num hug, \hld\ \alst{s}at umb allan dag; &
...
\alst{f}yrr skal’k mi̇́nu \hld\ \alst{f}jǫrvi láta &
...
Gótt ’s at \alst{r}áða \hld\ \alst{R}i̇́nar malmi, &
...
good of lineages, and let them grow.\evb\evg
...
Réð til \alst{h}ęfnda \hld\ \alst{h}ęr-gjarn i̇́ sal &
...
ęn \alst{f}óta hlutr \hld\ \alst{f}ell aptr i̇́ stað.\eva
...
\bvg\bva%
\alst{S}ofnuð vas Guð·ru̇n \hld\ i̇́ \alst{s}ę́ingu &
\alst{s}orga-laus \hld\ hjá \alst{S}ig·\emph{vę}rði; &
en hǫ̇n \alst{v}aknaði \hld\ \alst{v}ilja firrð &
es hǫ̇n \edtrans{\alst{F}ręys vinar}{Frea’s friend}{\Bfootnote{It is not clear why Siward is called the friend of this god in particular, but for the notion of a protégé of a god as his friend see \textlink{Havamal}[157] n.  A possible connection between Siward and Frea would be the hart-symbolism common to both; see \textlink{Fafnismal}[2] n., \textlink{Voluspa}[51]/3.}} \hld\ \alst{f}laut i̇́ dręyra.\eva

\bvb Guthrun lay sleeping in the bed, \\
sorrowless by Siward’s side, \\
but she awoke deprived of strength of will \\
when in the blood of Frea’s friend \ken*{= Siward} she swam.\evb\evg


\bvg\bva%
\alst{S}vá \alst{s}ló hǫ̇n \alst{s}várar \hld\ \alst{s}i̇́nar hęndr &
...
\alst{s}vá sló hǫ̇n \alst{s}vára\emph{n} \hld\ \alst{s}i̇́nni hęndi &
at \alst{k}vǫ́ðu við \hld\ \alst{k}álkar i̇́ vǫ́ &
\edtrans{ok \alst{g}ullu við \hld\ \alst{g}ę̇ss i̇́ tu̇ni}{and in response shrieked the geese in the yard}{\Bfootnote{Identically shared with \textlink{GudrunOne}[16]/3.}}.\eva
...
\bvb Then Byrnhild laughed, Budle’s daughter, \\
...
sę́ir \alst{b}rǿðr þi̇́num \hld\ \alst{b}lóðugt sár, &
...
Lítt sé⸗sk \alst{A}tli \hld\ \alst{ó}fu þi̇́na; &
...
vas⸗at hann i̇́ \alst{au}gu \hld\ \alst{y}ðr of líkr, &
...
\bvg\bva%
Þȧ vas ȧ \alst{h}vǫrfun \hld\ \alst{h}ugr mi̇́nn umb þat &
hvárt ek skylda \alst{v}ega \hld\ eða \alst{v}al fęlla, &
\alst{b}ǫll i̇́ \alst{b}rynju, \hld\ umb \alst{b}róður sǫk. &
...
lék mér \alst{m}ęirr i̇́ \alst{m}un \hld\ \alst{m}ęiðmar þiggja, &
...
es hann \alst{m}i̇́na spyrr \hld\ \alst{m}orð-fǫr gǫrva,\eva
...
þȧ mun ȧ \alst{h}ęfndum \hld\ \alst{h}arma mi̇́nna.“\eva
...
\llap{„}\alst{S}ęggi vil’k alla \hld\ i̇́ \alst{s}al ganga, &
\alst{þ}i̇́na með mi̇́num \hld\ ---nú ’s \alst{þ}ǫrf mikil--- &
...
\bvg\bva%
\Ballnote{Byrnhild dons a golden byrnie and fatally wounds herself by disembowelement (see note to l.~4 \emph{miðlaði}).  There is a notable contradiction here, since Byrnhild apparently stabs herself through the byrnie she has just donned.}%
Lęit hǫ̇n of \alst{a}lla \hld\ \alst{ęi}gu si̇́na, &
\alst{s}oltnar þýjar \hld\ ok \alst{s}al-konur; &
\alst{g}oll-brynju smó \hld\ ---vas⸗a \alst{g}ótt i̇́ hug--- &
áðr sik \edtrans{\alst{m}iðlaði}{pierced her stomach}{\Bfootnote{\emph{miðla} usually means ‘to deal out, share’ but here has the unparallelled sense ‘cut something at the middle’.  The image is thus that Byrnhild plunges her sword into her belly and disembowels herself.}} \hld\ \alst{m}ę́kis ęggjum.\eva
...
nęitt \alst{M}ęnju góð, \hld\ \alst{m}i̇́n at vitja.\eva
...
mun⸗a \alst{y}ðvart far \hld\ \alst{a}llt i̇́ sundi &
...
\edtrans{of \alst{b}orinn \alst{B}uðla \hld\ \alst{b}róðir mi̇́nn}{the man born of Budle, my own brother}{\Bfootnote{Identically shared with \textlink{GudrunOne}[25]/3.}}.\eva
...
munt i̇́ \alst{ø}ngan \hld\ \alst{o}rm-garð lagiðr.\eva
...
\alst{s}ę́lu \alst{s}i̇́nni, \hld\ ok \alst{s}ofa lífi. &
...
\bvg\bva%
{[...]} eru i̇́ vǫr-úðum \hld\ Jȯn·akrs sonum; &
mun hǫ̇n \alst{S}van·hildi \hld\ \alst{s}ęnda af landi, &
\alst{s}i̇́na męy \hld\ ok \alst{S}ig·\emph{va}rðar.\eva
...
sú mun i̇́ \alst{h}ęimi \hld\ \alst{h}inst bø̇n vesa: &
...
\alst{m}i̇́na þjȯna, \hld\ \alst{m}ęnjum gǫfga, &
...
Liggi okkar ęnn i̇́ \alst{m}illi \hld\ \edtrans{\alst{m}almr hring-variðr}{ring-adorned metal \ken{sword}}{\Bfootnote{A ring-sword, long obsolete by the time of \Sigurdskamma.  See \textlink{HelgakvidaHjorvardssonar}[9]/1 n.}}, &
...
ef hǫ̇num \alst{f}ylgir \hld\ \alst{f}ęrð mi̇́n heðan; &
...
þat’s \alst{B}uðli gaf \hld\ \alst{b}arni si̇́nu.\eva
