...
\bvg\bva%
\edtrans{\edtext{Ár}{\Afootnote{The \emph{A} is an ornamented initial 3 lines in height in \Regius.}} vas þat’s}{It was of yore that}{\Bfootnote{Shared with \textlink{GudrunOne}[1]/1; see there for further parallels.}} \alst{S}ig·urðr \hld\ \alst{s}ótti Gjúka &
...
they exchanged oaths, men brave of zeal.\evb\evg
...
while Siward rode alongside them, \\
...
the most young maiden; he left it to the lad of Yivick.\evb\evg
...
\bvg\bva%
„\alst{V}ǫn gęng’k \alst{v}ilja, \hld\ \alst{v}ers ok \edtext{b\emph{arn}a}{\Afootnote{\emph{bęggja} \Regius}}, &
...
and, prospering, to control the wealth, \\
...
He was without the sworn oaths— \\
the sworn oaths, the taken truces.”\evb\evg
...
the sword was stood unto Siward’s heart.\evb\evg
...
\bvb Guthrun lay asleep in the bed, \\
...
\bvb TODO: Translation. \\
I know clearly why this is happening now: \\
...
Why dost thou abandon thy whitish colour? \\
