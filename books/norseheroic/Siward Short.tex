...
\Sigurdskamma\ has some unusual archaic features, particularly the use of the particle \emph{of} before nouns and the adjective \emph{líkr} (see st. 23/1 n.).  Contrary to Sapp’s statistical model these traits probably allow us to date the poem to the 10th century.  It should be of some interest to the reader that its depictions of widow suicide (sati) and the afterlife are likely authentically pagan.
...
\bvg\bva%
\edtext{Ręiðr varð Gunnarr \hld\ ok hnipnaði}{\Bfootnote{This line is missing alliteration and no obvious emendation can be found.}}, &
...
\edtrans{stóð til \alst{h}jarta \hld\ \alst{h}jǫrr}{the sword was plunged unto the heart}{\Bfootnote{Formulaic.  Cf. \textlink{Voluspa}[52]/3–4}} Sig·urði.\eva

\bvb It was easy to incite the unyielding man; \\
the sword was plunged unto the heart of Siward.\evb\evg
...
\bvg\bva%
\alst{H}né hans \edtrans{of dolgr}{enemy}{\Bfootnote{Identical in sense to \emph{dolgr}.  The prefixing of a noun by the particle \emph{of} is a highly archaic feature.  The particle originally corresponds to an older Germanic \emph{*ga-} (thus Anon \emph{Bjark} 1/4b (in \Skp\ 3): \emph{of sinnar} ‘companions’ < PGmc \emph{*ga·sinþaniz} > OE \emph{ge·sïþas} ‘id.’) but became obsolete early except for when preceding finite verbs; in the Scaldic corpus attestations of it prefixing nouns occur exclusively(?—TODO) before ca. 1000 CE (\Skp\ 5, p. xcic).  The authenticity of \emph{of dolgr} is confirmed by its attestation in Egill \emph{Arkv} 22 (in \Skp\ 5) from ca. 962 CE.
In general the use of the particle \emph{of} in \Sigurdskamma\ is archaic, something which suggests an early dating for the poem; it occurs twice in \emph{of líkr} (36/2b, 61/4b; = OE \emph{ge·líc}, instead of the usual ON \emph{glíkr} with fossilized \emph{*ga-} > \emph{g-}!) and once before another noun in \emph{of skǫp} (58/5a; = OE \emph{ge·sceap}).}} \hld\ til \alst{h}luta tvęggja; &
...
but the part of his feet fell back to the ground.\evb\evg
...
but she awoke deprived of will \\
...
\bvb TODO: Translation. \\
I know clearly the reason for this now: \\
alone is Byrnhild at fault for all the bale.\evb\evg


\bvg\bva%
\Ballnote{Siward comforts Guthrun by blaming Byrnhild for his death while defending the innocence of her brother Guther, who after all has no apparent motive to kill Siward, who has never done anything ill against him.}%
...
“Thou dost not laugh, O hate-eager woman \\
...
Lítt sés’k \alst{A}tli \hld\ \alst{ó}fu þïna; &
...
\bvb Nor did I wish any husband should own me \\
before ye Yivickings rode to the court \\
on your horses, three great kings \\
TODO\evb\evg


\bvg\bva%
\edtext{Þęim hétum’k þȧ}{\Bfootnote{There is almost certainly some corruption going on here due to the unusual meter of this orphaned “line”, but the syntax and sense otherwise appears in order and no obvious emendation suggests itself.}} &
...
þó \alst{þ}ikkis’k ér \hld\ \alst{þ}jóð-konungar.\eva

\bvb Then I vowed myself to \emph{him} \\
who sat with the gold on the back of Grane. \\
He was not like \emph{you} in his eyes \\
...
at \alst{h}vár-ki léts’k \hld\ \alst{h}ǫfn of dęila, &
\alst{g}oll né jarðir, \hld\ nema \alst{g}efas’k léta’k; &
...
\alst{Þ}at myndi \alst{þ}ȧ \hld\ \alst{þ}jóð-kunnt vera, &
...
\alst{K}rǫng of \alst{k}oms’k \hld\ fyr \alst{k}né móður, &
...
\emph{she} ever born to ill will, \\
...
\bvb Until out of thinking the flax-clad woman \\
young of age quoth a word in reply: \\
“I wish not that one reluctant or hardly asked \\
...
\bvb yet on your limbs fewer will burn \\
ounces of silver when ye arrive \\
—nor boons of Mene \ken{gold}—to visit me.\evb\evg


\bvg\bva%
\alst{S}ęts’k-tu niðr, Gunnarr, \hld\ mun’k \alst{s}ęgja þér &
...
of \alst{b}orinn \alst{B}uðla, \hld\ \alst{b}róðir mïnn.\eva
...
\bvb Let lie between us two the ring-adorned metal \ken{sword}, \\
the edge-sharp iron, again laid so \\
as when we both mounted one bed \\
