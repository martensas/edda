...
fyr \alst{v}estan \alst{v}er, \hld\ ef þik \alst{v}ita lystir, &
...
\bvg\bva%
\alst{V}íg lýsir þú; \hld\ \alst{v}arð fyr Helga &
...
nú vill \alst{d}yljask \hld\ \alst{d}ǫglingr fyr mér &
...
Helgi var þá at Loga-fjǫllum ok hafði baritsk við Hundings sonu.  Þar felldi hann þá Álf ok Eyj·\emph{ó}lf, Hjǫr·varð ok Her·varð ok var hann all-víg-móðr ok sat undir Ara-steini.  Þar hitti Sigrún hann ok rann á hals hǫ́num ok kyssti hann ok sagði hǫ́num erendi sitt, svá sem segir í Vǫlsunga kviðu inni fornu:\epa
...
fyrr létsk hon \alst{u}nna \hld\ af \alst{ǫ}llum hug &
...
\alst{h}afa kvaðsk hȯn \alst{H}ęlga \hld\ \alst{h}ylli skyldu.\eva
...
es \alst{b}arðisk \alst{b}olr, \hld\ vas ȧ \alst{b}rot hǫfuð.\eva
...
\ind ok knę́tta’k þér þó ï \alst{f}aðmi \alst{f}elask.“\eva
...
þó’tt \alst{ó}ska-byrr \hld\ \alst{e}ptir lęggisk! &
\alst{R}enni-a sá marr, \hld\ es und þér \alst{r}enni, &
þó’tt \alst{f}íęndr þína \hld\ \alst{f}orðask ęigir!\eva
...
„\edtext{\alst{Ǿ}r ert, systir, \hld\ ok \alst{ø}r-vita}{\lemma{Ǿr \dots\ ok ør-viti ‘Mad \dots\ and out of thy wits’}\Bfootnote{Formulaic, also occurring in \textlink{Lokasenna} 21/1 and \textlink{Oddrunargratr} TODO.}}, &
...
né \edtrans{\alst{a}ldar rof}{Ripping of the Age}{\Bfootnote{Formulaic.  Cf. TODO \emph{rjúfask ręgin}. This is the same root, only zero-grade.}} \hld\ þó’tt-u \alst{o}ss lítir, &
...
\bvg\bva\speakernote{[Hęlgi kvað:]}%
„Nú kveð’k \alst{ę}nskis \hld\ \alst{ø}r-vę́nt vesa, &
