...
In the depiction of this motif in the present poem one might see a conflict between two varying conceptions of the afterlife, viz. the popular idea of the dead as dwelling \emph{within} his burial mound or grave, and the elite conception of the dead warrior departing to Walhall.  The “lover’s ghost” is only compatible with the former, but as a legendary warrior Hallow is thought to go to Walhall immediately after death, and so to resolve the two the poet has Hallow ride down from Walhall to the mound, where he reunites with Syerun.
...
\bvg\bva%
\llap{„}\alst{H}vǫss eru augu \hld\ ï \alst{H}agals þýju, &
...
\bvg\bva%
Nú hęfir \alst{h}ǫrð dǿmi \hld\ \alst{h}ildingr þegit &
