...
\bvg\bva%
\Ballnote{Byrnhild blames the tragic events on her brother Attle, who according to \textlink{Sigurdskamma}[37] forced her to be married.}%
Þȧ kvað þat \alst{B}ryn·hildr \hld\ \alst{B}uðla dóttir: &
...
\edtext{\alst{ę}ld ȧ \alst{jǫ}fri \hld\ \alst{o}rm-bęðs}{\lemma{ęld orm-bęðs ‘fire of the wyrm-bed \ken{gold}’}\Bfootnote{An unparalleled kenning.  \textsc{gold} can be ‘fire of the river’ (since it shines underwater) and ‘wyrm-bed’ (since the Wyrm or dragon dwells upon it), but not ‘fire of the wyrm-bed’.  TODO: reference Meissner.}} litum; &
