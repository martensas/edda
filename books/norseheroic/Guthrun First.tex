...
The \textbf{First Lay of Guthrun} (\GudrunOne) directly follows the narrative of \textlink{Brot}, as is seen by the fact that the concluding prose of \textlink{Brot} directly leads into the introduction to \GudrunOne\ in \Regius.  As such the two are clearly intended to form a continuous narrative.
...
né \alst{k}vęina of \hld\ sem \alst{k}onur aðrar}{\lemma{hǫ̇n \dots\ aðrar ‘as she \dots\ women.’}\Bfootnote{Closely related to \textlink{GudrunTwo}[10]/3–5.}}.\eva
...
\edtext{tvęggja dǿtra, \hld\ þriggja systra}{\Bfootnote{No alliteration is found in this line and no obvious emendation can be found.}}, &
\alst{á}tta brǿðra, \hld\ þó ek \alst{ęi}n lifi.“\eva

\bvb Then quoth Yeflie, Yivick’s sister: \\
“I know myself on the earth am the most joyless. \\
...
ok \alst{g}ullu við \hld\ \alst{g}ę̇ss ï tu̇ni, &
...
\bvg\bva%
Þȧ kvað þat \alst{B}ryn·hildr \hld\ \alst{B}uðla dóttir: &
„\edtrans{Vęldr \alst{ęi}nn \alst{A}tli \hld\ \alst{ǫ}llu bǫlvi}{TODO}{\Bfootnote{Cf. \textlink{HelgakvidaTwo}[34]/3 and \textlink{Sigurdskamma}[27]/4.}} &
