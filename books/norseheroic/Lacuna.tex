...
TODO: The stanzas [are to] follow the numbering of stanzas in \VolsungaSaga.
...
\bvg\bva%
\edtext{\alst{S}ig·\emph{vǫ}rðr}{\Afootnote{metr.~emend.~\parencite[135--141]{Sievers1889}; \emph{Sig·urðr} \Regius}} Grana \hld\ \alst{s}verði kęyrði; &
...
En \alst{h}lýri þi̇́nn \hld\ \alst{h}várki þorði &
\alst{ę}ld at ríða \hld\ né \alst{y}fir stíga.\eva
...
\bvg\bva%
\alst{Ú}t gekk \edtext{\alst{S}ig·\emph{vǫ}rðr}{\Afootnote{metr.~emend.~\parencite[135--141]{Sievers1889}; \emph{Sig·urðr} \Regius}} \hld\ \alst{a}nn·spjalli frȧ, &
...
\bvg\bva%
\Ballnote{This st.~is apparently related to \textlink{Brot}[4], with which it shares (in divergent form) its first two lines.  It is cited in \VolsungaSaga\ 30, where it is introduced by the words \emph{sem skáld’it kvað:} ‘as the scald quoth:’}%
