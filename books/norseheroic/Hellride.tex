...
\bpb After Byrnhild’s death two pyres were made: one for Siward, and it burned earlier; but Byrnhild was burned on the other, and she was in that chariot which was canopied with \inx[C]{god-weave}.  So it is said that Byrnhild drove with the chariot onto the Hellway and passed near a yard where a certain \inx[C]{gow} lived.  Quoth the gow:\epb\epg
...
\llap{„}Þú \edtrans{vast}{wast}{\Afootnote{\emph{est} ‘art’ \FlatMS}}, \alst{B}ryn-hildr, \hld\ \alst{B}uðla dóttir, &
