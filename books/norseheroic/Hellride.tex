...
\textbf{The Hell-ride of Byrnhild} (\Helreid) describes how Byrnhild after her death is burned on her pyre in a beautiful chariot or wagon.  In the afterlife she rides on the \inx[P]{Hellway} to reach her resting place in \inx[P]{Hell} when her road is blocked by a certain \inx[C]{gow} or troll-woman.  The poem consists of their conversation.

\subsection{Textual preservation and transmission}

\Helreid\ is attested in full in \Regius, where it follows \Sigurdskamma\ and is followed by \GudrunTwo.

The poem is also attested, with the exception of st.~6, in \Nornagest\ 9, in a sequence of tales about the Walsings which also includes \textlink{Reginsmal}.  \Nornagest\ is attested in several mss., including \FlatMS.  TODO: \textcite{Halldorsson2000}, Introduction.

The textual variants in \Nornagest’s version of \Helreid are divergent to the point that \Nornagest’s \Helreid\ cannot be directly copied from \Regius, but it is unclear whether it ultimately derives from \Regius\ through a chain of copies, or whether both derive from a lost archetype predating \Regius.  At the very least, we can tell from the similarities between the prose of \Nornagest\ and \Regius\ that the two are unlikely to be related through oral tradition alone.
...
\llap{„}\edtext{Skalt}{\Afootnote{The \emph{S} is an ornamented initial 3 lines in height in \Regius.}} i̇́ \alst{g}ǫgnum \hld\ \alst{g}anga ęigi &
\alst{g}rjóti studda \hld\ \alst{g}arða mi̇́na; &
...
\bvg\bva\mssnote{\Regius~TODO, \FlatMS~TODO}%
Hvat skalt \alst{v}itja \hld\ \edtext{af \alst{V}al-landi}{\Afootnote{\emph{vá á landi} \FlatMS}}, &
\edtrans{\alst{h}var-fu̇st}{straying}{\Afootnote{\emph{hverf-lynt} ‘fickle-minded’ \FlatMS}} \alst{h}ǫfuð, \hld\ \alst{h}úsa mi̇́nna? &
\edtext{Þú hęfir, \alst{V}ǫ́r golls, \hld\ ef þik \alst{v}ita lystir, &
\alst{m}ild, af hǫndum \hld\ \alst{m}anns blóð þvegit.}{\lemma{Þú \dots\ þvegit. ‘Thou \dots\ hands.’}\Afootnote{\emph{\alst{Þ}ú hęfir vǫrgum \hld\ ef \alst{þ}i̇́n vitja / \alst{m}ǫrgum til \alst{m}atar \hld\ \alst{m}anns blóð gefit} ‘Thou hast to many---if thou art visited(?)---wolves given man-blood for food.’ \FlatMS}}“\eva
...
\llap{„}\alst{B}regð \edtext{ęigi mér}{\Afootnote{\emph{mér ęigi} \FlatMS}}, \hld\ \alst{b}rúðr ór stęini, &
þó’tt ek \edtrans{\alst{v}ę́ra’k}{I may have been}{\Afootnote{add. \emph{fyrr} ‘formerly’ \FlatMS}} \hld\ i̇́ \alst{v}íkingu; &
...
\llap{„}Þú \edtrans{vast}{wast}{\Afootnote{\emph{ert} ‘art’ \FlatMS}}, \alst{B}ryn-hildr, \hld\ \alst{B}uðla dóttir, &
\alst{h}ęilli verstu \hld\ i̇́ \alst{h}ęim borin; &
...
\llap{„}Ek mun \alst{s}ęgja þér \hld\ \alst{s}vinn ór ręiðu, &
...
\alst{H}étu mik allir \hld\ i̇́ \alst{H}lym-dǫlum &
...
Þȧ lét’k \alst{g}amlan \hld\ ȧ \edtext{\alst{G}o\emph{t}-þjóðu}{\Afootnote{\emph{Goð-þjóðu} \Regius}\lemma{Go\emph{t}-þjóðu ‘land of the Gots’}\Bfootnote{Also found in \textlink{Gudrunarhvot}[8], 16.  The spelling \emph{-t-} attested in mss.~of \HervararSaga\ st.~94/8b (\Skp\ 8).
It is notable that ON \emph{Got-þjóð} is a direct reflex of the attested Gotish self-name, \emph{Gut-þiuda}, as found in the Gotish liturgical calendar \parencite[118]{Schaferdiek1988}.
}} &
...
\bvg\bva\mssnote{\Regius~TODO, \FlatMS~TODO}%
Lauk hann mik \alst{sk}jǫldum \hld\ i̇́ \alst{Sk}ata-lundi, &
\alst{r}auðum ok hvítum, \hld\ \alst{r}andir snurtu; &
þann bað hann \alst{s}líta \hld\ \alst{s}vefni mi̇́num &
es \alst{h}vęr⸗gi lands \hld\ \alst{h}rę́ða⸗sk kynni.\eva
...
\alst{h}ǫ́van brinna \hld\ \alst{h}ęr alls viðar; &
...
þar’s \alst{f}óstri mi̇́nn \hld\ \alst{f}lętjum stýrði; &
\alst{ęi}nn þȯtti hann þar \hld\ \alst{ǫ}llum bętri, &
\alst{v}íkingr Dana, \hld\ i̇́ \alst{v}erðungu.\eva
...
\bvg\bva\mssnote{\Regius~TODO, \FlatMS~TODO}%
\alst{S}vǫ́fum vit ok unðum \hld\ i̇́ \alst{s}ę́ing ęinni &
sem hann mi̇́nn \alst{b}róðir \hld\ of \alst{b}orinn vę́ri; &
...
at ek \edtext{\alst{S}ig·\emph{vę}rði}{\Afootnote{metr.~emend.~\parencite[135--141]{Sievers1889}; \emph{Sig·urði} \Regius}} \hld\ \alst{s}vę́fa’k ȧ armi; &
þar varð’k þęss \alst{v}ís \hld\ es \alst{v}ildi’g⸗a’k &
at þau \alst{v}éltu mik \hld\ i̇́ \alst{v}er-fangi.\eva
...
\bvg\bva\mssnote{\Regius~TODO, \FlatMS~TODO}%
\Ballnote{Following this stanza, \Nornagest\ adds the following short prose passage: \emph{Þá ǿpti gýgr ǫgurligri rǫddu ok hljóp inn í bjarg’it.} ‘Then the gow shrieked with a terrible voice and jumped into the hill.’}%
Munu við \alst{o}f·stríð \hld\ \alst{a}lls til lęngi &
\alst{k}onur ok \alst{k}arlar \hld\ \alst{k}vikkvir fǿðask; &
vit skulum \alst{o}kkrum \hld\ \edtrans{\alst{a}ldri slíta}{end our age}{\Bfootnote{In the afterlife.  An interesting expression considering how both their \emph{aldrar} ‘ages, lifetimes’ have already concluded, but Byrnhild is presumably saying that they will now spend an eternity together.}}, &
\edtext{\alst{S}ig·\emph{vǫ}rðr}{\Afootnote{metr.~emend.~\parencite[135--141]{Sievers1889}; \emph{Sig·urðr} \Regius}}, \alst{s}aman. \hld\ \alst{S}økks-tu, gýgjar-kyn!“\eva
