...
\bvg\bva%
\edtext{Þá}{\Afootnote{The \emph{Þ} is an ornamented initial 3 lines high, with the left vertical stroke ascending 3 lines and descending 2 lines in the margin in \Regius.}} \edtrans{frá’k}{I have learned}{\Bfootnote{A formulaic opening of a Germanic poem, where the narrator expresses that the story is traditional rather than personally witnessed by means of the formulaic verb PGmc. \emph{*frehnaną} ‘(come to) learn, find out through hearsay’.
Cf. \Ynglingatal\ 8/1, 15/5, 16/1, \Beowulf\ 1--2, and especially \textlink{Wessobrunn}/1, where the syntax (note the bracketing of the finite verb between the article and the noun it modifies) and wording is identical to the present line: \emph{Dat ga·fręgin ih mit firahim \hld\ firi-wizzó męista} ‘I have learned among men this greatest of wonders’.
The common ancestor may be reconstructed in PGmc.~as follows: \emph{*þa}-\textsc{acc-sg} \emph{frah ek} \dots\ \textsc{noun-acc-sg} ‘I have learned (of) that \textsc{noun}’.}} \alst{s}ęnnu \hld\ \alst{s}líðr-fęng⸗ligasta, &
