...
\subsubsection{Prose parallels}

\Gudrunarhvot\ is paraphrased in \VolsungaSaga\ 41, which as usual with that text appears (cf.~st.~5/3a) to have relied on a ms.~related to, but not identical with or descended from \Regius.

For other Norse attestations of the journey of Hamthew and Sarle and their revenge on Ermenric see the Introduction to \textlink{Hamdismal}.

\subsection{Style and word-choices}
...
A few rare or marked words occur: \emph{tȧ} in 9/2b, \emph{hu̇nn} in 12/1a, \emph{þjóð-konungr} in 14/2b.

\subsection{Meter}

The meter is \Fornyrdislag.

The length of the stanza is variable and not limited to 4 lines.

The number of non-alliterating ll.~in \Regius\ is high, and includes 5/1, 5/3, 13/2, 14/4, 18/1 and 20/4.  Of these 5/3 can be restored on the basis of \VolsungaSaga, but the rest are irrestorably defective.  All remaining non-alliterating ll.~except for 13/2 have some accompanying signs of corruption along with the lack of alliteration.  5/1 and 20/4 are too short and appear to have lost an alliterating word in transmission, as certainly happened in 5/3.  14/4 and 18/1 are isolated half-lines.  Thus, only 13/2 is a rhythmically perfect line without alliteration.
...
\edtext{Guð·rún}{\Afootnote{The \emph{G} is an ornamented capital 2 lines high in \Regius.}} gekk þá til sę́var er hón hafði drepit Atla, gekk út á sę́’inn ok vildi fara sér. Hón mátti eigi søkkva. Rak hana yfir fjǫrð’inn á land Jón·akrs konungs; hann fekk hennar. Þeira synir vóru þeir Sǫrli ok \edtrans{Erpr}{Earp}{\Bfootnote{Actually, the prose is mistaken here.  Earp was Enacker’s son from a previous marriage and not the son of Guthrun (\textlink{Hamdismal}[12]--14).}} ok Ham·ðir. Þar fǿddi⸗sk upp Svan·hildr Sig·urðar dóttir. Hón var gipt Jǫrmun·rekk inum ríkja. Með hánum var Bikki. Hann réð þat at Rand·vér konungs son skyldi taka hana; þat sagði Bikki konungi. Konungr lét hengja Rand·vé en troða Svan·hildi undir hrossa fótum. En er þat spurði Guð·rún þá kvaddi hón sonu sína.\epa

\bpb {\huge G}\textsc{uthrun then went to the sea} after she had slain Attle, went out into the sea and would end herself.  She could not sink.  She was driven across the firth to the land of king Enacker; he got her to wife.  Their sons were Sarle and Earp and Hamthew.  There Swanhild, Siward’s daughter, was reared.  She was married off to Ermenric the powerful.  With him was \inx[P]{Beck}.  He counseled that Randwigh, the king’s son, should sleep with her; this Beck told the king.  The king let Randwigh be hanged, but Swanhild he had trampled beneath the hooves of horses.  But when Guthrun learned of that she called out to her sons.\epb\epg
...
\bvg\bva%
\edtext{Þá}{\Afootnote{The \emph{Þ} is an ornamented initial 3 lines high, with the left vertical stroke ascending 3 lines and descending 2 lines in the margin in \Regius.}} \edtrans{frá’k}{I have learnt}{\Bfootnote{A formulaic opening.  The narrator expresses that  he is not a direct witness to the events of the poem by means of the formulaic verb \emph{fregna} (< PGmc. \emph{*frehnaną} ‘(come to) learn, find out through hearsay’).
This formula has identical parallels elsewhere in ON and WGmc. poetry; cf.~\Ynglingatal\ 8/1, 15/5, 16/1, \Beowulf\ 74, 575, 1026 etc., \textlink{Heliand} 288, 367, 510, etc., and esp.~\textlink{Wessobrunn}[1]/1, where the syntax (note the bracketing of the finite verb between the article and the noun it modifies) is identical to the present line: \emph{Dat ga·fręgin ih mit firahim~\hld\ firi-wizzó męista} ‘I have learnt among men that greatest of wonders’.
The ancestral expression may be reconstructed in PGmc.~as follows: \emph{*þa}-\textsc{acc-sg} \emph{ga·frah ek} \dots\ \textsc{noun-acc-sg} ‘I have learnt (of) that \textsc{noun}’. ---
For related formulaic openings involving the verb \emph{*hauzijaną} ‘hear’ cf.~\textlink{Oddrunargratr}[1]/1, \textlink{Hildebrandslied} 1.}} \alst{s}ęnnu \hld\ \alst{s}líðr-fęng⸗ligasta, &
\alst{t}rauð mǫ́l \alst{t}alið \hld\ af \alst{t}rega stórum, &
es \alst{h}arð-\alst{h}uguð \hld\ \alst{h}vatti at vígi &
\alst{g}rimmum orðum \hld\ \alst{G}uð·ru̇n sonu:\eva

\bvb {\huge I} \textsc{have learnt that exchange} brought the direst results--- \\
...
\bvg\bva%
\llap{„}Hví \alst{s}itið \edtext{\emph{it}}{\Afootnote{metr. emend.; om. by haplography (\emph{*‘ſıtıt ıt’} > \emph{‘ſıtıt’}) \Regius}}? \hld\ Hví \alst{s}ofið lífi? &
Hví \alst{t}regr⸗at ykkr \hld\ \alst{t}ęiti at mę́la, &
\edtext{es \alst{Jǫ}rmun·rekr \hld\ \alst{y}ðra systur, &
\alst{u}nga at \alst{a}ldri, \hld\ \alst{jó}m \edtrans{of traddi}{has had \dots\ trampled}{\Bfootnote{Lit. ‘made to be trampled’, 3sg past ind.~of \emph{(of) tręðja} ‘make to be trampled’, causative of \emph{troða} ‘trample, tread (upon)’.}}, &
\alst{h}vítum ok svǫrtum \hld\ ȧ \alst{h}ęr-vegi &
\alst{g}rǫ́um, \alst{g}ang-tǫmum \hld\ \alst{G}otna hrossum?}{\lemma{es \dots\ hrossum. ‘when \dots\ horses?’}\Bfootnote{Repeated almost identically in \textlink{Hamdismal}[3].}}\eva
...
ef it \alst{m}óð ę́ttið \hld\ \alst{m}i̇́nna brǿðra &
...
\bvg\bva%
\Ballnote{Ll.~1--5a in this st.~closely correspond to \textlink{Hamdismal}[6]/1--3, 7/1--2.}%
Þȧ kvað þat \alst{H}am·ðir \hld\ inn \alst{h}ugum stóri: &
\llap{„}\alst{L}ítt myndir þú \hld\ \alst{l}ęyfa dǫ́ð Hǫgna &
\edtext{þȧ’s \edtext{\alst{S}ig·\emph{vǫ}rð}{\Afootnote{metr.~emend.~\parencite[135--141]{Sievers1889}; \emph{Sig·urð} \Regius}} vǫkðu \hld\ \alst{s}vefni ór}{\Bfootnote{This l.~is metrically defective in the present poem but survives better as \textlink{Hamdismal}[6]/3.}}; &
\alst{b}ǿkr vǫ́ru þi̇́nar, \hld\ inar \alst{b}lá-hvítu, &
roðnar i̇́ \alst{v}ers dręyra, \hld\ folgnar i̇́ \alst{v}al-blóði.\eva
...
knę́ttim \edtext{\emph{\alst{a}llir}}{\Afootnote{om. \Regius}\lemma{allir ‘all’}\Bfootnote{The restoration of this word is secured by its occurrence in the paraphrase of this st.~in \VolsungaSaga\ 41: \emph{ok betr mę́ttim vér allir saman drepa Jǫrmun·rek konung} ‘and it would be better if we all together might kill king Ermenric.’  This implies that the version of the poem before the redactor of \VolsungaSaga\ was in some ways better preserved than that surviving in \Regius.}} \hld\ \alst{Jǫ}rmun·rekki, &
...
\bvg\bva%
Þȧ kvað þat \alst{H}am·ðir \hld\ inn \alst{h}ugum stóri: &
\llap{„}Svá \edtext{kom⸗a’\emph{k}}{\Afootnote{\emph{‘comaz’} \Regius}} \alst{m}ęirr aptr \hld\ \alst{m}óður at vitja &
\alst{g}ęir-Njǫrðr hniginn \hld\ ȧ \alst{G}oð-þjóðu &
at þú \alst{ę}rfi \hld\ at \alst{ǫ}ll oss drykkir, &
at \alst{S}van·hildi \hld\ ok \alst{s}onu þi̇́na.“\eva
...
\bvg\bva%
\Ballnote{The two boys depart (cf.~\textlink{Hamdismal}), and Guthrun’s long monologue begins, lasting from sts.~10 to 20.}%
...
\bvg\bva%
\llap{„}\alst{Þ}rjȧ vissa’k ęlda, \hld\ \alst{þ}rjȧ vissa’k arna, &
\alst{v}as’k þrimr \alst{v}erum \hld\ \alst{v}egin at húsi; &
\alst{ęi}nn vas mér \edtext{\alst{S}ig·\emph{vǫ}rðr}{\Afootnote{metr.~emend.~\parencite[135--141]{Sievers1889}; \emph{Sig·urðr} \Regius}} \hld\ \alst{ǫ}llum bętri &
es \alst{b}rǿðr mi̇́nir \hld\ at \alst{b}ana urðu.\eva
...
\alst{þ}riðja sinni \hld\ \edtrans{\alst{þ}jóð-konungi}{great king}{\Bfootnote{An old poetic word; for etymology + distribution see \textlink{Gripisspa}[1]/2 n.}}; &
\alst{ó}l ek mér \alst{jó}ð, \hld\ \alst{ę}rfi-vǫrðu &
{[...]} \hld\ Jȯn·akrs \edtext{sonu}{\Bfootnote{emend.; \emph{sonum} \Regius}}.\eva
...
\bvg\bva%
\Ballnote{For the description illustrating the quality of a dead person by likeness to superior natural phenomena, cf.~\textlink{HelgakvidaTwo}[38], \textlink{GudrunOne}[18], \textlink{GudrunTwo}[2].}%
Ęn umb \alst{S}van·hildi \hld\ \alst{s}ǫ́tu þýjar, &
es mi̇́nna \alst{b}arna \hld\ \alst{b}atst full-hugða’k; &
\alst{s}vá vas \alst{S}van·hildr \hld\ i̇́ \alst{s}al mi̇́num, &
\alst{s}ęm vę́ri \alst{s}ø̇m-lęitr \hld\ \alst{s}ólar gęisli.\eva

\bvb But around Swanhild handmaids sat, \\
her whom I truly thought best among my children. \\
So was Swanhild in my hall \\
like were she a fair-faced ray of the sun.\evb\evg


\bvg\bva%
\alst{G}ǿdda’k \alst{g}olli \hld\ ok \alst{g}uð-vęfjum, &
áðr ek \alst{g}ę́fa’k \hld\ \alst{G}ot-þjóðar til; &
þat ’s mér \alst{h}arðast \hld\ \alst{h}arma mi̇́nna &
of þann inn \alst{h}víta \hld\ \alst{h}add Svan·hildar: &
\alst{au}ri trǫddu \hld\ und \alst{jó}a fótum;\eva

\bvb I endowed her with gold and with cloth of \inx[C]{god-weave} \\
before I gave her to the folk of the Gots. \\
That is for me the hardest of my harms, \\
over the white hair of Swanhild \\
---they had it trampled in mud beneath the hooves of steeds!---\evb\evg


\bvg\bva%
ęn sá \alst{s}árastr, \hld\ es þęir \edtext{\alst{S}ig·\emph{vǫ}rð}{\Afootnote{metr.~emend.~\parencite[135--141]{Sievers1889}; \emph{Sig·urð} \Regius}} mi̇́nn, &
\alst{s}igri rę̇ntan, \hld\ i̇́ \alst{s}ę́ing vǫ́gu; &
...
\alst{k}onung ȯ·blauðan \hld\ \alst{k}vikvan skǫ́ru.}{\lemma{ęn \dots\ skǫ́ru ‘but \dots\ alive.’}\Bfootnote{For the deaths of Guther and Hawn cf.~\textlink{Atlakvida}[23]--35, \textlink{Atlamal}[56]--64.}}\eva
...
they cut the unsoft king \ken*{= Hawn}, alive.\evb\evg


\bvg\bva%
\Ballnote{After recounting her cruel fates, Guthrun addresses Siward, who is long dead.  The tone is at last one of release.  With the departure of her doomed sons Guthrun has nothing to live for upon the earth; her family line is ended, as Byrnhild predicted (\textlink{Sigurdskamma}[63]--64) and she now knows that at last her hard life must soon be over.  She will at last find happiness again, but only in death, reunited with her true love and first husband, Siward.---
An interesting question not dealt with in the poetry is the fact that Byrnhild has already joined Siward by suttee immediately after his death (\textlink{Sigurdskamma}[65]--71, \textlink{Helreid}).  Do the two rival women encounter each other in the afterlife as co-wifes, or does one oust the other?}%
Fjǫlð man’k bǫlva, \hld\ \edtext{[...]}{\Bfootnote{A half-line is undoubtedly missing here.  It would presumably have mirrored the first half-line, containing \emph{fjǫlð man’k b-} ‘I recall a multitude of ...’ with alliteration on a noun beginning with \emph{b}; cf.~the similar structure of \textlink{Thrymskvida}[23]/3.}} &
\alst{b}ęit-tu, \edtext{\alst{S}ig·\emph{vǫ}rðr}{\Afootnote{metr.~emend.~\parencite[135--141]{Sievers1889}; \emph{Sig·urðr} \Regius}}, \hld\ inn \alst{b}lakka mar, &
...
who to Guthrun might give presents.\evb\evg


\bvg\bva%
\alst{M}inns-tu, \edtext{\alst{S}ig·\emph{vǫ}rðr}{\Afootnote{metr.~emend.~\parencite[135--141]{Sievers1889}; \emph{Sig·urðr} \Regius}}, \hld\ hvat vit \alst{m}ę́ltum &
þȧ’s vit ȧ \alst{b}ęð \hld\ \alst{b}ę́ði sǫ́tum? &
at þú \alst{m}yndir \alst{m}i̇́n \hld\ \alst{m}óðugr vitja, &
\alst{h}alr, ór \alst{h}ęlju, \hld\ en ek þi̇́n ór \alst{h}ęimi.\eva

\bvb Dost thou remember, Siward, what we said \\
when on the bed we both did sit, \\
that thou, fierce man, wouldst visit me \\
out of Hell---and I thee out of the world?\evb\evg


\bvg\bva%
\Ballnote{Guthrun orders the construction of her own pyre.  It is not necessary to think that she is to be burned alive, although that is by no means impossible; she may plan to commit suicide (prob. by a sword) beforehand.}%
Hlaðið \alst{é}r, \alst{ja}rlar, \hld\ \edtrans{\alst{ęi}ki-kǫst’inn}{the oaken pile}{\Bfootnote{Acc. sg. of \emph{ęiki-kǫstr} ‘pile, heap of oakwood’, suffixed with the definite \emph{inn}.  The clitic definite, a decidedly late, or at the very least non-poetic, feature, is metrically required.}}, &
látið þann und \edtrans{\alst{h}i\emph{mn}i}{heaven}{\Afootnote{emend.; \emph{hilmi} ‘prince’ \Regius}\Bfootnote{Although \emph{und hilmi} could be read as ‘around the prince’, the pyre is certainly Guthrun’s.  At this point in the narrative Siward is long dead, and the point of the pyre is for Guthrun to join him in the afterlife.  Since no prince is being burned this requires emendation, and \emph{himni} ‘heaven’ (dat.~sg.) easily presents itself.  It is a common poetic motif for something to be ‘the best under heaven’; cf.~\textlink{Gripisspa}[10]/4, \Ynglingatal\ 27, Sö 136 (under Misc.~Runic Poetry), etc.}} \hld\ \alst{h}ę́stan verða! &
Męgi \alst{b}ręnna \edtext{\alst{b}rjóst \hld\ \alst{b}ǫlva-fullt}{\lemma{brjóst bǫlva-fullt ‘my bale-filled breast’}\Bfootnote{The possessive pronoun is implicit.  With these words Guthrun reflects on the many evils she has been responsible for (cf.~\textlink{Atlakvida}[47]).}} ęldr &
{[\dots]} umb hjarta \hld\ þiðni sorgir!“\eva
...
\bvg\bva%
\Ballnote{The last st.~seems to step out of the world of the poem.  It should probably be read in the voice of the narrating ballad-poet, who addresses the members of the audience and wishes them better fortunes than the characters in the legend.  The aristocratic titles afforded to the audience are notable.}%
...
after this grief-chain has been retold.\evb\evg
