...
\noindent {\Large \emph{Om drömmar skola rinna bort, som snö, \\
när lyktas vintern, åter blottas Jord, \\
från sinne sömnomhöljt, och därmed dö, \\
jag båd’ att efter levde dessa ord. \\
Dem tage, hålle hon som intet vet, \\
om fällde i sin ovetskap blott en \\
fullärlig tår---men skedde icke det, \\
då bränn dem under Månens klara sken, \\
att det som sjungits utan kraft och mod \\
bort glömmes, och ej mer förnedrar dem \\
som förr för intet mer utguto blod \\
än yrig dröm om himmelrikets hem. \\
Ty knappt du, Måne, skiner för vår skull \\
om vi förbliva halva---och du full.}}
\par}
