...
What is this book?  It is a book of poems, really, of songs—songs dating to the first millenium \ce\ or some time thereafter.  What is their nature?  They were sung by the Germanic peoples about their Gods and heroes through Dark Ages, through the fall of Rome and the volcanic winter of 536, in ships going to England and on the shores of England, in frozen settlements on Iceland and Greenland, in Danish fields, Swedish forests, Norwegian firths and, even, German monasteries.
...
The alliterative, Northern epics are stories the Germanic-speaking West for many centuries forgot.  We forgot them when we became just that, Westerners—Christians, Romans.  It was Alcuin, the English scholar, who in a letter upbraided his less learnèd English brethren who would rather sing pagan Saxon songs about Ingeld than the Psalms of David—“what does Ingeld have to do with Christ?” he asked.  It was Louis the Pious, king of the Franks, who burned his father’s, Charlemagne’s, great collection of German epic poetry.  For these new men, whose souls were circumcised, even if their bodies were not, the ethos of the old folk-songs was too warlike, to fatalistic, in a word, too pagan.

The echoes of the same songs in time suffered a tragic fate in England and the Continent.  The heavily damaged copies written in idioms and hands far too archaic to be understood by later ages were cut up and used for their thick leather as covers for younger, more modern books.  And yet measuring fate would not have it that they were, like so many other European pagan traditions, forever lost.  It was on Iceland alone, that northern island outpost on the edge of the known world, where the songs of Gods and heroes lived on in the mouths of hoary upholders of tradition.  It was that most distant offshoot of Germandom, whose insatiable settlers sailed as far as Greenland and North America, which in time came to preserve what the center had lost.

The Codex Regius of the Poetic Edda, the last surviving storehouse of the songs of the Germanic gods, was rediscovered in Iceland in 1642.  Together with the Prose Edda it laid the ground for the new field of the study of Germanic antiquity, which over time developed in lockstep with the evolution of Western science and culture in general and that of philology and linguistics in particular.  Over the centuries it was joined by \emph{Beowulf}, the Exeter Book, \emph{Hildebrandslied}, the Merseburg charms, the Gallehus horns and countless other minor sources.  No edition could aim to give a complete overview of all scholarly efforts since the 17th century.  The goal of the present edition must only be to provide a small selection of previous insights, together with some new ones, which (it is hoped) may inspire the curiosity of the English-speaking reader and increase his or her understanding and respect for these frequently very difficult texts.

\section{The historical and cultural context}

  It is presupposed throughout this book that the Germanic-speaking peoples, the English, Scots, Swedes, Danes, Norwegians, Faroese, Icelanders, Frisians, and Germans were originally united by much more than their languages.  These nations, although greatly splintered by the turns of history, at one point share not only language, but culture, religion, and common ancestry.

  All Germanic languages—like the Romance languages from Latin—ultimately descend from Proto-Germanic.  Unlike its contemporary Classical Latin, Proto-Germanic is a reconstructed language only attested in a few borrowed names and short, late runic inscriptions.  Still, we have enough data to be able to reconstruct it fairly faithfully, and such reconstructions will appear throughout the book.
...
\section{Germanic alliterative poetry}
  ...
  Tacitus may also give us the earliest example of the Germanic long-line, the same meter as \textlink{Beowulf} and the Poetic Edda, when he (\emph{Germania} 40) lists the following tribes as worshipping \emph{Nerthus}: \emph{Reudigni, Aviones, Anglii, Varini, Eudoses, Suardones, Nuithones}.  If \emph{Nuithones} is emended to \emph{*Unithones} the whole may be arranged into two long-lines, both with vowel-alliteration \parencites{Malone1934}{Malone1936}:
  ...
  The most likely explanation for this use of alliteration is a rather straight-forward one: the Germanic informer recited the tribes in the order he had learnt them, namely as an alliterative poem or \emph{þula} not unlike what we find in later texts like \textlink{Widsith} \parencite{Malone1936}.
  ...
  The earliest Germanic-language attestations of the long-line are in runic inscriptions from the early centuries \ce, the oldest of which is an early 3rd century sword-chape from Thorsberg moor in Schleswig; they are edited in the pres. ed. under Miscellaneous Runic Poetry.

  In these inscriptions we find not just the fully formed long-line but also examples of unique stylistic traits common to all later Germanic alliterative poetry.  Thus the Tjurkö bracteate (DR IK184) calls gold \emph{walha-kurné} (dat. sg.) ‘Roman grain’, a kenning-like reference to the melting of Roman solidi; the Thorsberg chape (DR 7) expresses being ‘famous’ with the litotes \emph{ni wajé-máriʀ} ‘not ill-famed’ (cf. \textlink{Atlakvida}[13]/1); and the Noleby stone (Vg 63) mirrors the formula \emph{rúnó ragina-kundó} (acc. sg.) ‘rune born of the Gods’ later found in the 9th century \hyperref[Havamal:80]{\emph{Háva mǫ́l}, st. 80}.

  Of course, a far greater trove of rich expressions and images, many of great antiquity, is found in the much more extensive corpus of poetry written down in mediæval manuscripts.  In \Beowulf\ and the Edda ‘sea-stallions’ sail across the ocean like in Homer; in \textlink{Grimnismal}[38] the sun is drawn across Heaven in her chariot like in \Rigveda\ and the Trundholm Sun Chariot; in \Beowulf, \textlink{Heliand}, \textlink{Atlakvida} and others feasts are held in great chiefly ‘mead-halls’ as known from archeology of both the Nordic Bronze and Iron Ages.

  These are not uniquely mediæval motifs, nor are they inventions of the first centuries \ce; instead they time and time again find strong parallels in texts and archeological finds as old as the Bronze Age.  The poems themselves are clearly much younger than this, but still not so young that their decidedly unlatinate authors could have been influenced in any way by texts yet unknown to Northern Europe.  Rather, they retain ancient traditions which must have been passed down through an unbroken chain of poetry going back far into prehistory, to when the Indo-Europeans were still nomadic steppe-pastoralists, when most of Europe was thick forest and marshlands.
