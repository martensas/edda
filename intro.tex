...
\begin{titlingpage}
  ...
  \HUGE \textsc{\@title} \\
  \vspace{1cm}
  \Huge \emph{The Poetic Edda} \\
  \Huge \emph{and Other Old Germanic \\ Alliterative Poetry} \\
  \vspace{1cm}
  ...
  The reader is kindly asked to download periodically the newest version from \url{https://github.com/martensas/edda}. \\
  Corrections and questions are gratefully accepted at \url{kon6studios@gmail.com}.
  \makeatother
\end{titlingpage}
...
\begin{center}{\huge \emph{Om drömmar ſkola rinna bort, ſom ſnö, \\
när lyktas vintern, åter blottas Jord, \\
från ſinne ſömnomhöljt, och dermed dö, \\
jag båd’ att efter lefde deſſa ord. \\
Dem tage, hålle hon ſom intet vet, \\
om fällde i ſin ovetſkap blott en \\
fullärlig tår---men ſkedde icke det, \\
då bränn dem under Månens klara ſken, \\
att det ſom ſjungits utan kraft och mod \\
förglömmes, och ej mer förnedrar dem \\
ſom förr för intet mer utguto blod \\
än yrig dröm om himmelrikets hem. \\
Ty knappt ens Månen ſkiner för vår ſkull \\
...
\begin{center}{\Large \emph{Meðal-snotr \hld\ skyli manna hvęrr, \\
ę́va til snotr séi; \\
því’t snotrs manns hjarta \hld\ verðr sjaldan glatt, \\
ef sá ’s al-snotr es á.}}\end{center}
...
{\leftskip=0pt plus .5fil \rightskip=0pt plus -.5fil \parfillskip=0pt plus 1fil
\noindent This work has benefitted from the feedback and criticism of countless people.  The following persons have been especially helpful in giving suggestions, corrections, and stimulating discussion: Antonín Ryšavý, Axel Nilsson, Connor Alford, Esmeralda d., Graham Scheper, John Newman, J. Hertling, Joseph S. Hopkins, Lukas Danford, Mikael Males, Nikhil Surya Dwibhashyam, Trevor L. Payne, Zhao Yuanlong.\par}

\newpage\thispagestyle{empty}

\def\booktitle{Contents}%
\tableofcontents
...
\bookStart{Bibliography}

\def\booktitle{Bibliography}%

\section{List of Abbreviations}

\printshorthands[heading=none]
...
\section{The historical and cultural context}
  ...
  What the genetics show us is that the Germanic peoples originate in Northern Europe, chiefly Scandinavia and Northern Germany, and that the speakers of Proto-Germanic were genetically indistinguishable from modern indigenous Scandinavians.  They in turn derived much of their ancestry from the early Indo-Europeans of the Pontic-Caspian steppe, who mixed with Early European Farmers to the west to form the Corded Ware Culture, which over time expanded in all directions \parencite{McColl2024}.

  In the West this early Indo-European culture formed the Bell Beakers who conquered Ireland and Iberia; in the South it formed the Italic peoples who eventually became the Romans; in the East it formed the Sintashta culture, or Proto-Indo-Iranians, whose descendants became the Iranians and Vedic Indians who founded the Zoroastrian and Vedic religions; in the Northeast it formed the Balts and Slavs; and in Scandinavia it formed the Battle Axe and Single Grave cultures which eventually gave way to the Nordic Bronze Age, the ancestors of the Germanic peoples.
  ...
  Although the genes for light eyes and hair colour were present already on the Pontic-Caspian steppe, it was in the later Corded Ware that the heavy selection for these traits was effected \parencites{Wilde2014}{Ju2021}{Perretti2025}, traits which to this day reach their highest frequency in Northern Europe \parencite{Frost2006}.
...
\section{Germanic alliterative poetry}
  ...
  The earliest indisputable native attestations of the long-line are in runic inscriptions from the early centuries \ce, the oldest of which is an early 3rd century sword-chape from Thorsberg moor in Schleswig.  These inscription are edited in the pres. ed. under Runic Poetry.

  In these finds we see not just the fully formed long-line but also examples of stylistic traits common to all later Germanic alliterative poetry.  Thus the 5th century Tjurkö bracteate (DR IK184) calls gold \emph{walha-kurné} (dat. sg.) ‘Roman grain’, a kenning-like reference to the melting of Roman solidi; the 3rd century Thorsberg chape (DR 7) expresses being ‘famous’ with the litotes \emph{ni wajé-máriʀ} ‘not ill-famed’ (cf.~\textlink{Atlakvida}[13]/1); and the 6th century Noleby stone (Vg 63) mirrors the formula \emph{rúnó ragina-kundó} (acc. sg.) ‘rune born of the Gods’ later found in the 9th century \hyperref[Havamal:80]{\emph{Hǫ́va mǫ́l}, st.~80}.

  Of course, a far greater trove of rich expressions and images, many of great antiquity, is found in the extensive corpus of poetry written in mediaeval manuscripts.  In \Beowulf\ and the Edda ‘sea-stallions’ sail across the ocean like in Homer; in \textlink{Grimnismal}[38] the sun is drawn across Heaven in her chariot like in \Rigveda\ and the Trundholm Sun Chariot; in \Beowulf, \textlink{Heliand}, \textlink{Atlakvida} and other poems feasts are held in great chiefly ‘mead-halls’, not unknown from the archaeology of the Nordic Bronze and Iron Ages.

  The richness of the poetic tradition is expressed through a language of kennings, stock phrases and exclusive synonyms found only in poetry.  Many of these synonyms are quite ancient, being Indo-European words otherwise extinct in all Germanic languages which find their last refuge in poetry.  Such are the Old English \emph{eoh}, Old Norse \emph{jór}, corresponding to the Sanskrit \textoi{áşva}, Latin \emph{equus}, all meaning ‘horse’; Old Norse \emph{týr}, corresponding to Sanskrit \textoi{dēvá}, Latin \emph{deus}, all meaning ‘god’; Old English \emph{folde}, Old Norse \emph{fold}, corresponding to Sanskrit \textoi{pr̥tʰivī́}, all meaning ‘land, (mother) earth’.  The fact that many of these relate to the cult perhaps suggests that the Germanic religion was not as innovative as is commonly supposed.

  What a comparative investigation reveals is thus that these poetic motifs and words are seldom uniquely mediaeval, nor even inventions of the first centuries \ce; instead they time and time again find parallels in texts and archaeological finds as old as the Bronze Age.  The poems themselves are clearly much younger than this, but still not so young that their undoubtedly unlatinate authors could have been influenced by texts like the Iliad, which were still yet unknown in Northern Europe.  Rather, they seem to retain ancient traditions which must have been passed down through an unbroken chain of poetry going back far into prehistory, to when the Indo-Europeans were still nomadic steppe-pastoralists and much of Europe was still covered by thick forest and marshlands.
  ...
  \subsection{Structure}
    ...
    Any vowel or diphthong can alliterate with any other vowel or diphthong.
...
\section{The corpus}
  ...
  \begin{enumerate}
    ...
    \item \textbf{Galders}, i.e., alliterative spells and charms, both from runic inscriptions and mediaeval manuscripts.
  ...
  \subsection{Manuscripts}
    ...
    The edited Old English poetry primarily derives from a few manuscripts.  Particularly important are the Exeter Book (\ExeterBook) and \Lacnunga.
...
\section{The presentation of the text}
  ...
  \subsection{The Old Germanic text}
    ...
    \item Excepting those long vowels which have their origin in earlier diphthongs, which are written with the circumflex.
    ...
    \item I distinguish long nasal \emph{ȧ, ė, i̇́, ȯ, u̇} from long oral \emph{á, é, í, ó, ú}, as done in the First Grammatical Treatise.
    ...
    A few changes are specific to OSwe and ODan.  According to rule 3 in the general orthographic conventions above, I distinguish between \emph{ǿ} (< \emph{ǿ}) vs. \emph{ø̂} (< \emph{au, ęy}), \emph{é} (< \emph{é}) vs. \emph{ê} (< \emph{ęi}).

    Where all unstressed vowels have been reduced to a schwa-like sound, this is written with \emph{e}.
  ...
  \subsection{The English translation}
    ...
    What sets my translation apart from previous English translations is that it aims to follow the style and register of the original text closely, without sacrificing the literal sense of the words, e.g., by removing or inserting matter where it is not present in the original.  The downside of this is that literality and consistency at times must come at the cost of fluid idiomatic English, but it has the advantage of giving the reader a good idea not just of \emph{what} the original text says, but \emph{how} it says it.  The reader should keep in mind that he is venturing in a foreign land, that he is reading ancient and obscure words---not \emph{The New York Times} or \emph{The Guardian}.
    ...
    \subsection{The proper nouns}
      The single most idiosyncratic part of the present translation will undoubtedly be its handling of proper nouns. I have opted to render all cultural and religious terms, names of places, heroes, gods, and other entities by their natural English cognates (e.g., \emph{Thunder} for Old Norse \emph{Þórr}); and, where such do not exist, by their philologically expected English (so-called “Anglish”) forms (e.g., \emph{*wallow} for Old Norse \emph{vǫlva}).  Due to the parallel original-language edition and index, it is hoped that no vital information will be lost by this decision; the reader wishing to know the original form of Webthrithner can either look in the Old Norse, or, if the case endings confuse him, peruse the index.

      There are three reasons behind this choice.  The first is ideological.  It is my belief that the Old Germanic myths and poems and gods and heroes are a shared Northern European heritage.  When one compares these mediaeval texts from Germany, England, and Scandinavia, one cannot but notice the striking similarity of their diction, the reoccurence of figures and formulae, and the common worldview.  Likewise, the personages are frequently the same: the Scandinavian hero \emph{Vǫlundr} is the same character as the English \emph{Wélund}, the Norse god \emph{Óðinn} is the same as the English \emph{Wóden}, and this is how they were understood by the native speakers of the old tongues.  Since English is a Germanic language and its speakers the linguistic heirs of the Anglo-Saxons and Norse---in many case their direct descendants---and since these varying names are ultimately mere distinctions in pronunciation which reflect shared underlying forms, it was felt important and valuable to render them in the English translation by their natural or expected English reflexes.  The forms of the names thereby serve to reflect the continuity between the speakers of modern English and those of the Old Germanic languages.

      The second reason is one of consistency.  If we are to restore well-attested names like Weden and Thunder, it would not be consistent to retain others in an unadapted form (e.g., to have Weden conversing with \emph{Vaf·þrúðnir}, or Thunder with \emph{Hár·barðr}), which would produce a highly discordant effect.  Since the Anglish names are to be restored in some places, consistency requires that they be restored in all, even where they do not survive in modern English (or even in Old English).

      The third reason is one of linguistic aesthetics.  It is an indisputable fact that the commonly accepted forms like \emph{Odin}, \emph{Thor}, \emph{Midgard} etc.~are debased.  They do not even represent the Old Norse pronunciation as accurately as would be possible within the constraints of English ortography (e.g., \emph{Odin} would be better anglicized as \emph{Othin}).  What is more, they are often difficult for English speakers to pronounce and lead to absurd errors and mispronunciations.  The fluent reader of Old Norse cannot but shudder when he hears \emph{ę́sir} and \emph{Ǫ́s·garðr} pronounced as \textipa{/aI"sI:\*r/} and “ass-guard”, or when he sees \emph{Jǫrmun·gandr} spelled “Jormangander”.  The native English forms, on the other hand, fit well within English orthography, and their pronunciation is immediately recognisable.
